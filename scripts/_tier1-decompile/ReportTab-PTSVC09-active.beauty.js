const ju = (s, f0 = ju, M = f0.f || (f0.f = ["assets/xlsx.min-CZi5yKex.js", "assets/vendor-react-ByYOq5k4.js"])) => s.map(A0 => M[A0]);
import {
  _ as cu,
  E as yE,
  h as _u
...
function vE(s, f0, M) {
  ...
  const A0 = s.fy1_totals,
    C = s.fy2_totals,
    i0 = s.comparison.filter(R0 => R0.fy1?.has_data && R0.fy2?.has_data);
  ...
  const e0 = (R0, u0 = 0) => Number.isFinite(Number(R0)) ? Number(R0) : u0,
    ...
    G0 = e0(C.ipd_discharge),
    V0 = e0(A0.ipd_deaths),
    M0 = e0(C.ipd_deaths),
    c0 = e0(A0.opd_deaths),
    m0 = e0(C.opd_deaths),
    S0 = e0(A0.total_deaths),
    p0 = e0(C.total_deaths),
    eu = e0(A0.ipd_early_deaths),
    a0 = e0(C.ipd_early_deaths),
    G = Eu > 0 ? V0 / Eu * 100 : 0,
    y0 = G0 > 0 ? M0 / G0 * 100 : 0,
    $0 = e0(s.death_growth_pct),
    C0 = V0 > 0 ? eu / V0 * 100 : 0,
    h0 = M0 > 0 ? a0 / M0 * 100 : 0;
  let J = null,
    tu = -1 / 0;
  ...
  let v0, ou;
  y0 >= 3 ? (v0 = `\u{1F534} IPD Mortality Rate ${y0.toFixed(2)}% \u0E2A\u0E39\u0E07\u0E40\u0E01\u0E34\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 3% \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E15\u0E31\u0E49\u0E07 Mortality Review Committee \u0E20\u0E32\u0E22\u0E43\u0E19 7 \u0E27\u0E31\u0E19 \xB7 \u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E01\u0E23\u0E30\u0E17\u0E1A HA accreditation`, ou = "#f43f5e") : $0 >= 20 ? (v0 = `\u26A0 \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E01\u0E32\u0E23\u0E40\u0E2A\u0E35\u0E22\u0E0A\u0E35\u0E27\u0E34\u0E15\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 ${$0}% \u2014 \u0E23\u0E27\u0E21\u0E15\u0E32\u0E22 FY${M} ${p0} \u0E23\u0E32\u0E22 (FY${f0} ${S0}) \xB7 \u0E15\u0E49\u0E2D\u0E07\u0E2A\u0E2D\u0E1A\u0E2A\u0E27\u0E19 Root Cause`, ou = "#f59e0b") : y0 <= 1.5 && $0 <= 0 ? (v0 = `\u2705 Mortality Rate \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E14\u0E35 \u2014 IPD Rate ${y0.toFixed(2)}% \xB7 ${$0>=0?"+":""}${$0}% \u0E40\u0E17\u0E35\u0E22\u0E1A\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19 \xB7 Quality of Care \u0E14\u0E35`, ou = "#10b981") : (v0 = `IPD Mortality ${y0.toFixed(2)}% (FY${f0}: ${G.toFixed(2)}%) \xB7 ${$0>=0?"+":""}${$0}% \xB7 Early Death ${h0.toFixed(1)}% \u0E02\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E15\u0E32\u0E22 IPD`, ou = "#0ea5e9");
  const w0 = (R0, u0, yu) => R0 <= u0 ? "#10b981" : R0 <= yu ? "#f59e0b" : "#f43f5e",
    X0 = [{
      label: `IPD Mortality Rate (${M})`,
      value: `${y0.toFixed(2)}%`,
      sub: `FY${f0}: ${G.toFixed(2)}%`,
      color: w0(y0, 1.5, 3)
    }, {
      label: "Total Deaths",
      value: j0(p0),
  ...
  b0.push({
    ...
    text: `\u0E1B\u0E35\u0E07\u0E1A ${M}: IPD \u0E40\u0E2A\u0E35\u0E22\u0E0A\u0E35\u0E27\u0E34\u0E15 ${j0(M0)} \u0E23\u0E32\u0E22 (rate ${y0.toFixed(2)}%) \xB7 OPD \u0E40\u0E2A\u0E35\u0E22\u0E0A\u0E35\u0E27\u0E34\u0E15 ${j0(m0)} \u0E23\u0E32\u0E22 \xB7 \u0E23\u0E27\u0E21 ${j0(p0)}. \u0E40\u0E17\u0E35\u0E22\u0E1A\u0E1B\u0E35\u0E07\u0E1A ${f0}: IPD ${j0(V0)} (rate ${G.toFixed(2)}%) \xB7 OPD ${j0(c0)} \xB7 \u0E23\u0E27\u0E21 ${j0(S0)}. \u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E41\u0E1B\u0E25\u0E07 ${$0>=0?"+":""}${$0}%. ` + (y0 > G + .3 ? "\u26A0 Rate \u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19\u0E21\u0E35\u0E19\u0E31\u0E22\u0E2A\u0E33\u0E04\u0E31\u0E0D" : y0 < G - .3 ? "\u2705 Rate \u0E25\u0E14\u0E25\u0E07\u0E21\u0E35\u0E19\u0E31\u0E22\u0E2A\u0E33\u0E04\u0E31\u0E0D" : "Rate \u0E43\u0E01\u0E25\u0E49\u0E40\u0E04\u0E35\u0E22\u0E07\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19"),
    color: ou
  }), b0.push({
    icon: "\u23F1\uFE0F",
    title: "Early Death Pattern (LOS < 2 \u0E27\u0E31\u0E19)",
    text: `\u0E1B\u0E35\u0E07\u0E1A ${M}: Early Death ${j0(a0)} \u0E23\u0E32\u0E22 (${h0.toFixed(1)}% \u0E02\u0E2D\u0E07 IPD Deaths) \xB7 \u0E40\u0E17\u0E35\u0E22\u0E1A\u0E1B\u0E35\u0E07\u0E1A ${f0}: ${j0(eu)} \u0E23\u0E32\u0E22 (${C0.toFixed(1)}%). ` + (h0 >= 30 ? "\u{1F534} >30% \u0E40\u0E1B\u0E47\u0E19 early death \u2014 \u0E1A\u0E48\u0E07\u0E0A\u0E35\u0E49\u0E04\u0E27\u0E32\u0E21\u0E23\u0E38\u0E19\u0E41\u0E23\u0E07\u0E02\u0E2D\u0E07\u0E42\u0E23\u0E04\u0E15\u0E2D\u0E19\u0E23\u0E31\u0E1A\u0E40\u0E02\u0E49\u0E32 \u0E2B\u0E23\u0E37\u0E2D admission criteria \u0E17\u0E35\u0E48\u0E2D\u0E32\u0E08\u0E0A\u0E49\u0E32" : h0 >= 15 ? "\u26A0 Early death \u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E2A\u0E39\u0E07 \u2014 \u0E04\u0E27\u0E23\u0E17\u0E1A\u0E17\u0E27\u0E19 triage / ER-to-admission flow" : "\u2705 Early death \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E1B\u0E01\u0E15\u0E34"),
  ...
  const s0 = [];
  return y0 >= 3 && (s0.push("\u{1F534} P0 \xB7 \u0E15\u0E31\u0E49\u0E07 Mortality Review Board (MRB) \u0E23\u0E32\u0E22\u0E2A\u0E31\u0E1B\u0E14\u0E32\u0E2B\u0E4C \u2014 review 100% IPD deaths \xB7 \u0E41\u0E22\u0E01 Preventable vs Non-preventable"), s0.push("\u{1F534} P0 \xB7 Re-train CPR/ACLS + Code Blue response \u0E17\u0E38\u0E01 ward \u0E20\u0E32\u0E22\u0E43\u0E19 30 \u0E27\u0E31\u0E19")), $0 >= 10 && M0 > 0 && s0.push("\u{1F7E0} P1 \xB7 M&M Conference \u0E23\u0E32\u0E22\u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 focus DRG/DX \u0E17\u0E35\u0E48\u0E21\u0E35 mortality \u0E2A\u0E39\u0E07\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14"), h0 >= 20 && s0.push("\u{1F7E0} P1 \xB7 ER Triage Audit \xB7 Early Warning Score (NEWS2) compliance check \xB7 ICU availability in 24/7"), J && tu >= 3 && s0.push(`\u{1F7E1} P2 \xB7 Retrospective Case Review \u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A ${J} \xB7 deep-dive case mix + intervention timing`), M0 >= 20 && s0.push("\u{1F535} P1 \xB7 \u0E2A\u0E23\u0E49\u0E32\u0E07 Mortality Dashboard \u0E23\u0E32\u0E22 Ward / DRG \xB7 \u0E17\u0E1A\u0E17\u0E27\u0E19\u0E17\u0E38\u0E01 3 \u0E40\u0E14\u0E37\u0E2D\u0E19"), s0.push("\u{1F535} P1 \xB7 Preventable Death Reporting \u2014 \u0E41\u0E22\u0E01\u0E40\u0E04\u0E2A\u0E17\u0E35\u0E48 intervention \u0E17\u0E35\u0E48\u0E14\u0E35\u0E01\u0E27\u0E48\u0E32\u0E2D\u0E32\u0E08\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C"), m0 > 0 && s0.push("\u{1F7E1} P2 \xB7 ER Mortality Review \u2014 focus DNR/DAMA patterns \xB7 dispatch time \xB7 resuscitation quality"), b0.push({
    icon: "\u26A0\uFE0F",
    ...
    kpi: X0,
    sections: b0,
    footerLeft: `IPD Discharged ${j0(G0)} \xB7 ${i0.length} \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E17\u0E35\u0E48\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E44\u0E14\u0E49 \xB7 FY${f0} vs FY${M} \xB7 \u0E2D\u0E31\u0E1B\u0E40\u0E14\u0E15 ${new Date().toLocaleString("th-TH")}`
  }
}
...
async function uu(s, f0) {
  const M = await fetch(s, f0),
    A0 = M.headers.get("content-type") || "";
  if (!M.ok) {
    if (A0.includes("application/json")) {
      const C = await M.json();
      throw new Error(C.error || `HTTP ${M.status}`)
    }
...
function DE(s, f0, M, A0 = "OPD") {
  const C = aE[A0] || aE.OPD;
  if (!s?.comparison || !s.fy1_totals || !s.fy2_totals) return null;
  const i0 = s.fy1_totals,
    e0 = s.fy2_totals,
  ...
  const Eu = i0.lab_orders + i0.drug_orders + i0.xray_orders,
    G0 = i0.lab_price + i0.drug_price + i0.xray_price,
    V0 = e0.lab_orders + e0.drug_orders + e0.xray_orders,
    M0 = e0.lab_price + e0.drug_price + e0.xray_price,
    c0 = Number(s.overall_orders_growth_pct ?? 0),
    m0 = Number(s.overall_price_growth_pct ?? 0),
    S0 = V0 - Eu,
    p0 = M0 - G0,
    eu = m0 - c0,
    a0 = (Q, V) => V > 0 ? Math.round((Q - V) / V * 100) : Q > 0 ? 100 : 0,
    G = {
      Lab: {
    ...
    C0 = {
      lab: G0 > 0 ? i0.lab_price / G0 * 100 : 0,
      drug: G0 > 0 ? i0.drug_price / G0 * 100 : 0,
      xray: G0 > 0 ? i0.xray_price / G0 * 100 : 0
    },
    h0 = {
      lab: M0 > 0 ? e0.lab_price / M0 * 100 : 0,
      drug: M0 > 0 ? e0.drug_price / M0 * 100 : 0,
      xray: M0 > 0 ? e0.xray_price / M0 * 100 : 0
    },
    J = Math.round(h0.lab ** 2 + h0.drug ** 2 + h0.xray ** 2),
    tu = J >= 5e3 ? {
      text: "\u0E23\u0E27\u0E21\u0E28\u0E39\u0E19\u0E22\u0E4C\u0E2A\u0E39\u0E07",
      color: "#dc2626"
    } : J >= 3500 ? {
    ...
    v0 = G.Drug.px >= G.Lab.px && G.Drug.px >= G.Xray.px ? {
      name: "Drug (\u0E22\u0E32)",
      g: G.Drug.px
    } : G.Lab.px >= G.Xray.px ? {
    ...
    ou = G.Drug.px <= G.Lab.px && G.Drug.px <= G.Xray.px ? {
      name: "Drug (\u0E22\u0E32)",
      g: G.Drug.px
    } : G.Lab.px <= G.Xray.px ? {
      name: "Lab (\u0E2B\u0E49\u0E2D\u0E07\u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E01\u0E32\u0E23)",
    ...
    w0 = s.comparison.filter(Q => Q.fy1.has_data && Q.fy2.has_data),
    X0 = [];
  let b0 = null,
    Q0 = null,
    s0 = -1 / 0,
    R0 = 1 / 0;
  for (const Q of w0) {
    const V = Q.fy1.lab_orders + Q.fy1.drug_orders + Q.fy1.xray_orders,
    ...
    X0.push({
      ...
      fy1Px: U0,
      fy2Px: q0
    }), ru > s0 && (s0 = ru, b0 = Q.month), ru < R0 && (R0 = ru, Q0 = Q.month)
  }
  let u0 = 0,
    yu = 0;
  if (X0.length >= 2) {
    yu = X0.reduce((V, k0) => V + k0.g, 0) / X0.length;
    const Q = X0.reduce((V, k0) => V + (k0.g - yu) ** 2, 0) / X0.length;
  ...
  if (X0.length >= 4) {
    const Q = Math.floor(X0.length / 2),
      ...
      U0 = V.reduce((au, nu) => au + nu.fy1Px, 0),
      q0 = V.reduce((au, nu) => au + nu.fy2Px, 0),
      ru = k0.reduce((au, nu) => au + nu.fy1Px, 0),
      vu = k0.reduce((au, nu) => au + nu.fy2Px, 0),
      Su = U0 > 0 ? (q0 - U0) / U0 * 100 : 0,
      Cu = ru > 0 ? (vu - ru) / ru * 100 : 0,
      Du = Cu - Su;
    Y0 = {
      h1_label: `${V[0].month}\u2013${V[V.length-1].month}`,
  ...
  if (X0.length >= 3 && u0 > 0) {
    ...
    for (const V of X0) {
      const k0 = V.g - yu;
      Math.abs(k0) >= Q && gu.push({
        month: V.month,
        growth: Math.round(V.g),
  ...
  const Fu = 12 / j0,
    ...
    Ru = {};
  for (const [Q, V] of Object.entries(l0)) {
    const k0 = $0(V.unit),
      U0 = V.share - V.shareFY1;
    let q0;
    V.pxG >= 5 && V.ordG >= 5 ? q0 = "\u0E02\u0E22\u0E32\u0E22\u0E15\u0E31\u0E27\u0E17\u0E31\u0E49\u0E07\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E41\u0E25\u0E30\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32" : V.pxG >= 5 && V.ordG < 2 ? q0 = "Value-driven \u2014 \u0E23\u0E32\u0E04\u0E32\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19" : V.pxG < 0 && V.ordG > 0 ? q0 = "Margin Compression \u2014 \u0E23\u0E32\u0E04\u0E32\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E16\u0E39\u0E01\u0E01\u0E14" : V.pxG < -3 && V.ordG < 0 ? q0 = "\u0E2B\u0E14\u0E15\u0E31\u0E27\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E2D\u0E07\u0E21\u0E34\u0E15\u0E34" : q0 = "\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E43\u0E19\u0E23\u0E30\u0E14\u0E31\u0E1A\u0E1B\u0E01\u0E15\u0E34", Ru[Q] = {
      label: V.label,
      icon: V.icon,
      color: V.color,
      share: V.share.toFixed(1),
      share_delta: U0.toFixed(1),
      ord_growth: V.ordG,
      px_growth: V.pxG,
      unit_fy2: Math.round(V.unit.f2),
      unit_growth: k0,
      abs_px: V.absPx,
      driver: q0,
      narrative: `${V.label}: \u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 ${V.ordG>=0?"+":""}${V.ordG}% \xB7 \u0E21\u0E39\u0E25\u0E04\u0E48\u0E32 ${V.pxG>=0?"+":""}${V.pxG}% (${V.absPx>=0?"+":""}${n(Math.abs(V.absPx))} \u0E1A\u0E32\u0E17) \xB7 \u0E23\u0E32\u0E04\u0E32/\u0E04\u0E23\u0E31\u0E49\u0E07 \u0E3F${n(Math.round(V.unit.f2))} (${k0>=0?"\u2191":"\u2193"}${Math.abs(k0)}%) \xB7 \u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19 ${V.share.toFixed(1)}% (${U0>=0?"+":""}${U0.toFixed(1)} \u0E08\u0E38\u0E14) \u2014 ${q0}`
    }
  }
  let t0;
  const Pu = m0 - c0,
    iu = `${p0>=0?"+":"\u2212"}\u0E3F${n(Math.abs(p0))}`;
  m0 >= 10 && c0 >= 10 ? t0 = `\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${C.short} \u0E1B\u0E35\u0E07\u0E1A ${M} \u0E02\u0E22\u0E32\u0E22\u0E15\u0E31\u0E27\u0E41\u0E02\u0E47\u0E07\u0E41\u0E23\u0E07 \u2014 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 +${m0}% (${iu}) \u0E08\u0E32\u0E01\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 +${c0}% (${j0} \u0E40\u0E14\u0E37\u0E2D\u0E19) \u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19\u0E01\u0E32\u0E23\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E17\u0E31\u0E49\u0E07\u0E40\u0E0A\u0E34\u0E07\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E41\u0E25\u0E30\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E1E\u0E23\u0E49\u0E2D\u0E21\u0E01\u0E31\u0E19` : m0 >= 5 && Pu >= 5 ? t0 = `\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${C.short} +${m0}% (${iu}) \u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E01\u0E32\u0E23\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 (${c0}%) \u2014 Yield \u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19\u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19 Case Complexity / \u0E01\u0E32\u0E23\u0E1B\u0E23\u0E31\u0E1A Unit Price \u0E04\u0E27\u0E23\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E27\u0E48\u0E32\u0E22\u0E31\u0E48\u0E07\u0E22\u0E37\u0E19\u0E2B\u0E23\u0E37\u0E2D\u0E40\u0E1B\u0E47\u0E19\u0E1C\u0E25\u0E0A\u0E31\u0E48\u0E27\u0E04\u0E23\u0E32\u0E27` : c0 > 5 && m0 < 0 ? t0 = `\u26A0 \u0E2A\u0E31\u0E0D\u0E0D\u0E32\u0E13 Margin Compression \u2014 \u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 +${c0}% \u0E41\u0E15\u0E48\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 ${m0}% (${iu}) \u0E23\u0E32\u0E04\u0E32\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E16\u0E39\u0E01\u0E01\u0E14\u0E14\u0E31\u0E19 \u0E04\u0E27\u0E23\u0E40\u0E23\u0E48\u0E07\u0E17\u0E1A\u0E17\u0E27\u0E19 ${C.pricePressure}` : m0 <= -5 && c0 <= 0 ? t0 = `\u26A0 \u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${C.short} \u0E2B\u0E14\u0E15\u0E31\u0E27\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E2D\u0E07\u0E21\u0E34\u0E15\u0E34 \u2014 \u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 ${c0}% \u0E41\u0E25\u0E30\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 ${m0}% (${iu}) \u0E15\u0E49\u0E2D\u0E07\u0E2A\u0E2D\u0E1A\u0E2A\u0E27\u0E19 Root Cause \u0E14\u0E48\u0E27\u0E19 (${C.rootCause})` : t0 = `\u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${C.short} ${m0>=0?"\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15":"\u0E2B\u0E14\u0E15\u0E31\u0E27"} ${Math.abs(m0)}% \u0E40\u0E0A\u0E34\u0E07\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32 (${iu}) \xB7 \u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 ${c0>=0?"+":""}${c0}% \xB7 Yield ${eu>=0?"+":""}${eu.toFixed(1)}pp \xB7 \u0E0A\u0E48\u0E27\u0E07\u0E17\u0E35\u0E48\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E44\u0E14\u0E49 ${j0} \u0E40\u0E14\u0E37\u0E2D\u0E19`;
  const Wu = Math.round(M0 / j0),
    g0 = `Run-rate \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${n(Wu)} \u0E1A\u0E32\u0E17/\u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 \u0E2B\u0E32\u0E01\u0E23\u0E31\u0E01\u0E29\u0E32\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E19\u0E35\u0E49\u0E44\u0E14\u0E49\u0E04\u0E23\u0E1A\u0E1B\u0E35 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${C.short} \u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E44\u0E27\u0E49\u0E17\u0E35\u0E48 ${n(xu)} \u0E1A\u0E32\u0E17 (\u0E40\u0E17\u0E35\u0E22\u0E1A FY${f0} annualized: ${n(bu)} \u0E1A\u0E32\u0E17 \xB7 ${zu>=0?"\u0E1A\u0E27\u0E01":"\u0E25\u0E1A"} ${n(Math.abs(zu))} \u0E1A\u0E32\u0E17)`,
    Tu = `\u0E1B\u0E35\u0E07\u0E1A ${M} \u0E21\u0E35\u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E43\u0E0A\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23\u0E23\u0E27\u0E21 ${n(V0)} \u0E04\u0E23\u0E31\u0E49\u0E07 (\u0E1B\u0E35\u0E07\u0E1A ${f0}: ${n(Eu)} \u0E04\u0E23\u0E31\u0E49\u0E07 \xB7 ${S0>=0?"+":""}${n(Math.abs(S0))} \u0E04\u0E23\u0E31\u0E49\u0E07 / ${c0>=0?"+":""}${c0}%) \u0E2A\u0E48\u0E27\u0E19\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32\u0E23\u0E27\u0E21 ${n(M0)} \u0E1A\u0E32\u0E17 (\u0E1B\u0E35\u0E07\u0E1A ${f0}: ${n(G0)} \u0E1A\u0E32\u0E17 \xB7 ${p0>=0?"+":""}${n(Math.abs(p0))} \u0E1A\u0E32\u0E17 / ${m0>=0?"+":""}${m0}%). Yield Gap = ${eu>=0?"+":""}${eu.toFixed(1)} percentage points \u2014 ` + (m0 > c0 + 2 ? "Yield \u0E15\u0E48\u0E2D\u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19 \u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19 Case Mix \u0E0B\u0E31\u0E1A\u0E0B\u0E49\u0E2D\u0E19\u0E02\u0E36\u0E49\u0E19, \u0E01\u0E32\u0E23\u0E1B\u0E23\u0E31\u0E1A\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E48\u0E32\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 \u0E2B\u0E23\u0E37\u0E2D\u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49\u0E22\u0E32/\u0E2B\u0E31\u0E15\u0E16\u0E01\u0E32\u0E23\u0E17\u0E35\u0E48\u0E21\u0E35\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19. " : m0 < c0 - 2 ? "Yield \u0E15\u0E48\u0E2D\u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E15\u0E48\u0E33\u0E25\u0E07 \u0E2D\u0E32\u0E08\u0E40\u0E01\u0E34\u0E14\u0E08\u0E32\u0E01 Generic Substitution, \u0E01\u0E32\u0E23\u0E1B\u0E23\u0E31\u0E1A\u0E23\u0E32\u0E04\u0E32\u0E25\u0E07 \u0E2B\u0E23\u0E37\u0E2D Case Mix \u0E2D\u0E48\u0E2D\u0E19\u0E25\u0E07. " : "Yield \u0E15\u0E48\u0E2D\u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E04\u0E48\u0E2D\u0E19\u0E02\u0E49\u0E32\u0E07\u0E04\u0E07\u0E17\u0E35\u0E48 \u0E01\u0E32\u0E23\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E2A\u0E21\u0E14\u0E38\u0E25\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E41\u0E25\u0E30\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32. ") + g0,
    x0 = `\u0E42\u0E04\u0E23\u0E07\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E1B\u0E35\u0E07\u0E1A ${M}: Drug ${h0.drug.toFixed(1)}% \xB7 Lab ${h0.lab.toFixed(1)}% \xB7 CT/X-ray ${h0.xray.toFixed(1)}% (\u0E1B\u0E35\u0E07\u0E1A ${f0}: ${C0.drug.toFixed(1)}% / ${C0.lab.toFixed(1)}% / ${C0.xray.toFixed(1)}%). Growth Driver \u0E2B\u0E25\u0E31\u0E01\u0E04\u0E37\u0E2D ${v0.name} (+${v0.g}%) \xB7 \u0E2B\u0E21\u0E27\u0E14\u0E2D\u0E48\u0E2D\u0E19\u0E41\u0E23\u0E07\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14\u0E04\u0E37\u0E2D ${ou.name} (${ou.g>=0?"+":""}${ou.g}%). HHI = ${n(J)} (${tu.text}) \u2014 ` + (Math.abs(h0.drug - C0.drug) >= 3 ? `\u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19 Drug ${h0.drug>C0.drug?"\u0E02\u0E22\u0E31\u0E1A\u0E02\u0E36\u0E49\u0E19":"\u0E25\u0E14\u0E25\u0E07"} ${Math.abs(h0.drug-C0.drug).toFixed(1)} \u0E08\u0E38\u0E14 \u0E1A\u0E48\u0E07\u0E0A\u0E35\u0E49\u0E1E\u0E24\u0E15\u0E34\u0E01\u0E23\u0E23\u0E21\u0E01\u0E32\u0E23\u0E2A\u0E31\u0E48\u0E07\u0E43\u0E0A\u0E49\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E44\u0E1B\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E21\u0E35\u0E19\u0E31\u0E22\u0E2A\u0E33\u0E04\u0E31\u0E0D` : "Portfolio \u0E04\u0E48\u0E2D\u0E19\u0E02\u0E49\u0E32\u0E07\u0E04\u0E07\u0E17\u0E35\u0E48 \u0E44\u0E21\u0E48\u0E21\u0E35\u0E01\u0E32\u0E23\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E41\u0E1B\u0E25\u0E07\u0E40\u0E0A\u0E34\u0E07\u0E42\u0E04\u0E23\u0E07\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E17\u0E35\u0E48\u0E21\u0E35\u0E19\u0E31\u0E22\u0E2A\u0E33\u0E04\u0E31\u0E0D"),
    ...
    Au = `\u0E04\u0E48\u0E32\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07 \u0E1B\u0E35\u0E07\u0E1A ${M}: Lab \u0E3F${n(Math.round(y0.Lab.f2))}/\u0E04\u0E23\u0E31\u0E49\u0E07 (${$0(y0.Lab)>=0?"\u2191":"\u2193"}${Math.abs($0(y0.Lab))}% \xB7 FY${f0}: \u0E3F${n(Math.round(y0.Lab.f1))}) \xB7 Drug \u0E3F${n(Math.round(y0.Drug.f2))}/\u0E04\u0E23\u0E31\u0E49\u0E07 (${$0(y0.Drug)>=0?"\u2191":"\u2193"}${Math.abs($0(y0.Drug))}% \xB7 FY${f0}: \u0E3F${n(Math.round(y0.Drug.f1))}) \xB7 CT/X-ray \u0E3F${n(Math.round(y0.Xray.f2))}/\u0E04\u0E23\u0E31\u0E49\u0E07 (${$0(y0.Xray)>=0?"\u2191":"\u2193"}${Math.abs($0(y0.Xray))}% \xB7 FY${f0}: \u0E3F${n(Math.round(y0.Xray.f1))}) \u2014 \u0E15\u0E31\u0E27\u0E40\u0E25\u0E02\u0E19\u0E35\u0E49\u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19 Case Complexity \u0E41\u0E25\u0E30\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E08\u0E23\u0E34\u0E07\u0E15\u0E48\u0E2D\u0E01\u0E32\u0E23\u0E43\u0E2B\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 ${Mu}. ` + (y0.Drug.f2 > y0.Drug.f1 * 1.1 ? "Drug Unit Price \u0E1E\u0E38\u0E48\u0E07\u0E40\u0E01\u0E34\u0E19 10% \u2014 \u0E04\u0E27\u0E23\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A High-cost Drug List. " : "") + (y0.Xray.f2 > y0.Xray.f1 * 1.1 ? "Imaging Unit Price \u0E1E\u0E38\u0E48\u0E07\u0E40\u0E01\u0E34\u0E19 10% \u2014 \u0E2D\u0E32\u0E08\u0E21\u0E35\u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49 CT/MRI \u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E21\u0E32\u0E01\u0E02\u0E36\u0E49\u0E19. " : "");
  let ku;
  if (b0 && Q0) {
    const Q = Math.round(s0 - R0);
    ku = `\u0E40\u0E14\u0E37\u0E2D\u0E19 Peak: ${b0} (${s0>=0?"+":""}${Math.round(s0)}%) \xB7 \u0E40\u0E14\u0E37\u0E2D\u0E19 Dip: ${Q0} (${R0>=0?"+":""}${Math.round(R0)}%) \xB7 Spread = ${Q} percentage points. ` + (Q >= 40 ? "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E2A\u0E39\u0E07 \u2014 \u0E0A\u0E48\u0E2D\u0E07\u0E27\u0E48\u0E32\u0E07\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E1E\u0E35\u0E04\u0E41\u0E25\u0E30\u0E14\u0E34\u0E1B\u0E21\u0E32\u0E01 \u0E15\u0E49\u0E2D\u0E07\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23 Staffing, Stock, Capacity \u0E41\u0E1A\u0E1A\u0E22\u0E37\u0E14\u0E2B\u0E22\u0E38\u0E48\u0E19" : Q >= 20 ? "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E1B\u0E32\u0E19\u0E01\u0E25\u0E32\u0E07 \u2014 \u0E21\u0E35 Seasonality \u0E41\u0E15\u0E48\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23\u0E44\u0E14\u0E49" : "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E15\u0E48\u0E33 \u2014 Demand \u0E04\u0E48\u0E2D\u0E19\u0E02\u0E49\u0E32\u0E07\u0E2A\u0E21\u0E48\u0E33\u0E40\u0E2A\u0E21\u0E2D")
  } else ku = "\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E23\u0E32\u0E22\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E40\u0E1E\u0E35\u0E22\u0E07\u0E1E\u0E2D\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A\u0E01\u0E32\u0E23\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C Seasonality";
  const N0 = [];
  if (c0 > 10 && m0 < 0 && N0.push(`\u{1F534} Margin Compression: \u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 +${c0}% \u0E41\u0E15\u0E48\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 ${m0}% (${iu}) \u2014 \u0E23\u0E32\u0E04\u0E32\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E16\u0E39\u0E01\u0E01\u0E14\u0E14\u0E31\u0E19 \u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A Price List / Discount Policy / Insurance Reimbursement Rate`), m0 >= 15 && c0 <= 3 && N0.push(`\u{1F7E0} Single-source Growth: \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E42\u0E15\u0E08\u0E32\u0E01 Unit Price \u0E40\u0E1B\u0E47\u0E19\u0E2B\u0E25\u0E31\u0E01 (+${m0}% vs +${c0}% volume) \u2014 \u0E40\u0E1B\u0E23\u0E32\u0E30\u0E1A\u0E32\u0E07\u0E15\u0E48\u0E2D\u0E01\u0E32\u0E23\u0E1B\u0E23\u0E31\u0E1A\u0E23\u0E32\u0E04\u0E32\u0E22\u0E32/\u0E23\u0E35\u0E40\u0E2D\u0E40\u0E08\u0E19\u0E15\u0E4C/\u0E2D\u0E31\u0E15\u0E23\u0E32 \u0E2A\u0E1B\u0E2A\u0E0A. \u0E43\u0E19\u0E1B\u0E35\u0E16\u0E31\u0E14\u0E44\u0E1B`), (G.Drug.ord > 20 || G.Drug.px > 20) && N0.push(`\u{1F534} Drug Utilization \u0E1E\u0E38\u0E48\u0E07 (+${G.Drug.ord}% orders / +${G.Drug.px}% value \xB7 ${G.Drug.absPx>=0?"+":""}\u0E3F${n(Math.abs(G.Drug.absPx))}) \u2014 \u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A Polypharmacy, \u0E04\u0E27\u0E32\u0E21\u0E40\u0E2B\u0E21\u0E32\u0E30\u0E2A\u0E21\u0E02\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E2A\u0E31\u0E48\u0E07\u0E43\u0E0A\u0E49 \u0E41\u0E25\u0E30 Formulary Compliance`), G.Xray.ord > 15 && G.Xray.ord > c0 * 1.5 + 5 && N0.push(`\u{1F7E0} Imaging \u0E42\u0E15\u0E40\u0E23\u0E47\u0E27\u0E01\u0E27\u0E48\u0E32\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E27\u0E21 (+${G.Xray.ord}% vs ${c0}%) \u2014 \u0E23\u0E30\u0E27\u0E31\u0E07 Defensive Medicine / Over-ordering \u0E04\u0E27\u0E23\u0E17\u0E1A\u0E17\u0E27\u0E19 Evidence-based Guideline`), m0 < -10 && N0.push(`\u{1F534} \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${C.short} \u0E2B\u0E14\u0E15\u0E31\u0E27 ${m0}% (${iu}) \u2014 \u0E2A\u0E31\u0E0D\u0E0D\u0E32\u0E13 ${C.rootCause} \u0E15\u0E49\u0E2D\u0E07\u0E2A\u0E2D\u0E1A\u0E2A\u0E27\u0E19\u0E14\u0E48\u0E27\u0E19`), Math.max(h0.drug, h0.lab, h0.xray) > 70) {
    const Q = h0.drug >= h0.lab && h0.drug >= h0.xray ? "Drug" : h0.lab >= h0.xray ? "Lab" : "CT/X-ray";
    N0.push(`\u{1F7E0} Concentration Risk: \u0E2B\u0E21\u0E27\u0E14 ${Q} \u0E04\u0E23\u0E2D\u0E07\u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E40\u0E01\u0E34\u0E19 70% (HHI=${n(J)}) \u2014 \u0E01\u0E32\u0E23\u0E1E\u0E36\u0E48\u0E07\u0E1E\u0E32\u0E2B\u0E21\u0E27\u0E14\u0E40\u0E14\u0E35\u0E22\u0E27\u0E2A\u0E39\u0E07 \u0E2B\u0E32\u0E01\u0E40\u0E01\u0E34\u0E14 Supply Disruption \u0E08\u0E30\u0E01\u0E23\u0E30\u0E17\u0E1A\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E23\u0E27\u0E21\u0E17\u0E31\u0E19\u0E17\u0E35`)
  }
  if (u0 >= 30 && N0.push(`\u{1F7E0} Volatility \u0E2A\u0E39\u0E07 (SD=${u0}%) \u2014 \u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E15\u0E48\u0E2D\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19 \u0E27\u0E32\u0E07\u0E41\u0E1C\u0E19 Inventory \u0E41\u0E25\u0E30 Staffing \u0E22\u0E32\u0E01 \u0E04\u0E27\u0E23\u0E43\u0E0A\u0E49 Safety Stock \u0E17\u0E35\u0E48\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19`), gu.length > 0) {
    const Q = gu.slice(0, 2).map(V => `${V.month} (${V.growth>=0?"+":""}${V.growth}%)`).join(", ");
    N0.push(`\u{1F7E1} \u0E1E\u0E1A\u0E40\u0E14\u0E37\u0E2D\u0E19 Outlier ${gu.length} \u0E40\u0E14\u0E37\u0E2D\u0E19: ${Q}${gu.length>2?"\u2026":""} \u2014 \u0E2A\u0E2D\u0E1A\u0E2A\u0E27\u0E19\u0E40\u0E2B\u0E15\u0E38\u0E1C\u0E25\u0E40\u0E0A\u0E34\u0E07 Root Cause (\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E25\u0E32\u0E2D\u0E2D\u0E01, \u0E22\u0E32\u0E02\u0E32\u0E14, \u0E19\u0E42\u0E22\u0E1A\u0E32\u0E22\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19, \u0E40\u0E2B\u0E15\u0E38\u0E01\u0E32\u0E23\u0E13\u0E4C\u0E1E\u0E34\u0E40\u0E28\u0E29)`)
  }
  Y0 && Y0.direction === "decelerating" && N0.push(`\u{1F7E1} Momentum \u0E0A\u0E30\u0E25\u0E2D\u0E15\u0E31\u0E27 \u2014 \u0E04\u0E23\u0E36\u0E48\u0E07\u0E2B\u0E25\u0E31\u0E07 (${Y0.h2_label}) \u0E42\u0E15 ${Y0.h2_growth}% \u0E40\u0E17\u0E35\u0E22\u0E1A\u0E04\u0E23\u0E36\u0E48\u0E07\u0E41\u0E23\u0E01 (${Y0.h1_label}) ${Y0.h1_growth}% \xB7 \u0E04\u0E27\u0E32\u0E21\u0E40\u0E23\u0E48\u0E07 ${Y0.accel}pp \u0E1A\u0E48\u0E07\u0E0A\u0E35\u0E49\u0E01\u0E32\u0E23\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E01\u0E33\u0E25\u0E31\u0E07\u0E40\u0E23\u0E34\u0E48\u0E21\u0E0A\u0E30\u0E25\u0E2D`), N0.length === 0 && N0.push("\u2705 \u0E44\u0E21\u0E48\u0E1E\u0E1A Red Flags \u0E17\u0E35\u0E48\u0E21\u0E35\u0E19\u0E31\u0E22\u0E2A\u0E33\u0E04\u0E31\u0E0D\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07\u0E17\u0E35\u0E48\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C \u2014 \u0E41\u0E19\u0E30\u0E19\u0E33\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E15\u0E48\u0E2D\u0E40\u0E19\u0E37\u0E48\u0E2D\u0E07\u0E41\u0E25\u0E30\u0E40\u0E17\u0E35\u0E22\u0E1A Benchmark \u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01");
  const Lu = A0 === "IPD" ? "Cost-per-admission \xB7 Order-per-admission \xB7 Yield-per-DRG" : "Cost-per-visit \xB7 Order-per-visit \xB7 Yield-per-order",
    z0 = A0 === "IPD" ? "\u0E41\u0E22\u0E01\u0E15\u0E32\u0E21 Ward / DRG" : "\u0E41\u0E22\u0E01\u0E15\u0E32\u0E21\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01/\u0E01\u0E25\u0E38\u0E48\u0E21\u0E42\u0E23\u0E04",
    Nu = A0 === "IPD" ? 65 : 55,
    L0 = [];
  m0 > 5 ? L0.push(`\u{1F535} P1 \xB7 \u0E27\u0E32\u0E07\u0E41\u0E1C\u0E19\u0E07\u0E1A\u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13\u0E41\u0E25\u0E30 Supply Chain \u0E23\u0E2D\u0E07\u0E23\u0E31\u0E1A\u0E01\u0E32\u0E23\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15 +${m0}% \u0E42\u0E14\u0E22\u0E40\u0E09\u0E1E\u0E32\u0E30\u0E2B\u0E21\u0E27\u0E14 ${v0.name} \u0E0B\u0E36\u0E48\u0E07\u0E40\u0E1B\u0E47\u0E19 Growth Driver \u0E2B\u0E25\u0E31\u0E01`) : m0 < -3 && L0.push(`\u{1F534} P0 \xB7 \u0E08\u0E31\u0E14\u0E15\u0E31\u0E49\u0E07 Task Force \u0E1F\u0E37\u0E49\u0E19\u0E1F\u0E39\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${C.short} (${m0}% \xB7 ${iu}) \u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C Root Cause ${z0} \u0E20\u0E32\u0E22\u0E43\u0E19 30 \u0E27\u0E31\u0E19`);
  const Iu = G.Lab.ord > 15 ? "Lab" : G.Xray.ord > 15 ? "CT/X-ray" : G.Drug.ord > 15 ? "Drug" : null;
  return Iu && L0.push(`\u{1F7E1} P2 \xB7 \u0E17\u0E1A\u0E17\u0E27\u0E19 Evidence-based Ordering Protocol \u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A ${Iu} \u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E04\u0E38\u0E21 Unnecessary Ordering \u0E41\u0E25\u0E30\u0E25\u0E14\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E15\u0E48\u0E2D${A0==="IPD"?"admission":"visit"} (\u0E04\u0E32\u0E14\u0E25\u0E14\u0E44\u0E14\u0E49 5\u201310%)`), b0 && L0.push(`\u{1F535} P1 \xB7 \u0E0A\u0E48\u0E27\u0E07 ${b0} \u0E04\u0E37\u0E2D\u0E40\u0E14\u0E37\u0E2D\u0E19 Peak Demand \u2014 ${C.peakPlan} \u0E25\u0E48\u0E27\u0E07\u0E2B\u0E19\u0E49\u0E32 30\u201360 \u0E27\u0E31\u0E19`), u0 >= 20 && L0.push(`\u{1F7E1} P2 \xB7 Volatility \u0E2A\u0E39\u0E07 (SD=${u0}%) \u2014 \u0E1B\u0E23\u0E31\u0E1A Safety Stock \u0E41\u0E25\u0E30 Flexible Staffing Model \u0E40\u0E0A\u0E48\u0E19 On-call pool \u0E2B\u0E23\u0E37\u0E2D Agency staff`), Y0 && Y0.direction === "decelerating" && m0 > 0 && L0.push(`\u{1F7E1} P2 \xB7 Momentum \u0E0A\u0E30\u0E25\u0E2D (${Y0.accel}pp) \u2014 \u0E17\u0E33 Quick Win \u0E43\u0E19\u0E04\u0E23\u0E36\u0E48\u0E07\u0E2B\u0E25\u0E31\u0E07\u0E1B\u0E35\u0E07\u0E1A ${A0==="IPD"?"\u0E40\u0E0A\u0E48\u0E19 Enhance Admission pathway, \u0E25\u0E14 AMA/DAMA":"\u0E40\u0E0A\u0E48\u0E19 Campaign \u0E04\u0E31\u0E14\u0E01\u0E23\u0E2D\u0E07, Chronic Care Follow-up"}`), L0.push(`\u{1F535} P1 \xB7 \u0E2A\u0E23\u0E49\u0E32\u0E07 Executive KPI Dashboard \u0E23\u0E32\u0E22 3 \u0E40\u0E14\u0E37\u0E2D\u0E19: ${Lu} ${z0}`), (G.Drug.px > 15 || h0.drug > Nu) && L0.push("\u{1F534} P0 \xB7 \u0E15\u0E31\u0E49\u0E07 Pharmacy & Therapeutics Committee \u0E17\u0E1A\u0E17\u0E27\u0E19 High-cost Drug List \u0E2A\u0E48\u0E07\u0E40\u0E2A\u0E23\u0E34\u0E21 Generic Substitution \u0E41\u0E25\u0E30 Therapeutic Interchange"), G.Xray.ord > 15 && L0.push(`\u{1F7E1} P2 \xB7 \u0E1E\u0E31\u0E12\u0E19\u0E32 Clinical Decision Support \u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A\u0E01\u0E32\u0E23\u0E2A\u0E31\u0E48\u0E07 CT/X-ray ${C.imagingNote} (\u0E04\u0E32\u0E14\u0E25\u0E14 Inappropriate Imaging 10\u201320%)`), J >= 5e3 && L0.push(`\u{1F7E1} P2 \xB7 HHI=${n(J)} \u0E1A\u0E48\u0E07\u0E0A\u0E35\u0E49\u0E01\u0E32\u0E23\u0E1E\u0E36\u0E48\u0E07\u0E1E\u0E32\u0E2B\u0E21\u0E27\u0E14\u0E40\u0E14\u0E35\u0E22\u0E27\u0E2A\u0E39\u0E07 \u2014 \u0E27\u0E32\u0E07\u0E41\u0E1C\u0E19 Diversification \u0E02\u0E2D\u0E07 Service Portfolio \u0E25\u0E14\u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E40\u0E0A\u0E34\u0E07 Operational`), {
    headline: t0,
    kpi: {
...
function nE({
  ...
  const C = Z.useMemo(() => DE(s, f0, M, A0), [s, f0, M, A0]);
  if (!C) return null;
    ...
    children: [u.jsxs("div", {
      ...
      children: C.empty ? u.jsx("div", {
        ...
        children: [u.jsx("div", {
          ...
          children: [u.jsx(wu, {
            label: "\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 Orders",
            value: `${C.kpi.orders_growth_pct>=0?"+":""}${C.kpi.orders_growth_pct}%`,
            sub: `${C.kpi.orders_abs_diff>=0?"+":""}${n(Math.abs(C.kpi.orders_abs_diff))} \u0E04\u0E23\u0E31\u0E49\u0E07`,
            color: C.kpi.orders_growth_pct >= 0 ? "#16a34a" : "#dc2626"
          }), u.jsx(wu, {
            label: "\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 Revenue",
            value: `${C.kpi.price_growth_pct>=0?"+":""}${C.kpi.price_growth_pct}%`,
            sub: `${C.kpi.price_abs_diff>=0?"+":""}\u0E3F${n(Math.abs(C.kpi.price_abs_diff))}`,
            color: C.kpi.price_growth_pct >= 0 ? "#16a34a" : "#dc2626"
          }), u.jsx(wu, {
            label: "Yield Delta",
            value: `${C.kpi.yield_delta>=0?"+":""}${C.kpi.yield_delta.toFixed(1)}pp`,
            sub: C.kpi.yield_delta >= 2 ? "Case Mix \u0E0B\u0E31\u0E1A\u0E0B\u0E49\u0E2D\u0E19\u0E02\u0E36\u0E49\u0E19" : C.kpi.yield_delta <= -2 ? "Margin \u0E16\u0E39\u0E01\u0E01\u0E14" : "\u0E2A\u0E21\u0E14\u0E38\u0E25",
            color: "#7c3aed"
          }), u.jsx(wu, {
            label: "Volatility (SD)",
            value: `${C.kpi.volatility}%`,
            sub: C.kpi.vol_level.text,
            color: C.kpi.vol_level.color,
            accent: C.kpi.vol_level.color
          }), u.jsx(wu, {
            label: "Concentration (HHI)",
            value: n(C.kpi.hhi),
            sub: C.kpi.hhi_level.text,
            color: C.kpi.hhi_level.color,
            accent: C.kpi.hhi_level.color
          }), u.jsx(wu, {
            label: `Run-rate ${M}`,
            value: `\u0E3F${n(C.kpi.avg_monthly_px)}/\u0E14.`,
            sub: `\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E40\u0E15\u0E47\u0E21\u0E1B\u0E35 \u0E3F${n(C.kpi.annualized_fy2)}`,
            color: "#0ea5e9"
          })]
        }), u.jsxs("div", {
          style: {
          ...
          children: [C.momentum ? u.jsx(pu, {
            icon: "\u{1F680}",
            title: "Momentum & Acceleration",
            text: `\u0E04\u0E23\u0E36\u0E48\u0E07\u0E41\u0E23\u0E01 (${C.momentum.h1_label}): ${C.momentum.h1_growth>=0?"+":""}${C.momentum.h1_growth}% \xB7 \u0E04\u0E23\u0E36\u0E48\u0E07\u0E2B\u0E25\u0E31\u0E07 (${C.momentum.h2_label}): ${C.momentum.h2_growth>=0?"+":""}${C.momentum.h2_growth}% \xB7 \u0E04\u0E27\u0E32\u0E21\u0E40\u0E23\u0E48\u0E07 ${C.momentum.accel>=0?"+":""}${C.momentum.accel}pp \u2014 ${C.momentum.direction==="accelerating"?"\u0E01\u0E32\u0E23\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E01\u0E33\u0E25\u0E31\u0E07\u0E40\u0E23\u0E48\u0E07\u0E15\u0E31\u0E27 \u2014 \u0E2A\u0E31\u0E0D\u0E0D\u0E32\u0E13\u0E1A\u0E27\u0E01\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A Q3\u2013Q4 \u0E02\u0E2D\u0E07\u0E1B\u0E35\u0E07\u0E1A":C.momentum.direction==="decelerating"?"\u0E01\u0E32\u0E23\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E01\u0E33\u0E25\u0E31\u0E07\u0E0A\u0E30\u0E25\u0E2D \u2014 \u0E04\u0E27\u0E23\u0E17\u0E33 Quick Win \u0E41\u0E25\u0E30 Mid-year Review":"\u0E01\u0E32\u0E23\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E04\u0E07\u0E17\u0E35\u0E48 \u2014 \u0E41\u0E19\u0E27\u0E42\u0E19\u0E49\u0E21\u0E40\u0E2A\u0E16\u0E35\u0E22\u0E23 \u0E04\u0E32\u0E14\u0E01\u0E32\u0E23\u0E13\u0E4C\u0E44\u0E14\u0E49"}`,
            color: C.momentum.direction === "accelerating" ? "#10b981" : C.momentum.direction === "decelerating" ? "#f59e0b" : "#0ea5e9"
          }) : u.jsx(pu, {
            icon: "\u{1F680}",
            title: "Momentum & Acceleration",
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsx(Vu, {
              item: C.deep_dive.Lab
            }), u.jsx(Vu, {
              item: C.deep_dive.Drug
            }), u.jsx(Vu, {
              item: C.deep_dive.Xray
            })]
          })]
        }), u.jsxs("div", {
          style: {
          ...
          children: [u.jsx(pu, {
            ...
            text: C.seasonal_insight,
            color: "#8b5cf6"
          }), u.jsx(pu, {
            icon: "\u{1F3AF}",
            title: "Anomaly Detection",
            text: C.anomalies.length === 0 ? "\u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E40\u0E14\u0E37\u0E2D\u0E19 Outlier \u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07\u0E17\u0E35\u0E48\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C (threshold = 1.5 \xD7 SD). \u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E15\u0E48\u0E2D\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E2A\u0E2D\u0E14\u0E04\u0E25\u0E49\u0E2D\u0E07\u0E01\u0E31\u0E1A\u0E04\u0E48\u0E32\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 \u2014 \u0E23\u0E30\u0E1A\u0E1A Inventory/Staffing \u0E17\u0E33\u0E07\u0E32\u0E19\u0E44\u0E14\u0E49\u0E04\u0E48\u0E2D\u0E19\u0E02\u0E49\u0E32\u0E07\u0E41\u0E21\u0E48\u0E19\u0E22\u0E33" : `\u0E1E\u0E1A ${C.anomalies.length} \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E17\u0E35\u0E48\u0E40\u0E1A\u0E35\u0E48\u0E22\u0E07\u0E40\u0E1A\u0E19\u0E08\u0E32\u0E01 Trend \u0E40\u0E01\u0E34\u0E19 1.5 \xD7 SD: ${C.anomalies.map(j0=>`${j0.month} (${j0.direction==="spike"?"\u25B2":"\u25BC"}${j0.growth>=0?"+":""}${j0.growth}%)`).join(" \xB7 ")} \u2014 \u0E04\u0E27\u0E23\u0E2A\u0E2D\u0E1A\u0E2A\u0E27\u0E19 Root Cause \u0E40\u0E0A\u0E34\u0E07 Operational (\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E25\u0E32, \u0E22\u0E32\u0E02\u0E32\u0E14, \u0E19\u0E42\u0E22\u0E1A\u0E32\u0E22\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19, Outbreak)`,
            color: C.anomalies.length === 0 ? "#10b981" : "#f59e0b"
          })]
        }), u.jsx("div", {
          style: {
            marginBottom: "10px"
          ...
          children: u.jsx(pu, {
            ...
            text: `\u0E08\u0E32\u0E01 Run-rate ${C.kpi.comparable_months} \u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 Annualized FY${M}: \u0E3F${n(C.kpi.annualized_fy2)} \u0E1A\u0E32\u0E17 \xB7 Annualized FY${f0}: \u0E3F${n(C.kpi.annualized_fy1)} \u0E1A\u0E32\u0E17 \xB7 Gap = ${C.kpi.annualized_gap>=0?"+":"\u2212"}\u0E3F${n(Math.abs(C.kpi.annualized_gap))} \u0E1A\u0E32\u0E17. ${C.kpi.annualized_gap>=0?"\u0E2B\u0E32\u0E01\u0E23\u0E31\u0E01\u0E29\u0E32\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E19\u0E35\u0E49\u0E44\u0E14\u0E49\u0E04\u0E23\u0E1A\u0E1B\u0E35 \u0E08\u0E30\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E08\u0E32\u0E01\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19":"\u0E2B\u0E32\u0E01\u0E22\u0E31\u0E07\u0E04\u0E07\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E19\u0E35\u0E49\u0E15\u0E48\u0E2D\u0E44\u0E1B \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E40\u0E15\u0E47\u0E21\u0E1B\u0E35\u0E08\u0E30\u0E2B\u0E14\u0E15\u0E31\u0E27\u0E08\u0E32\u0E01\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19"} \u0E02\u0E49\u0E2D\u0E2A\u0E33\u0E04\u0E31\u0E0D: \u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E41\u0E1A\u0E1A Linear Extrapolation \u2014 \u0E44\u0E21\u0E48\u0E23\u0E27\u0E21 Seasonality adjustment`,
            color: "#0ea5e9"
          })
        }), u.jsxs("div", {
          style: {
          ...
          children: [u.jsxs("span", {
            children: ["\u0E10\u0E32\u0E19\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25: ", C.meta.comparable_months, " \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E17\u0E35\u0E48\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E44\u0E14\u0E49 \xB7 \u0E1B\u0E35\u0E07\u0E1A ", C.meta.fy1, " vs ", C.meta.fy2, " \xB7 12 \u0E21\u0E34\u0E15\u0E34\u0E01\u0E32\u0E23\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C"]
          }), u.jsx("span", {
...
function BE() {
  const [s, f0] = Z.useState("opd-compare"), [M, A0] = Z.useState(null), [C, i0] = Z.useState(null), [e0, j0] = Z.useState(null), [Eu, G0] = Z.useState(null), [V0, M0] = Z.useState(null), [c0, m0] = Z.useState(null), [S0, p0] = Z.useState(!0), [eu, a0] = Z.useState(null), G = Z.useRef(null), [y0, $0] = Z.useState(null), [C0, h0] = Z.useState(null), [J, tu] = Z.useState(null), [v0, ou] = Z.useState(null), [w0, X0] = Z.useState(null), [b0, Q0] = Z.useState(null), [s0, R0] = Z.useState(null), [u0, yu] = Z.useState(null), [hu, Y0] = Z.useState(null), gu = new Date, Fu = gu.getMonth() + 1, bu = gu.getFullYear(), xu = Fu >= 10 ? bu + 544 : bu + 543, zu = xu - 1, [l0, Ru] = Z.useState(zu), [t0, Pu] = Z.useState(xu), iu = `${bu}-${String(Fu).padStart(2,"0")}-01`, Wu = new Date().toISOString().slice(0, 10), [g0, Tu] = Z.useState(iu), [x0, Mu] = Z.useState(Wu), [Au, ku] = Z.useState(iu), [N0, Lu] = Z.useState(Wu), [z0, Nu] = Z.useState(10), L0 = Z.useCallback(e => e ? z0 === "all" ? e : e.slice(0, z0) : [], [z0]), Iu = Z.useMemo(() => L0(C0?.patients), [C0, L0]), Q = Z.useMemo(() => {
    if (!b0?.patients) return null;
    const e = b0.patients,
      t = b0.total_income || 0,
      d = b0.unique_patients || new Set(e.map(r => r.hn)).size,
      R = e.length > 0 ? Math.round(t / e.length) : 0;
    let o = 0,
      c = 0;
    const a = {
        "<40": 0,
      ...
      y = {},
      g = {},
      D = b0.diseases || ["DM", "HT", "DLP", "IHD", "Stroke", "COPD", "CKD1", "CKD2", "CKD3", "CKD4", "CKD5", "CKD", "Other"],
      S = Object.fromEntries(D.map(r => [r, 0])),
      F = r => r ? /^E11/.test(r) ? "DM" : /^E78/.test(r) ? "DLP" : r === "I10" ? "HT" : /^I25/.test(r) ? "IHD" : /^I69/.test(r) ? "Stroke" : /^J44/.test(r) ? "COPD" : /^N181/.test(r) ? "CKD1" : /^N182/.test(r) ? "CKD2" : /^N183/.test(r) ? "CKD3" : /^N184/.test(r) ? "CKD4" : /^N18[56]/.test(r) ? "CKD5" : /^N18/.test(r) ? "CKD" : null : null;
    for (const r of e) {
      r.sex === "\u0E0A\u0E32\u0E22" ? o++ : r.sex === "\u0E2B\u0E0D\u0E34\u0E07" && c++;
      const $ = Number(r.age_y) || 0;
      $ < 40 ? a["<40"]++ : $ < 50 ? a["40-49"]++ : $ < 60 ? a["50-59"]++ : $ < 70 ? a["60-69"]++ : a["70+"]++;
      const i = (r.icd_pairs || "").split("||"),
        h = new Set;
      for (const N of i) {
        if (!N) continue;
        const v = N.indexOf("::"),
          _ = (v >= 0 ? N.slice(0, v) : N).toUpperCase(),
          U = v >= 0 ? N.slice(v + 2) : "";
        if (!_ || !su.test(_)) continue;
        y[_] || (y[_] = {
          code: _,
          name: U,
          count: 0,
          totalInc: 0
        }), y[_].count++, y[_].totalInc += r.income || 0;
        const j = F(_);
        j && h.add(j)
      }
      r.ckd_stage && /^CKD/.test(r.ckd_stage) && (["CKD", "CKD1", "CKD2", "CKD3", "CKD4", "CKD5"].forEach(N => h.delete(N)), h.add(r.ckd_stage)), h.size === 0 && h.add("Other"), h.forEach(N => {
        N in S && S[N]++
      });
      const b = r.pttype_name || "-";
      g[b] || (g[b] = {
        count: 0,
        income: 0
      }), g[b].count++, g[b].income += r.income || 0
    }
    const z = Math.max(...Object.values(a), 1),
      T = Object.values(y).sort((r, $) => $.count - r.count),
      P = Object.entries(g).sort((r, $) => $[1].count - r[1].count);
    let A = 0,
      w = 0,
      H = 0,
      p = 0;
    for (const r of e) r.ckd_stage && A++, r.ckd_stage && r.egfr != null && (w++, H += r.egfr), (r.ckd_stage === "CKD4" || r.ckd_stage === "CKD5") && p++;
    return {
      pts: e,
      totalIncome: t,
      uniquePatients: d,
      ...
      ckdCount: A,
      ckdWithEgfrCount: w,
      avgEgfr: w > 0 ? Math.round(H / w) : null,
      advancedCkd: p,
      diseaseCountsFE: S
    }
  }, [b0]), V = Z.useCallback(async () => {
    p0(!0), a0(null);
    try {
    ...
    p0(!1)
  }, [Au, N0]), k0 = Z.useCallback(async () => {
    p0(!0), a0(null);
    try {
      const e = await uu(`/api/report/opd-compare-daterange?start=${g0}&end=${x0}&_t=${Date.now()}`, {
        credentials: "include"
      });
      i0(e)
    } catch (e) {
  ...
  Z.useCallback(async () => {
    p0(!0), a0(null);
    try {
      const e = await uu(`/api/report/resource-usage?fy1=${l0}&fy2=${t0}&_t=${Date.now()}`, {
        credentials: "include"
      });
      j0(e)
    } catch (e) {
  ...
  const U0 = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/resource-opd-monthly?fy1=${l0}&fy2=${t0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        G0(e)
      } catch (e) {
    ...
    q0 = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/resource-ipd-monthly?fy1=${l0}&fy2=${t0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        M0(e)
      } catch (e) {
    ...
    ru = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/mortality-monthly?fy1=${l0}&fy2=${t0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        m0(e)
      } catch (e) {
    ...
    vu = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/frax-patients?start=${g0}&end=${x0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        h0(e)
      } catch (e) {
    ...
    Du = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/fluoride-patients?start=${g0}&end=${x0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        ou(e)
      } catch (e) {
    ...
    au = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/elderly-cxr?start=${g0}&end=${x0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        X0(e)
      } catch (e) {
    ...
    nu = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/ncd-patients?start=${g0}&end=${x0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        Q0(e)
      } catch (e) {
    ...
    Ou = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/imaging-services?start=${g0}&end=${x0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        R0(e)
      } catch (e) {
    ...
    Hu = Z.useCallback(async () => {
      p0(!0), a0(null);
      try {
        const e = await uu(`/api/report/pttype-services?from=${g0}&to=${x0}&_t=${Date.now()}`, {
          credentials: "include"
        });
        yu(e)
      } catch (e) {
  ...
  Z.useEffect(() => {
    s === "ipd-compare" ? V() : s === "opd-compare" ? k0() : s === "resource-opd" ? U0() : s === "resource-ipd" ? q0() : s === "mortality" ? ru() : s === "frax" ? vu() : s === "pt" ? Su() : s === "fluoride" ? Du() : s === "elderly-cxr" ? au() : s === "ncd-disease" ? nu() : s === "imaging-services" ? Ou() : s === "pttype-services" ? Hu() : s === "staff-services" && Cu()
  }, [s, V, k0, U0, q0, ru, vu, Su, Cu, Du, au, nu, Ou, Hu]), Z.useEffect(() => {
    const e = setTimeout(() => {
  ...
  const Yu = Z.useMemo(() => {
      ...
      const t = M.fiscal_years?.fy2?.be || t0;
    ...
    sE = Z.useCallback(() => {
      ...
      t.document.write(`
      <html><head><title>\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 ${M?.title||`${l0}-${t0}`}</title>
      <style>
    ...
    lE = Z.useCallback(() => {
      const e = (t, d) => {
        const R = t.utils.book_new(),
          ...
          z = [],
          T = (W, B, L, k) => {
            const X = typeof L == "number" ? "n" : "s";
            S[t.utils.encode_cell({
              r: W,
              c: B
            })] = k ? {
              v: L,
        ...
        if (T(v, 0, `${d.titleEmoji||"\u{1F4CB}"}  ${d.titleText}`, A), P(v, 0, v, c - 1), z[v] = {
            hpx: 56
          }, v++, T(v, 0, `\u{1F4C5}  \u0E0A\u0E48\u0E27\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25:  ${d.dateRange.start}  \u2192  ${d.dateRange.end}    \xB7    \u{1F465}  ${(d.totalCount||0).toLocaleString()} \u0E23\u0E32\u0E22${d.uniqueCount?`  /  ${d.uniqueCount.toLocaleString()} HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33`:""}`, w), P(v, 0, v, c - 1), z[v] = {
            hpx: 28
          }, v++, T(v, 0, `\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E40\u0E21\u0E37\u0E48\u0E2D:  ${new Date().toLocaleString("th-TH")}    \xB7    ${d.dataSource||""}`, H), P(v, 0, v, c - 1), z[v] = {
            hpx: 18
          }, v++, _(8), d.kpis && d.kpis.length) {
          T(v, 0, "\u{1F4CA}  KPI \u0E2A\u0E23\u0E38\u0E1B", p(d.themeColor || a.purpleDark)), P(v, 0, v, c - 1), z[v] = {
            hpx: 32
          }, v++;
          for (const W of d.kpis) T(v, 0, W.label, r), P(v, 0, v, 1), T(v, 2, W.value, $(W.color, W.fmt)), P(v, 2, v, 4), T(v, 5, W.unit || "", i), T(v, 6, W.note || "", h), P(v, 6, v, 7), z[v] = {
            hpx: 32
          }, v++;
          _(12)
        }
        if (d.breakdowns && d.breakdowns.length)
          for (const W of d.breakdowns) {
            if (T(v, 0, `${W.icon||"\u{1F4C8}"}  ${W.title}`, p(W.color)), P(v, 0, v, c - 1), z[v] = {
                hpx: 32
              }, v++, W.headers) {
              ...
              W.headers.forEach((k, X) => {
                const [q, E0] = L[X] || [X, X];
                T(v, q, k, b(W.color)), q !== E0 && P(v, q, v, E0)
              }), z[v] = {
                hpx: 30
              }, v++
            }
        ...
        if (d.insights && d.insights.length) {
          T(v, 0, "\u{1F916}  AI Insights & \u0E02\u0E49\u0E2D\u0E40\u0E2A\u0E19\u0E2D\u0E41\u0E19\u0E30", p(a.red)), P(v, 0, v, c - 1), z[v] = {
            hpx: 32
          }, v++, T(v, 0, "\u0E23\u0E30\u0E14\u0E31\u0E1A", b(a.red)), T(v, 1, "\u0E2B\u0E21\u0E27\u0E14", b(a.red)), P(v, 1, v, 2), T(v, 3, "\u0E2A\u0E34\u0E48\u0E07\u0E17\u0E35\u0E48\u0E1E\u0E1A", b(a.red)), P(v, 3, v, 4), T(v, 5, "\u0E02\u0E49\u0E2D\u0E40\u0E2A\u0E19\u0E2D\u0E41\u0E19\u0E30 / Action", b(a.red)), P(v, 5, v, 7), z[v] = {
            hpx: 30
          }, v++;
          const W = {
              critical: 0,
            ...
            B = [...d.insights].sort((k, X) => (W[k.sev] ?? 9) - (W[X.sev] ?? 9)),
            L = {
              critical: {
          ...
          for (const k of B) {
            ...
            const q = Math.max(Math.ceil((k.action || "").length / 80), Math.ceil((k.msg || "").length / 40), 2);
            z[v] = {
        ...
        if (d.references && d.references.length) {
          T(v, 0, "\u{1F4DA}  \u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38 / \u0E2D\u0E49\u0E32\u0E07\u0E2D\u0E34\u0E07", p(a.muted)), P(v, 0, v, c - 1), z[v] = {
            hpx: 30
          }, v++;
          for (const [W, B] of d.references) {
            const L = W === "\u0E2D\u0E2D\u0E01\u0E41\u0E1A\u0E1A\u0E42\u0E14\u0E22",
              k = L ? a.greenDark : a.slateDark,
              X = L ? a.greenDark : a.muted,
              q = L ? a.greenLight : a.slateSoft;
            T(v, 0, W, N({
              font: {
                bold: !0,
                sz: 11,
        ...
        S["!ref"] = t.utils.encode_range({
          ...
          xSplit: 0,
          ySplit: 3
        }, t.utils.book_append_sheet(R, S, "Overview");
        const U = {};
        d.patientHeader.forEach((W, B) => {
        ...
        d.patientData.forEach((W, B) => {
          const L = B % 2 === 0 ? void 0 : a.stripe;
          W.forEach((k, X) => {
            const q = typeof k == "number",
              E0 = j.includes(X);
            U[t.utils.encode_cell({
              r: B + 1,
              c: X
        ...
        }), U["!cols"] = (d.patientColWidths || d.patientHeader.map(() => 14)).map(W => ({
          wch: W
        })), U["!rows"] = [{
          hpx: 30
        }], U["!freeze"] = {
          xSplit: 0,
          ySplit: 1
        }, t.utils.book_append_sheet(R, U, d.patientSheetName || "Data"), t.writeFile(R, d.filename)
      };
      if (s === "ipd-compare") {
        if (!M?.comparison) return;
        const t = (g, D) => g > 0 ? Math.round((D - g) / g * 100) + "%" : D > 0 ? "100%" : "0%",
          d = M.fiscal_years?.fy1?.label || `\u0E1B\u0E35\u0E07\u0E1A ${l0}`,
          R = M.fiscal_years?.fy2?.label || `\u0E1B\u0E35\u0E07\u0E1A ${t0}`,
          o = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", `Admit (${d})`, `D/C (${d})`, "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19", "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22", "\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07", "\u0E40\u0E15\u0E35\u0E22\u0E07\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E08\u0E23\u0E34\u0E07", "Sum AdjRW", "CMI", `Admit (${R})`, `D/C (${R})`, "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19", "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22", "\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07", "\u0E40\u0E15\u0E35\u0E22\u0E07\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E08\u0E23\u0E34\u0E07", "Sum AdjRW", "CMI", "YoY Admit %", "YoY D/C %", "YoY \u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19 %", "YoY ALOS %", "YoY \u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07 %", "YoY Active Bed %", "YoY AdjRW %", "YoY CMI %", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 Admit", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 D/C", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 \u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19"],
          c = M.comparison.map(g => [g.month, g.fy1.admits, g.fy1.discharges, g.fy1.total_los, g.fy1.alos, g.fy1.occupancy_rate, g.fy1.active_beds, g.fy1.sum_adjrw, g.fy1.cmi, g.fy2.admits, g.fy2.discharges, g.fy2.total_los, g.fy2.alos, g.fy2.occupancy_rate, g.fy2.active_beds, g.fy2.sum_adjrw, g.fy2.cmi, t(g.fy1.admits, g.fy2.admits), t(g.fy1.discharges, g.fy2.discharges), t(g.fy1.total_los, g.fy2.total_los), t(g.fy1.alos, g.fy2.alos), t(g.fy1.occupancy_rate, g.fy2.occupancy_rate), t(g.fy1.active_beds, g.fy2.active_beds), t(g.fy1.sum_adjrw, g.fy2.sum_adjrw), t(g.fy1.cmi, g.fy2.cmi), g.admit_diff, (g.fy2.discharges || 0) - (g.fy1.discharges || 0), g.fy2.total_los - g.fy1.total_los]),
          a = M.fy1_totals,
          y = M.fy2_totals;
        c.push(["\u0E23\u0E27\u0E21", a.admits, a.discharges, a.total_los, a.alos, a.occupancy_rate, a.active_beds, a.sum_adjrw, a.cmi, y.admits, y.discharges, y.total_los, y.alos, y.occupancy_rate, y.active_beds, y.sum_adjrw, y.cmi, t(a.admits, y.admits), t(a.discharges, y.discharges), t(a.total_los, y.total_los), t(a.alos, y.alos), t(a.occupancy_rate, y.occupancy_rate), t(a.active_beds, y.active_beds), t(a.sum_adjrw, y.sum_adjrw), t(a.cmi, y.cmi), M.overall_admit_diff, (y.discharges || 0) - (a.discharges || 0), y.total_los - a.total_los]), cu(() => import("./xlsx-BuHXVOW6.js"), []).then(g => {
          const D = [o, ...c],
            S = g.utils.aoa_to_sheet(D);
          S["!cols"] = o.map((z, T) => {
            const P = Math.max(z.length, ...c.map(A => String(A[T] ?? "").length));
            return {
              wch: Math.min(Math.max(P + 2, 8), 30)
            }
          });
          const F = g.utils.book_new();
          g.utils.book_append_sheet(F, S, "IPD Compare"), g.writeFile(F, `BCH360_IPD_Compare_${Au}_${N0}.xlsx`)
        });
        return
      }
      if (s === "frax") {
        ...
        const t = C0.patients;
        t.reduce((A, w) => A + (w.income || 0), 0);
        const d = new Set(t.map(A => A.hn)).size,
          R = t.length > 0 ? t.reduce((A, w) => A + (Number(w.major_osteoporotic) || 0), 0) / t.length : 0,
          o = t.length > 0 ? t.reduce((A, w) => A + (Number(w.hip_fracture) || 0), 0) / t.length : 0,
          c = t.filter(A => Number(A.major_osteoporotic) >= 20).length,
          a = t.filter(A => Number(A.hip_fracture) >= 3).length,
          y = t.length > 0 ? Math.round(t.reduce((A, w) => A + (Number(w.age) || 0), 0) / t.length) : 0,
          g = {
            "50-59": 0,
            "60-69": 0,
            "70-79": 0,
        ...
        t.forEach(A => {
          const w = Number(A.age) || 0;
          w < 60 ? g["50-59"]++ : w < 70 ? g["60-69"]++ : w < 80 ? g["70-79"]++ : g["80+"]++
        });
        const D = {};
        t.forEach(A => {
          const w = A.pttype_name || "-";
          D[w] = (D[w] || 0) + 1
        });
        const S = Object.entries(D).sort((A, w) => w[1] - A[1]),
          F = [];
        c > 0 && F.push({
          sev: "critical",
          ...
          sev: "med",
          cat: "Population Risk",
          msg: `\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 Major Risk = ${R.toFixed(1)}% \u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E17\u0E31\u0E48\u0E27\u0E44\u0E1B`,
          ...
          sev: "info",
          cat: "Operational",
          msg: `\u0E23\u0E27\u0E21 ${t.length} \u0E23\u0E32\u0E22 \u0E43\u0E19 ${Math.max(1,Math.ceil((new Date(x0)-new Date(g0))/864e5)+1)} \u0E27\u0E31\u0E19`,
        ...
        const z = [{
            ...
            rows: Object.entries(g).map(([A, w]) => [{
              ...
              v: A === "80+" ? "\u0E01\u0E25\u0E38\u0E48\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E2A\u0E39\u0E07\u0E2A\u0E38\u0E14" : A === "70-79" ? "\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E2A\u0E39\u0E07 \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E40\u0E1D\u0E49\u0E32\u0E23\u0E30\u0E27\u0E31\u0E07" : "",
              align: "left",
              font: {
                sz: 9,
                color: {
          ...
          P = t.map(A => [A.no, A.vn, A.hn, A.cid, A.fullname, A.sex, A.age, A.phone || "", A.vstdate, A.vsttime, A.pttype_name || "", A.weight || "", A.height || "", A.bmi ? Number(A.bmi) : "", A.major_osteoporotic, A.hip_fracture]);
        cu(() => import("./xlsx.min-CZi5yKex.js").then(A => A.x), ju([0, 1])).then(A => {
          e(A, {
            filename: `BCH360_FRAX_BoneDensity_${g0}_${x0}.xlsx`,
            titleEmoji: "\u{1F9B4}",
            ...
            kpis: [{
              ...
              unit: "%",
              color: R >= 20 ? "DC2626" : R >= 10 ? "F59E0B" : "10B981",
              fmt: "0.0",
              note: R >= 20 ? "\u{1F534} \u0E2A\u0E39\u0E07\u0E21\u0E32\u0E01" : R >= 10 ? "\u26A0 \u0E2A\u0E39\u0E07" : "\u2705 \u0E1B\u0E01\u0E15\u0E34"
            }, {
      ...
      if (s === "pt" || s === "staff-services") {
        ...
        const t = J.patients,
          d = t.reduce((h, b) => h + (Number(b.income) || 0), 0),
          R = new Set(t.map(h => h.hn)).size,
          o = t.length > 0 ? Math.round(d / t.length) : 0,
          c = t.filter(h => h.visit_type === "OPD").length,
          a = t.filter(h => h.visit_type === "IPD").length,
          y = t.length > 0 ? Math.round(t.reduce((h, b) => h + (Number(b.age_y) || 0), 0) / t.length) : 0,
          g = {
            "<30": 0,
            "30-44": 0,
            "45-59": 0,
        ...
        t.forEach(h => {
          const b = Number(h.age_y) || 0;
          b < 30 ? g["<30"]++ : b < 45 ? g["30-44"]++ : b < 60 ? g["45-59"]++ : g["60+"]++
        });
        const D = {};
        t.forEach(h => {
          const b = (h.icd10 || "").split(",").map(v => v.trim().toUpperCase()).filter(v => su.test(v)),
            N = (h.icd10name || "").split("|").map(v => v.trim());
          b.forEach((v, _) => {
            D[v] || (D[v] = {
              code: v,
              name: N[_] || "",
              count: 0,
              totalInc: 0
            }), D[v].count++, D[v].totalInc += h.income || 0
          })
        });
        const S = Object.values(D).sort((h, b) => b.count - h.count).slice(0, 10),
          F = {};
        t.forEach(h => {
          const b = h.pttype_name || "-";
          F[b] || (F[b] = {
            count: 0,
            income: 0
          }), F[b].count++, F[b].income += h.income || 0
        });
        const z = Object.entries(F).sort((h, b) => b[1].count - h[1].count),
          T = {};
        t.forEach(h => {
          const b = h.department || "-";
          T[b] || (T[b] = {
            count: 0,
            income: 0
          }), T[b].count++, T[b].income += h.income || 0
        });
        const P = Object.entries(T).sort((h, b) => b[1].count - h[1].count),
          A = t.filter(h => /M53|M54|M62|M79/.test(h.icd10 || "")).length,
          w = t.filter(h => /M0[5-9]|M1[5-9]/.test(h.icd10 || "")).length,
          H = t.filter(h => /I6[0-9]|G81|G82/.test(h.icd10 || "")).length,
          p = [];
        A > t.length * .3 && p.push({
          sev: "high",
          cat: "Office Syndrome",
          msg: `Office syndrome (M53/M54/M62/M79): ${A} \u0E23\u0E32\u0E22 (${Math.round(A/t.length*100)}%)`,
          ...
          sev: "med",
          cat: "Arthritis",
          msg: `Arthritis cases: ${w} \u0E23\u0E32\u0E22 \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23 joint protection`,
        ...
        cu(() => import("./xlsx.min-CZi5yKex.js").then(h => h.x), ju([0, 1])).then(h => {
          e(h, {
            filename: `BCH360_${s==="staff-services"?"StaffServices":"PhysicalTherapy"}_${g0}_${x0}.xlsx`,
            titleEmoji: "\u{1F9B5}",
            ...
            totalCount: t.length,
            uniqueCount: R,
            kpis: [...s === "staff-services" && J?.staff_registry_count ? [{
              label: "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14",
              value: J.staff_registry_count,
              unit: "\u0E23\u0E32\u0E22",
              color: "7C3AED",
              fmt: "#,##0",
              note: `\u0E21\u0E32\u0E43\u0E0A\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 ${R} \u0E23\u0E32\u0E22 (${J.staff_registry_count>0?Math.round(R/J.staff_registry_count*1e3)/10:0}%)`
            }] : [], {
      ...
      if (s === "fluoride") {
        ...
        const t = v0.patients,
          ...
          R = t.reduce((p, r) => p + (Number(r.income) || 0), 0),
          o = new Set(t.map(p => p.hn)).size,
          c = t.length > 0 ? Math.round(R / t.length) : 0,
        ...
        t.forEach(p => {
          ...
          r < 35 ? y["25-34"]++ : r < 45 ? y["35-44"]++ : r < 55 ? y["45-54"]++ : y["55-59"]++
        });
        const g = {};
        t.forEach(p => {
          const r = (p.icd10 || "").split(",").map(i => i.trim().toUpperCase()).filter(i => su.test(i)),
            $ = (p.icd10name || "").split("|").map(i => i.trim());
          r.forEach((i, h) => {
            g[i] || (g[i] = {
              code: i,
              name: $[h] || "",
              count: 0,
              totalInc: 0
            }), g[i].count++, g[i].totalInc += p.income || 0
          })
        });
        const D = Object.values(g).sort((p, r) => r.count - p.count).slice(0, 10),
          S = {};
        t.forEach(p => {
          ...
          S[r] || (S[r] = {
            count: 0,
            income: 0
          }), S[r].count++, S[r].income += p.income || 0
        });
        const F = Object.entries(S).sort((p, r) => r[1].count - p[1].count),
          z = t.filter(p => /K02|K03/.test(p.icd10 || "")).length,
          T = t.filter(p => /K05|K06/.test(p.icd10 || "")).length,
          P = [];
        z > 0 && P.push({
          sev: "high",
          cat: "Caries Burden",
          msg: `Dental caries (K02-K03): ${z} \u0E23\u0E32\u0E22 (${Math.round(z/t.length*100)}%)`,
          ...
          sev: "info",
          cat: "Demographic",
          msg: `\u0E2D\u0E32\u0E22\u0E38\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${a} \u0E1B\u0E35 \xB7 \u0E2A\u0E48\u0E27\u0E19\u0E43\u0E2B\u0E0D\u0E48 ${Object.entries(y).sort((p,r)=>r[1]-p[1])[0]?.[0]} \u0E1B\u0E35`,
        ...
        const A = [{
          ...
          w = ["\u0E25\u0E33\u0E14\u0E31\u0E1A", "\u0E0A\u0E37\u0E48\u0E2D-\u0E2A\u0E01\u0E38\u0E25", "HN", "\u0E2A\u0E34\u0E17\u0E18\u0E34", "\u0E2D\u0E32\u0E22\u0E38", "\u0E40\u0E25\u0E02\u0E1A\u0E31\u0E15\u0E23\u0E1B\u0E23\u0E30\u0E0A\u0E32\u0E0A\u0E19", "\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48", "\u0E41\u0E1C\u0E19\u0E01", "\u0E17\u0E35\u0E48\u0E2D\u0E22\u0E39\u0E48", "\u0E40\u0E1A\u0E2D\u0E23\u0E4C\u0E42\u0E17\u0E23", "ICD-10", "\u0E0A\u0E37\u0E48\u0E2D\u0E42\u0E23\u0E04", "\u0E04\u0E48\u0E32\u0E1F\u0E25\u0E39\u0E2D\u0E2D\u0E44\u0E23\u0E14\u0E4C", "\u0E22\u0E2D\u0E14\u0E40\u0E07\u0E34\u0E19", "\u0E2D\u0E32\u0E01\u0E32\u0E23\u0E2A\u0E33\u0E04\u0E31\u0E0D"],
        ...
        cu(() => import("./xlsx.min-CZi5yKex.js").then(p => p.x), ju([0, 1])).then(p => {
          e(p, {
            filename: `BCH360_Fluoride_25_59_${g0}_${x0}.xlsx`,
            titleEmoji: "\u{1F9B7}",
      ...
      if (s === "elderly-cxr") {
        ...
        const t = w0.patients,
          d = w0.total_income || t.reduce((i, h) => i + (Number(h.income) || 0), 0),
          R = w0.total_cxr_price || t.reduce((i, h) => i + (Number(h.cxr_price) || 0), 0),
          o = new Set(t.map(i => i.hn)).size,
          c = t.length > 0 ? Math.round(d / t.length) : 0,
          a = t.filter(i => i.sex === "\u0E0A\u0E32\u0E22").length,
          y = t.filter(i => i.sex === "\u0E2B\u0E0D\u0E34\u0E07").length,
          g = t.length > 0 ? Math.round(t.reduce((i, h) => i + (Number(h.age_y) || 0), 0) / t.length) : 0,
          D = {
            "60-64": 0,
            "65-69": 0,
            "70-74": 0,
        ...
        t.forEach(i => {
          ...
          h < 65 ? D["60-64"]++ : h < 70 ? D["65-69"]++ : h < 75 ? D["70-74"]++ : h < 80 ? D["75-79"]++ : D["80+"]++
        });
        const S = {};
        t.forEach(i => {
          const h = (i.icd10 || "").split(",").map(N => N.trim().toUpperCase()).filter(N => su.test(N)),
            b = (i.icd10name || "").split("|").map(N => N.trim());
          h.forEach((N, v) => {
            S[N] || (S[N] = {
              code: N,
              name: b[v] || "",
              count: 0,
              totalInc: 0
            }), S[N].count++, S[N].totalInc += i.income || 0
          })
        });
        const F = Object.values(S).sort((i, h) => h.count - i.count).slice(0, 10),
          z = {};
        t.forEach(i => {
          ...
          z[h] || (z[h] = {
            count: 0,
            income: 0
          }), z[h].count++, z[h].income += i.income || 0
        });
        const T = Object.entries(z).sort((i, h) => h[1].count - i[1].count),
          P = t.filter(i => /A1[5-9]/.test(i.icd10 || "")).length,
          A = t.filter(i => /C3[3-4]/.test(i.icd10 || "")).length,
          w = t.filter(i => /J1[2-8]/.test(i.icd10 || "")).length,
          H = [];
        P > 0 && H.push({
          sev: "critical",
          cat: "TB Suspect",
          ...
          sev: "info",
          cat: "Demographic",
          msg: `\u0E2D\u0E32\u0E22\u0E38\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${g} \u0E1B\u0E35 \xB7 \u0E0A\u0E32\u0E22 ${a} \u0E2B\u0E0D\u0E34\u0E07 ${y}`,
          action: "monitor age-specific yield \xB7 gender comparison \u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A TB/CA detection"
        }), H.push({
          sev: "info",
          cat: "Cost Analysis",
          msg: `\u0E04\u0E48\u0E32 CXR \u0E23\u0E27\u0E21 ${R.toLocaleString()} \u0E1A\u0E32\u0E17 \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 Visit \u0E23\u0E27\u0E21 ${d.toLocaleString()} \u0E1A\u0E32\u0E17`,
        ...
        const p = [{
          ...
          $ = t.map(i => [i.no, i.pt_name, i.hn, i.sex, i.age_y, i.cid, i.pttype_name, i.vstdate, i.department, i.address, i.mobile_phone_number, i.cxr_name, i.cxr_price, i.icd10, i.icd10name, i.income, i.chief_complaint]);
        cu(() => import("./xlsx.min-CZi5yKex.js").then(i => i.x), ju([0, 1])).then(i => {
          e(i, {
            filename: `BCH360_Elderly_CXR_60plus_${g0}_${x0}.xlsx`,
            titleEmoji: "\u2622\uFE0F",
      ...
      if (s === "pttype-services") {
        ...
        const t = r => Number(r || 0),
          d = new Set(hu === null ? u0.group_order || [] : hu),
          R = (u0.groups || []).filter(r => d.has(r.group_name)),
          o = (u0.summary || []).filter(r => d.has(r.group_name)),
          c = (u0.group_trend || []).filter(r => d.has(r.group_name)),
          a = R.reduce((r, $) => r + ($.total_visits || 0), 0),
          y = ["", "\u0E21.\u0E04.", "\u0E01.\u0E1E.", "\u0E21\u0E35.\u0E04.", "\u0E40\u0E21.\u0E22.", "\u0E1E.\u0E04.", "\u0E21\u0E34.\u0E22.", "\u0E01.\u0E04.", "\u0E2A.\u0E04.", "\u0E01.\u0E22.", "\u0E15.\u0E04.", "\u0E1E.\u0E22.", "\u0E18.\u0E04."],
          g = r => {
            const $ = Number(r.slice(5, 7)),
              i = Number(r.slice(0, 4));
            return `${y[$]} ${(i+543)%100}`
          },
          D = ["\u0E2D\u0E31\u0E19\u0E14\u0E31\u0E1A", "\u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C", "\u0E08\u0E33\u0E19\u0E27\u0E19 pttype", "OPD (\u0E04\u0E23\u0E31\u0E49\u0E07)", "OPD (\u0E04\u0E19)", "IPD (\u0E04\u0E23\u0E31\u0E49\u0E07)", "IPD (\u0E04\u0E19)", "ER (\u0E04\u0E23\u0E31\u0E49\u0E07)", "ER (\u0E04\u0E19)", "\u0E23\u0E27\u0E21 (\u0E04\u0E23\u0E31\u0E49\u0E07)", "% \u0E02\u0E2D\u0E07\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14"],
          S = [...R].sort((r, $) => $.total_visits - r.total_visits),
          F = S.map((r, $) => [$ + 1, r.group_name, t(r.pttype_count), t(r.opd_visits), t(r.opd_hn), t(r.ipd_admissions), t(r.ipd_hn), t(r.er_visits), t(r.er_hn), t(r.total_visits), a > 0 ? (r.total_visits / a * 100).toFixed(2) + "%" : "0%"]),
          z = ["", "\u0E23\u0E27\u0E21\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14", S.reduce((r, $) => r + ($.pttype_count || 0), 0), S.reduce((r, $) => r + $.opd_visits, 0), S.reduce((r, $) => r + $.opd_hn, 0), S.reduce((r, $) => r + $.ipd_admissions, 0), S.reduce((r, $) => r + $.ipd_hn, 0), S.reduce((r, $) => r + $.er_visits, 0), S.reduce((r, $) => r + $.er_hn, 0), a, "100%"],
          T = ["\u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C", "\u0E23\u0E2B\u0E31\u0E2A pttype", "\u0E0A\u0E37\u0E48\u0E2D pttype", "OPD (\u0E04\u0E23\u0E31\u0E49\u0E07)", "OPD (\u0E04\u0E19)", "IPD (\u0E04\u0E23\u0E31\u0E49\u0E07)", "IPD (\u0E04\u0E19)", "ER (\u0E04\u0E23\u0E31\u0E49\u0E07)", "ER (\u0E04\u0E19)", "\u0E23\u0E27\u0E21 (\u0E04\u0E23\u0E31\u0E49\u0E07)"],
          P = o.map(r => [r.group_name, r.pttype, r.pttype_name, t(r.opd_visits), t(r.opd_hn), t(r.ipd_admissions), t(r.ipd_hn), t(r.er_visits), t(r.er_hn), t(r.total_visits)]),
          A = Array.from(new Set(c.map(r => r.ym))).sort(),
          w = S.map(r => r.group_name),
          H = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", ...w, "\u0E23\u0E27\u0E21"],
          p = A.map(r => {
            const $ = [g(r)];
            let i = 0;
            for (const h of w) {
              const b = c.find(v => v.ym === r && v.group_name === h),
                N = b ? Number(b.total || 0) : 0;
              $.push(N), i += N
            }
            return $.push(i), $
          });
        cu(() => import("./xlsx-BuHXVOW6.js"), []).then(r => {
          const $ = r.utils.book_new(),
            i = r.utils.aoa_to_sheet([D, ...F, z]);
          i["!cols"] = D.map(_ => ({
            wch: Math.min(Math.max(_.length + 4, 12), 28)
          })), r.utils.book_append_sheet($, i, "\u0E2A\u0E23\u0E38\u0E1B\u0E15\u0E32\u0E21\u0E2B\u0E21\u0E27\u0E14");
          const h = r.utils.aoa_to_sheet([T, ...P]);
          if (h["!cols"] = T.map(_ => ({
              wch: Math.min(Math.max(_.length + 4, 12), 36)
            })), r.utils.book_append_sheet($, h, "\u0E23\u0E32\u0E22\u0E25\u0E30\u0E40\u0E2D\u0E35\u0E22\u0E14 pttype"), p.length > 0) {
            const _ = r.utils.aoa_to_sheet([H, ...p]);
            _["!cols"] = H.map((U, j) => ({
              wch: j === 0 ? 14 : Math.min(Math.max(U.length + 4, 12), 24)
            })), r.utils.book_append_sheet($, _, "\u0E41\u0E19\u0E27\u0E42\u0E19\u0E49\u0E21\u0E23\u0E32\u0E22\u0E40\u0E14\u0E37\u0E2D\u0E19")
          }
          const b = (u0.age_breakdown || []).filter(_ => d.has(_.group_name));
          if (b.length > 0) {
            const _ = u0.age_order || ["\u0E27\u0E31\u0E22\u0E40\u0E14\u0E47\u0E01 (0-14 \u0E1B\u0E35)", "\u0E27\u0E31\u0E22\u0E23\u0E38\u0E48\u0E19/\u0E27\u0E31\u0E22\u0E2B\u0E19\u0E38\u0E48\u0E21\u0E2A\u0E32\u0E27 (15-24 \u0E1B\u0E35)", "\u0E27\u0E31\u0E22\u0E41\u0E23\u0E07\u0E07\u0E32\u0E19 (25-59 \u0E1B\u0E35)", "\u0E27\u0E31\u0E22\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 (60 \u0E1B\u0E35\u0E02\u0E36\u0E49\u0E19\u0E44\u0E1B)", "\u0E44\u0E21\u0E48\u0E23\u0E30\u0E1A\u0E38"],
              U = ["\u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C", ..._, "\u0E23\u0E27\u0E21"],
              j = {};
            for (const k of b) j[k.group_name] || (j[k.group_name] = {}), j[k.group_name][k.age_group] = k.total;
            const W = S.map(k => {
                const X = [k.group_name];
                let q = 0;
                for (const E0 of _) {
                  const o0 = j[k.group_name]?.[E0] || 0;
                  X.push(o0), q += o0
                }
                return X.push(q), X
              }),
              B = ["\u0E23\u0E27\u0E21\u0E15\u0E48\u0E2D\u0E0A\u0E48\u0E27\u0E07\u0E2D\u0E32\u0E22\u0E38"];
            for (let k = 0; k < _.length; k++) B.push(W.reduce((X, q) => X + (q[k + 1] || 0), 0));
            B.push(W.reduce((k, X) => k + (X[X.length - 1] || 0), 0));
            const L = r.utils.aoa_to_sheet([U, ...W, B]);
            L["!cols"] = U.map(k => ({
              wch: Math.min(Math.max(k.length + 4, 14), 32)
            })), r.utils.book_append_sheet($, L, "\u0E0A\u0E48\u0E27\u0E07\u0E2D\u0E32\u0E22\u0E38 \xD7 \u0E2B\u0E21\u0E27\u0E14")
          }
          const N = [
              ...
              ["\u0E2B\u0E21\u0E27\u0E14\u0E17\u0E35\u0E48\u0E40\u0E25\u0E37\u0E2D\u0E01", `${R.length} \u0E08\u0E32\u0E01 ${(u0.group_order||[]).length} \u0E2B\u0E21\u0E27\u0E14\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19`],
              [],
              ["\u0E2D\u0E2D\u0E01\u0E41\u0E1A\u0E1A\u0E42\u0E14\u0E22", "IT Banchang Team \xB7 BOSSART"]
            ],
            v = r.utils.aoa_to_sheet(N);
          v["!cols"] = [{
            wch: 22
          }, {
            wch: 60
          }], r.utils.book_append_sheet($, v, "Meta"), r.writeFile($, `BCH360_PttypeServices_${u0.from}_${u0.to}.xlsx`)
        });
        return
      }
      if (s === "imaging-services") {
        ...
        const t = s0.patients,
          d = s0.services || ["XRAY", "CT", "Portable", "BMD"],
          R = s0.service_labels || {},
          o = s0.service_counts || {},
          c = s0.total_income || 0,
          a = s0.total_imaging_price || 0,
          y = s0.unique_patients || new Set(t.map(b => b.hn)).size,
          g = t.length > 0 ? Math.round(c / t.length) : 0,
          D = t.length > 0 ? Math.round(a / t.length) : 0,
          S = t.filter(b => b.sex === "\u0E0A\u0E32\u0E22").length,
          F = t.filter(b => b.sex === "\u0E2B\u0E0D\u0E34\u0E07").length,
          z = t.length > 0 ? Math.round(t.reduce((b, N) => b + (Number(N.age_y) || 0), 0) / t.length) : 0,
          T = {
            "<20": 0,
            "20-39": 0,
            "40-59": 0,
        ...
        t.forEach(b => {
          (b.icd_pairs || "").split("||").filter(Boolean).forEach(N => {
            const [v, _] = N.split("::"), U = (v || "").toUpperCase();
            !U || !su.test(U) || (P[U] || (P[U] = {
              code: U,
              name: _ || "",
              count: 0,
        ...
        const A = Object.values(P).sort((b, N) => N.count - b.count).slice(0, 10),
          w = {};
        t.forEach(b => {
          ...
          w[N] || (w[N] = {
            count: 0,
            income: 0
          }), w[N].count++, w[N].income += b.income || 0
        });
        const H = Object.entries(w).sort((b, N) => N[1].count - b[1].count),
          p = [];
        o.CT > 0 && p.push({
          sev: "info",
          cat: "CT Volume",
          ...
          sev: "info",
          cat: "Cost Summary",
          msg: `\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 imaging \u0E23\u0E27\u0E21 ${a.toLocaleString()} \u0E1A\u0E32\u0E17 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${D.toLocaleString()} \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22`,
        ...
        const r = {
          ...
          h = t.map(b => [b.no, b.pt_name, b.hn, b.sex, b.age_y, b.cid, b.pttype_name, b.vstdate, b.vsttime, b.department, b.address, b.mobile_phone_number, b.service_groups, b.service_names, b.service_codes, b.imaging_price, b.icd10, b.icd10name, b.income, b.chief_complaint]);
        cu(() => import("./xlsx.min-CZi5yKex.js").then(b => b.x), ju([0, 1])).then(b => {
          e(b, {
            filename: `BCH360_Imaging_${g0}_${x0}.xlsx`,
            titleEmoji: "\u{1FA7B}",
            ...
            dataSource: s0.data_source || "HOSxP XE \xB7 opitemrece + nondrugitems",
            totalCount: t.length,
            uniqueCount: y,
            kpis: [{
              ...
              color: "EC4899",
              fmt: "#,##0",
              note: `${t.length>0?Math.round(F/t.length*100):0}% \u0E02\u0E2D\u0E07\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14`
            }, {
              label: "\u0E2D\u0E32\u0E22\u0E38\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22",
              value: z,
              unit: "\u0E1B\u0E35",
      ...
      if (s === "opd-compare") {
        ...
        const t = (S, F) => S > 0 ? Math.round((F - S) / S * 100) + "%" : F > 0 ? "100%" : "0%",
          d = C.fiscal_years?.fy1?.label || "\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19",
          R = C.fiscal_years?.fy2?.label || "\u0E1B\u0E35\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19",
          ...
          a = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", ...c.map(S => `${S} (${d})`), ...c.map(S => `${S} (${R})`), ...c.map(S => `YoY ${S} %`)],
          y = C.comparison.map(S => [S.month, ...o.map(F => S.fy1[F]), ...o.map(F => S.fy2[F]), ...o.map(F => t(S.fy1[F], S.fy2[F]))]),
          g = C.fy1_totals,
          D = C.fy2_totals;
        y.push(["\u0E23\u0E27\u0E21", ...o.map(S => g[S]), ...o.map(S => D[S]), ...o.map(S => t(g[S], D[S]))]), cu(() => import("./xlsx-BuHXVOW6.js"), []).then(S => {
          const F = S.utils.aoa_to_sheet([a, ...y]);
          F["!cols"] = a.map((T, P) => ({
            wch: Math.min(Math.max(T.length + 2, 10), 25)
          }));
          const z = S.utils.book_new();
          S.utils.book_append_sheet(z, F, "OPD Compare"), S.writeFile(z, `BCH360_OPD_Compare_${g0}_${x0}.xlsx`)
        });
        return
      }
      if (s === "resource-opd" || s === "resource-ipd") {
        const t = s === "resource-opd" ? Eu : V0;
        if (!t?.comparison) return;
        const d = s === "resource-opd" ? "OPD" : "IPD",
          R = s === "resource-opd" ? "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E19\u0E2D\u0E01" : "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19",
          o = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", `Lab \u0E04\u0E23\u0E31\u0E49\u0E07 (${l0})`, `Lab \u0E1A\u0E32\u0E17 (${l0})`, `Drug \u0E04\u0E23\u0E31\u0E49\u0E07 (${l0})`, `Drug \u0E1A\u0E32\u0E17 (${l0})`, `Xray \u0E04\u0E23\u0E31\u0E49\u0E07 (${l0})`, `Xray \u0E1A\u0E32\u0E17 (${l0})`, `\u0E23\u0E27\u0E21\u0E04\u0E23\u0E31\u0E49\u0E07 (${l0})`, `\u0E23\u0E27\u0E21\u0E1A\u0E32\u0E17 (${l0})`, `Lab \u0E04\u0E23\u0E31\u0E49\u0E07 (${t0})`, `Lab \u0E1A\u0E32\u0E17 (${t0})`, `Drug \u0E04\u0E23\u0E31\u0E49\u0E07 (${t0})`, `Drug \u0E1A\u0E32\u0E17 (${t0})`, `Xray \u0E04\u0E23\u0E31\u0E49\u0E07 (${t0})`, `Xray \u0E1A\u0E32\u0E17 (${t0})`, `\u0E23\u0E27\u0E21\u0E04\u0E23\u0E31\u0E49\u0E07 (${t0})`, `\u0E23\u0E27\u0E21\u0E1A\u0E32\u0E17 (${t0})`, "\u0E08\u0E33\u0E19\u0E27\u0E19 %", "\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32 %"],
          c = (T, P) => P > 0 ? Math.round((T - P) / P * 100) : T > 0 ? 100 : 0,
          a = t.comparison.filter(T => T.fy1?.has_data || T.fy2?.has_data).map(T => {
            const P = T.fy1,
              A = T.fy2,
              w = P.lab_orders + P.drug_orders + P.xray_orders,
              H = P.lab_price + P.drug_price + P.xray_price,
              p = A.lab_orders + A.drug_orders + A.xray_orders,
              r = A.lab_price + A.drug_price + A.xray_price,
              $ = P.has_data && A.has_data ? c(p, w) : "",
              i = P.has_data && A.has_data ? c(r, H) : "";
            return [T.month, P.lab_orders || "", P.lab_price || "", P.drug_orders || "", P.drug_price || "", P.xray_orders || "", P.xray_price || "", P.has_data ? w : "", P.has_data ? H : "", A.lab_orders || "", A.lab_price || "", A.drug_orders || "", A.drug_price || "", A.xray_orders || "", A.xray_price || "", A.has_data ? p : "", A.has_data ? r : "", $ !== "" ? `${$}%` : "", i !== "" ? `${i}%` : ""]
          }),
          y = t.fy1_totals,
          g = t.fy2_totals,
          D = y.lab_orders + y.drug_orders + y.xray_orders,
          S = y.lab_price + y.drug_price + y.xray_price,
          F = g.lab_orders + g.drug_orders + g.xray_orders,
          z = g.lab_price + g.drug_price + g.xray_price;
        a.push(["\u0E23\u0E27\u0E21", y.lab_orders, y.lab_price, y.drug_orders, y.drug_price, y.xray_orders, y.xray_price, D, S, g.lab_orders, g.lab_price, g.drug_orders, g.drug_price, g.xray_orders, g.xray_price, F, z, `${t.overall_orders_growth_pct}%`, `${t.overall_price_growth_pct}%`]), cu(() => import("./xlsx-BuHXVOW6.js"), []).then(T => {
          const P = [o, ...a],
            A = T.utils.aoa_to_sheet(P);
          A["!cols"] = o.map((H, p) => {
            const r = Math.max(H.length, ...a.map($ => String($[p] ?? "").length));
            return {
              wch: Math.min(Math.max(r + 2, 8), 28)
            }
          });
          const w = T.utils.book_new();
          T.utils.book_append_sheet(w, A, `\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${R}`), T.writeFile(w, `BCH360_Resource_${d}_Monthly_${l0}_${t0}.xlsx`)
        });
        return
      }
      if (s === "ncd-disease") {
        ...
        const {
          ...
          avgEgfr: z,
          advancedCkd: T
        } = Q, P = b0.diseases || ["DM", "HT", "IHD", "Stroke", "COPD", "CKD1", "CKD2", "CKD3", "CKD4", "CKD5", "CKD"], A = b0.disease_labels || {}, w = Q.diseaseCountsFE || b0.disease_counts || {}, H = {
          length: F
        }, p = g.slice(0, 10), r = [], $ = Math.max(1, Math.ceil((new Date(x0) - new Date(g0)) / 864e5) + 1), i = t.length / $, h = Math.round(i * 250);
        if (T > 0) {
          const m = Math.round(T / Math.max(S, 1) * 100);
          r.push({
            sev: "critical",
            cat: "CKD \u0E23\u0E30\u0E22\u0E30\u0E23\u0E38\u0E19\u0E41\u0E23\u0E07",
        ...
        const v = t.filter(m => /Stroke/.test(m.disease_groups) && /HT/.test(m.disease_groups)).length;
        v > 0 && r.push({
          sev: "high",
          ...
          sev: "high",
          cat: "IHD Management",
          msg: `\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 IHD ${w.IHD} \u0E23\u0E32\u0E22 \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23 secondary prevention \u0E40\u0E15\u0E47\u0E21\u0E23\u0E39\u0E1B\u0E41\u0E1A\u0E1A`,
          action: "ASA + Statin lifelong \xB7 \u03B2-blocker \u0E2B\u0E23\u0E37\u0E2D ACEi/ARB \xB7 cardiac rehab \xB7 annual ECG/Echo"
        });
        const _ = t.filter(m => Number(m.age_y) >= 60).length,
          U = t.filter(m => {
        ...
        if (_ > 0) {
          const m = Math.round(_ / t.length * 100);
          r.push({
            sev: "info",
            cat: "Demographic",
            msg: `\u0E01\u0E25\u0E38\u0E48\u0E21\u0E1C\u0E39\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 \u226560 \u0E1B\u0E35: ${_} visit (${m}%) \u0E02\u0E2D\u0E07 NCD clinic`,
        ...
        if (j > 0) {
          const m = Math.round(j / Math.max(S, 1) * 100);
          r.push({
            sev: "med",
        ...
        const B = t.filter(m => o > 0 && (m.income || 0) > o * 2.5).length;
        if (B > 0) {
          const m = Math.round(B / t.length * 100),
            O = t.filter(r0 => (r0.income || 0) > o * 2.5).reduce((r0, _0) => r0 + (_0.income || 0), 0);
          r.push({
            sev: "info",
            cat: "Cost Outlier",
        ...
        if (L > 0) {
          ...
          r.push({
            sev: m > 80 ? "med" : "info",
            cat: "Payer Mix",
            msg: `UC/\u0E1A\u0E31\u0E15\u0E23\u0E17\u0E2D\u0E07: ${m}% (${L}/${t.length}) \u2014 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${o.toLocaleString()} \u0E1A\u0E32\u0E17/visit`,
        ...
        const X = Object.entries(k).sort((m, O) => O[1] - m[1])[0];
        if (X && X[1] > t.length * .25) {
          const m = Math.round(X[1] / t.length * 100);
          r.push({
            sev: "info",
            cat: "Geographic Hotspot",
            msg: `\u0E15\u0E33\u0E1A\u0E25 ${X[0]} \u0E21\u0E35\u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E2A\u0E39\u0E07: ${X[1]} \u0E23\u0E32\u0E22 (${m}%)`,
        ...
        r.push({
          ...
          msg: `\u0E04\u0E48\u0E32\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${i.toFixed(1)} visit/\u0E27\u0E31\u0E19 (${t.length} visit \u0E43\u0E19 ${$} \u0E27\u0E31\u0E19) \xB7 \u0E04\u0E32\u0E14\u0E01\u0E32\u0E23\u0E13\u0E4C\u0E17\u0E31\u0E49\u0E07\u0E1B\u0E35 ~${h.toLocaleString()} visit`,
          action: "\u0E27\u0E32\u0E07\u0E41\u0E1C\u0E19 manpower \xB7 \u0E40\u0E15\u0E23\u0E35\u0E22\u0E21 drug stock \xB7 \u0E02\u0E22\u0E32\u0E22 slot \u0E0A\u0E48\u0E27\u0E07 peak (\u0E15.\u0E04.-\u0E01.\u0E1E.) \xB7 \u0E1E\u0E34\u0E08\u0E32\u0E23\u0E13\u0E32 NCD clinic \u0E40\u0E1B\u0E34\u0E14\u0E40\u0E1E\u0E34\u0E48\u0E21 slot \u0E1A\u0E48\u0E32\u0E22"
        });
        const E0 = t.filter(m => m.ckd_stage === "CKD3").length,
          o0 = t.filter(m => m.ckd_stage === "CKD4").length,
          T0 = t.filter(m => m.ckd_stage === "CKD5").length;
        if (E0 + o0 + T0 > 0) {
          const m = Math.round(E0 * .05),
            O = Math.round(o0 * .07),
            r0 = (T0 + O) * 936e3;
          r.push({
            sev: O > 0 ? "med" : "info",
            cat: "Projection \xB7 12 months",
            msg: `\u0E04\u0E32\u0E14\u0E01\u0E32\u0E23\u0E13\u0E4C: CKD3\u21924 ~${m} \u0E23\u0E32\u0E22 \xB7 CKD4\u2192ESRD ~${O} \u0E23\u0E32\u0E22 \xB7 ESRD \u0E23\u0E27\u0E21 ${T0+O} \u0E23\u0E32\u0E22 \u2192 HD cost ~${r0.toLocaleString()} \u0E1A\u0E32\u0E17/\u0E1B\u0E35`,
        ...
        const J0 = (() => {
          const m = t.length > 0 ? t.filter(r0 => r0.creatinine != null).length / t.length : 0,
            O = S > 0 ? 1 - T / S : 1;
        ...
        cu(() => import("./xlsx.min-CZi5yKex.js").then(m => m.x), ju([0, 1])).then(m => {
          const O = m.utils.book_new(),
            ...
            H0 = (Y = {}) => ({
              ...
              alignment: {
                horizontal: Y.align || "left",
                vertical: "center",
                wrapText: !!Y.wrap,
                indent: Y.align === "left" ? 1 : 0
              },
              border: W0,
              fill: Y.bg ? {
                patternType: "solid",
          ...
          let l = 0;
          K(l, 0, "\u{1FAC0}  \u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E2A\u0E23\u0E38\u0E1B\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 NCD \u0E41\u0E22\u0E01\u0E42\u0E23\u0E04", dE), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 56
          }, l++, K(l, 0, `\u{1F4C5}  \u0E0A\u0E48\u0E27\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25:  ${b0.date_range.start}  \u2192  ${b0.date_range.end}    \xB7    \u{1F465}  ${t.length.toLocaleString()} visit  /  ${R.toLocaleString()} \u0E23\u0E32\u0E22`, cE), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 28
          }, l++, K(l, 0, `\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E40\u0E21\u0E37\u0E48\u0E2D:  ${new Date().toLocaleString("th-TH")}    \xB7    ${b0.data_source||""}`, pE), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 18
          }, l++, mu(8), K(l, 0, "\u{1F4CA}  KPI \u0E2A\u0E23\u0E38\u0E1B", fu(I.purpleDark)), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 32
          }, l++;
          const hE = [
            ["\u0E08\u0E33\u0E19\u0E27\u0E19 Visit NCD", t.length, "\u0E04\u0E23\u0E31\u0E49\u0E07", I.purpleDark, "#,##0", "\u0E08\u0E33\u0E19\u0E27\u0E19\u0E01\u0E32\u0E23\u0E21\u0E32\u0E15\u0E23\u0E27\u0E08\u0E23\u0E27\u0E21\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07\u0E40\u0E27\u0E25\u0E32"],
            ["\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 (HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33)", R, "\u0E23\u0E32\u0E22", I.purple, "#,##0", "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E32\u0E22\u0E1A\u0E38\u0E04\u0E04\u0E25 \u0E19\u0E31\u0E1A 1 HN \u0E15\u0E48\u0E2D 1 \u0E04\u0E23\u0E31\u0E49\u0E07"],
          ...
          for (const [Y, d0, D0, B0, P0, du] of hE) K(l, 0, Y, qu), n0(l, 0, l, 1), K(l, 2, d0, Ju(B0, P0)), n0(l, 2, l, 4), K(l, 5, D0, Qu), K(l, 6, du, Zu), n0(l, 6, l, 7), F0[l] = {
            hpx: 32
          }, l++;
          mu(12), K(l, 0, "\u{1FA7A}  \u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E01\u0E25\u0E38\u0E48\u0E21\u0E42\u0E23\u0E04 NCD", fu(I.blue)), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 32
          }, l++, K(l, 0, "\u0E01\u0E25\u0E38\u0E48\u0E21\u0E42\u0E23\u0E04", I0(I.blue)), K(l, 1, "\u0E08\u0E33\u0E19\u0E27\u0E19 Visit", I0(I.blue)), n0(l, 1, l, 2), K(l, 3, "%", I0(I.blue)), n0(l, 3, l, 4), K(l, 5, "\u0E04\u0E33\u0E2D\u0E18\u0E34\u0E1A\u0E32\u0E22 / ICD-10 Range", I0(I.blue)), n0(l, 5, l, 7), F0[l] = {
            hpx: 30
          }, l++;
          let uE = 0;
          for (const Y of P) {
          ...
          mu(12), K(l, 0, "\u{1FAD8}  \u0E2A\u0E23\u0E38\u0E1B CKD (eGFR-based \xB7 CKD-EPI 2009)", fu(I.green)), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 32
          }, l++;
          const gE = [
            ["\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 CKD \u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14", S, "\u0E23\u0E32\u0E22", I.green, "#,##0", "\u0E23\u0E27\u0E21 Stage 1-5 + \u0E44\u0E21\u0E48\u0E23\u0E30\u0E1A\u0E38 stage"],
            ["CKD \u0E17\u0E35\u0E48\u0E21\u0E35\u0E15\u0E23\u0E27\u0E08 Cr / eGFR", H.length, "\u0E23\u0E32\u0E22", I.green, "#,##0", `${S>0?Math.round(H.length/S*100):0}% \u0E02\u0E2D\u0E07 CKD \u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14`],
            ["eGFR \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22", z ?? 0, "ml/min/1.73m\xB2", z != null && z < 60 ? I.amber : I.green, "#,##0", z != null && z < 60 ? "\u26A0 \u0E15\u0E48\u0E33\u0E01\u0E27\u0E48\u0E32\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E1B\u0E01\u0E15\u0E34 (\u226560)" : "\u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E1B\u0E01\u0E15\u0E34"],
            ["CKD Stage 4-5 (severe)", T, "\u0E23\u0E32\u0E22", T > 0 ? I.red : I.green, "#,##0", T > 0 ? "\u{1F534} \u0E15\u0E49\u0E2D\u0E07\u0E40\u0E15\u0E23\u0E35\u0E22\u0E21 Renal Replacement Therapy" : "\u2705 \u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E40\u0E04\u0E2A severe"]
          ];
          for (const [Y, d0, D0, B0, P0, du] of gE) K(l, 0, Y, qu), n0(l, 0, l, 1), K(l, 2, d0, Ju(B0, P0)), n0(l, 2, l, 4), K(l, 5, D0, Qu), K(l, 6, du, Zu), n0(l, 6, l, 7), F0[l] = {
            hpx: 30
          }, l++;
          mu(12), K(l, 0, "\u{1F465}  \u0E01\u0E32\u0E23\u0E01\u0E23\u0E30\u0E08\u0E32\u0E22\u0E2D\u0E32\u0E22\u0E38", fu(I.amber)), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 32
          }, l++, K(l, 0, "\u0E0A\u0E48\u0E27\u0E07\u0E2D\u0E32\u0E22\u0E38", I0(I.amber)), K(l, 1, "\u0E08\u0E33\u0E19\u0E27\u0E19 Visit", I0(I.amber)), n0(l, 1, l, 3), K(l, 4, "%", I0(I.amber)), n0(l, 4, l, 5), K(l, 6, "\u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38", I0(I.amber)), n0(l, 6, l, 7), F0[l] = {
            hpx: 30
          }, l++;
          let EE = 0;
          for (const [Y, d0] of Object.entries(y)) {
            const D0 = EE % 2 === 1 ? I.stripe : void 0,
              B0 = Y === "70+" ? "\u0E01\u0E25\u0E38\u0E48\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E2A\u0E39\u0E07 \xB7 monitor frailty" : Y === "60-69" ? "\u0E1C\u0E39\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38\u0E15\u0E2D\u0E19\u0E15\u0E49\u0E19" : Y === "<40" ? "NCD \u0E43\u0E19\u0E27\u0E31\u0E22\u0E17\u0E33\u0E07\u0E32\u0E19" : "";
            K(l, 0, Y, H0({
              align: "center",
              font: {
                bold: !0,
              ...
              bg: D0
            })), n0(l, 1, l, 3), K(l, 4, t.length > 0 ? d0 / t.length : 0, H0({
              align: "right",
              numFmt: "0.0%",
              font: {
                sz: 11
          ...
          mu(12), K(l, 0, "\u{1F3C6}  Top 10 ICD-10 \u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22", fu(I.purple)), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 32
          }, l++, K(l, 0, "ICD-10", I0(I.purple)), K(l, 1, "\u0E0A\u0E37\u0E48\u0E2D\u0E42\u0E23\u0E04", I0(I.purple)), n0(l, 1, l, 5), K(l, 6, "\u0E08\u0E33\u0E19\u0E27\u0E19", I0(I.purple)), K(l, 7, "\u0E23\u0E27\u0E21\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 (\u0E1A\u0E32\u0E17)", I0(I.purple)), F0[l] = {
            hpx: 30
          }, l++;
          let eE = 0;
          for (const Y of p) {
          ...
          mu(12), K(l, 0, "\u{1F4B3}  \u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E01\u0E32\u0E23\u0E23\u0E31\u0E01\u0E29\u0E32 (Top 10)", fu(I.slate)), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 32
          }, l++, K(l, 0, "\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E01\u0E32\u0E23\u0E23\u0E31\u0E01\u0E29\u0E32", I0(I.slate)), n0(l, 0, l, 4), K(l, 5, "\u0E08\u0E33\u0E19\u0E27\u0E19", I0(I.slate)), K(l, 6, "%", I0(I.slate)), K(l, 7, "\u0E23\u0E27\u0E21\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 (\u0E1A\u0E32\u0E17)", I0(I.slate)), F0[l] = {
            hpx: 30
          }, l++;
          let tE = 0;
          for (const [Y, d0] of D.slice(0, 10)) {
            ...
            K(l, 0, Y, H0({
              ...
              bg: D0
            })), K(l, 6, t.length > 0 ? d0.count / t.length : 0, H0({
              align: "right",
              numFmt: "0.0%",
              font: {
                sz: 11
          ...
          mu(12), K(l, 0, "\u{1F916}  AI Insights & \u0E02\u0E49\u0E2D\u0E40\u0E2A\u0E19\u0E2D\u0E41\u0E19\u0E30\u0E17\u0E32\u0E07\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01/\u0E1A\u0E23\u0E34\u0E2B\u0E32\u0E23", fu(I.red)), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 32
          }, l++, K(l, 0, "\u0E23\u0E30\u0E14\u0E31\u0E1A", I0(I.red)), K(l, 1, "\u0E2B\u0E21\u0E27\u0E14", I0(I.red)), n0(l, 1, l, 2), K(l, 3, "\u0E2A\u0E34\u0E48\u0E07\u0E17\u0E35\u0E48\u0E1E\u0E1A", I0(I.red)), n0(l, 3, l, 4), K(l, 5, "\u0E02\u0E49\u0E2D\u0E40\u0E2A\u0E19\u0E2D\u0E41\u0E19\u0E30 / Action", I0(I.red)), n0(l, 5, l, 7), F0[l] = {
            hpx: 30
          }, l++;
          const rE = {
              critical: 0,
            ...
            xE = [...r].sort((Y, d0) => (rE[Y.sev] ?? 9) - (rE[d0.sev] ?? 9)),
            oE = {
              critical: {
                label: "\u{1F534} CRITICAL",
                bg: I.redLight,
          ...
          for (const Y of xE) {
            ...
            K(l, 0, d0.label, {
              ...
              border: W0
            }), n0(l, 1, l, 2), K(l, 3, Y.msg, {
              font: {
                name: r0,
                sz: 10,
                bold: Y.sev === "critical" || Y.sev === "high",
                color: {
                  rgb: I.text
                }
              },
          ...
          mu(12), K(l, 0, "\u{1F4DA}  \u0E2D\u0E49\u0E32\u0E07\u0E2D\u0E34\u0E07\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E01\u0E32\u0E23\u0E08\u0E31\u0E14\u0E01\u0E25\u0E38\u0E48\u0E21", fu(I.muted)), n0(l, 0, l, _0 - 1), F0[l] = {
            hpx: 30
          }, l++;
          const mE = [
          ...
          for (const [Y, d0] of mE) {
            const D0 = Y === "\u0E2D\u0E2D\u0E01\u0E41\u0E1A\u0E1A\u0E42\u0E14\u0E22",
              B0 = D0 ? I.greenDark : I.slateDark,
              P0 = D0 ? I.greenDark : I.muted,
              du = D0 ? I.greenLight : I.slateSoft;
            K(l, 0, Y, H0({
              font: {
                bold: !0,
                sz: 11,
          ...
          Z0["!ref"] = m.utils.encode_range({
            ...
            wch: 28
          }], Z0["!rows"] = F0, Z0["!freeze"] = {
            xSplit: 0,
            ySplit: 3
          }, m.utils.book_append_sheet(O, Z0, "Overview");
          const Bu = {};
          x.forEach((Y, d0) => {
            ...
            Y.forEach((B0, P0) => {
              const du = typeof B0 == "number",
                Xu = P0 === 17,
                iE = P0 === 18,
                fE = P0 === 16;
              let Ku = D0,
                Gu = I.text;
              Xu && B0 && (Ku = B0 === "CKD5" ? I.redLight : B0 === "CKD4" ? "FED7AA" : B0 === "CKD3" ? "FEF3C7" : I.greenLight, Gu = B0 === "CKD5" ? I.red : B0 === "CKD4" ? "C2410C" : B0 === "CKD3" ? "B45309" : "047857"), fE && typeof B0 == "number" && (Gu = B0 < 30 ? I.red : B0 < 60 ? "B45309" : "047857"), Bu[m.utils.encode_cell({
                r: d0 + 1,
                c: P0
              })] = {
                v: B0,
          ...
          }), Bu["!cols"] = [6, 22, 10, 6, 6, 16, 24, 11, 9, 16, 30, 14, 18, 14, 30, 10, 9, 10, 11, 32].map(Y => ({
            wch: Y
          })), Bu["!rows"] = [{
            hpx: 30
          }], Bu["!freeze"] = {
            xSplit: 0,
            ySplit: 1
          }, m.utils.book_append_sheet(O, Bu, "Patient Data"), m.writeFile(O, `BCH360_NCD_ByDisease_${g0}_${x0}.xlsx`)
        });
        return
      }
      if (s === "mortality") {
        if (!c0?.comparison) return;
        const t = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", `IPD \u0E08\u0E33\u0E2B\u0E19\u0E48\u0E32\u0E22 (${l0})`, `IPD \u0E15\u0E32\u0E22 (${l0})`, `IPD \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E15\u0E32\u0E22% (${l0})`, `OPD \u0E15\u0E32\u0E22 (${l0})`, `\u0E23\u0E27\u0E21\u0E15\u0E32\u0E22 (${l0})`, `IPD \u0E08\u0E33\u0E2B\u0E19\u0E48\u0E32\u0E22 (${t0})`, `IPD \u0E15\u0E32\u0E22 (${t0})`, `IPD \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E15\u0E32\u0E22% (${t0})`, `OPD \u0E15\u0E32\u0E22 (${t0})`, `\u0E23\u0E27\u0E21\u0E15\u0E32\u0E22 (${t0})`],
          d = c0.comparison.map(y => [y.month, y.fy1.ipd_discharge, y.fy1.ipd_deaths, y.fy1.ipd_mortality_rate, y.fy1.opd_deaths, y.fy1.total_deaths, y.fy2.ipd_discharge, y.fy2.ipd_deaths, y.fy2.ipd_mortality_rate, y.fy2.opd_deaths, y.fy2.total_deaths]),
          R = "\uFEFF" + [t.join(","), ...d.map(y => y.join(","))].join(`\r
`),
          o = new Blob([R], {
        ...
        a.href = c, a.download = `BCH360_Mortality_${l0}_${t0}.csv`, a.click(), URL.revokeObjectURL(c)
      }
    }, [s, M, C, Eu, V0, c0, C0, J, v0, w0, b0, s0, u0, hu, l0, t0, g0, x0, Au, N0]),
    Uu = Z.useMemo(() => {
      const e = [];
  ...
  return u.jsxs("div", {
    ...
    children: [u.jsxs("div", {
      ...
      children: [u.jsx("span", {
        ...
        onClick: () => s === "ipd-compare" ? V() : s === "opd-compare" ? k0() : s === "resource-opd" ? U0() : s === "resource-ipd" ? q0() : s === "frax" ? vu() : s === "pt" ? Su() : s === "staff-services" ? Cu() : s === "fluoride" ? Du() : s === "elderly-cxr" ? au() : s === "ncd-disease" ? nu() : s === "imaging-services" ? Ou() : s === "pttype-services" ? Hu() : ru(),
        disabled: S0,
        style: {
          padding: "6px 16px",
          borderRadius: "8px",
        ...
        children: S0 ? "Loading..." : "\u0E42\u0E2B\u0E25\u0E14\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25"
      }), u.jsx("button", {
        onClick: sE,
        disabled: s === "ipd-compare" ? !M : s === "opd-compare" ? !C : s === "resource-opd" ? !Eu : s === "resource-ipd" ? !V0 : s === "frax" ? !C0 : s === "pt" || s === "staff-services" ? !J : s === "fluoride" ? !v0 : s === "elderly-cxr" ? !w0 : s === "ncd-disease" ? !b0?.patients : s === "imaging-services" ? !s0?.patients : s === "pttype-services" ? !u0?.groups : !c0,
        style: {
          padding: "6px 14px",
          borderRadius: "8px",
          fontSize: "12px",
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
          ...
          const o = M.fy1_totals,
            c = M.fy2_totals,
            a = (r, $) => r > 0 ? Math.round(($ - r) / r * 100) : 0,
            y = a(o.admits, c.admits),
            g = a(o.discharges, c.discharges),
            D = a(o.total_los, c.total_los),
            S = a(o.alos, c.alos);
          a(o.occupancy_rate, c.occupancy_rate);
          const F = a(o.sum_adjrw, c.sum_adjrw),
            z = a(o.cmi, c.cmi),
            T = M.comparable_months || 0,
            P = M.custom_range ? `${M.custom_range.start} \u2014 ${M.custom_range.end}` : M.fiscal_years?.fy2?.label || "",
            A = [],
            w = c.admits - c.discharges,
            H = o.discharges > 0 ? o.sum_adjrw / o.discharges : 0,
            p = c.discharges > 0 ? c.sum_adjrw / c.discharges : 0;
          M.total_beds * 30 * T, y < -5 ? A.push({
            icon: "\u{1F4C9}",
            color: "#dc2626",
            title: `\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 Admit \u0E25\u0E14\u0E25\u0E07 ${Math.abs(y)}%`,
            detail: `\u0E23\u0E31\u0E1A\u0E40\u0E02\u0E49\u0E32 ${n(o.admits)} \u2192 ${n(c.admits)} \u0E23\u0E32\u0E22 (\u0E25\u0E14 ${n(Math.abs(c.admits-o.admits))} \u0E23\u0E32\u0E22) \xB7 D/C ${n(o.discharges)} \u2192 ${n(c.discharges)} \u0E23\u0E32\u0E22 (${g>=0?"+":""}${g}%) \u2014 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19${Math.abs(y)>15?"\u0E25\u0E14\u0E25\u0E07\u0E21\u0E32\u0E01":"\u0E25\u0E14\u0E25\u0E07"} \u0E2A\u0E48\u0E07\u0E1C\u0E25\u0E15\u0E48\u0E2D\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E41\u0E25\u0E30\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07\u0E42\u0E14\u0E22\u0E15\u0E23\u0E07`,
            actions: [{
              who: "\u0E1D\u0E48\u0E32\u0E22\u0E01\u0E32\u0E23\u0E41\u0E1E\u0E17\u0E22\u0E4C",
            ...
            icon: "\u26A0\uFE0F",
            color: "#f59e0b",
            title: `Admit \u0E21\u0E32\u0E01\u0E01\u0E27\u0E48\u0E32 D/C ${n(w)} \u0E23\u0E32\u0E22 \u2014 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E2A\u0E30\u0E2A\u0E21\u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A`,
            ...
            icon: "\u23F1\uFE0F",
            color: "#f59e0b",
            title: `ALOS \u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 ${S}% (${n(o.alos,2)} \u2192 ${n(c.alos,2)} \u0E27\u0E31\u0E19)`,
            detail: `\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E23\u0E27\u0E21 ${n(o.total_los)} \u2192 ${n(c.total_los)} \u0E27\u0E31\u0E19 (${D>=0?"+":""}${D}%) \u2014 \u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E22\u0E32\u0E27\u0E02\u0E36\u0E49\u0E19\u0E41\u0E21\u0E49\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E25\u0E14\u0E25\u0E07 \u0E41\u0E2A\u0E14\u0E07\u0E27\u0E48\u0E32 Discharge \u0E0A\u0E49\u0E32\u0E25\u0E07 \u0E2B\u0E23\u0E37\u0E2D\u0E21\u0E35\u0E40\u0E04\u0E2A\u0E0B\u0E31\u0E1A\u0E0B\u0E49\u0E2D\u0E19\u0E21\u0E32\u0E01\u0E02\u0E36\u0E49\u0E19`,
            actions: [{
              who: "\u0E04\u0E13\u0E30\u0E01\u0E23\u0E23\u0E21\u0E01\u0E32\u0E23 UM",
            ...
            icon: "\u2705",
            color: "#16a34a",
            title: `ALOS \u0E25\u0E14\u0E25\u0E07 ${Math.abs(S)}% \u2014 D/C Planning \u0E21\u0E35\u0E1B\u0E23\u0E30\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E20\u0E32\u0E1E`,
            ...
            icon: "\u27A1\uFE0F",
            color: "var(--md-text-tertiary)",
            title: `ALOS \u0E17\u0E23\u0E07\u0E15\u0E31\u0E27 ${n(c.alos,2)} \u0E27\u0E31\u0E19 (${S>=0?"+":""}${S}%)`,
            detail: `\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E23\u0E27\u0E21 ${n(c.total_los)} \u0E27\u0E31\u0E19 \u2014 \u0E44\u0E21\u0E48\u0E21\u0E35\u0E01\u0E32\u0E23\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E41\u0E1B\u0E25\u0E07\u0E17\u0E35\u0E48\u0E15\u0E49\u0E2D\u0E07\u0E14\u0E33\u0E40\u0E19\u0E34\u0E19\u0E01\u0E32\u0E23\u0E40\u0E23\u0E48\u0E07\u0E14\u0E48\u0E27\u0E19`,
            actions: []
          });
          {
            const r = [];
            y < 0 && r.push(`Volume \u0E25\u0E14 ${Math.abs(y)}%`), z < -5 && r.push(`CMI \u0E25\u0E14 ${Math.abs(z)}%`), F < -10 ? A.push({
              icon: "\u{1F4B0}",
              color: "#dc2626",
              title: `\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 (AdjRW) \u0E25\u0E14\u0E25\u0E07 ${Math.abs(F)}% \u2014 ${r.join(" + ")||"\u0E15\u0E49\u0E2D\u0E07\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E40\u0E1E\u0E34\u0E48\u0E21"}`,
              detail: `AdjRW ${n(o.sum_adjrw,1)} \u2192 ${n(c.sum_adjrw,1)} (\u0E25\u0E14 ${n(Math.abs(c.sum_adjrw-o.sum_adjrw),1)}) \xB7 RW \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22/\u0E23\u0E32\u0E22 ${H.toFixed(2)} \u2192 ${p.toFixed(2)} \xB7 CMI ${n(o.cmi,2)} \u2192 ${n(c.cmi,2)} \u2014 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E25\u0E14\u0E21\u0E32\u0E01\u0E01\u0E27\u0E48\u0E32\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 \u0E41\u0E2A\u0E14\u0E07\u0E27\u0E48\u0E32 Case-mix \u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E41\u0E1B\u0E25\u0E07`,
              actions: [{
                who: "\u0E17\u0E35\u0E21 Coding/DRG",
              ...
              icon: "\u{1F4B0}",
              color: "#16a34a",
              title: `\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 (AdjRW) \u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 ${F}%`,
              detail: `AdjRW ${n(o.sum_adjrw,1)} \u2192 ${n(c.sum_adjrw,1)} \xB7 RW \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22/\u0E23\u0E32\u0E22 ${H.toFixed(2)} \u2192 ${p.toFixed(2)} \u2014 ${z>5?"Case-mix \u0E0B\u0E31\u0E1A\u0E0B\u0E49\u0E2D\u0E19\u0E02\u0E36\u0E49\u0E19":"\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E40\u0E1E\u0E34\u0E48\u0E21"}`,
              actions: [{
                who: "\u0E04\u0E13\u0E30\u0E01\u0E23\u0E23\u0E21\u0E01\u0E32\u0E23 UM",
              ...
              icon: "\u{1F4B0}",
              color: "#f59e0b",
              title: `\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 (AdjRW) \u0E25\u0E14\u0E25\u0E07\u0E40\u0E25\u0E47\u0E01\u0E19\u0E49\u0E2D\u0E22 ${Math.abs(F)}%`,
              detail: `AdjRW ${n(o.sum_adjrw,1)} \u2192 ${n(c.sum_adjrw,1)} \xB7 RW \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22/\u0E23\u0E32\u0E22 ${H.toFixed(2)} \u2192 ${p.toFixed(2)}`,
              actions: [{
                who: "\u0E17\u0E35\u0E21 Coding",
          ...
          return c.occupancy_rate > 85 ? A.push({
            icon: "\u{1F6CF}\uFE0F",
            color: "#dc2626",
            ...
            icon: "\u{1F4CB}",
            color: "#dc2626",
            title: `CMI \u0E25\u0E14\u0E25\u0E07 ${Math.abs(z)}% (${n(o.cmi,2)} \u2192 ${n(c.cmi,2)}) \u2014 Case-mix \u0E40\u0E1A\u0E32\u0E25\u0E07 \u0E2B\u0E23\u0E37\u0E2D Under-coding`,
            ...
            icon: "\u{1F4CB}",
            color: "#16a34a",
            title: `CMI \u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 ${z}% (${n(o.cmi,2)} \u2192 ${n(c.cmi,2)}) \u2014 \u0E14\u0E39\u0E41\u0E25\u0E40\u0E04\u0E2A\u0E0B\u0E31\u0E1A\u0E0B\u0E49\u0E2D\u0E19\u0E21\u0E32\u0E01\u0E02\u0E36\u0E49\u0E19`,
          ...
          }), A.filter(r => r.actions.length === 0 || r.detail), A.filter(r => r.actions.length > 0), u.jsxs("div", {
            style: {
              marginTop: "12px",
              padding: "16px 18px",
              borderRadius: "12px",
    ...
    })(), !S0 && s === "ipd-compare" && M?.comparison && u.jsxs("div", {
      style: {
        background: "var(--md-surface)",
        border: "1px solid var(--md-border)",
        boxShadow: "var(--md-shadow-sm)",
...
Bed`,
            ...
            children: [M.comparison.filter(e => e.fy1.has_data && e.fy2.has_data).map((e, t) => u.jsxs("tr", {
              ...
              children: [u.jsx("td", {
                ...
                const a = d > 0 ? Math.round((R - d) / d * 100) : R > 0 ? 100 : 0;
                return u.jsxs("td", {
                  style: {
                    ...E.tdNum,
                    fontWeight: 800,
              ...
              children: [u.jsx("td", {
                ...
                return u.jsxs(u.Fragment, {
                  children: [u.jsx("td", {
                    ...
                    children: n(R.discharges)
                  }), u.jsx("td", {
                    style: d,
                    children: n(R.total_los)
                  }), u.jsx("td", {
                    style: {
                      ...d,
                      borderRight: t
                    ...
                    style: d,
                    children: n(R.occupancy_rate, 2)
                  }), u.jsx("td", {
                    style: {
                      ...d,
                      borderRight: t
                    },
                    children: n(R.active_beds, 2)
                  }), u.jsx("td", {
                    style: d,
                    children: n(R.sum_adjrw, 2)
                  }), u.jsx("td", {
                    style: {
                      ...d,
                      borderRight: e
    ...
    }), !S0 && s === "opd-compare" && C?.comparison && (() => {
      const e = C.fy1_totals,
        t = C.fy2_totals,
        d = (o, c) => o > 0 ? Math.round((c - o) / o * 100) : 0,
        R = [{
          label: "Visit",
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
          ...
          children: ["\u0E2A\u0E23\u0E38\u0E1B YoY \u0E40\u0E1B\u0E23\u0E35\u0E22\u0E1A\u0E40\u0E17\u0E35\u0E22\u0E1A (", C.comparable_months, " \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E17\u0E35\u0E48\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E44\u0E14\u0E49)"]
        }), u.jsxs("div", {
          style: {
            fontSize: "12px",
            fontWeight: 600,
          ...
          children: [u.jsxs("span", {
            ...
            children: [C.fiscal_years.fy1.start, " \u2014 ", C.fiscal_years.fy1.end]
          }), u.jsx("span", {
            style: {
              fontWeight: 800,
              color: "var(--md-text-tertiary)"
            ...
            children: [C.fiscal_years.fy2.start, " \u2014 ", C.fiscal_years.fy2.end]
          })]
        }), u.jsx("div", {
          style: {
            display: "grid",
    ...
    })(), !S0 && s === "opd-compare" && C?.comparison && u.jsxs("div", {
      style: {
        background: "var(--md-surface)",
        border: "1px solid var(--md-border)",
        boxShadow: "var(--md-shadow-sm)",
      ...
      children: [u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
          ...
          children: [u.jsx("div", {
            ...
            children: [C.custom_range.start, " \u0E16\u0E36\u0E07 ", C.custom_range.end, " vs \u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19 \xB7 \u0E40\u0E15\u0E35\u0E22\u0E07\u0E08\u0E23\u0E34\u0E07: ", C.comparable_months, " \u0E40\u0E14\u0E37\u0E2D\u0E19"]
          })]
        }), u.jsxs("table", {
          style: {
            width: "100%",
          ...
          children: [u.jsxs("thead", {
            ...
            children: [C.comparison.filter(e => e.fy1.has_data || e.fy2.has_data).map((e, t) => {
              const d = (o, c) => o > 0 ? Math.round((c - o) / o * 100) : c > 0 ? 100 : 0,
                R = "1px solid var(--md-border)";
              return u.jsxs("tr", {
                style: {
                  background: t % 2 === 0 ? "transparent" : "var(--md-surface-2, rgba(0,0,0,.02))"
                },
              ...
              const e = C.fy1_totals,
                ...
                c = (a, y) => a > 0 ? Math.round((y - a) / a * 100) : 0;
              return u.jsxs("tr", {
                style: {
                  background: E.totalBg
                },
                children: [u.jsx("td", {
                  ...
                  return u.jsxs("td", {
                    style: {
                      ...
                      fontWeight: 900,
                      fontSize: "11px",
                      color: D > 0 ? "#16a34a" : D < 0 ? "#dc2626" : "var(--md-text-tertiary)"
                    },
                    children: [D > 0 ? "\u25B2" : D < 0 ? "\u25BC" : "", " ", Math.abs(D), "%"]
                  }, g)
                })]
              })
            })()]
        ...
        children: [u.jsx("span", {
          ...
          children: C.timestamp && new Date(C.timestamp).toLocaleString("th-TH")
        })]
      })]
    }), !S0 && s === "resource-opd" && Eu?.comparison && (() => {
      const e = Eu,
        t = e.fy1_totals,
        d = e.fy2_totals,
        R = (a, y) => y > 0 ? Math.round((a - y) / y * 100) : a > 0 ? 100 : 0;
        ...
        children: [u.jsxs("div", {
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsxs("thead", {
              ...
              children: [e.comparison.filter(a => a.fy1?.has_data && a.fy2?.has_data).map((a, y) => {
                const g = a.fy1,
                  D = a.fy2,
                  S = g.lab_orders + g.drug_orders + g.xray_orders,
                  F = g.lab_price + g.drug_price + g.xray_price,
                  z = D.lab_orders + D.drug_orders + D.xray_orders,
                  T = D.lab_price + D.drug_price + D.xray_price,
                  P = R(z, S),
                  A = R(T, F),
                  w = y % 2 === 0 ? "transparent" : "var(--md-surface-2, rgba(0,0,0,.02))",
                  H = y % 2 === 0 ? "var(--md-surface)" : "var(--md-surface-2, #f8fafc)";
                return u.jsxs("tr", {
                  style: {
                    background: w
                  },
                  children: [u.jsx("td", {
                    ...
                    style: E.tdNum,
                    children: g.lab_orders ? n(g.lab_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: c
                    },
                    children: g.lab_price ? n(g.lab_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: g.drug_orders ? n(g.drug_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: c
                    },
                    children: g.drug_price ? n(g.drug_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: g.xray_orders ? n(g.xray_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: o
                    },
                    children: g.xray_price ? n(g.xray_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: D.lab_orders ? n(D.lab_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: c
                    },
                    children: D.lab_price ? n(D.lab_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: D.drug_orders ? n(D.drug_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: c
                    },
                    children: D.drug_price ? n(D.drug_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: D.xray_orders ? n(D.xray_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: o
                    },
                    children: D.xray_price ? n(D.xray_price) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 800,
                    ...
                    children: a.has_data ? `${P>0?"\u25B2":P<0?"\u25BC":""} ${Math.abs(P)}%` : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 800,
                      color: A >= 0 ? "#16a34a" : "#dc2626"
                    },
                    children: a.has_data ? `${A>0?"\u25B2":A<0?"\u25BC":""} ${Math.abs(A)}%` : ""
                  })]
                }, y)
              }), u.jsxs("tr", {
                style: {
    ...
    })(), !S0 && s === "resource-opd" && Eu?.comparison && u.jsx(nE, {
      data: Eu,
      fy1: l0,
      fy2: t0,
      level: "OPD"
    }), !S0 && s === "resource-ipd" && V0?.comparison && (() => {
      const e = V0,
        t = e.fy1_totals,
        d = e.fy2_totals,
        R = (a, y) => y > 0 ? Math.round((a - y) / y * 100) : a > 0 ? 100 : 0;
        ...
        children: [u.jsxs("div", {
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              children: e.title || `\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 (Lab / Drug / CT-Xray) \u0E40\u0E1B\u0E23\u0E35\u0E22\u0E1A\u0E40\u0E17\u0E35\u0E22\u0E1A ${l0} vs ${t0}`
            }), u.jsxs("div", {
              style: {
                fontSize: "12px",
                fontWeight: 600,
              ...
              children: [e.comparison.filter(a => a.fy1?.has_data && a.fy2?.has_data).map((a, y) => {
                ...
                return u.jsxs("tr", {
                  ...
                  children: [u.jsx("td", {
                    ...
                    style: E.tdNum,
                    children: n(g.lab_orders)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(g.lab_price)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(g.drug_orders)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(g.drug_price)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(g.xray_orders)
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: o
                    },
                    children: n(g.xray_price)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(D.lab_orders)
                  }), u.jsx("td", {
                    ...
                    children: a.has_data && g.has_data && D.has_data ? `${P>=0?"\u25B2":"\u25BC"} ${Math.abs(P)}%` : "\u2014"
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 800,
                    ...
                    children: a.has_data && g.has_data && D.has_data ? `${A>=0?"\u25B2":"\u25BC"} ${Math.abs(A)}%` : "\u2014"
                  })]
                }, a.month)
              }), u.jsxs("tr", {
                style: {
    ...
    })(), !S0 && s === "resource-ipd" && V0?.comparison && u.jsx(nE, {
      data: V0,
      fy1: l0,
      fy2: t0,
      level: "IPD"
    }), !S0 && s === "mortality" && c0?.comparison && (() => {
      const e = c0,
        t = e.fy1_totals,
        d = e.fy2_totals,
        R = (a, y) => y > 0 ? Math.round((a - y) / y * 100) : a > 0 ? 100 : 0,
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsxs("thead", {
              ...
              children: [e.comparison.filter(a => a.fy1?.has_data && a.fy2?.has_data).map((a, y) => {
                const g = a.fy1,
                  D = a.fy2,
                  S = R(D.total_deaths, g.total_deaths),
                ...
                return u.jsxs("tr", {
                  ...
                  children: [u.jsx("td", {
                    ...
                    children: o(g.ipd_mortality_rate)
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                    ...
                    style: {
                      ...E.tdNum,
                      color: D.ipd_deaths > 0 ? "#dc2626" : "inherit",
                      fontWeight: D.ipd_deaths > 0 ? 800 : 600
                    },
                    children: n(D.ipd_deaths)
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      color: D.ipd_mortality_rate >= 2 ? "#dc2626" : D.ipd_mortality_rate > 0 ? "#d97706" : "inherit",
                      fontWeight: 700
                    },
                    ...
                    style: {
                      ...E.tdNum,
                      color: D.opd_deaths > 0 ? "#dc2626" : "inherit",
                      fontWeight: D.opd_deaths > 0 ? 800 : 600
                    },
                    ...
                    style: {
                      ...E.tdNum,
                      fontWeight: 800,
                      color: D.total_deaths > 0 ? "#dc2626" : "inherit",
                      borderRight: c
                    },
                    ...
                    style: {
                      ...E.tdNum,
                      fontWeight: 800,
                      color: S > 0 ? "#dc2626" : S < 0 ? "#16a34a" : "inherit"
                    },
                    children: a.has_data && g.has_data && D.has_data ? `${S>0?"\u25B2":S<0?"\u25BC":""} ${Math.abs(S)}%` : "\u2014"
                  })]
                }, a.month)
              }), u.jsxs("tr", {
                style: {
          ...
          children: [u.jsxs("span", {
            children: [e.data_source, " \xB7 IPD Early Death (LOS<2d): \u0E1B\u0E35\u0E07\u0E1A ", l0, "=", t.ipd_early_deaths, " / \u0E1B\u0E35\u0E07\u0E1A ", t0, "=", d.ipd_early_deaths]
          }), u.jsx("span", {
            children: e.timestamp && new Date(e.timestamp).toLocaleString("th-TH")
          })]
        })]
      })
    })(), !S0 && s === "mortality" && c0?.comparison && u.jsx(yE, {
      ...
      narrative: vE(c0, l0, t0)
    }), !S0 && s === "frax" && C0?.patients && u.jsxs("div", {
      className: "rounded-2xl overflow-hidden",
      style: {
        background: "var(--md-surface)",
        border: "1px solid var(--md-border)",
      ...
      children: [u.jsxs("div", {
        ...
        children: [u.jsxs("span", {
          children: [z0 !== "all" && C0.patients.length > z0 && u.jsxs("span", {
            style: {
              color: "#d97706",
              marginRight: "6px"
            },
            children: ["\u{1F4CB} \u0E41\u0E2A\u0E14\u0E07 ", z0, " \u0E08\u0E32\u0E01 ", C0.patients.length.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 "]
    ...
    }), !S0 && s === "elderly-cxr" && w0?.patients && (() => {
      const e = w0.patients,
        t = w0.total_income || 0,
        d = w0.total_cxr_price || 0,
        R = e.length > 0 ? Math.round(t / e.length) : 0,
      ...
      const y = Object.values(a).sort((i, h) => h.count - i.count).slice(0, 10),
        g = y.length > 0 ? y[0].count : 1,
        D = {
          "60-64": 0,
          "65-69": 0,
          "70-74": 0,
      ...
      const S = Math.max(...Object.values(D), 1),
        F = {
          "60-64": "#3b82f6",
          "65-69": "#10b981",
          "70-74": "#f59e0b",
      ...
      const T = Object.entries(z).sort((i, h) => h[1].count - i[1].count),
        P = new Set(e.map(i => i.hn).filter(Boolean)).size,
        A = Object.entries(D).reduce((i, [h, b]) => b > i[1] ? [h, b] : i, ["", 0]),
        w = y.length > 0 ? y[0] : null,
        H = T.length > 0 ? T[0] : null,
        p = e.length > 0 ? Math.round(d / e.length) : 0,
        r = [`\u{1F4CA} \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21 CXR \u0E1C\u0E39\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 60+ \u0E1B\u0E35: \u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 ${w0.total.toLocaleString()} \u0E23\u0E32\u0E22 (\u0E08\u0E32\u0E01 ${P.toLocaleString()} HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33) \xB7 \u0E04\u0E48\u0E32 CXR \u0E23\u0E27\u0E21 ${d.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${p.toLocaleString()} \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22 \xB7 \u0E0A\u0E32\u0E22 ${o} \u0E23\u0E32\u0E22 / \u0E2B\u0E0D\u0E34\u0E07 ${c} \u0E23\u0E32\u0E22${o>0&&c>0?` (\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E2A\u0E48\u0E27\u0E19 ${(o/c).toFixed(2)}:1)`:""}`];
      if (A[0]) {
        const i = e.length > 0 ? Math.round(A[1] / e.length * 100) : 0;
        r.push(`\u{1F474} \u0E01\u0E25\u0E38\u0E48\u0E21\u0E2D\u0E32\u0E22\u0E38\u0E17\u0E35\u0E48\u0E17\u0E33 CXR \u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${A[0]} \u0E1B\u0E35 ${A[1]} \u0E23\u0E32\u0E22 (${i}%) \u2014 ${A[0]==="80+"?"\u0E01\u0E25\u0E38\u0E48\u0E21\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38\u0E21\u0E32\u0E01 \u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E1B\u0E2D\u0E14\u0E2D\u0E31\u0E01\u0E40\u0E2A\u0E1A/\u0E27\u0E31\u0E13\u0E42\u0E23\u0E04\u0E2A\u0E39\u0E07 \u0E04\u0E27\u0E23 follow-up \u0E17\u0E38\u0E01\u0E23\u0E32\u0E22":A[0].startsWith("60")?"\u0E01\u0E25\u0E38\u0E48\u0E21\u0E40\u0E23\u0E34\u0E48\u0E21\u0E15\u0E49\u0E19\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 \u0E04\u0E27\u0E23\u0E17\u0E33 baseline CXR \u0E41\u0E25\u0E30\u0E2A\u0E48\u0E07\u0E40\u0E2A\u0E23\u0E34\u0E21\u0E01\u0E32\u0E23\u0E15\u0E23\u0E27\u0E08\u0E1B\u0E23\u0E30\u0E08\u0E33\u0E1B\u0E35":"\u0E01\u0E25\u0E38\u0E48\u0E21\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38\u0E01\u0E25\u0E32\u0E07 \u0E04\u0E27\u0E23\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07 COPD/IHD \u0E23\u0E48\u0E27\u0E21\u0E14\u0E49\u0E27\u0E22"}`)
      }
      if (w && su.test(w.code) && r.push(`\u{1FA7B} \u0E1C\u0E25\u0E15\u0E23\u0E27\u0E08 CXR \u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${w.code} ${w.name||""} \u0E08\u0E33\u0E19\u0E27\u0E19 ${w.count} \u0E23\u0E32\u0E22 \u2014 ${w.code.startsWith("J18")?"\u0E1B\u0E2D\u0E14\u0E2D\u0E31\u0E01\u0E40\u0E2A\u0E1A \u0E04\u0E27\u0E23\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E1C\u0E25\u0E01\u0E32\u0E23\u0E23\u0E31\u0E01\u0E29\u0E32\u0E41\u0E25\u0E30\u0E09\u0E35\u0E14\u0E27\u0E31\u0E04\u0E0B\u0E35\u0E19\u0E1B\u0E49\u0E2D\u0E07\u0E01\u0E31\u0E19 Pneumococcal/Influenza":w.code.startsWith("J44")||w.code.startsWith("J43")?"COPD/Emphysema \u0E04\u0E27\u0E23\u0E40\u0E02\u0E49\u0E32\u0E2A\u0E39\u0E48\u0E23\u0E30\u0E1A\u0E1A COPD clinic \u0E41\u0E25\u0E30\u0E2A\u0E48\u0E07\u0E40\u0E2A\u0E23\u0E34\u0E21\u0E01\u0E32\u0E23\u0E40\u0E25\u0E34\u0E01\u0E1A\u0E38\u0E2B\u0E23\u0E35\u0E48":w.code.startsWith("I")?"\u0E42\u0E23\u0E04\u0E2B\u0E31\u0E27\u0E43\u0E08/\u0E2B\u0E25\u0E2D\u0E14\u0E40\u0E25\u0E37\u0E2D\u0E14 \u0E04\u0E27\u0E23\u0E1B\u0E23\u0E30\u0E2A\u0E32\u0E19\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01 NCD":"\u0E04\u0E27\u0E23\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E1C\u0E25\u0E01\u0E32\u0E23\u0E15\u0E23\u0E27\u0E08\u0E41\u0E25\u0E30\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E15\u0E32\u0E21\u0E2D\u0E32\u0E22\u0E38"}`), H) {
        const [i, h] = H, b = e.length > 0 ? Math.round(h.count / e.length * 100) : 0;
        b >= 50 && r.push(`\u{1F3AB} \u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${i} ${h.count} \u0E23\u0E32\u0E22 (${b}%) \u2014 \u0E2A\u0E48\u0E27\u0E19\u0E43\u0E2B\u0E0D\u0E48\u0E40\u0E1B\u0E47\u0E19\u0E1A\u0E31\u0E15\u0E23\u0E17\u0E2D\u0E07\u0E1C\u0E39\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 \u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E43\u0E2B\u0E49\u0E04\u0E23\u0E2D\u0E1A\u0E04\u0E25\u0E38\u0E21\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22 LTC \u0E02\u0E2D\u0E07\u0E0A\u0E38\u0E21\u0E0A\u0E19`)
      }
      w0.total > 0 && p > 0 && r.push("\u{1F4A1} \u0E41\u0E19\u0E30\u0E19\u0E33\u0E40\u0E0A\u0E34\u0E07\u0E19\u0E42\u0E22\u0E1A\u0E32\u0E22: CXR \u0E43\u0E19\u0E1C\u0E39\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 60+ \u0E40\u0E1B\u0E47\u0E19 screening \u0E2A\u0E33\u0E04\u0E31\u0E0D\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A TB/COPD/Lung CA \xB7 \u0E04\u0E27\u0E23\u0E01\u0E33\u0E2B\u0E19\u0E14\u0E40\u0E1B\u0E49\u0E32\u0E2B\u0E21\u0E32\u0E22 coverage \u226580% \u0E02\u0E2D\u0E07\u0E1C\u0E39\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38\u0E43\u0E19\u0E40\u0E02\u0E15 \xB7 \u0E08\u0E31\u0E14\u0E17\u0E33 CXR mobile clinic \u0E2B\u0E32\u0E01\u0E40\u0E02\u0E49\u0E32\u0E16\u0E36\u0E07\u0E44\u0E21\u0E48\u0E2A\u0E30\u0E14\u0E27\u0E01");
      const $ = {
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsx("div", {
          ...
          children: [u.jsxs("div", {
            ...
            }), T.slice(0, 8).map(([i, h], b) => {
              const N = e.length > 0 ? Math.round(h.count / e.length * 100) : 0,
            ...
            children: [u.jsx("div", {
              ...
              children: Object.entries(D).map(([i, h]) => u.jsxs("div", {
                style: {
                  flex: 1,
                  display: "flex",
                  flexDirection: "column",
            ...
            children: [u.jsx("div", {
              ...
              children: y.map((i, h) => {
                const b = g > 0 ? Math.round(i.count / g * 100) : 0;
                return u.jsxs("div", {
                  style: {
                    display: "flex",
                    alignItems: "center",
            ...
            children: [u.jsxs("div", {
              ...
              children: [u.jsx("thead", {
                ...
                children: L0(e).map((i, h) => {
                  const b = h % 2 !== 0 ? "var(--md-surface-2, rgba(0,0,0,.015))" : "transparent";
                  return u.jsxs("tr", {
                    style: {
                      background: b,
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", w0.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E0A\u0E32\u0E22 ", o, " \xB7 \u0E2B\u0E0D\u0E34\u0E07 ", c, " \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", R.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
    ...
    })(), !S0 && s === "fluoride" && v0?.patients && (() => {
      const e = v0.patients,
        t = v0.total_income || 0,
        d = v0.total_fluoride_price || 0,
        R = e.length > 0 ? Math.round(t / e.length) : 0;
      ...
      const g = Math.max(...Object.values(y), 1),
        D = {
          "25-34": "#3b82f6",
          "35-44": "#10b981",
          "45-54": "#f59e0b",
      ...
      const F = Object.entries(S).sort((p, r) => r[1].count - p[1].count),
        z = new Set(e.map(p => p.hn).filter(Boolean)).size,
        T = Object.entries(y).reduce((p, [r, $]) => $ > p[1] ? [r, $] : p, ["", 0]),
        P = e.length > 0 ? Math.round(d / e.length) : 0,
        A = F.length > 0 ? F[0] : null,
        w = [`\u{1F4CA} \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E01\u0E32\u0E23\u0E40\u0E04\u0E25\u0E37\u0E2D\u0E1A\u0E1F\u0E25\u0E39\u0E2D\u0E2D\u0E44\u0E23\u0E14\u0E4C (\u0E2D\u0E32\u0E22\u0E38 25-59 \u0E1B\u0E35): \u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 ${v0.total.toLocaleString()} \u0E23\u0E32\u0E22 (\u0E08\u0E32\u0E01 ${z.toLocaleString()} HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33) \xB7 \u0E04\u0E48\u0E32\u0E40\u0E04\u0E25\u0E37\u0E2D\u0E1A\u0E1F\u0E25\u0E39\u0E2D\u0E2D\u0E44\u0E23\u0E14\u0E4C\u0E23\u0E27\u0E21 ${d.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${P.toLocaleString()} \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22${P<50?" \u2014 \u0E15\u0E48\u0E33\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 \u0E2D\u0E32\u0E08\u0E21\u0E35\u0E01\u0E32\u0E23\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E23\u0E32\u0E04\u0E32\u0E44\u0E21\u0E48\u0E04\u0E23\u0E1A":P>150?" \u2014 \u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 \u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E04\u0E27\u0E32\u0E21\u0E16\u0E39\u0E01\u0E15\u0E49\u0E2D\u0E07\u0E02\u0E2D\u0E07\u0E23\u0E2B\u0E31\u0E2A\u0E04\u0E48\u0E32\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23":""}`];
      if (T[0]) {
        const p = e.length > 0 ? Math.round(T[1] / e.length * 100) : 0;
        w.push(`\u{1F465} \u0E01\u0E25\u0E38\u0E48\u0E21\u0E2D\u0E32\u0E22\u0E38\u0E17\u0E35\u0E48\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${T[0]} \u0E1B\u0E35 \u0E08\u0E33\u0E19\u0E27\u0E19 ${T[1]} \u0E23\u0E32\u0E22 (${p}%) \u2014 ${T[0]==="55-59"?"\u0E01\u0E25\u0E38\u0E48\u0E21\u0E43\u0E01\u0E25\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 \u0E15\u0E49\u0E2D\u0E07\u0E43\u0E2B\u0E49\u0E04\u0E33\u0E41\u0E19\u0E30\u0E19\u0E33\u0E40\u0E23\u0E37\u0E48\u0E2D\u0E07\u0E2A\u0E38\u0E02\u0E20\u0E32\u0E1E\u0E0A\u0E48\u0E2D\u0E07\u0E1B\u0E32\u0E01\u0E41\u0E25\u0E30\u0E01\u0E32\u0E23\u0E1B\u0E49\u0E2D\u0E07\u0E01\u0E31\u0E19\u0E42\u0E23\u0E04":T[0]==="25-34"?"\u0E01\u0E25\u0E38\u0E48\u0E21\u0E27\u0E31\u0E22\u0E17\u0E33\u0E07\u0E32\u0E19 \u0E04\u0E27\u0E23\u0E40\u0E19\u0E49\u0E19 health promotion \u0E41\u0E25\u0E30 follow-up periodic":"\u0E01\u0E25\u0E38\u0E48\u0E21\u0E01\u0E25\u0E32\u0E07\u0E27\u0E31\u0E22 \u0E04\u0E27\u0E23\u0E01\u0E23\u0E30\u0E15\u0E38\u0E49\u0E19\u0E04\u0E27\u0E32\u0E21\u0E15\u0E23\u0E30\u0E2B\u0E19\u0E31\u0E01\u0E40\u0E23\u0E37\u0E48\u0E2D\u0E07\u0E2A\u0E38\u0E02\u0E20\u0E32\u0E1E\u0E0A\u0E48\u0E2D\u0E07\u0E1B\u0E32\u0E01"}`)
      }
      if (c[0] && w.push(`\u{1F9B7} \u0E23\u0E2B\u0E31\u0E2A\u0E42\u0E23\u0E04/\u0E2B\u0E31\u0E15\u0E16\u0E01\u0E32\u0E23\u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${c[0].code} ${c[0].name||""} \u0E08\u0E33\u0E19\u0E27\u0E19 ${c[0].count} \u0E23\u0E32\u0E22 \u2014 ${c[0].code.startsWith("K02")?"\u0E1F\u0E31\u0E19\u0E1C\u0E38 \u0E04\u0E27\u0E23\u0E40\u0E2A\u0E23\u0E34\u0E21\u0E01\u0E32\u0E23\u0E43\u0E2B\u0E49\u0E04\u0E33\u0E41\u0E19\u0E30\u0E19\u0E33\u0E40\u0E23\u0E37\u0E48\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E41\u0E1B\u0E23\u0E07\u0E1F\u0E31\u0E19\u0E41\u0E25\u0E30\u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49\u0E1F\u0E25\u0E39\u0E2D\u0E2D\u0E44\u0E23\u0E14\u0E4C\u0E17\u0E35\u0E48\u0E1A\u0E49\u0E32\u0E19":"\u0E04\u0E27\u0E23\u0E1E\u0E34\u0E08\u0E32\u0E23\u0E13\u0E32\u0E41\u0E19\u0E27\u0E17\u0E32\u0E07\u0E01\u0E32\u0E23\u0E1B\u0E49\u0E2D\u0E07\u0E01\u0E31\u0E19\u0E41\u0E25\u0E30\u0E2A\u0E48\u0E07\u0E40\u0E2A\u0E23\u0E34\u0E21\u0E17\u0E35\u0E48\u0E40\u0E2B\u0E21\u0E32\u0E30\u0E2A\u0E21"}`), A) {
        const [p, r] = A, $ = e.length > 0 ? Math.round(r.count / e.length * 100) : 0;
        $ >= 50 && w.push(`\u{1F3AB} \u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${p} ${r.count} \u0E23\u0E32\u0E22 (${$}%) \u2014 \u0E21\u0E35\u0E01\u0E32\u0E23\u0E1E\u0E36\u0E48\u0E07\u0E1E\u0E32\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E40\u0E14\u0E35\u0E22\u0E27\u0E2A\u0E39\u0E07 \u0E04\u0E27\u0E23\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E40\u0E07\u0E37\u0E48\u0E2D\u0E19\u0E44\u0E02\u0E01\u0E32\u0E23\u0E40\u0E1A\u0E34\u0E01\u0E43\u0E2B\u0E49\u0E04\u0E23\u0E1A\u0E16\u0E49\u0E27\u0E19`)
      }
      v0.total < 50 && w.push(`\u26A0\uFE0F \u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E15\u0E48\u0E33 (${v0.total} \u0E23\u0E32\u0E22) \u2014 \u0E41\u0E19\u0E30\u0E19\u0E33\u0E43\u0E2B\u0E49\u0E17\u0E33 outreach \u0E43\u0E19\u0E0A\u0E38\u0E21\u0E0A\u0E19 \u0E40\u0E0A\u0E48\u0E19 \u0E01\u0E32\u0E23\u0E1B\u0E23\u0E30\u0E0A\u0E32\u0E2A\u0E31\u0E21\u0E1E\u0E31\u0E19\u0E18\u0E4C\u0E1C\u0E48\u0E32\u0E19\u0E2D\u0E2A\u0E21., \u0E08\u0E31\u0E14\u0E01\u0E34\u0E08\u0E01\u0E23\u0E23\u0E21\u0E43\u0E19\u0E0A\u0E38\u0E21\u0E0A\u0E19 \u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E01\u0E32\u0E23\u0E40\u0E02\u0E49\u0E32\u0E16\u0E36\u0E07`);
      const H = {
        ...
        children: [u.jsx("div", {
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              children: Object.entries(y).map(([p, r]) => u.jsxs("div", {
                style: {
                  flex: 1,
                  display: "flex",
                  flexDirection: "column",
            ...
            children: [u.jsx("div", {
              ...
              children: c.map((p, r) => {
                const $ = a > 0 ? Math.round(p.count / a * 100) : 0;
                return u.jsxs("div", {
                  style: {
                    display: "flex",
                    alignItems: "center",
            ...
            children: [u.jsxs("div", {
              ...
              children: [u.jsx("thead", {
                ...
                children: L0(e).map((p, r) => {
                  const $ = r % 2 !== 0 ? "var(--md-surface-2, rgba(0,0,0,.015))" : "transparent";
                  return u.jsxs("tr", {
                    style: {
                      background: $,
                      transition: "background .1s"
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", v0.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", R.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
      ...
      const R = J.opd_count || e.filter(x => x.visit_type === "OPD").length,
        o = J.ipd_count || e.filter(x => x.visit_type === "IPD").length,
        c = J.opd_income || e.filter(x => x.visit_type === "OPD").reduce((x, f) => x + f.income, 0),
        a = J.ipd_income || e.filter(x => x.visit_type === "IPD").reduce((x, f) => x + f.income, 0),
        y = {};
      e.forEach(x => {
      ...
      const g = Object.values(y).sort((x, f) => f.count - x.count).slice(0, 10),
        D = g.length > 0 ? g[0].count : 1,
        S = {};
      e.forEach(x => {
      ...
      const F = Object.entries(S).sort((x, f) => f[1].count - x[1].count),
        z = {
          "<18": 0,
          "18-34": 0,
          "35-59": 0,
      ...
      e.forEach(x => {
        ...
        f < 18 ? z["<18"]++ : f < 35 ? z["18-34"]++ : f < 60 ? z["35-59"]++ : z["60+"]++
      });
      const T = Math.max(...Object.values(z), 1),
        P = {
          "<18": "#3b82f6",
          "18-34": "#10b981",
          "35-59": "#f59e0b",
      ...
      e.forEach(x => {
        ...
        f && (A[f] = A[f] || {
          ...
          count: 0,
          income: 0
        }, A[f].count++, A[f].income += x.income || 0)
      });
      const w = Object.values(A).sort((x, f) => x.date.localeCompare(f.date)),
        H = Math.max(...w.map(x => x.count), 1),
        p = w.reduce((x, f) => x + f.income, 0),
        r = w.length > 0 ? Math.round(e.length / w.length) : 0,
        $ = J.yoy || null,
        i = (x, f) => $ == null || f == null || f === 0 ? null : Math.round((x - f) / f * 1e3) / 10,
        h = $ && $.total > 0 ? Math.round($.total_income / $.total) : null,
        b = (x, f, m) => {
        ...
        N = s === "staff-services" ? "\u0E01\u0E32\u0E23\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E02\u0E2D\u0E07\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23" : "\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E\u0E1A\u0E33\u0E1A\u0E31\u0E14 & PMC",
        v = s === "staff-services" ? "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23" : "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22",
        _ = s === "staff-services" ? "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E17\u0E35\u0E48\u0E40\u0E02\u0E49\u0E32\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23" : "\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23",
        ...
        k = w.length > 0 ? w.reduce((x, f) => f.count > x.count ? f : x, w[0]) : null,
        X = w.length > 0 ? w.reduce((x, f) => f.count < x.count ? f : x, w[0]) : null,
        q = F.length > 0 ? F[0] : null,
        E0 = g.length > 0 ? g[0] : null,
        o0 = $ ? i(J.total, $.total) : null,
        T0 = $ ? i(t, $.total_income) : null,
        K0 = [];
      if (K0.push(`\u{1F4CA} \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21${N} (${J.date_range?.start||""} \u0E16\u0E36\u0E07 ${J.date_range?.end||""}): ${_} ${J.total.toLocaleString()} \u0E23\u0E32\u0E22 (\u0E08\u0E32\u0E01 ${j.toLocaleString()} HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33) \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E23\u0E27\u0E21 ${t.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${d.toLocaleString()} \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22${o0!=null?` \xB7 ${o0>=0?"\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19":"\u0E25\u0E14\u0E25\u0E07"} ${Math.abs(o0).toFixed(1)}% \u0E40\u0E17\u0E35\u0E22\u0E1A\u0E0A\u0E48\u0E27\u0E07\u0E40\u0E14\u0E35\u0E22\u0E27\u0E01\u0E31\u0E19\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19`:""}`), T0 != null && Math.abs(T0) >= 20 && K0.push(T0 >= 0 ? `\u{1F4B0} \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E21\u0E35\u0E19\u0E31\u0E22\u0E2A\u0E33\u0E04\u0E31\u0E0D ${T0.toFixed(1)}% YoY (${($.total_income||0).toLocaleString()} \u2192 ${t.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17) \u2014 \u0E04\u0E27\u0E23\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E01\u0E33\u0E25\u0E31\u0E07\u0E04\u0E19/\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23\u0E43\u0E2B\u0E49\u0E2A\u0E2D\u0E14\u0E04\u0E25\u0E49\u0E2D\u0E07\u0E01\u0E31\u0E1A\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E07\u0E32\u0E19\u0E17\u0E35\u0E48\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 \u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E23\u0E31\u0E01\u0E29\u0E32\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23` : `\u{1F4C9} \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E25\u0E14\u0E25\u0E07 ${Math.abs(T0).toFixed(1)}% YoY \u2014 \u0E04\u0E27\u0E23\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E2A\u0E32\u0E40\u0E2B\u0E15\u0E38: \u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E41\u0E1B\u0E25\u0E07\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E01\u0E32\u0E23\u0E23\u0E31\u0E01\u0E29\u0E32 \xB7 \u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E25\u0E14 \xB7 \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E48\u0E32\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19 \u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E2B\u0E32\u0E08\u0E38\u0E14\u0E17\u0E35\u0E48\u0E15\u0E49\u0E2D\u0E07\u0E1B\u0E23\u0E31\u0E1A`), k && X && k.date !== X.date && w.length >= 3 && K0.push(`\u{1F4C5} \u0E27\u0E31\u0E19\u0E17\u0E35\u0E48${v}\u0E21\u0E32\u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${k.date.substring(5)} (${k.count} \u0E23\u0E32\u0E22) \xB7 \u0E19\u0E49\u0E2D\u0E22\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${X.date.substring(5)} (${X.count} \u0E23\u0E32\u0E22) \u2014 ${k.count>X.count*3?"\u0E01\u0E32\u0E23\u0E01\u0E23\u0E30\u0E08\u0E32\u0E22\u0E44\u0E21\u0E48\u0E2A\u0E21\u0E48\u0E33\u0E40\u0E2A\u0E21\u0E2D \u0E04\u0E27\u0E23\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E27\u0E48\u0E32\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E19\u0E49\u0E2D\u0E22\u0E21\u0E35\u0E1B\u0E31\u0E0D\u0E2B\u0E32 (\u0E27\u0E31\u0E19\u0E2B\u0E22\u0E38\u0E14/\u0E19\u0E42\u0E22\u0E1A\u0E32\u0E22) \u0E2B\u0E23\u0E37\u0E2D\u0E44\u0E21\u0E48 \u0E41\u0E25\u0E30\u0E40\u0E15\u0E23\u0E35\u0E22\u0E21\u0E23\u0E31\u0E1A\u0E20\u0E32\u0E23\u0E30\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E21\u0E32\u0E01":"\u0E01\u0E32\u0E23\u0E01\u0E23\u0E30\u0E08\u0E32\u0E22\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07\u0E1B\u0E01\u0E15\u0E34"}`), q) {
      ...
      if (E0 && su.test(E0.code) && K0.push(`\u{1FA7A} \u0E42\u0E23\u0E04/\u0E2B\u0E31\u0E15\u0E16\u0E01\u0E32\u0E23\u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${E0.code} ${E0.name||""} \u0E08\u0E33\u0E19\u0E27\u0E19 ${E0.count} \u0E23\u0E32\u0E22 \u2014 ${E0.code.startsWith("M")?"\u0E01\u0E25\u0E38\u0E48\u0E21\u0E42\u0E23\u0E04\u0E01\u0E25\u0E49\u0E32\u0E21\u0E40\u0E19\u0E37\u0E49\u0E2D/\u0E02\u0E49\u0E2D \u0E04\u0E27\u0E23\u0E23\u0E30\u0E1A\u0E38\u0E15\u0E33\u0E41\u0E2B\u0E19\u0E48\u0E07/\u0E23\u0E30\u0E22\u0E30\u0E43\u0E2B\u0E49\u0E25\u0E30\u0E40\u0E2D\u0E35\u0E22\u0E14\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E01\u0E47\u0E1A\u0E23\u0E2B\u0E31\u0E2A\u0E44\u0E14\u0E49\u0E41\u0E21\u0E48\u0E19\u0E22\u0E33":"\u0E41\u0E19\u0E30\u0E19\u0E33\u0E43\u0E2B\u0E49\u0E17\u0E33 protocol \u0E23\u0E31\u0E01\u0E29\u0E32\u0E40\u0E09\u0E1E\u0E32\u0E30\u0E01\u0E25\u0E38\u0E48\u0E21\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E1B\u0E23\u0E30\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E20\u0E32\u0E1E"}`), j > 0 && L >= 5 && K0.push(`\u{1F501} \u0E21\u0E35${v}\u0E01\u0E25\u0E31\u0E1A\u0E21\u0E32\u0E0B\u0E49\u0E33 ${B.toLocaleString()} visits \u0E08\u0E32\u0E01 ${W.toLocaleString()} HN (\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${(e.length/j).toFixed(1)} \u0E04\u0E23\u0E31\u0E49\u0E07/\u0E04\u0E19) \u2014 ${L>=30?"\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E01\u0E32\u0E23\u0E01\u0E25\u0E31\u0E1A\u0E21\u0E32\u0E0B\u0E49\u0E33\u0E2A\u0E39\u0E07\u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19\u0E04\u0E27\u0E32\u0E21\u0E15\u0E48\u0E2D\u0E40\u0E19\u0E37\u0E48\u0E2D\u0E07\u0E02\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E23\u0E31\u0E01\u0E29\u0E32 \u0E04\u0E27\u0E23\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C\u0E17\u0E32\u0E07\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01":"\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E01\u0E25\u0E31\u0E1A\u0E21\u0E32\u0E0B\u0E49\u0E33\u0E1B\u0E01\u0E15\u0E34 \u2014 \u0E40\u0E19\u0E49\u0E19\u0E40\u0E0A\u0E34\u0E0D\u0E0A\u0E27\u0E19"+U+"\u0E40\u0E1E\u0E34\u0E48\u0E21"}`), D && D.length > 0 && D[0]) {
        const x = D[0],
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsx("div", {
          ...
          children: [...s === "staff-services" && J.staff_registry_count ? [{
            label: "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14",
            icon: "\u{1F465}",
            ...
            icon: "\u{1F465}",
            value: (s === "staff-services" ? j : J.total).toLocaleString(),
            unit: "\u0E23\u0E32\u0E22",
            color: "#10b981",
            yoy: s === "staff-services" ? (() => {
              const x = i(j, $?.unique_hn),
            ...
            unit: "\u0E04\u0E23\u0E31\u0E49\u0E07",
            color: "#0d9488",
            yoy: b(i(J.total, $?.total), $?.total, "\u0E04\u0E23\u0E31\u0E49\u0E07")
          }] : [], {
            ...
            unit: "\u0E23\u0E32\u0E22",
            color: "#0ea5e9",
            yoy: b(i(R, $?.opd_count), $?.opd_count, "\u0E23\u0E32\u0E22")
          }, {
            label: "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 (IPD)",
            icon: "\u{1F6CF}\uFE0F",
            value: o.toLocaleString(),
            unit: "\u0E23\u0E32\u0E22",
            color: "#ef4444",
            yoy: b(i(o, $?.ipd_count), $?.ipd_count, "\u0E23\u0E32\u0E22")
          }, {
            label: "\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E23\u0E27\u0E21",
            icon: "\u{1F4B0}",
            value: t.toLocaleString(void 0, {
            ...
            unit: "\u0E1A\u0E32\u0E17",
            color: "#3b82f6",
            yoy: b(i(t, $?.total_income), $?.total_income, "\u0E3F")
          }, {
            label: "\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 / \u0E23\u0E32\u0E22",
            icon: "\u{1F4CA}",
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              const O = e.length > 0 ? Math.round(f.count / e.length * 100) : 0,
                r0 = ["#10b981", "#3b82f6", "#8b5cf6", "#f59e0b", "#ef4444"],
                _0 = r0[m % r0.length];
              return u.jsxs("div", {
                style: {
                  marginBottom: "8px"
            ...
            children: [u.jsx("div", {
              ...
              children: Object.entries(z).map(([x, f]) => u.jsxs("div", {
                style: {
                  flex: 1,
                  display: "flex",
                  flexDirection: "column",
            ...
            children: [u.jsx("div", {
              ...
              children: g.map((x, f) => {
                const m = D > 0 ? Math.round(x.count / D * 100) : 0;
                return u.jsxs("div", {
                  style: {
                    display: "flex",
                    alignItems: "center",
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              children: [w.length, " \u0E27\u0E31\u0E19 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", r, " \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19 \xB7 \u0E23\u0E27\u0E21 ", p.toLocaleString(), " \u0E1A\u0E32\u0E17"]
            })]
            ...
            children: w.map(x => u.jsxs("div", {
              ...
              children: [u.jsx("span", {
                ...
                style: {
                  ...
                  height: `${Math.max(8,x.count/H*80)}px`,
                  opacity: .85,
                  transition: "height .5s ease"
                }
              }), u.jsx("span", {
              ...
              children: [u.jsx("thead", {
                ...
                children: L0(e).map((x, f) => {
                  ...
                  return u.jsxs("tr", {
                    ...
                    onMouseEnter: r0 => r0.currentTarget.style.background = "rgba(59,130,246,.05)",
                    onMouseLeave: r0 => r0.currentTarget.style.background = m,
                    children: [u.jsx("td", {
                      style: {
                        ...E.td,
                        color: "var(--md-text-tertiary)",
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", J.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 OPD ", R, " (", c.toLocaleString(), " \u0E3F) \xB7 IPD ", o, " (", a.toLocaleString(), " \u0E3F) \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", d.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
      ...
      const {
        ...
        topIcd: g,
        rightList: D
      } = Q, S = b0.diseases || ["DM", "HT", "DLP", "IHD", "Stroke", "COPD", "CKD1", "CKD2", "CKD3", "CKD4", "CKD5", "CKD", "Other"], F = b0.disease_labels || {}, z = Q.diseaseCountsFE || b0.disease_counts || {}, T = {
        DM: "#ef4444",
        HT: "#f59e0b",
        DLP: "#eab308",
        IHD: "#dc2626",
        ...
        CKD: "#6b7280",
        Other: "#94a3b8"
      }, P = Math.max(...S.map(_ => z[_] || 0), 1), A = {
        "<40": "#06b6d4",
        "40-49": "#3b82f6",
        "50-59": "#10b981",
        "60-69": "#f59e0b",
        "70+": "#ef4444"
      }, w = g.slice(0, 10), H = w.length > 0 ? w[0].count : 1, p = S.filter(_ => (z[_] || 0) > 0 && _ !== "Other").sort((_, U) => (z[U] || 0) - (z[_] || 0)), r = p[0], $ = p[1], i = ["CKD1", "CKD2", "CKD3", "CKD4", "CKD5"].reduce((_, U) => _ + (z[U] || 0), 0), h = (z.CKD3 || 0) + (z.CKD4 || 0) + (z.CKD5 || 0), b = e.length > 0 ? Math.round(t / e.length) : 0, N = [`\u{1F4CA} \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21 NCD: ${e.length.toLocaleString()} visits \u0E08\u0E32\u0E01 ${d.toLocaleString()} HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33 \xB7 \u0E0A\u0E32\u0E22 ${o} \u0E23\u0E32\u0E22 / \u0E2B\u0E0D\u0E34\u0E07 ${c} \u0E23\u0E32\u0E22 \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E23\u0E27\u0E21 ${t.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${b.toLocaleString()} \u0E1A\u0E32\u0E17/visit`];
      if (r && N.push(`\u{1FA7A} \u0E42\u0E23\u0E04\u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${F[r]||r} ${(z[r]||0).toLocaleString()} \u0E23\u0E32\u0E22${$?` \xB7 \u0E23\u0E2D\u0E07\u0E21\u0E32 ${F[$]||$} ${(z[$]||0).toLocaleString()} \u0E23\u0E32\u0E22`:""}${["DM","HT","DLP"].includes(r)?" \u2014 \u0E01\u0E25\u0E38\u0E48\u0E21\u0E42\u0E23\u0E04\u0E1E\u0E37\u0E49\u0E19\u0E10\u0E32\u0E19 NCD \u0E04\u0E27\u0E23\u0E40\u0E02\u0E49\u0E21\u0E07\u0E27\u0E14\u0E40\u0E23\u0E37\u0E48\u0E2D\u0E07 self-care + \u0E01\u0E32\u0E23\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E1C\u0E25 HbA1c/BP":r==="Stroke"||r==="IHD"?" \u2014 \u0E01\u0E25\u0E38\u0E48\u0E21\u0E42\u0E23\u0E04\u0E2B\u0E31\u0E27\u0E43\u0E08\u0E2B\u0E25\u0E2D\u0E14\u0E40\u0E25\u0E37\u0E2D\u0E14 \u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E2A\u0E39\u0E07 \u0E15\u0E49\u0E2D\u0E07\u0E1B\u0E23\u0E30\u0E2A\u0E32\u0E19 specialist \u0E41\u0E25\u0E30 rehab":""}`), i > 0) {
        const _ = d > 0 ? Math.round(i / d * 100) : 0,
          U = i > 0 ? Math.round(h / i * 100) : 0;
        N.push(`\u{1FAC0} \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 CKD \u0E23\u0E27\u0E21 ${i.toLocaleString()} \u0E23\u0E32\u0E22 (${_}% \u0E02\u0E2D\u0E07 HN) \xB7 \u0E23\u0E30\u0E22\u0E30 3-5 ${h.toLocaleString()} \u0E23\u0E32\u0E22 (${U}%) \u2014 ${h>=50?"\u{1F534} \u0E21\u0E35 CKD \u0E23\u0E30\u0E22\u0E30\u0E25\u0E36\u0E01\u0E08\u0E33\u0E19\u0E27\u0E19\u0E21\u0E32\u0E01 \u0E15\u0E49\u0E2D\u0E07 early referral \u0E44\u0E1B\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01 nephrology + \u0E40\u0E15\u0E23\u0E35\u0E22\u0E21 dialysis":h>=10?"\u{1F7E0} \u0E04\u0E27\u0E23 monitor eGFR \u0E17\u0E38\u0E01 3 \u0E40\u0E14\u0E37\u0E2D\u0E19 + \u0E1B\u0E23\u0E31\u0E1A\u0E22\u0E32\u0E43\u0E2B\u0E49\u0E2A\u0E2D\u0E14\u0E04\u0E25\u0E49\u0E2D\u0E07":"\u{1F7E2} \u0E2A\u0E48\u0E27\u0E19\u0E43\u0E2B\u0E0D\u0E48\u0E2D\u0E22\u0E39\u0E48\u0E23\u0E30\u0E22\u0E30\u0E15\u0E49\u0E19 \u0E04\u0E27\u0E23\u0E40\u0E19\u0E49\u0E19 primary prevention"}`)
      }
      if (w[0] && N.push(`\u{1F48A} \u0E23\u0E2B\u0E31\u0E2A ICD-10 \u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22\u0E2A\u0E38\u0E14: ${w[0].code} ${w[0].name||""} (${w[0].count} \u0E23\u0E32\u0E22) \u2014 ${w[0].code.startsWith("E11")||w[0].code.startsWith("E10")?"DM \u0E04\u0E27\u0E23\u0E40\u0E1D\u0E49\u0E32\u0E23\u0E30\u0E27\u0E31\u0E07 complications: retinopathy, neuropathy, nephropathy":w[0].code.startsWith("I10")?"Hypertension \u0E04\u0E27\u0E23 monitor BP \u0E17\u0E38\u0E01 visit + \u0E1B\u0E23\u0E31\u0E1A lifestyle":w[0].code.startsWith("N18")?"CKD progression \u0E04\u0E27\u0E23\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E43\u0E01\u0E25\u0E49\u0E0A\u0E34\u0E14":"\u0E04\u0E27\u0E23\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19 comorbidities \u0E40\u0E1E\u0E37\u0E48\u0E2D holistic care"}`), (z.DM || 0) > 0 && (z.HT || 0) > 0) {
        const _ = Math.min(z.DM, z.HT);
        N.push(`\u26A0\uFE0F \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 DM + HT \u0E23\u0E48\u0E27\u0E21: \u0E04\u0E32\u0E14\u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13 ${_.toLocaleString()} \u0E23\u0E32\u0E22 (overlap) \u2014 \u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07 CV/CKD \u0E2A\u0E39\u0E07 \xB7 \u0E04\u0E27\u0E23\u0E21\u0E35 integrated NCD clinic \u0E17\u0E35\u0E48\u0E14\u0E39\u0E41\u0E25\u0E04\u0E23\u0E1A\u0E17\u0E31\u0E49\u0E07 2 \u0E42\u0E23\u0E04\u0E43\u0E19\u0E04\u0E23\u0E31\u0E49\u0E07\u0E40\u0E14\u0E35\u0E22\u0E27 \u0E25\u0E14 visit \u0E0B\u0E49\u0E33`)
      }
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsx("div", {
          ...
          const _ = ["DM", "HT", "DLP", "IHD", "Stroke", "COPD"].filter(k => S.includes(k)),
            U = ["CKD1", "CKD2", "CKD3", "CKD4", "CKD5", "CKD"].filter(k => S.includes(k)),
            j = z.Other || 0,
            W = U.reduce((k, X) => k + (z[X] || 0), 0),
            B = ({
              dg: k
            }) => {
              const X = z[k] || 0,
                q = e.length > 0 ? Math.round(X / e.length * 100) : 0,
                E0 = T[k] || "#7c3aed";
              return u.jsxs("div", {
                style: {
                ...
                children: [u.jsx("div", {
                  ...
                  children: [X.toLocaleString(), u.jsx("span", {
                    style: {
                      fontSize: "11px",
                      fontWeight: 600,
                      color: "var(--md-text-tertiary)",
            ...
            L = ({
              ...
              const X = z[k] || 0,
                q = W > 0 ? Math.round(X / W * 100) : 0,
                E0 = T[k] || "#10b981",
                o0 = k === "CKD" ? "?" : k.replace("CKD", "");
              return u.jsxs("div", {
                style: {
                  background: "var(--md-surface)",
                ...
                children: [u.jsxs("div", {
                  ...
                  children: F[k]?.replace(/^CKD Stage \d+ /, "").replace(/^CKD /, "")
                })]
              })
            };
          return u.jsxs("div", {
            ...
            children: [u.jsxs("div", {
              children: [u.jsxs("div", {
                ...
                style: {
                  display: "grid",
                  gridTemplateColumns: `repeat(${Math.min(_.length,6)}, minmax(0, 1fr))`,
                  gap: "10px"
                },
                children: _.map(k => u.jsx(B, {
                  dg: k
                }, k))
              })]
              ...
              children: [u.jsxs("div", {
                ...
                children: [u.jsx("span", {
                  ...
                  children: F.Other || "\u0E21\u0E32\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01 NCD \u0E41\u0E15\u0E48\u0E44\u0E21\u0E48\u0E21\u0E35\u0E23\u0E2B\u0E31\u0E2A\u0E42\u0E23\u0E04 NCD"
                })]
              }), u.jsxs("div", {
                style: {
                  display: "flex",
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              children: Object.entries(a).map(([_, U]) => u.jsxs("div", {
                style: {
                  flex: 1,
                  display: "flex",
                  flexDirection: "column",
            ...
            children: [u.jsx("div", {
              ...
              children: w.map((_, U) => {
                const j = H > 0 ? Math.round(_.count / H * 100) : 0;
                return u.jsxs("div", {
                  style: {
                    display: "flex",
                    alignItems: "center",
              ...
              children: [u.jsx("thead", {
                ...
                children: L0(e).map((_, U) => {
                  ...
                  return u.jsxs("tr", {
                    ...
                    children: [u.jsx("td", {
                      ...
                      children: _.mobile_phone_number || "\u2014"
                    }), u.jsx("td", {
                      style: {
                        ...E.td,
                        background: "rgba(168,85,247,.04)",
                      ...
                      children: _.creatinine != null ? Number(_.creatinine).toFixed(2) : "\u2014"
                    }), u.jsx("td", {
                      style: {
                        ...E.tdNum,
                        background: "rgba(16,185,129,.025)",
                        fontWeight: 800,
                        color: _.egfr == null ? "var(--md-text-tertiary)" : _.egfr < 30 ? "#dc2626" : _.egfr < 60 ? "#ea580c" : "#059669"
                      },
                      children: _.egfr != null ? _.egfr : "\u2014"
                    }), u.jsx("td", {
                      style: {
                        ...E.td,
                        background: "rgba(16,185,129,.025)"
                      },
                      children: _.ckd_stage ? u.jsx("span", {
                        style: {
                          padding: "2px 8px",
                          borderRadius: "99px",
                          fontSize: "10px",
                          fontWeight: 800,
                          background: _.ckd_stage === "CKD5" ? "rgba(220,38,38,.12)" : _.ckd_stage === "CKD4" ? "rgba(234,88,12,.12)" : _.ckd_stage === "CKD3" ? "rgba(245,158,11,.12)" : "rgba(16,185,129,.12)",
                          color: _.ckd_stage === "CKD5" ? "#dc2626" : _.ckd_stage === "CKD4" ? "#ea580c" : _.ckd_stage === "CKD3" ? "#d97706" : "#059669"
                        },
                        children: _.ckd_stage
                      }) : "\u2014"
                    }), u.jsx("td", {
                      style: {
                        ...E.tdNum,
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", e.length.toLocaleString(), " visit \xB7 ", d.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", R.toLocaleString(), " \u0E1A\u0E32\u0E17/visit"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
    ...
    })(), !S0 && s === "imaging-services" && s0?.patients && (() => {
      const e = s0.patients,
        t = s0.services || ["XRAY", "CT", "Portable", "BMD"],
        d = s0.service_labels || {},
        R = s0.service_counts || {},
        o = s0.total_income || 0,
        c = s0.total_imaging_price || 0,
        a = s0.unique_patients || 0,
        y = e.length > 0 ? Math.round(c / e.length) : 0,
        g = e.filter(j => j.sex === "\u0E0A\u0E32\u0E22").length,
        D = e.filter(j => j.sex === "\u0E2B\u0E0D\u0E34\u0E07").length,
        S = {
          XRAY: "#3b82f6",
          CT: "#7c3aed",
          Portable: "#f59e0b",
      ...
      e.forEach(j => {
        ...
        W < 20 ? z["<20"]++ : W < 40 ? z["20-39"]++ : W < 60 ? z["40-59"]++ : W < 80 ? z["60-79"]++ : z["80+"]++
      });
      const T = Math.max(...Object.values(z), 1),
        P = {
          "<20": "#06b6d4",
      ...
      e.forEach(j => {
        (j.icd_pairs || "").split("||").filter(Boolean).forEach(W => {
          const [B, L] = W.split("::"), k = (B || "").trim().toUpperCase();
          !k || !su.test(k) || (A[k] || (A[k] = {
            code: k,
            name: L || "",
            count: 0,
            totalInc: 0
          }), A[k].count++, A[k].totalInc += j.income || 0)
        })
      });
      const w = Object.values(A).sort((j, W) => W.count - j.count).slice(0, 10),
        H = w.length > 0 ? w[0].count : 1,
        p = {};
      e.forEach(j => {
      ...
      const r = Object.entries(p).sort((j, W) => W[1].count - j[1].count),
        $ = t.reduce((j, W) => j + (R[W] || 0), 0),
        i = t.reduce((j, W) => (R[W] || 0) > (R[j] || 0) ? W : j, t[0]),
        h = Object.entries(z).reduce((j, [W, B]) => B > j[1] ? [W, B] : j, ["", 0]),
        b = e.length > 0 ? Math.round(c / e.length) : 0,
        N = w.length > 0 ? w[0] : null,
        v = r.length > 0 ? r[0] : null,
        _ = [`\u{1F4CA} \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E23\u0E31\u0E07\u0E2A\u0E35\u0E27\u0E34\u0E17\u0E22\u0E32: ${e.length.toLocaleString()} visits \u0E08\u0E32\u0E01 ${a.toLocaleString()} HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33 \xB7 \u0E04\u0E48\u0E32\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E23\u0E27\u0E21 ${c.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${b.toLocaleString()} \u0E1A\u0E32\u0E17/visit \xB7 \u0E0A\u0E32\u0E22 ${g} / \u0E2B\u0E0D\u0E34\u0E07 ${D}`];
      if (i && $ > 0) {
        const j = Math.round((R[i] || 0) / $ * 100);
        _.push(`\u{1FA7B} \u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${i} ${(R[i]||0).toLocaleString()} \u0E04\u0E23\u0E31\u0E49\u0E07 (${j}% \u0E02\u0E2D\u0E07\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14) \u2014 ${i==="XRAY"?"X-Ray \u0E40\u0E1B\u0E47\u0E19 routine \u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14 \u0E04\u0E27\u0E23 monitor TAT \u0E43\u0E2B\u0E49 \u226430 \u0E19\u0E32\u0E17\u0E35":i==="CT"?"CT \u0E21\u0E35\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E2A\u0E39\u0E07 \u0E15\u0E49\u0E2D\u0E07 justify clinical indication \u0E2D\u0E22\u0E48\u0E32\u0E07\u0E40\u0E02\u0E49\u0E21\u0E07\u0E27\u0E14 \u0E25\u0E14 unnecessary scan":i==="Portable"?"Portable X-Ray \u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E17\u0E35\u0E48\u0E40\u0E15\u0E35\u0E22\u0E07 \u0E15\u0E49\u0E2D\u0E07\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E04\u0E27\u0E32\u0E21\u0E08\u0E33\u0E40\u0E1B\u0E47\u0E19\u0E41\u0E25\u0E30 infection control":"\u0E15\u0E23\u0E27\u0E08\u0E01\u0E23\u0E30\u0E14\u0E39\u0E01 \u0E04\u0E27\u0E23\u0E2A\u0E2D\u0E14\u0E04\u0E25\u0E49\u0E2D\u0E07\u0E01\u0E31\u0E1A T-score follow-up plan"}`)
      }
      if (h[0]) {
        const j = e.length > 0 ? Math.round(h[1] / e.length * 100) : 0;
        _.push(`\u{1F465} \u0E01\u0E25\u0E38\u0E48\u0E21\u0E2D\u0E32\u0E22\u0E38\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E23\u0E31\u0E07\u0E2A\u0E35\u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${h[0]} \u0E1B\u0E35 ${h[1]} \u0E23\u0E32\u0E22 (${j}%) \u2014 ${h[0]==="60-79"||h[0]==="80+"?"\u0E1C\u0E39\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38\u0E40\u0E1B\u0E47\u0E19\u0E01\u0E25\u0E38\u0E48\u0E21\u0E2B\u0E25\u0E31\u0E01 \u0E04\u0E27\u0E23\u0E40\u0E15\u0E23\u0E35\u0E22\u0E21 CXR + BMD \u0E40\u0E1B\u0E47\u0E19\u0E0A\u0E38\u0E14\u0E43\u0E19\u0E01\u0E32\u0E23\u0E15\u0E23\u0E27\u0E08\u0E1B\u0E23\u0E30\u0E08\u0E33\u0E1B\u0E35":h[0]==="40-59"?"\u0E27\u0E31\u0E22\u0E17\u0E33\u0E07\u0E32\u0E19 \u0E2A\u0E48\u0E27\u0E19\u0E43\u0E2B\u0E0D\u0E48\u0E08\u0E32\u0E01 trauma \u0E2B\u0E23\u0E37\u0E2D chronic disease screening":"\u0E27\u0E31\u0E22\u0E2B\u0E19\u0E38\u0E48\u0E21\u0E2A\u0E32\u0E27/\u0E40\u0E14\u0E47\u0E01 \u0E15\u0E23\u0E27\u0E08\u0E2A\u0E48\u0E27\u0E19\u0E43\u0E2B\u0E0D\u0E48\u0E08\u0E32\u0E01 trauma + acute condition"}`)
      }
      if (N && _.push(`\u{1F50D} \u0E02\u0E49\u0E2D\u0E1A\u0E48\u0E07\u0E0A\u0E35\u0E49\u0E01\u0E32\u0E23\u0E15\u0E23\u0E27\u0E08\u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22: ${N.code} ${N.name||""} (${N.count} \u0E04\u0E23\u0E31\u0E49\u0E07 \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 ${N.totalInc.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17) \u2014 \u0E17\u0E1A\u0E17\u0E27\u0E19\u0E04\u0E27\u0E32\u0E21\u0E40\u0E2B\u0E21\u0E32\u0E30\u0E2A\u0E21\u0E15\u0E32\u0E21 ACR appropriateness criteria`), v) {
        const [j, W] = v, B = e.length > 0 ? Math.round(W.count / e.length * 100) : 0;
        B >= 40 && _.push(`\u{1F3AB} \u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E21\u0E32\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${j} ${W.count} \u0E04\u0E23\u0E31\u0E49\u0E07 (${B}%) \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 ${W.income.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17`)
      }
      _.push("\u{1F4A1} \u0E41\u0E19\u0E30\u0E19\u0E33\u0E40\u0E0A\u0E34\u0E07\u0E19\u0E42\u0E22\u0E1A\u0E32\u0E22\u0E23\u0E31\u0E07\u0E2A\u0E35: (1) \u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A TAT \u0E02\u0E2D\u0E07 report turnaround \u226424 \u0E0A\u0E21. \xB7 (2) Audit indication \u0E02\u0E2D\u0E07 CT \u0E17\u0E38\u0E01\u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 (3) \u0E25\u0E14 radiation exposure \u0E15\u0E32\u0E21 ALARA \xB7 (4) Tele-radiology \u0E40\u0E1E\u0E37\u0E48\u0E2D second opinion \u0E40\u0E21\u0E37\u0E48\u0E2D\u0E08\u0E33\u0E40\u0E1B\u0E47\u0E19");
      const U = {
        ...
        children: [u.jsx("div", {
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              children: "\u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E2A\u0E34\u0E17\u0E18\u0E34"
            }), r.slice(0, 8).map(([j, W], B) => {
              const L = e.length > 0 ? Math.round(W.count / e.length * 100) : 0,
                k = ["#7c3aed", "#3b82f6", "#10b981", "#f59e0b", "#ef4444", "#ec4899", "#0ea5e9", "#8b5cf6"],
                X = k[B % k.length];
              return u.jsxs("div", {
                style: {
                  marginBottom: "8px"
            ...
            children: [u.jsx("div", {
              ...
              children: Object.entries(z).map(([j, W]) => u.jsxs("div", {
                style: {
                  flex: 1,
                  display: "flex",
                  flexDirection: "column",
            ...
            children: [u.jsx("div", {
              ...
              children: w.map((j, W) => {
                const B = H > 0 ? Math.round(j.count / H * 100) : 0;
                return u.jsxs("div", {
                  style: {
                    display: "flex",
                    alignItems: "center",
              ...
              children: [u.jsxs("div", {
                ...
                children: [u.jsx("span", {
                  ...
                  children: [u.jsx("div", {
                    ...
                    children: [s0.date_range.start, " \u0E16\u0E36\u0E07 ", s0.date_range.end]
                  })]
                })]
              }), u.jsxs("div", {
                style: {
    ...
    })(), !S0 && s === "pttype-services" && u0?.groups && (() => {
      const e = u0.group_order || ["UC", "\u0E02\u0E49\u0E32\u0E23\u0E32\u0E0A\u0E01\u0E32\u0E23 / \u0E2D\u0E1B\u0E17", "\u0E0A\u0E33\u0E23\u0E30\u0E40\u0E07\u0E34\u0E19\u0E40\u0E2D\u0E07", "\u0E15\u0E48\u0E32\u0E07\u0E0A\u0E32\u0E15\u0E34 (1.5 \u0E40\u0E17\u0E48\u0E32)", "\u0E15\u0E48\u0E32\u0E07\u0E14\u0E49\u0E32\u0E27", "\u0E1B\u0E23\u0E30\u0E01\u0E31\u0E19\u0E2A\u0E31\u0E07\u0E04\u0E21", "\u0E1E\u0E23\u0E1A", "\u0E23\u0E31\u0E10\u0E27\u0E34\u0E2A\u0E32\u0E2B\u0E01\u0E34\u0E08", "\u0E2D\u0E37\u0E48\u0E19\u0E46"],
        t = u0.groups || [],
        d = new Set(hu === null ? e : hu),
        R = t.filter(B => d.has(B.group_name)),
        o = (u0.group_trend || []).filter(B => d.has(B.group_name)),
        c = (u0.summary || []).filter(B => d.has(B.group_name)),
        a = R.reduce((B, L) => B + (L.total_visits || 0), 0),
        y = R.reduce((B, L) => B + (L.opd_visits || 0), 0),
        g = R.reduce((B, L) => B + (L.ipd_admissions || 0), 0),
        D = R.reduce((B, L) => B + (L.er_visits || 0), 0),
        S = R.reduce((B, L) => B + (Math.max(L.opd_hn, L.ipd_hn, L.er_hn) || 0), 0),
        F = B => Number(B || 0).toLocaleString(),
        z = [...R].sort((B, L) => L.total_visits - B.total_visits),
        T = z[0] || null,
        P = a > 0 && T ? Math.round(T.total_visits / a * 100) : 0,
        A = Array.from(new Set(o.map(B => B.ym))).sort(),
        w = z.map(B => B.group_name),
        H = A.map(B => {
          const L = {
            ym: B
          };
          for (const k of w) {
            const X = o.find(q => q.ym === B && q.group_name === k);
            L[k] = X ? X.total : 0
          }
          return L
        }),
        ...
        i = w.map($),
        h = B => {
          const L = hu === null ? [...e] : [...hu],
            k = L.indexOf(B);
          k >= 0 ? L.splice(k, 1) : L.push(B), Y0(L)
        },
        b = () => Y0(null),
        N = () => Y0([]),
        v = H.length > 0 ? H.reduce((B, L) => {
          const k = p.reduce((q, E0) => q + (B[E0] || 0), 0);
          return p.reduce((q, E0) => q + (L[E0] || 0), 0) > k ? L : B
        }, H[0]) : null,
        _ = v ? v.ym : "\u2014",
        U = v ? p.reduce((B, L) => B + (v[L] || 0), 0) : 0,
        j = [];
      if (j.push(`\u{1F4CA} \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E0A\u0E48\u0E27\u0E07 ${u0.from} \u2192 ${u0.to}: ${F(a)} \u0E04\u0E23\u0E31\u0E49\u0E07 (OPD ${F(y)} \xB7 IPD ${F(g)} \xB7 ER ${F(D)}) \u0E08\u0E32\u0E01\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E27\u0E21 ${F(S)} \u0E23\u0E32\u0E22 \u0E01\u0E23\u0E30\u0E08\u0E32\u0E22 ${R.length} \u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C (\u0E08\u0E32\u0E01\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14 ${e.length} \u0E2B\u0E21\u0E27\u0E14\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19)`), T && P >= 40 && j.push(`\u{1F3E5} \u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E40\u0E14\u0E48\u0E19\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${T.group_name} \u0E04\u0E34\u0E14\u0E40\u0E1B\u0E47\u0E19 ${P}% \u0E02\u0E2D\u0E07\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14 (${F(T.total_visits)} \u0E04\u0E23\u0E31\u0E49\u0E07) \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E41\u0E25\u0E30\u0E01\u0E32\u0E23 reimbursement \u0E01\u0E25\u0E38\u0E48\u0E21\u0E19\u0E35\u0E49\u0E40\u0E1B\u0E47\u0E19\u0E1E\u0E34\u0E40\u0E28\u0E29`), g > 0 && y > 0) {
        const B = (g / a * 100).toFixed(1);
      ...
      v && U > 0 && j.push(`\u{1F4C8} \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E1E\u0E35\u0E04: ${_} \u0E21\u0E35\u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E23\u0E27\u0E21 ${F(U)} \u0E04\u0E23\u0E31\u0E49\u0E07 (\u0E01\u0E25\u0E38\u0E48\u0E21 Top 5) \u2014 \u0E43\u0E0A\u0E49\u0E27\u0E32\u0E07\u0E41\u0E1C\u0E19\u0E01\u0E33\u0E25\u0E31\u0E07\u0E04\u0E19 + \u0E22\u0E32/\u0E2D\u0E38\u0E1B\u0E01\u0E23\u0E13\u0E4C\u0E25\u0E48\u0E27\u0E07\u0E2B\u0E19\u0E49\u0E32`), j.push("\u{1F4A1} \u0E41\u0E1C\u0E19\u0E1E\u0E31\u0E12\u0E19\u0E32: 1) \u0E08\u0E31\u0E14\u0E17\u0E33 Dashboard \u0E23\u0E32\u0E22\u0E01\u0E25\u0E38\u0E48\u0E21\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E2A\u0E48\u0E07\u0E17\u0E35\u0E21 UM \u0E17\u0E38\u0E01\u0E40\u0E14\u0E37\u0E2D\u0E19 2) \u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C recall rate per pttype 3) Audit \u0E40\u0E2D\u0E01\u0E2A\u0E32\u0E23\u0E40\u0E23\u0E35\u0E22\u0E01\u0E40\u0E01\u0E47\u0E1A\u0E04\u0E48\u0E32\u0E23\u0E31\u0E01\u0E29\u0E32\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E1E\u0E34\u0E48\u0E21 collection rate");
      const W = {
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
            ...
            children: e.map(B => {
              ...
              return u.jsxs("label", {
                style: {
                  ...
                  padding: "5px 10px",
                  borderRadius: 8,
                  border: `1px solid ${L?k:"var(--md-border)"}`,
                  background: L ? `${k}12` : "transparent",
                  cursor: "pointer",
                  fontSize: 11,
                  fontWeight: 700,
                  color: L ? k : "var(--md-text-tertiary)",
                  userSelect: "none"
                },
                children: [u.jsx("input", {
                  type: "checkbox",
          ...
          const B = Math.min(5, z.length),
            L = z.slice(0, B),
            k = H.map(x => x.ym),
            X = ["", "\u0E21.\u0E04.", "\u0E01.\u0E1E.", "\u0E21\u0E35.\u0E04.", "\u0E40\u0E21.\u0E22.", "\u0E1E.\u0E04.", "\u0E21\u0E34.\u0E22.", "\u0E01.\u0E04.", "\u0E2A.\u0E04.", "\u0E01.\u0E22.", "\u0E15.\u0E04.", "\u0E1E.\u0E22.", "\u0E18.\u0E04."],
            q = x => {
          ...
          L.forEach(x => {
            ...
            let m = 0;
            for (const O of H)(O[f] || 0) > m && (m = O[f] || 0);
            E0[f] = m
          });
          const o0 = H.map(x => {
            ...
            K0 = x => {
              ...
              const f = Math.max(1, Math.floor(H.length / 2)),
                m = H.slice(0, f).reduce((_0, I) => _0 + (I[x] || 0), 0),
                O = H.slice(f).reduce((_0, I) => _0 + (I[x] || 0), 0);
          ...
          return u.jsxs("div", {
            ...
            children: [u.jsxs("div", {
              ...
              children: u.jsxs("div", {
                style: {
                  display: "grid",
                  gridTemplateColumns: `170px repeat(${k.length}, minmax(64px, 1fr)) 90px`,
                  gap: 4,
                  minWidth: 540
                },
                children: [u.jsx("div", {
                  ...
                  return [u.jsxs("div", {
                    ...
                    return u.jsxs("div", {
                      ...
                      title: `${m} \u2014 ${q(lu)}: ${F(W0)} \u0E04\u0E23\u0E31\u0E49\u0E07`,
                      children: [u.jsx("div", {
                        style: {
                          fontSize: 13,
                          fontWeight: 900,
                          fontFamily: "monospace",
                          color: W0 > 0 ? Z0 > .5 ? "#fff" : "var(--md-text-primary)" : "var(--md-text-tertiary)",
                          lineHeight: 1
                        },
                        children: W0 > 0 ? F(W0) : "\u2014"
                      }), W0 > 0 && u.jsx("div", {
                        style: {
                          ...
                          fontWeight: 600,
                          fontFamily: "monospace",
                          color: Z0 > .5 ? "rgba(255,255,255,.75)" : "var(--md-text-tertiary)"
                        },
                        children: `${Math.round(Z0*100)}%`
                      })]
                    }, `r${f}c${O0}`)
                  }), u.jsxs("div", {
                    style: {
                  ...
                  children: F(o0.reduce((x, f) => x + f.total, 0))
                })]
              })
            }), u.jsx("div", {
              style: {
          ...
          children: [u.jsx("div", {
            ...
            children: [u.jsx("thead", {
              ...
              children: z.flatMap((B, L) => {
                const k = a > 0 ? (B.total_visits / a * 100).toFixed(1) : "0.0",
                  X = c.filter(o0 => o0.group_name === B.group_name).sort((o0, T0) => T0.total_visits - o0.total_visits),
                  q = u.jsxs("tr", {
                    style: {
                  ...
                  E0 = X.map((o0, T0) => u.jsxs("tr", {
                    ...
                    children: [u.jsxs("td", {
                      ...
                      children: a > 0 ? `${(o0.total_visits/a*100).toFixed(1)}%` : "\u2014"
                    })]
                  }, `g${L}r${T0}`));
                return [q, ...E0]
              })
          ...
          const B = u0.age_order || ["\u0E27\u0E31\u0E22\u0E40\u0E14\u0E47\u0E01 (0-14 \u0E1B\u0E35)", "\u0E27\u0E31\u0E22\u0E23\u0E38\u0E48\u0E19/\u0E27\u0E31\u0E22\u0E2B\u0E19\u0E38\u0E48\u0E21\u0E2A\u0E32\u0E27 (15-24 \u0E1B\u0E35)", "\u0E27\u0E31\u0E22\u0E41\u0E23\u0E07\u0E07\u0E32\u0E19 (25-59 \u0E1B\u0E35)", "\u0E27\u0E31\u0E22\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 (60 \u0E1B\u0E35\u0E02\u0E36\u0E49\u0E19\u0E44\u0E1B)", "\u0E44\u0E21\u0E48\u0E23\u0E30\u0E1A\u0E38"],
            ...
            X = (u0.age_breakdown || []).filter(f => d.has(f.group_name)),
            q = {};
          for (const f of B) q[f] = 0;
          for (const f of X) q[f.age_group] = (q[f.age_group] || 0) + (f.total || 0);
          const E0 = Object.values(q).reduce((f, m) => f + m, 0),
            o0 = {};
          for (const f of z) o0[f.group_name] = {};
          for (const f of X) o0[f.group_name] || (o0[f.group_name] = {}), o0[f.group_name][f.age_group] = f.total;
          const T0 = {};
          for (const f of z) {
            let m = 0;
            for (const O of B) {
              const r0 = o0[f.group_name]?.[O] || 0;
              r0 > m && (m = r0)
            }
            T0[f.group_name] = m
          }
              ...
              children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                  ...
                  style: {
                    ...
                    fontSize: 11,
                    fontWeight: 800,
                    color: k[f] || "var(--md-text-secondary)",
                    textAlign: "center",
                    borderBottom: `2px solid ${k[f]||"var(--md-divider)"}40`
                  },
                  children: [u.jsx("div", {
                    style: {
                      fontSize: 14
                  ...
                  const O = $(f.group_name),
                    r0 = T0[f.group_name] || 1,
                    _0 = x.reduce((I, lu) => I + (o0[f.group_name]?.[lu] || 0), 0);
                  return [u.jsxs("div", {
                    style: {
                      padding: "10px 12px",
                      fontSize: 12,
                    ...
                    const O0 = o0[f.group_name]?.[I] || 0,
                      W0 = r0 > 0 ? O0 / r0 : 0,
                      Z0 = k[I] || "#94a3b8",
                      $u = O0 > 0 ? `${Z0}${K0(W0*.85)}` : "transparent";
                    return u.jsxs("div", {
                      style: {
                        padding: "10px 4px",
                        textAlign: "center",
                        background: $u,
                        borderRadius: 4,
                        border: O0 > 0 ? `1px solid ${Z0}30` : "1px solid transparent",
                        minHeight: 50,
                        display: "flex",
                        flexDirection: "column",
                        alignItems: "center",
                      ...
                      title: `${f.group_name} \u2014 ${I}: ${J0(O0)} \u0E04\u0E23\u0E31\u0E49\u0E07`,
                      children: [u.jsx("div", {
                        style: {
                          fontSize: 13,
                          fontWeight: 900,
                          fontFamily: "monospace",
                          color: O0 > 0 ? W0 > .5 ? "#fff" : "var(--md-text-primary)" : "var(--md-text-tertiary)",
                          lineHeight: 1
                        },
                        children: O0 > 0 ? J0(O0) : "\u2014"
                      }), O0 > 0 && _0 > 0 && u.jsx("div", {
                        style: {
                          ...
                          fontWeight: 600,
                          fontFamily: "monospace",
                          color: W0 > .5 ? "rgba(255,255,255,.75)" : "var(--md-text-tertiary)"
                        },
                        children: `${(O0/_0*100).toFixed(0)}%`
                      })]
                    }, `ar${m}c${lu}`)
                  }), u.jsx("div", {
                    style: {
    ...
    })(), s !== "pt" && s !== "staff-services" && s !== "fluoride" && s !== "elderly-cxr" && s !== "ncd-disease" && s !== "imaging-services" && s !== "pttype-services" && s !== "ipd-compare" && u.jsx(_u, {
      data: y0,
      theme: "default",
