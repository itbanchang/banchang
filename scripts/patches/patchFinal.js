...
const s1 = '{/* ━━━━━ 💰 Financial Strategic Root-Cause Analysis (Unified) ━━━━━ */}';
const e1 = '{/* ━━━ Hero KPI Strip — Professional Design ━━━ */}';

if (code.includes(s1) && code.includes(e1)) {
    code = code.substring(0, code.indexOf(s1)) + code.substring(code.indexOf(e1));
}

const s2 = '{/* ━━━━━ FHI + Professional Finance Analytics Panel ━━━━━ */}';
const e2 = `<div className="glass-card" style={{ padding: '1rem 1.25rem', borderLeft: '3px solid #f59e0b' }}>`;
...
if (code.includes(s2) && code.indexOf(e2) > -1) {
    code = code.substring(0, code.indexOf(s2)) + aiPanel + code.substring(code.indexOf(e2));
}
