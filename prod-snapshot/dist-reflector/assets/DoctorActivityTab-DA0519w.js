...
function x0(E, t, o) {
  ...
  if (m > 50) {
    ...
    $.push({
      ...
      color: "#f43f5e",
      situation: `${a} \u0E23\u0E31\u0E1A\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${Math.round(m)} \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19 (\u0E40\u0E01\u0E34\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C OPD \u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 30\u201350 \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19 \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13 ${F} \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19) \u0E15\u0E25\u0E2D\u0E14\u0E0A\u0E48\u0E27\u0E07 ${I} \u0E27\u0E31\u0E19 \u2014 \u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07 Burnout \u0E2A\u0E39\u0E07 \u0E2A\u0E48\u0E07\u0E1C\u0E25\u0E15\u0E48\u0E2D\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E01\u0E32\u0E23\u0E27\u0E34\u0E19\u0E34\u0E08\u0E09\u0E31\u0E22 \u0E04\u0E27\u0E32\u0E21\u0E1B\u0E25\u0E2D\u0E14\u0E20\u0E31\u0E22\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 \u0E41\u0E25\u0E30\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E01\u0E32\u0E23\u0E04\u0E07\u0E2D\u0E22\u0E39\u0E48\u0E02\u0E2D\u0E07\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E43\u0E19\u0E23\u0E30\u0E22\u0E30\u0E22\u0E32\u0E27`,
  ...
  if (A > 0 && p < A * .6 && (E.opd_visits || 0) > 200) {
    ...
    $.push({
      ...
      color: "#dc2626",
      situation: `${a} \u0E2A\u0E23\u0E49\u0E32\u0E07\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 \u0E3F${r(p)}/\u0E23\u0E32\u0E22 \u0E15\u0E48\u0E33\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07 \u0E3F${r(A)}/\u0E23\u0E32\u0E22 \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13 ${Math.round((1-p/A)*100)}% \xB7 \u0E08\u0E32\u0E01\u0E08\u0E33\u0E19\u0E27\u0E19 OPD ${r(E.opd_visits)} \u0E23\u0E32\u0E22 \u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 ${I} \u0E27\u0E31\u0E19 \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13\u0E01\u0E32\u0E23 Revenue Gap \u0E2A\u0E39\u0E07\u0E16\u0E36\u0E07 \u0E3F${r(B)} \xB7 \u0E2D\u0E32\u0E08\u0E21\u0E35\u0E2A\u0E32\u0E40\u0E2B\u0E15\u0E38\u0E44\u0E14\u0E49\u0E2B\u0E25\u0E32\u0E22\u0E14\u0E49\u0E32\u0E19\u0E17\u0E35\u0E48\u0E04\u0E27\u0E23\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E40\u0E23\u0E48\u0E07\u0E14\u0E48\u0E27\u0E19`,
  ...
  if (g > 0 && h > g * 1.5) {
    ...
    $.push({
      ...
      color: "#f59e0b",
      situation: `${a} \u0E21\u0E35 Orders/Visit = ${h} \u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07 (${g.toFixed(2)}) \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13 ${Math.round((h/g-1)*100)}% \xB7 \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13\u0E01\u0E32\u0E23\u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E2A\u0E48\u0E27\u0E19\u0E40\u0E01\u0E34\u0E19 ${r(F)} \u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 ${I} \u0E27\u0E31\u0E19 \xB7 \u0E2D\u0E32\u0E08\u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19 Over-investigation \u0E2B\u0E23\u0E37\u0E2D\u0E01\u0E32\u0E23\u0E2A\u0E31\u0E48\u0E07\u0E15\u0E23\u0E27\u0E08\u0E0B\u0E49\u0E33\u0E42\u0E14\u0E22\u0E44\u0E21\u0E48\u0E08\u0E33\u0E40\u0E1B\u0E47\u0E19 \u0E0B\u0E36\u0E48\u0E07\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E42\u0E14\u0E22\u0E44\u0E21\u0E48\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E01\u0E32\u0E23\u0E14\u0E39\u0E41\u0E25`,
  ...
  return (E.opd_visits || 0) > 100 && h > 0 && h < .2 && $.push({
    ...
    color: "#3b82f6",
    situation: `${a} \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19 Top ${Math.max(1,100-c)}% \u0E14\u0E49\u0E32\u0E19\u0E1C\u0E25\u0E1C\u0E25\u0E34\u0E15 OPD \u0E41\u0E15\u0E48\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E23\u0E31\u0E1A\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 IPD \u0E40\u0E25\u0E22\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 ${I} \u0E27\u0E31\u0E19 \xB7 \u0E02\u0E32\u0E14\u0E42\u0E2D\u0E01\u0E32\u0E2A\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E17\u0E31\u0E01\u0E29\u0E30\u0E01\u0E32\u0E23\u0E14\u0E39\u0E41\u0E25\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 Complex \u0E41\u0E25\u0E30\u0E17\u0E33\u0E43\u0E2B\u0E49\u0E17\u0E35\u0E21 IPD \u0E02\u0E32\u0E14\u0E01\u0E32\u0E23\u0E2A\u0E19\u0E31\u0E1A\u0E2A\u0E19\u0E38\u0E19\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 peak`,
...
function p0(E) {
  ...
  const p = o.map(i => i.total_visits || 0),
    ...
    K = q(I),
    N = Math.round(K * 100),
    Q = [...o].filter(i => i.total_visits > 0).sort((i, k) => (k.revenue_per_visit || 0) - (i.revenue_per_visit || 0)),
    X = Q[0],
    e = Q[Q.length - 1],
    n = Math.round(U(a.filter(i => i > 0))),
    f = Number(U($.filter(i => i > 0)).toFixed(2)),
    x = [...o].sort((i, k) => (k.orders_per_visit || 0) - (i.orders_per_visit || 0))[0],
    v = [...o].filter(i => i.opd_visits > 50).sort((i, k) => (i.orders_per_visit || 0) - (k.orders_per_visit || 0))[0],
    T = .05,
    M = o.filter(i => {
...
function h0() {
  const [E, t] = z.useState(null), [o, c] = z.useState(!0), [m, A] = z.useState(null), [g, h] = z.useState("today"), [p, I] = z.useState(1), [$, a] = z.useState(Y()), [F, B] = z.useState(Y()), [W, H] = z.useState("total_visits"), [D, w] = z.useState(() => new Set), [L, V] = z.useState(!1), [j, R] = z.useState(null), [O, G] = z.useState(() => new Set), [s, _] = z.useState(!1), J = z.useCallback(e => {
    w(n => {
      const f = new Set(n);
    ...
    try {
      ...
      const v = await fetch(`/api/doctor/activity-summary?${x}`, {
        credentials: "include"
      });
  ...
  const K = z.useMemo(() => E?.doctors ? [...E.doctors].sort((e, n) => (n[W] || 0) - (e[W] || 0)) : [], [E, W]),
    N = z.useMemo(() => K.length ? K.slice(0, 3).map(e => ({
    ...
    Q = z.useMemo(() => {
      const e = (E?.dentists || []).slice().sort((n, f) => (f.opd_visits || 0) - (n.opd_visits || 0));
    ...
    X = z.useMemo(() => E?.trend_7d ? E.trend_7d.map(e => ({
      ...
      doctors: e.doctors,
      visits: e.visits,
      workload: e.doctors > 0 ? Math.round(e.visits / e.doctors * 10) / 10 : 0
    })) : [], [E]);
  return u.jsxs("div", {
    ...
    children: [u.jsxs("div", {
      ...
      const n = ["all_doctors", "doctors", "opd", "ipd", "gini", "top20", "revenue", "all_dentists", "dentists", "dentists", "dentists"],
        f = [];
      E.summary && E.summary.total_doctors !== void 0 && f.push({
        label: "\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14",
        value: r(E.summary.total_doctors || 0),
        sub: `active \u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A \xB7 \u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E07\u0E32\u0E19 ${E.summary.opd_doctors||0} \u0E17\u0E48\u0E32\u0E19`,
        color: "#1e40af"
      }), f.push(...e.kpi || []), E.summary && E.summary.dental_doctors !== void 0 && f.push({
        ...
        children: [u.jsxs("div", {
          ...
          children: [u.jsxs("div", {
            ...
            children: (() => {
              ...
              l.filter && (y = y.filter(l.filter)), y.sort((d, i) => l.asc ? (d[l.sortKey] || 0) - (i[l.sortKey] || 0) : (i[l.sortKey] || 0) - (d[l.sortKey] || 0)), l.limit && (y = y.slice(0, l.limit));
              const S = y.reduce((d, i) => d + (i[l.sortKey] || 0), 0),
                b = d => l.showCols.includes(d);
              return [u.jsxs("div", {
                style: {
                  padding: "16px 20px",
                ...
                children: y.length === 0 ? u.jsx("div", {
                  ...
                  children: [u.jsx("thead", {
                    ...
                    children: [...y.map((d, i) => {
                      const k = S > 0 ? Math.round((d[l.sortKey] || 0) / S * 100) : 0;
                      return u.jsxs("tr", {
                        style: {
                        ...
                        children: [u.jsx("td", {
                          ...
                          children: [d.name || d.code, d.position ? u.jsx("div", {
                            style: {
                              fontSize: "10px",
                              color: "var(--md-text-tertiary)",
                              fontWeight: 500
                          ...
                          children: r((d.lab_orders || 0) + (d.xray_orders || 0))
                        }), b("total") && u.jsx("td", {
                          style: {
                            padding: "8px 6px",
                            textAlign: "right",
                          ...
                          children: `\u0E3F${r(Math.round(d.opd_revenue||0))}`
                        }), b("ipdRev") && u.jsx("td", {
                          style: {
                            padding: "8px 6px",
                            textAlign: "right",
                          ...
                          children: `\u0E3F${r(Math.round(d.ipd_revenue||0))}`
                        }), b("rev") && u.jsx("td", {
                          style: {
                            padding: "8px 6px",
                            textAlign: "right",
                          ...
                          children: `\u0E3F${r(Math.round(d.total_revenue||0))}`
                        }), u.jsx("td", {
                          style: {
                            padding: "8px 6px",
                            textAlign: "right",
                      ...
                      children: [u.jsx("td", {
                        ...
                        children: r(y.reduce((d, i) => d + (i.opd_visits || 0), 0))
                      }), b("ipd") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: r(y.reduce((d, i) => d + (i.ipd_admissions || 0), 0))
                      }), b("orders") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: r(y.reduce((d, i) => d + ((i.lab_orders || 0) + (i.xray_orders || 0)), 0))
                      }), b("total") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: r(y.reduce((d, i) => d + (i.total_visits || 0), 0))
                      }), b("opdRev") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: `\u0E3F${r(Math.round(y.reduce((d,i)=>d+(i.opd_revenue||0),0)))}`
                      }), b("ipdRev") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: `\u0E3F${r(Math.round(y.reduce((d,i)=>d+(i.ipd_revenue||0),0)))}`
                      }), b("rev") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: `\u0E3F${r(Math.round(y.reduce((d,i)=>d+(i.total_revenue||0),0)))}`
                      }), u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
      ...
      children: [u.jsxs("div", {
        ...
        var e = Math.max.apply(null, N.map(function(v) {
            return v.OPD || 0
          }).concat([1])),
          n = Math.max.apply(null, N.map(function(v) {
            return v.IPD || 0
          }).concat([1])),
          f = Math.max.apply(null, N.map(function(v) {
            return v.Orders || 0
          }).concat([1])),
          x = [{
        ...
        return u.jsx("div", {
          ...
          children: N.map(function(v, T) {
            var M = x[T] || x[2],
              C = (v.OPD || 0) + (v.IPD || 0),
              l = C > 0 ? ((v.Orders || 0) / C).toFixed(2) : "\u2014",
              y = (v.name || "").trim(),
              S = y.split(/\s+/),
              b = S.length >= 2 ? (S[0].charAt(0) || "") + (S[S.length - 1].charAt(0) || "") : y.slice(0, 2);
            b || (b = "\u2014");
            var d = [{
              label: "OPD",
              value: v.OPD || 0,
      ...
      children: [u.jsxs("div", {
        ...
        var e = Math.max.apply(null, Q.map(function(x) {
            return x.OPD || 0
          }).concat([1])),
          n = Math.max.apply(null, Q.map(function(x) {
            return x.Orders || 0
          }).concat([1])),
          f = [{
            accent: "linear-gradient(135deg,#fbbf24,#f59e0b)",
            ...
            return u.jsxs("div", {
              ...
              children: [u.jsxs("div", {
                ...
                children: [u.jsxs("div", {
                  ...
                  children: b.map(function(d) {
                    var i = d.max > 0 ? Math.min(100, d.value / d.max * 100) : 0;
                    return u.jsxs("div", {
                      style: {
                        marginBottom: "12px"
                      },
                      children: [u.jsxs("div", {
                        ...
                        children: [u.jsx("span", {
                          ...
                          style: {
                            fontSize: "16px",
                            fontWeight: 800,
                            color: d.value > 0 ? d.color : "var(--md-text-tertiary)",
                            fontFeatureSettings: '"tnum"'
                          },
                          children: d.value
                        })]
      ...
      children: [u.jsxs("div", {
        ...
        children: [u.jsx("div", {
          ...
          children: "\u{1F4CA} \u0E20\u0E32\u0E23\u0E30\u0E07\u0E32\u0E19\u0E23\u0E32\u0E22\u0E27\u0E31\u0E19 7 \u0E27\u0E31\u0E19\u0E25\u0E48\u0E32\u0E2A\u0E38\u0E14 \u2014 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E15\u0E48\u0E2D\u0E41\u0E1E\u0E17\u0E22\u0E4C"
        }), u.jsxs("div", {
          style: {
            fontSize: "11px",
            fontWeight: 600,
        ...
        children: u.jsxs(l0, {
          ...
          children: [u.jsx(o0, {
            ...
            formatter: (e, n) => n === "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22" ? [`${e} \u0E04\u0E19`, n] : n === "\u0E20\u0E32\u0E23\u0E30\u0E07\u0E32\u0E19" ? [`${e} \u0E04\u0E19/\u0E41\u0E1E\u0E17\u0E22\u0E4C`, n] : [e, n],
            labelFormatter: (e, n) => {
              const f = n?.[0]?.payload;
              return f ? `${e} \xB7 \u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E2B\u0E19\u0E49\u0E32\u0E17\u0E35\u0E48 ${f.doctors} \u0E17\u0E48\u0E32\u0E19` : e
            }
          }), u.jsx(s0, {
            yAxisId: "left",
            dataKey: "visits",
            fill: "rgba(124,58,237,.45)",
        ...
        style: {
          marginTop: "10px",
          paddingTop: "10px",
          borderTop: "1px dashed var(--md-divider)",
          display: "grid",
          gridTemplateColumns: `repeat(${X.length}, minmax(0,1fr))`,
          gap: "4px",
          fontSize: "10px",
          color: "var(--md-text-tertiary)",
          textAlign: "center"
        },
        children: X.map((e, n) => u.jsxs("div", {
          style: {
            padding: "4px 2px",
            borderRadius: "6px",
      ...
      children: [u.jsxs("div", {
        ...
        children: u.jsxs("table", {
          ...
          children: [u.jsx("thead", {
            ...
            children: K.map((e, n) => {
              const f = D.has(e.code),
                x = f ? t0(e, K, E.period?.days ? E.period.days : Math.max(1, Math.round((new Date(E.period.end) - new Date(E.period.start)) / 864e5) + 1)) : null;
              return u.jsxs(Z.Fragment, {
                children: [u.jsxs("tr", {
                  onClick: () => J(e.code),
                  style: {
                    borderBottom: "1px solid var(--md-divider)",
                    background: f ? "rgba(2,132,199,.05)" : n % 2 === 0 ? "transparent" : "rgba(0,0,0,.02)",
                    cursor: "pointer"
                  },
                  children: [u.jsx("td", {
                    style: {
            ...
            children: [...E.dentists.map((e, n) => {
              ...
              return u.jsxs(Z.Fragment, {
                children: [u.jsxs("tr", {
                  ...
                  style: {
                    borderBottom: "1px solid var(--md-divider)",
                    background: f ? "rgba(6,182,212,.06)" : n % 2 === 0 ? "transparent" : "rgba(0,0,0,.02)",
                    cursor: "pointer"
                  },
                  children: [u.jsx("td", {
                    style: {
              ...
              children: [u.jsx("td", {
                ...
                children: (() => {
                  const e = E.dentists.reduce((f, x) => f + (x.opd_visits || 0), 0),
                    n = E.dentists.reduce((f, x) => f + (x.lab_orders || 0) + (x.xray_orders || 0), 0);
