const fu = (l, f0 = fu, M = f0.f || (f0.f = ["assets/xlsx.min-CZi5yKex.js", "assets/vendor-react-ByYOq5k4.js"])) => l.map(v0 => M[v0]);
import {
  _ as nu,
  E as DE,
  h as ju
...
function jE(l, f0, M) {
  if (!l?.comparison || !l.fy1_totals || !l.fy2_totals) return null;
  const v0 = l.fy1_totals,
    $ = l.fy2_totals,
    n0 = l.comparison.filter(R0 => R0.fy1?.has_data && R0.fy2?.has_data);
  ...
  for (const R0 of n0) {
    ...
    u0 > eu && (eu = u0, J = R0.month)
  }
  let D0, ru;
  y0 >= 3 ? (D0 = `\u{1F534} IPD Mortality Rate ${y0.toFixed(2)}% \u0E2A\u0E39\u0E07\u0E40\u0E01\u0E34\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 3% \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E15\u0E31\u0E49\u0E07 Mortality Review Committee \u0E20\u0E32\u0E22\u0E43\u0E19 7 \u0E27\u0E31\u0E19 \xB7 \u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E01\u0E23\u0E30\u0E17\u0E1A HA accreditation`, ru = "#f43f5e") : F0 >= 20 ? (D0 = `\u26A0 \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E01\u0E32\u0E23\u0E40\u0E2A\u0E35\u0E22\u0E0A\u0E35\u0E27\u0E34\u0E15\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 ${F0}% \u2014 \u0E23\u0E27\u0E21\u0E15\u0E32\u0E22 FY${M} ${c0} \u0E23\u0E32\u0E22 (FY${f0} ${C0}) \xB7 \u0E15\u0E49\u0E2D\u0E07\u0E2A\u0E2D\u0E1A\u0E2A\u0E27\u0E19 Root Cause`, ru = "#f59e0b") : y0 <= 1.5 && F0 <= 0 ? (D0 = `\u2705 Mortality Rate \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E14\u0E35 \u2014 IPD Rate ${y0.toFixed(2)}% \xB7 ${F0>=0?"+":""}${F0}% \u0E40\u0E17\u0E35\u0E22\u0E1A\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19 \xB7 Quality of Care \u0E14\u0E35`, ru = "#10b981") : (D0 = `IPD Mortality ${y0.toFixed(2)}% (FY${f0}: ${Y.toFixed(2)}%) \xB7 ${F0>=0?"+":""}${F0}% \xB7 Early Death ${x0.toFixed(1)}% \u0E02\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E15\u0E32\u0E22 IPD`, ru = "#0ea5e9");
...
function n(l, f0 = 0) {
  return l == null || l === "" || isNaN(l) ? "\u2014" : Number(l).toLocaleString("th-TH", {
    minimumFractionDigits: f0,
    maximumFractionDigits: f0
  })
}
async function Q0(l, f0) {
  const M = await fetch(l, f0),
...
function _E(l, f0, M, v0 = "OPD") {
  const $ = dE[v0] || dE.OPD;
  if (!l?.comparison || !l.fy1_totals || !l.fy2_totals) return null;
  const n0 = l.fy1_totals,
    e0 = l.fy2_totals,
    _0 = l.comparable_months || 0;
  if (_0 === 0) return {
    headline: `\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E17\u0E35\u0E48\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E44\u0E14\u0E49\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E1B\u0E35\u0E07\u0E1A ${f0} \u0E01\u0E31\u0E1A ${M} \u2014 \u0E23\u0E30\u0E1A\u0E1A\u0E08\u0E30\u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C\u0E44\u0E14\u0E49\u0E40\u0E21\u0E37\u0E48\u0E2D\u0E21\u0E35\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E04\u0E23\u0E1A\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E19\u0E49\u0E2D\u0E22 1 \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E02\u0E2D\u0E07\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E2D\u0E07\u0E1B\u0E35`,
    empty: !0
  };
  const uu = n0.lab_orders + n0.drug_orders + n0.xray_orders,
    ...
    g0 = Number(l.overall_orders_growth_pct ?? 0),
    m0 = Number(l.overall_price_growth_pct ?? 0),
    C0 = G0 - uu,
    c0 = I0 - Y0,
    Eu = m0 - g0,
    ...
    ru = Y.Drug.px <= Y.Lab.px && Y.Drug.px <= Y.Xray.px ? {
      name: "Drug (\u0E22\u0E32)",
      g: Y.Drug.px
    } : Y.Lab.px <= Y.Xray.px ? {
      name: "Lab (\u0E2B\u0E49\u0E2D\u0E07\u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E01\u0E32\u0E23)",
    ...
    z0 = l.comparison.filter(Z => Z.fy1.has_data && Z.fy2.has_data),
    X0 = [];
  let b0 = null,
    Z0 = null,
    p0 = -1 / 0,
  ...
  for (const Z of z0) {
    ...
    X0.push({
      ...
      fy1Px: U0,
      fy2Px: q0
    }), tu > p0 && (p0 = tu, b0 = Z.month), tu < R0 && (R0 = tu, Z0 = Z.month)
  }
  let u0 = 0,
    yu = 0;
  if (X0.length >= 2) {
  ...
  if (X0.length >= 4) {
    const Z = Math.floor(X0.length / 2),
      ...
      U0 = U.reduce((iu, du) => iu + du.fy1Px, 0),
      q0 = U.reduce((iu, du) => iu + du.fy2Px, 0),
      tu = w0.reduce((iu, du) => iu + du.fy1Px, 0),
      vu = w0.reduce((iu, du) => iu + du.fy2Px, 0),
      $u = U0 > 0 ? (q0 - U0) / U0 * 100 : 0,
      wu = tu > 0 ? (vu - tu) / tu * 100 : 0,
      Du = wu - $u;
    V0 = {
  ...
  for (const [Z, U] of Object.entries(Au)) {
    ...
    U.pxG >= 5 && U.ordG >= 5 ? q0 = "\u0E02\u0E22\u0E32\u0E22\u0E15\u0E31\u0E27\u0E17\u0E31\u0E49\u0E07\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E41\u0E25\u0E30\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32" : U.pxG >= 5 && U.ordG < 2 ? q0 = "Value-driven \u2014 \u0E23\u0E32\u0E04\u0E32\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19" : U.pxG < 0 && U.ordG > 0 ? q0 = "Margin Compression \u2014 \u0E23\u0E32\u0E04\u0E32\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E16\u0E39\u0E01\u0E01\u0E14" : U.pxG < -3 && U.ordG < 0 ? q0 = "\u0E2B\u0E14\u0E15\u0E31\u0E27\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E2D\u0E07\u0E21\u0E34\u0E15\u0E34" : q0 = "\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E43\u0E19\u0E23\u0E30\u0E14\u0E31\u0E1A\u0E1B\u0E01\u0E15\u0E34", ku[Z] = {
      ...
      abs_px: U.absPx,
      driver: q0,
      narrative: `${U.label}: \u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13 ${U.ordG>=0?"+":""}${U.ordG}% \xB7 \u0E21\u0E39\u0E25\u0E04\u0E48\u0E32 ${U.pxG>=0?"+":""}${U.pxG}% (${U.absPx>=0?"+":""}${n(Math.abs(U.absPx))} \u0E1A\u0E32\u0E17) \xB7 \u0E23\u0E32\u0E04\u0E32/\u0E04\u0E23\u0E31\u0E49\u0E07 \u0E3F${n(Math.round(U.unit.f2))} (${w0>=0?"\u2191":"\u2193"}${Math.abs(w0)}%) \xB7 \u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19 ${U.share.toFixed(1)}% (${U0>=0?"+":""}${U0.toFixed(1)} \u0E08\u0E38\u0E14) \u2014 ${q0}`
    }
  }
  let r0;
  const Lu = m0 - g0,
    E0 = `${c0>=0?"+":"\u2212"}\u0E3F${n(Math.abs(c0))}`;
    ...
    children: [u.jsxs("div", {
      ...
      children: [u.jsx("div", {
        ...
        style: {
          fontSize: "12px",
          fontWeight: 800,
          color: l.ord_growth >= 0 ? "#16a34a" : "#dc2626",
          textAlign: "right"
        },
        children: [l.ord_growth >= 0 ? "+" : "", l.ord_growth, "%"]
      }), u.jsx("div", {
        style: {
          fontSize: "11px",
          color: "var(--md-text-tertiary)",
        ...
        style: {
          fontSize: "12px",
          fontWeight: 800,
          color: l.px_growth >= 0 ? "#16a34a" : "#dc2626",
          textAlign: "right"
        },
        children: [l.px_growth >= 0 ? "+" : "", l.px_growth, "%"]
      }), u.jsx("div", {
        style: {
          fontSize: "11px",
          color: "var(--md-text-tertiary)",
        ...
        children: ["\u0E3F", n(l.unit_fy2), " ", u.jsxs("span", {
          style: {
            fontSize: "11px",
            color: l.unit_growth >= 0 ? "#16a34a" : "#dc2626"
          },
          children: ["(", l.unit_growth >= 0 ? "\u2191" : "\u2193", Math.abs(l.unit_growth), "%)"]
        })]
      }), u.jsx("div", {
        style: {
          fontSize: "11px",
        ...
        children: [l.share, "% ", u.jsxs("span", {
          style: {
            fontSize: "11px",
            color: Number(l.share_delta) >= 0 ? "#16a34a" : "#dc2626"
          },
          children: ["(", Number(l.share_delta) >= 0 ? "+" : "", l.share_delta, "pp)"]
        })]
      })]
    }), u.jsx("div", {
      style: {
...
function cE({
  ...
  const $ = Q.useMemo(() => _E(l, f0, M, v0), [l, f0, M, v0]);
  if (!$) return null;
      ...
      children: $.empty ? u.jsx("div", {
        ...
        children: [u.jsx("div", {
          ...
          children: [u.jsx(Fu, {
            ...
            sub: `${$.kpi.orders_abs_diff>=0?"+":""}${n(Math.abs($.kpi.orders_abs_diff))} \u0E04\u0E23\u0E31\u0E49\u0E07`,
            color: $.kpi.orders_growth_pct >= 0 ? "#16a34a" : "#dc2626"
          }), u.jsx(Fu, {
            label: "\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 Revenue",
            value: `${$.kpi.price_growth_pct>=0?"+":""}${$.kpi.price_growth_pct}%`,
            sub: `${$.kpi.price_abs_diff>=0?"+":""}\u0E3F${n(Math.abs($.kpi.price_abs_diff))}`,
            ...
            label: `Run-rate ${M}`,
            value: `\u0E3F${n($.kpi.avg_monthly_px)}/\u0E14.`,
            sub: `\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E40\u0E15\u0E47\u0E21\u0E1B\u0E35 \u0E3F${n($.kpi.annualized_fy2)}`,
            color: "#0ea5e9"
          })]
        }), u.jsxs("div", {
          style: {
          ...
          children: u.jsx(pu, {
            ...
            text: `\u0E08\u0E32\u0E01 Run-rate ${$.kpi.comparable_months} \u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 Annualized FY${M}: \u0E3F${n($.kpi.annualized_fy2)} \u0E1A\u0E32\u0E17 \xB7 Annualized FY${f0}: \u0E3F${n($.kpi.annualized_fy1)} \u0E1A\u0E32\u0E17 \xB7 Gap = ${$.kpi.annualized_gap>=0?"+":"\u2212"}\u0E3F${n(Math.abs($.kpi.annualized_gap))} \u0E1A\u0E32\u0E17. ${$.kpi.annualized_gap>=0?"\u0E2B\u0E32\u0E01\u0E23\u0E31\u0E01\u0E29\u0E32\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E19\u0E35\u0E49\u0E44\u0E14\u0E49\u0E04\u0E23\u0E1A\u0E1B\u0E35 \u0E08\u0E30\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E08\u0E32\u0E01\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19":"\u0E2B\u0E32\u0E01\u0E22\u0E31\u0E07\u0E04\u0E07\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E19\u0E35\u0E49\u0E15\u0E48\u0E2D\u0E44\u0E1B \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E40\u0E15\u0E47\u0E21\u0E1B\u0E35\u0E08\u0E30\u0E2B\u0E14\u0E15\u0E31\u0E27\u0E08\u0E32\u0E01\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19"} \u0E02\u0E49\u0E2D\u0E2A\u0E33\u0E04\u0E31\u0E0D: \u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E41\u0E1A\u0E1A Linear Extrapolation \u2014 \u0E44\u0E21\u0E48\u0E23\u0E27\u0E21 Seasonality adjustment`,
            color: "#0ea5e9"
          })
        }), u.jsxs("div", {
          style: {
...
function CE() {
  const [l, f0] = Q.useState("opd-compare"), [M, v0] = Q.useState(null), [$, n0] = Q.useState(null), [e0, _0] = Q.useState(null), [uu, Y0] = Q.useState(null), [G0, I0] = Q.useState(null), [g0, m0] = Q.useState(null), [C0, c0] = Q.useState(!0), [Eu, i0] = Q.useState(null), Y = Q.useRef(null), [y0, F0] = Q.useState(null), [$0, x0] = Q.useState(null), [J, eu] = Q.useState(null), [D0, ru] = Q.useState(null), [z0, X0] = Q.useState(null), [b0, Z0] = Q.useState(null), [p0, R0] = Q.useState(null), [u0, yu] = Q.useState(null), [hu, V0] = Q.useState(null), [su, zu] = Q.useState(null), _u = new Date, Cu = _u.getMonth() + 1, bu = _u.getFullYear(), Au = Cu >= 10 ? bu + 544 : bu + 543, ku = Au - 1, [r0, Lu] = Q.useState(ku), [E0, Wu] = Q.useState(Au), Ru = `${bu}-${String(Cu).padStart(2,"0")}-01`, Tu = new Date().toISOString().slice(0, 10), [l0, Mu] = Q.useState(Ru), [s0, Su] = Q.useState(Tu), [O0, Nu] = Q.useState(Ru), [gu, Ou] = Q.useState(Tu), [A0, Iu] = Q.useState(10), Z = Q.useCallback(e => e ? A0 === "all" ? e : e.slice(0, A0) : [], [A0]), U = Q.useMemo(() => Z($0?.patients), [$0, Z]), w0 = Q.useMemo(() => {
    if (!b0?.patients) return null;
    const e = b0.patients,
      t = b0.total_income || 0,
      s = b0.unique_patients || new Set(e.map(o => o.hn)).size,
      B = e.length > 0 ? Math.round(t / e.length) : 0;
    let r = 0,
      c = 0;
    const i = {
        "<40": 0,
    ...
    for (const o of e) {
      ...
      for (const N of a) {
        if (!N) continue;
        const D = N.indexOf("::"),
          S = (D >= 0 ? N.slice(0, D) : N).toUpperCase(),
          V = D >= 0 ? N.slice(D + 2) : "";
        if (!S || !lu.test(S)) continue;
        y[S] || (y[S] = {
          code: S,
          name: V,
          count: 0,
  ...
  Q.useEffect(() => {
    l === "ipd-compare" ? U0() : l === "opd-compare" ? q0() : l === "resource-opd" ? tu() : l === "resource-ipd" ? vu() : l === "mortality" ? $u() : l === "frax" ? wu() : l === "pt" ? Du() : l === "fluoride" ? Hu() : l === "elderly-cxr" ? Xu() : l === "ncd-disease" ? Ku() : l === "imaging-services" ? Yu() : l === "pttype-services" ? Gu() : l === "staff-services" ? iu() : l === "selfharm" && du()
  }, [l, U0, q0, tu, vu, $u, wu, Du, iu, Hu, Xu, Ku, Yu, Gu, du]), Q.useEffect(() => {
    const e = setTimeout(() => {
    ...
    hE = Q.useCallback(() => {
      const e = (t, s) => {
        ...
        if (T(D, 0, `${s.titleEmoji||"\u{1F4CB}"}  ${s.titleText}`, v), P(D, 0, D, c - 1), k[D] = {
            ...
            hpx: 18
          }, D++, S(8), s.kpis && s.kpis.length) {
          T(D, 0, "\u{1F4CA}  KPI \u0E2A\u0E23\u0E38\u0E1B", p(s.themeColor || i.purpleDark)), P(D, 0, D, c - 1), k[D] = {
            hpx: 32
          }, D++;
          for (const W of s.kpis) T(D, 0, W.label, o), P(D, 0, D, 1), T(D, 2, W.value, w(W.color, W.fmt)), P(D, 2, D, 4), T(D, 5, W.unit || "", a), T(D, 6, W.note || "", g), P(D, 6, D, 7), k[D] = {
            hpx: 32
          }, D++;
          S(12)
        }
          ...
          for (const W of s.breakdowns) {
            if (T(D, 0, `${W.icon||"\u{1F4C8}"}  ${W.title}`, p(W.color)), P(D, 0, D, c - 1), k[D] = {
              ...
              W.headers.forEach((R, H) => {
                const [q, o0] = L[H] || [H, H];
                T(D, q, R, b(W.color)), q !== o0 && P(D, q, D, o0)
              }), k[D] = {
                hpx: 30
              }, D++
            }
        ...
        C["!ref"] = t.utils.encode_range({
          ...
          xSplit: 0,
          ySplit: 3
        }, t.utils.book_append_sheet(B, C, "Overview");
        const V = {};
        ...
        s.patientData.forEach((W, j) => {
          ...
          xSplit: 0,
          ySplit: 1
        }, t.utils.book_append_sheet(B, V, s.patientSheetName || "Data"), t.writeFile(B, s.filename)
      };
      if (l === "ipd-compare") {
        if (!M?.comparison) return;
        const t = (h, A) => h > 0 ? Math.round((A - h) / h * 100) + "%" : A > 0 ? "100%" : "0%",
          s = M.fiscal_years?.fy1?.label || `\u0E1B\u0E35\u0E07\u0E1A ${r0}`,
          B = M.fiscal_years?.fy2?.label || `\u0E1B\u0E35\u0E07\u0E1A ${E0}`,
          r = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", `Admit (${s})`, `D/C (${s})`, "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19", "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22", "\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07", "\u0E40\u0E15\u0E35\u0E22\u0E07\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E08\u0E23\u0E34\u0E07", "Sum AdjRW", "CMI", `Admit (${B})`, `D/C (${B})`, "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19", "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22", "\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07", "\u0E40\u0E15\u0E35\u0E22\u0E07\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E08\u0E23\u0E34\u0E07", "Sum AdjRW", "CMI", "YoY Admit %", "YoY D/C %", "YoY \u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19 %", "YoY ALOS %", "YoY \u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07 %", "YoY Active Bed %", "YoY AdjRW %", "YoY CMI %", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 Admit", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 D/C", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 \u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19"],
      ...
      if (l === "frax") {
        ...
        const s = new Set(t.map(v => v.hn)).size,
          B = t.length > 0 ? t.reduce((v, F) => v + (Number(F.major_osteoporotic) || 0), 0) / t.length : 0,
        ...
        c > 0 && z.push({
          ...
          sev: "med",
          cat: "Population Risk",
          msg: `\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 Major Risk = ${B.toFixed(1)}% \u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E17\u0E31\u0E48\u0E27\u0E44\u0E1B`,
        ...
        nu(() => import("./xlsx.min-CZi5yKex.js").then(v => v.x), fu([0, 1])).then(v => {
          e(v, {
            ...
            kpis: [{
              ...
              value: Math.round(B * 10) / 10,
              unit: "%",
              color: B >= 20 ? "DC2626" : B >= 10 ? "F59E0B" : "10B981",
              fmt: "0.0",
              note: B >= 20 ? "\u{1F534} \u0E2A\u0E39\u0E07\u0E21\u0E32\u0E01" : B >= 10 ? "\u26A0 \u0E2A\u0E39\u0E07" : "\u2705 \u0E1B\u0E01\u0E15\u0E34"
            }, {
      ...
      if (l === "pt" || l === "staff-services") {
        ...
        const A = {};
        t.forEach(g => {
          const b = (g.icd10 || "").split(",").map(D => D.trim().toUpperCase()).filter(D => lu.test(D)),
        ...
        nu(() => import("./xlsx.min-CZi5yKex.js").then(g => g.x), fu([0, 1])).then(g => {
          e(g, {
            filename: `BCH360_${l==="staff-services"?"StaffServices":"PhysicalTherapy"}_${l0}_${s0}.xlsx`,
            titleEmoji: "\u{1F9B5}",
            titleText: l === "staff-services" ? "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E01\u0E32\u0E23\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E02\u0E2D\u0E07\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23" : "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E\u0E1A\u0E33\u0E1A\u0E31\u0E14 \u0E41\u0E25\u0E30 PMC",
            themeColor: "0EA5E9",
            ...
            totalCount: t.length,
            uniqueCount: B,
            kpis: [...l === "staff-services" && J?.staff_registry_count ? [{
              label: "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14",
              value: J.staff_registry_count,
              unit: "\u0E23\u0E32\u0E22",
              color: "7C3AED",
              fmt: "#,##0",
              note: `\u0E21\u0E32\u0E43\u0E0A\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 ${B} \u0E23\u0E32\u0E22 (${J.staff_registry_count>0?Math.round(B/J.staff_registry_count*1e3)/10:0}%)`
            }] : [], {
              label: l === "staff-services" ? "\u0E08\u0E33\u0E19\u0E27\u0E19 Visit \u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23" : "\u0E08\u0E33\u0E19\u0E27\u0E19 Visit PT",
              value: t.length,
              unit: "\u0E04\u0E23\u0E31\u0E49\u0E07",
              color: "0EA5E9",
              fmt: "#,##0",
              note: l === "staff-services" ? "\u0E23\u0E27\u0E21 visit \u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07\u0E40\u0E27\u0E25\u0E32" : "\u0E23\u0E27\u0E21\u0E01\u0E32\u0E23\u0E21\u0E32\u0E15\u0E23\u0E27\u0E08\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E"
            }, {
              label: l === "staff-services" ? "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E17\u0E35\u0E48\u0E40\u0E02\u0E49\u0E32\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 (HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33)" : "\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 (HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33)",
              value: B,
              unit: "\u0E23\u0E32\u0E22",
              color: "0284C7",
              fmt: "#,##0",
              note: l === "staff-services" ? "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E23\u0E32\u0E22\u0E1A\u0E38\u0E04\u0E04\u0E25" : "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E32\u0E22\u0E1A\u0E38\u0E04\u0E04\u0E25"
            }, {
      ...
      if (l === "fluoride") {
        ...
        const t = D0.patients,
          ...
          B = t.reduce((p, o) => p + (Number(o.income) || 0), 0),
          r = new Set(t.map(p => p.hn)).size,
          c = t.length > 0 ? Math.round(B / t.length) : 0,
        ...
        const h = {};
        t.forEach(p => {
          const o = (p.icd10 || "").split(",").map(a => a.trim().toUpperCase()).filter(a => lu.test(a)),
        ...
        nu(() => import("./xlsx.min-CZi5yKex.js").then(p => p.x), fu([0, 1])).then(p => {
          e(p, {
      ...
      if (l === "elderly-cxr") {
        ...
        const t = z0.patients,
          ...
          B = z0.total_cxr_price || t.reduce((a, g) => a + (Number(g.cxr_price) || 0), 0),
        ...
        const C = {};
        t.forEach(a => {
          const g = (a.icd10 || "").split(",").map(N => N.trim().toUpperCase()).filter(N => lu.test(N)),
        ...
        P > 0 && X.push({
          ...
          sev: "info",
          cat: "Cost Analysis",
          msg: `\u0E04\u0E48\u0E32 CXR \u0E23\u0E27\u0E21 ${B.toLocaleString()} \u0E1A\u0E32\u0E17 \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 Visit \u0E23\u0E27\u0E21 ${s.toLocaleString()} \u0E1A\u0E32\u0E17`,
        ...
        nu(() => import("./xlsx.min-CZi5yKex.js").then(a => a.x), fu([0, 1])).then(a => {
          e(a, {
      ...
      if (l === "pttype-services") {
        if (!u0?.groups) return;
        const t = o => Number(o || 0),
          s = new Set(hu === null ? u0.group_order || [] : hu),
          B = (u0.groups || []).filter(o => s.has(o.group_name)),
          r = (u0.summary || []).filter(o => s.has(o.group_name)),
          c = (u0.group_trend || []).filter(o => s.has(o.group_name)),
          i = B.reduce((o, w) => o + (w.total_visits || 0), 0),
          ...
          C = [...B].sort((o, w) => w.total_visits - o.total_visits),
        ...
        nu(() => import("./xlsx-BuHXVOW6.js"), []).then(o => {
          ...
          const N = [
              ...
              ["\u0E2B\u0E21\u0E27\u0E14\u0E17\u0E35\u0E48\u0E40\u0E25\u0E37\u0E2D\u0E01", `${B.length} \u0E08\u0E32\u0E01 ${(u0.group_order||[]).length} \u0E2B\u0E21\u0E27\u0E14\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19`],
              [],
          ...
          D["!cols"] = [{
            ...
            wch: 60
          }], o.utils.book_append_sheet(w, D, "Meta"), o.writeFile(w, `BCH360_PttypeServices_${u0.from}_${u0.to}.xlsx`)
        });
        return
      }
      if (l === "imaging-services") {
        ...
        t.forEach(b => {
          (b.icd_pairs || "").split("||").filter(Boolean).forEach(N => {
            const [D, S] = N.split("::"), V = (D || "").toUpperCase();
            !V || !lu.test(V) || (P[V] || (P[V] = {
              code: V,
              name: S || "",
              count: 0,
        ...
        nu(() => import("./xlsx.min-CZi5yKex.js").then(b => b.x), fu([0, 1])).then(b => {
          e(b, {
      ...
      if (l === "opd-compare") {
        ...
        const t = (C, z) => C > 0 ? Math.round((z - C) / C * 100) + "%" : z > 0 ? "100%" : "0%",
          ...
          B = $.fiscal_years?.fy2?.label || "\u0E1B\u0E35\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19",
          ...
          i = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", ...c.map(C => `${C} (${s})`), ...c.map(C => `${C} (${B})`), ...c.map(C => `YoY ${C} %`)],
          y = $.comparison.map(C => [C.month, ...r.map(z => C.fy1[z]), ...r.map(z => C.fy2[z]), ...r.map(z => t(C.fy1[z], C.fy2[z]))]),
          h = $.fy1_totals,
          A = $.fy2_totals;
        y.push(["\u0E23\u0E27\u0E21", ...r.map(C => h[C]), ...r.map(C => A[C]), ...r.map(C => t(h[C], A[C]))]), nu(() => import("./xlsx-BuHXVOW6.js"), []).then(C => {
      ...
      if (l === "resource-opd" || l === "resource-ipd") {
        const t = l === "resource-opd" ? uu : G0;
        if (!t?.comparison) return;
        const s = l === "resource-opd" ? "OPD" : "IPD",
          B = l === "resource-opd" ? "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E19\u0E2D\u0E01" : "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19",
        ...
        i.push(["\u0E23\u0E27\u0E21", y.lab_orders, y.lab_price, y.drug_orders, y.drug_price, y.xray_orders, y.xray_price, A, C, h.lab_orders, h.lab_price, h.drug_orders, h.drug_price, h.xray_orders, h.xray_price, z, k, `${t.overall_orders_growth_pct}%`, `${t.overall_price_growth_pct}%`]), nu(() => import("./xlsx-BuHXVOW6.js"), []).then(T => {
          const P = [r, ...i],
          ...
          T.utils.book_append_sheet(F, v, `\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${B}`), T.writeFile(F, `BCH360_Resource_${s}_Monthly_${r0}_${E0}.xlsx`)
        });
        return
      }
      if (l === "ncd-disease") {
        ...
        nu(() => import("./xlsx.min-CZi5yKex.js").then(m => m.x), fu([0, 1])).then(m => {
          ...
          K(d, 0, "\u{1FAC0}  \u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E2A\u0E23\u0E38\u0E1B\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 NCD \u0E41\u0E22\u0E01\u0E42\u0E23\u0E04", gE), d0(d, 0, d, S0 - 1), k0[d] = {
            hpx: 56
          }, d++, K(d, 0, `\u{1F4C5}  \u0E0A\u0E48\u0E27\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25:  ${b0.date_range.start}  \u2192  ${b0.date_range.end}    \xB7    \u{1F465}  ${t.length.toLocaleString()} visit  /  ${B.toLocaleString()} \u0E23\u0E32\u0E22`, xE), d0(d, 0, d, S0 - 1), k0[d] = {
            hpx: 28
          ...
          const fE = [
            ...
            ["\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 (HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33)", B, "\u0E23\u0E32\u0E22", I.purple, "#,##0", "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E32\u0E22\u0E1A\u0E38\u0E04\u0E04\u0E25 \u0E19\u0E31\u0E1A 1 HN \u0E15\u0E48\u0E2D 1 \u0E04\u0E23\u0E31\u0E49\u0E07"],
          ...
          for (const [G, h0, B0, j0, L0, cu] of fE) K(d, 0, G, uE), d0(d, 0, d, 1), K(d, 2, h0, EE(j0, L0)), d0(d, 2, d, 4), K(d, 5, B0, eE), K(d, 6, cu, tE), d0(d, 6, d, 7), k0[d] = {
            hpx: 32
          }, d++;
          ...
          for (const [G, h0, B0, j0, L0, cu] of yE) K(d, 0, G, uE), d0(d, 0, d, 1), K(d, 2, h0, EE(j0, L0)), d0(d, 2, d, 4), K(d, 5, B0, eE), K(d, 6, cu, tE), d0(d, 6, d, 7), k0[d] = {
            hpx: 30
          }, d++;
          ...
          for (const [G, h0] of AE) {
            const B0 = G === "\u0E2D\u0E2D\u0E01\u0E41\u0E1A\u0E1A\u0E42\u0E14\u0E22",
              ...
              cu = B0 ? I.greenLight : I.slateSoft;
            K(d, 0, G, H0({
              font: {
                bold: !0,
                sz: 11,
          ...
          ou["!ref"] = m.utils.encode_range({
            ...
            wch: 28
          }], ou["!rows"] = k0, ou["!freeze"] = {
            xSplit: 0,
            ySplit: 3
          }, m.utils.book_append_sheet(O, ou, "Overview");
          const Bu = {};
          x.forEach((G, h0) => {
      ...
      if (l === "mortality") {
        ...
        const t = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", `IPD \u0E08\u0E33\u0E2B\u0E19\u0E48\u0E32\u0E22 (${r0})`, `IPD \u0E15\u0E32\u0E22 (${r0})`, `IPD \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E15\u0E32\u0E22% (${r0})`, `OPD \u0E15\u0E32\u0E22 (${r0})`, `\u0E23\u0E27\u0E21\u0E15\u0E32\u0E22 (${r0})`, `IPD \u0E08\u0E33\u0E2B\u0E19\u0E48\u0E32\u0E22 (${E0})`, `IPD \u0E15\u0E32\u0E22 (${E0})`, `IPD \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E15\u0E32\u0E22% (${E0})`, `OPD \u0E15\u0E32\u0E22 (${E0})`, `\u0E23\u0E27\u0E21\u0E15\u0E32\u0E22 (${E0})`],
          ...
          B = "\uFEFF" + [t.join(","), ...s.map(y => y.join(","))].join(`\r
`),
          r = new Blob([B], {
    ...
    }, [l, M, $, uu, G0, g0, $0, J, D0, z0, b0, p0, u0, hu, r0, E0, l0, s0, O0, gu]),
    Zu = Q.useMemo(() => {
      const e = [];
  ...
  return u.jsxs("div", {
    ...
    children: [u.jsxs("div", {
      ...
      children: [u.jsx("div", {
        ...
        children: l === "ipd-compare" ? "\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 (IPD)" : l === "opd-compare" ? "\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E19\u0E2D\u0E01 (OPD)" : l === "resource-opd" ? "\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E19\u0E2D\u0E01 (Lab/Drug/CT-Xray)" : l === "resource-ipd" ? "\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 (Lab/Drug/CT-Xray)" : l === "frax" ? "FRAX Calculator (\u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E01\u0E23\u0E30\u0E14\u0E39\u0E01\u0E2B\u0E31\u0E01)" : l === "pt" ? "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E\u0E1A\u0E33\u0E1A\u0E31\u0E14 \u0E41\u0E25\u0E30 PMC" : l === "staff-services" ? "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E01\u0E32\u0E23\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E02\u0E2D\u0E07\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23" : l === "fluoride" ? "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E01\u0E32\u0E23\u0E40\u0E04\u0E25\u0E37\u0E2D\u0E1A\u0E1F\u0E25\u0E39\u0E2D\u0E2D\u0E44\u0E23\u0E14\u0E4C 25-59 \u0E1B\u0E35" : l === "elderly-cxr" ? "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E1C\u0E39\u0E49\u0E2A\u0E39\u0E07\u0E2D\u0E32\u0E22\u0E38 60+ \u0E17\u0E35\u0E48\u0E21\u0E35 CXR" : l === "ncd-disease" ? "\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 NCD \u0E41\u0E22\u0E01\u0E42\u0E23\u0E04" : l === "imaging-services" ? "\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 XRAY / CT / Portable / BMD" : "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E01\u0E32\u0E23\u0E15\u0E32\u0E22 (OPD / IPD)"
      })]
    }), u.jsxs("div", {
      ...
      children: [u.jsx("span", {
        ...
        children: [u.jsx("option", {
          ...
          value: "selfharm",
          children: "\u0E17\u0E33\u0E23\u0E49\u0E32\u0E22\u0E15\u0E31\u0E27\u0E40\u0E2D\u0E07\u0E42\u0E14\u0E22\u0E40\u0E08\u0E15\u0E19\u0E32 (X60-X84)"
        }), u.jsx("option", {
          value: "ncd-disease",
      ...
      }), l === "ipd-compare" ? u.jsxs(u.Fragment, {
        children: [u.jsx("span", {
          style: {
            fontSize: "12px",
            fontWeight: 800,
      ...
      }) : l === "opd-compare" ? u.jsxs(u.Fragment, {
        children: [u.jsx("span", {
          style: {
            fontSize: "12px",
            fontWeight: 800,
      ...
      }) : l === "frax" || l === "pt" || l === "staff-services" || l === "fluoride" || l === "elderly-cxr" || l === "ncd-disease" || l === "imaging-services" || l === "pttype-services" ? u.jsxs(u.Fragment, {
        children: [u.jsx("span", {
          style: {
            fontSize: "12px",
            fontWeight: 800,
        ...
        onClick: () => l === "ipd-compare" ? U0() : l === "opd-compare" ? q0() : l === "resource-opd" ? tu() : l === "resource-ipd" ? vu() : l === "frax" ? wu() : l === "pt" ? Du() : l === "staff-services" ? iu() : l === "fluoride" ? Hu() : l === "elderly-cxr" ? Xu() : l === "ncd-disease" ? Ku() : l === "imaging-services" ? Yu() : l === "pttype-services" ? Gu() : $u(),
        disabled: C0,
        style: {
          padding: "6px 16px",
          borderRadius: "8px",
        ...
        onClick: pE,
        disabled: l === "ipd-compare" ? !M : l === "opd-compare" ? !$ : l === "resource-opd" ? !uu : l === "resource-ipd" ? !G0 : l === "frax" ? !$0 : l === "pt" || l === "staff-services" ? !J : l === "fluoride" ? !D0 : l === "elderly-cxr" ? !z0 : l === "ncd-disease" ? !b0?.patients : l === "imaging-services" ? !p0?.patients : l === "pttype-services" ? !u0?.groups : !g0,
        style: {
          padding: "6px 14px",
          borderRadius: "8px",
          fontSize: "12px",
        ...
        children: l === "frax" || l === "pt" || l === "staff-services" || l === "fluoride" || l === "elderly-cxr" || l === "ipd-compare" || l === "opd-compare" || l === "resource-opd" || l === "resource-ipd" || l === "ncd-disease" || l === "imaging-services" || l === "pttype-services" ? "Excel" : "CSV"
      }), u.jsxs("div", {
        style: {
          display: "flex",
          alignItems: "center",
        ...
        children: [u.jsxs("div", {
          ...
          children: B.map((r, c) => u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              children: [n(r.v1, r.dec || 0), " \u2192 ", n(r.v2, r.dec || 0)]
            })]
          }, c))
        }), (() => {
          ...
          M.total_beds * 30 * T, y < -5 ? v.push({
            ...
            detail: `\u0E23\u0E31\u0E1A\u0E40\u0E02\u0E49\u0E32 ${n(r.admits)} \u2192 ${n(c.admits)} \u0E23\u0E32\u0E22 (\u0E25\u0E14 ${n(Math.abs(c.admits-r.admits))} \u0E23\u0E32\u0E22) \xB7 D/C ${n(r.discharges)} \u2192 ${n(c.discharges)} \u0E23\u0E32\u0E22 (${h>=0?"+":""}${h}%) \u2014 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19${Math.abs(y)>15?"\u0E25\u0E14\u0E25\u0E07\u0E21\u0E32\u0E01":"\u0E25\u0E14\u0E25\u0E07"} \u0E2A\u0E48\u0E07\u0E1C\u0E25\u0E15\u0E48\u0E2D\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E41\u0E25\u0E30\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07\u0E42\u0E14\u0E22\u0E15\u0E23\u0E07`,
            actions: [{
              who: "\u0E1D\u0E48\u0E32\u0E22\u0E01\u0E32\u0E23\u0E41\u0E1E\u0E17\u0E22\u0E4C",
            ...
            detail: `\u0E23\u0E31\u0E1A\u0E40\u0E02\u0E49\u0E32 ${n(r.admits)} \u2192 ${n(c.admits)} \u0E23\u0E32\u0E22 (\u0E40\u0E1E\u0E34\u0E48\u0E21 ${n(c.admits-r.admits)} \u0E23\u0E32\u0E22) \u2014 \u0E04\u0E27\u0E32\u0E21\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E40\u0E15\u0E35\u0E22\u0E07\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19 \u0E15\u0E49\u0E2D\u0E07\u0E40\u0E15\u0E23\u0E35\u0E22\u0E21\u0E01\u0E33\u0E25\u0E31\u0E07\u0E04\u0E19\u0E41\u0E25\u0E30\u0E40\u0E15\u0E35\u0E22\u0E07\u0E23\u0E2D\u0E07\u0E23\u0E31\u0E1A`,
            actions: [{
              who: "\u0E2B\u0E31\u0E27\u0E2B\u0E19\u0E49\u0E32 Ward",
            ...
            icon: "\u26A0\uFE0F",
            color: "#f59e0b",
            title: `Admit \u0E21\u0E32\u0E01\u0E01\u0E27\u0E48\u0E32 D/C ${n(F)} \u0E23\u0E32\u0E22 \u2014 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E2A\u0E30\u0E2A\u0E21\u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A`,
            ...
            icon: "\u23F1\uFE0F",
            color: "#f59e0b",
            title: `ALOS \u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 ${C}% (${n(r.alos,2)} \u2192 ${n(c.alos,2)} \u0E27\u0E31\u0E19)`,
            detail: `\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E23\u0E27\u0E21 ${n(r.total_los)} \u2192 ${n(c.total_los)} \u0E27\u0E31\u0E19 (${A>=0?"+":""}${A}%) \u2014 \u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E22\u0E32\u0E27\u0E02\u0E36\u0E49\u0E19\u0E41\u0E21\u0E49\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E25\u0E14\u0E25\u0E07 \u0E41\u0E2A\u0E14\u0E07\u0E27\u0E48\u0E32 Discharge \u0E0A\u0E49\u0E32\u0E25\u0E07 \u0E2B\u0E23\u0E37\u0E2D\u0E21\u0E35\u0E40\u0E04\u0E2A\u0E0B\u0E31\u0E1A\u0E0B\u0E49\u0E2D\u0E19\u0E21\u0E32\u0E01\u0E02\u0E36\u0E49\u0E19`,
            actions: [{
              who: "\u0E04\u0E13\u0E30\u0E01\u0E23\u0E23\u0E21\u0E01\u0E32\u0E23 UM",
            ...
            detail: `ALOS ${n(r.alos,2)} \u2192 ${n(c.alos,2)} \u0E27\u0E31\u0E19 \u2014 \u0E1B\u0E23\u0E30\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E20\u0E32\u0E1E\u0E14\u0E35\u0E02\u0E36\u0E49\u0E19 \u0E04\u0E27\u0E23\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E27\u0E48\u0E32 Readmission Rate \u0E44\u0E21\u0E48\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 (D/C \u0E40\u0E23\u0E47\u0E27\u0E40\u0E01\u0E34\u0E19\u0E44\u0E1B)`,
            actions: [{
              who: "\u0E04\u0E13\u0E30\u0E01\u0E23\u0E23\u0E21\u0E01\u0E32\u0E23 UM",
            ...
            icon: "\u27A1\uFE0F",
            color: "var(--md-text-tertiary)",
            title: `ALOS \u0E17\u0E23\u0E07\u0E15\u0E31\u0E27 ${n(c.alos,2)} \u0E27\u0E31\u0E19 (${C>=0?"+":""}${C}%)`,
          ...
          });
          {
            ...
            y < 0 && o.push(`Volume \u0E25\u0E14 ${Math.abs(y)}%`), k < -5 && o.push(`CMI \u0E25\u0E14 ${Math.abs(k)}%`), z < -10 ? v.push({
              ...
              detail: `AdjRW ${n(r.sum_adjrw,1)} \u2192 ${n(c.sum_adjrw,1)} (\u0E25\u0E14 ${n(Math.abs(c.sum_adjrw-r.sum_adjrw),1)}) \xB7 RW \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22/\u0E23\u0E32\u0E22 ${X.toFixed(2)} \u2192 ${p.toFixed(2)} \xB7 CMI ${n(r.cmi,2)} \u2192 ${n(c.cmi,2)} \u2014 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E25\u0E14\u0E21\u0E32\u0E01\u0E01\u0E27\u0E48\u0E32\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 \u0E41\u0E2A\u0E14\u0E07\u0E27\u0E48\u0E32 Case-mix \u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E41\u0E1B\u0E25\u0E07`,
              actions: [{
                who: "\u0E17\u0E35\u0E21 Coding/DRG",
              ...
              detail: `AdjRW ${n(r.sum_adjrw,1)} \u2192 ${n(c.sum_adjrw,1)} \xB7 RW \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22/\u0E23\u0E32\u0E22 ${X.toFixed(2)} \u2192 ${p.toFixed(2)} \u2014 ${k>5?"Case-mix \u0E0B\u0E31\u0E1A\u0E0B\u0E49\u0E2D\u0E19\u0E02\u0E36\u0E49\u0E19":"\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E40\u0E1E\u0E34\u0E48\u0E21"}`,
              actions: [{
                who: "\u0E04\u0E13\u0E30\u0E01\u0E23\u0E23\u0E21\u0E01\u0E32\u0E23 UM",
              ...
              detail: `AdjRW ${n(r.sum_adjrw,1)} \u2192 ${n(c.sum_adjrw,1)} \xB7 RW \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22/\u0E23\u0E32\u0E22 ${X.toFixed(2)} \u2192 ${p.toFixed(2)}`,
              actions: [{
                who: "\u0E17\u0E35\u0E21 Coding",
          ...
          return c.occupancy_rate > 85 ? v.push({
            ...
            icon: "\u{1F4CB}",
            color: "#dc2626",
            title: `CMI \u0E25\u0E14\u0E25\u0E07 ${Math.abs(k)}% (${n(r.cmi,2)} \u2192 ${n(c.cmi,2)}) \u2014 Case-mix \u0E40\u0E1A\u0E32\u0E25\u0E07 \u0E2B\u0E23\u0E37\u0E2D Under-coding`,
            ...
            icon: "\u{1F4CB}",
            color: "#16a34a",
            title: `CMI \u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19 ${k}% (${n(r.cmi,2)} \u2192 ${n(c.cmi,2)}) \u2014 \u0E14\u0E39\u0E41\u0E25\u0E40\u0E04\u0E2A\u0E0B\u0E31\u0E1A\u0E0B\u0E49\u0E2D\u0E19\u0E21\u0E32\u0E01\u0E02\u0E36\u0E49\u0E19`,
    ...
    })(), !C0 && l === "ipd-compare" && M?.comparison && u.jsxs("div", {
      style: {
        background: "var(--md-surface)",
        border: "1px solid var(--md-border)",
        boxShadow: "var(--md-shadow-sm)",
...
Bed`,
            ...
            children: [M.comparison.filter(e => e.fy1.has_data && e.fy2.has_data).map((e, t) => u.jsxs("tr", {
              ...
              children: [u.jsx("td", {
                ...
                const i = s > 0 ? Math.round((B - s) / s * 100) : B > 0 ? 100 : 0;
                return u.jsxs("td", {
                  style: {
                    ...E.tdNum,
                    fontWeight: 800,
              ...
              children: [u.jsx("td", {
                ...
                return u.jsxs(u.Fragment, {
                  children: [u.jsx("td", {
                    ...
                    children: n(B.discharges)
                  }), u.jsx("td", {
                    style: s,
                    children: n(B.total_los)
                  }), u.jsx("td", {
                    style: {
                      ...s,
                      borderRight: t
                    ...
                    style: s,
                    children: n(B.occupancy_rate, 2)
                  }), u.jsx("td", {
                    style: {
                      ...s,
                      borderRight: t
                    },
                    children: n(B.active_beds, 2)
                  }), u.jsx("td", {
                    style: s,
                    children: n(B.sum_adjrw, 2)
                  }), u.jsx("td", {
                    style: {
                      ...s,
                      borderRight: e
        ...
        children: [u.jsxs("div", {
          ...
          children: B.map((r, c) => u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              children: [r.prefix || "", n(r.v1, r.dec || 0), " \u2192 ", r.prefix || "", n(r.v2, r.dec || 0)]
            })]
          }, c))
        })]
      })
    })(), !C0 && l === "opd-compare" && $?.comparison && u.jsxs("div", {
      style: {
        background: "var(--md-surface)",
        border: "1px solid var(--md-border)",
        boxShadow: "var(--md-shadow-sm)",
    ...
    }), !C0 && l === "resource-opd" && uu?.comparison && (() => {
      const e = uu,
        t = e.fy1_totals,
        s = e.fy2_totals,
        B = (i, y) => y > 0 ? Math.round((i - y) / y * 100) : i > 0 ? 100 : 0;
              ...
              children: [e.comparison.filter(i => i.fy1?.has_data && i.fy2?.has_data).map((i, y) => {
                ...
                return u.jsxs("tr", {
                  ...
                  children: [u.jsx("td", {
                    ...
                    style: E.tdNum,
                    children: h.lab_orders ? n(h.lab_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: c
                    },
                    children: h.lab_price ? n(h.lab_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: h.drug_orders ? n(h.drug_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: c
                    },
                    children: h.drug_price ? n(h.drug_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: h.xray_orders ? n(h.xray_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: r
                    },
                    children: h.xray_price ? n(h.xray_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: A.lab_orders ? n(A.lab_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: c
                    },
                    children: A.lab_price ? n(A.lab_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: A.drug_orders ? n(A.drug_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: c
                    },
                    children: A.drug_price ? n(A.drug_price) : ""
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: A.xray_orders ? n(A.xray_orders) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: r
                    },
                    children: A.xray_price ? n(A.xray_price) : ""
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 800,
    ...
    })(), !C0 && l === "resource-opd" && uu?.comparison && u.jsx(cE, {
      data: uu,
      fy1: r0,
      fy2: E0,
      level: "OPD"
    }), !C0 && l === "resource-ipd" && G0?.comparison && (() => {
      const e = G0,
        t = e.fy1_totals,
        s = e.fy2_totals,
        B = (i, y) => y > 0 ? Math.round((i - y) / y * 100) : i > 0 ? 100 : 0;
              ...
              children: [e.comparison.filter(i => i.fy1?.has_data && i.fy2?.has_data).map((i, y) => {
                ...
                return u.jsxs("tr", {
                  ...
                  children: [u.jsx("td", {
                    ...
                    style: E.tdNum,
                    children: n(h.lab_orders)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(h.lab_price)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(h.drug_orders)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(h.drug_price)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(h.xray_orders)
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: r
                    },
                    children: n(h.xray_price)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(A.lab_orders)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(A.lab_price)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(A.drug_orders)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(A.drug_price)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(A.xray_orders)
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      borderRight: r
                    },
                    children: n(A.xray_price)
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 800,
    ...
    })(), !C0 && l === "resource-ipd" && G0?.comparison && u.jsx(cE, {
      data: G0,
      fy1: r0,
      fy2: E0,
      level: "IPD"
    }), !C0 && l === "mortality" && g0?.comparison && (() => {
      const e = g0,
        t = e.fy1_totals,
        s = e.fy2_totals,
        B = (i, y) => y > 0 ? Math.round((i - y) / y * 100) : i > 0 ? 100 : 0,
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsxs("thead", {
              ...
              children: [e.comparison.filter(i => i.fy1?.has_data && i.fy2?.has_data).map((i, y) => {
                const h = i.fy1,
                  A = i.fy2,
                  C = B(A.total_deaths, h.total_deaths),
                ...
                return u.jsxs("tr", {
                  ...
                  children: [u.jsx("td", {
                    ...
                    children: n(h.total_deaths)
                  }), u.jsx("td", {
                    style: E.tdNum,
                    children: n(A.ipd_discharge)
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
    ...
    })(), !C0 && l === "mortality" && g0?.comparison && u.jsx(DE, {
    ...
    }), !C0 && l === "frax" && $0?.patients && u.jsxs("div", {
      className: "rounded-2xl overflow-hidden",
      style: {
        background: "var(--md-surface)",
        border: "1px solid var(--md-border)",
              ...
              children: [u.jsx("thead", {
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", z0.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E0A\u0E32\u0E22 ", r, " \xB7 \u0E2B\u0E0D\u0E34\u0E07 ", c, " \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", B.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
              ...
              children: [u.jsx("thead", {
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", D0.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", B.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
    ...
    })(), !C0 && (l === "pt" || l === "staff-services") && J?.patients && (() => {
      const e = J.patients,
        t = J.total_income || 0,
        s = e.length > 0 ? Math.round(t / e.length) : 0;
      e.length > 0 && Math.max(...e.map(x => x.income || 0));
      const B = J.opd_count || e.filter(x => x.visit_type === "OPD").length,
      ...
      const F = Object.values(v).sort((x, f) => x.date.localeCompare(f.date)),
        ...
        N = l === "staff-services" ? "\u0E01\u0E32\u0E23\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E02\u0E2D\u0E07\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23" : "\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E\u0E1A\u0E33\u0E1A\u0E31\u0E14 & PMC",
        D = l === "staff-services" ? "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23" : "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22",
        S = l === "staff-services" ? "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E17\u0E35\u0E48\u0E40\u0E02\u0E49\u0E32\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23" : "\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23",
        V = l === "staff-services" ? "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E43\u0E2B\u0E21\u0E48" : "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E2B\u0E21\u0E48",
      ...
      if (o0 && lu.test(o0.code) && K0.push(`\u{1FA7A} \u0E42\u0E23\u0E04/\u0E2B\u0E31\u0E15\u0E16\u0E01\u0E32\u0E23\u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${o0.code} ${o0.name||""} \u0E08\u0E33\u0E19\u0E27\u0E19 ${o0.count} \u0E23\u0E32\u0E22 \u2014 ${o0.code.startsWith("M")?"\u0E01\u0E25\u0E38\u0E48\u0E21\u0E42\u0E23\u0E04\u0E01\u0E25\u0E49\u0E32\u0E21\u0E40\u0E19\u0E37\u0E49\u0E2D/\u0E02\u0E49\u0E2D \u0E04\u0E27\u0E23\u0E23\u0E30\u0E1A\u0E38\u0E15\u0E33\u0E41\u0E2B\u0E19\u0E48\u0E07/\u0E23\u0E30\u0E22\u0E30\u0E43\u0E2B\u0E49\u0E25\u0E30\u0E40\u0E2D\u0E35\u0E22\u0E14\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E01\u0E47\u0E1A\u0E23\u0E2B\u0E31\u0E2A\u0E44\u0E14\u0E49\u0E41\u0E21\u0E48\u0E19\u0E22\u0E33":"\u0E41\u0E19\u0E30\u0E19\u0E33\u0E43\u0E2B\u0E49\u0E17\u0E33 protocol \u0E23\u0E31\u0E01\u0E29\u0E32\u0E40\u0E09\u0E1E\u0E32\u0E30\u0E01\u0E25\u0E38\u0E48\u0E21\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E1B\u0E23\u0E30\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E20\u0E32\u0E1E"}`), _ > 0 && L >= 5 && K0.push(`\u{1F501} \u0E21\u0E35${D}\u0E01\u0E25\u0E31\u0E1A\u0E21\u0E32\u0E0B\u0E49\u0E33 ${j.toLocaleString()} visits \u0E08\u0E32\u0E01 ${W.toLocaleString()} HN (\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${(e.length/_).toFixed(1)} \u0E04\u0E23\u0E31\u0E49\u0E07/\u0E04\u0E19) \u2014 ${L>=30?"\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E01\u0E32\u0E23\u0E01\u0E25\u0E31\u0E1A\u0E21\u0E32\u0E0B\u0E49\u0E33\u0E2A\u0E39\u0E07\u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19\u0E04\u0E27\u0E32\u0E21\u0E15\u0E48\u0E2D\u0E40\u0E19\u0E37\u0E48\u0E2D\u0E07\u0E02\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E23\u0E31\u0E01\u0E29\u0E32 \u0E04\u0E27\u0E23\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C\u0E17\u0E32\u0E07\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01":"\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E01\u0E25\u0E31\u0E1A\u0E21\u0E32\u0E0B\u0E49\u0E33\u0E1B\u0E01\u0E15\u0E34 \u2014 \u0E40\u0E19\u0E49\u0E19\u0E40\u0E0A\u0E34\u0E0D\u0E0A\u0E27\u0E19"+V+"\u0E40\u0E1E\u0E34\u0E48\u0E21"}`), A && A.length > 0 && A[0]) {
        const x = A[0],
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsx("div", {
          ...
          children: [...l === "staff-services" && J.staff_registry_count ? [{
            label: "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14",
            icon: "\u{1F465}",
            ...
            label: l === "staff-services" ? "\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E17\u0E35\u0E48\u0E40\u0E02\u0E49\u0E32\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23" : "\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23",
            icon: "\u{1F465}",
            value: (l === "staff-services" ? _ : J.total).toLocaleString(),
            unit: "\u0E23\u0E32\u0E22",
            color: "#10b981",
            yoy: l === "staff-services" ? (() => {
            ...
            unit: "\u0E23\u0E32\u0E22",
            color: "#0ea5e9",
            yoy: b(a(B, w?.opd_count), w?.opd_count, "\u0E23\u0E32\u0E22")
          }, {
            label: "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 (IPD)",
            icon: "\u{1F6CF}\uFE0F",
            value: r.toLocaleString(),
              ...
              children: [u.jsx("thead", {
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", J.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 OPD ", B, " (", c.toLocaleString(), " \u0E3F) \xB7 IPD ", r, " (", i.toLocaleString(), " \u0E3F) \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", s.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
              ...
              children: [u.jsx("thead", {
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", e.length.toLocaleString(), " visit \xB7 ", s.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", B.toLocaleString(), " \u0E1A\u0E32\u0E17/visit"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
    ...
    })(), !C0 && l === "imaging-services" && p0?.patients && (() => {
      const e = p0.patients,
      ...
      const o = Object.entries(p).sort((_, W) => W[1].count - _[1].count),
        w = t.reduce((_, W) => _ + (B[W] || 0), 0),
        a = t.reduce((_, W) => (B[W] || 0) > (B[_] || 0) ? W : _, t[0]),
      ...
      if (N && S.push(`\u{1F50D} \u0E02\u0E49\u0E2D\u0E1A\u0E48\u0E07\u0E0A\u0E35\u0E49\u0E01\u0E32\u0E23\u0E15\u0E23\u0E27\u0E08\u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22: ${N.code} ${N.name||""} (${N.count} \u0E04\u0E23\u0E31\u0E49\u0E07 \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 ${N.totalInc.toLocaleString(void 0,{maximumFractionDigits:0})} \u0E1A\u0E32\u0E17) \u2014 \u0E17\u0E1A\u0E17\u0E27\u0E19\u0E04\u0E27\u0E32\u0E21\u0E40\u0E2B\u0E21\u0E32\u0E30\u0E2A\u0E21\u0E15\u0E32\u0E21 ACR appropriateness criteria`), D) {
        const [_, W] = D, j = e.length > 0 ? Math.round(W.count / e.length * 100) : 0;
    ...
    })(), !C0 && l === "pttype-services" && u0?.groups && (() => {
      const e = u0.group_order || ["UC", "\u0E02\u0E49\u0E32\u0E23\u0E32\u0E0A\u0E01\u0E32\u0E23 / \u0E2D\u0E1B\u0E17", "\u0E0A\u0E33\u0E23\u0E30\u0E40\u0E07\u0E34\u0E19\u0E40\u0E2D\u0E07", "\u0E15\u0E48\u0E32\u0E07\u0E0A\u0E32\u0E15\u0E34 (1.5 \u0E40\u0E17\u0E48\u0E32)", "\u0E15\u0E48\u0E32\u0E07\u0E14\u0E49\u0E32\u0E27", "\u0E1B\u0E23\u0E30\u0E01\u0E31\u0E19\u0E2A\u0E31\u0E07\u0E04\u0E21", "\u0E1E\u0E23\u0E1A", "\u0E23\u0E31\u0E10\u0E27\u0E34\u0E2A\u0E32\u0E2B\u0E01\u0E34\u0E08", "\u0E2D\u0E37\u0E48\u0E19\u0E46"],
        t = u0.groups || [],
        s = new Set(hu === null ? e : hu),
        B = t.filter(j => s.has(j.group_name)),
        r = (u0.group_trend || []).filter(j => s.has(j.group_name)),
        c = (u0.summary || []).filter(j => s.has(j.group_name)),
        i = B.reduce((j, L) => j + (L.total_visits || 0), 0),
        y = B.reduce((j, L) => j + (L.opd_visits || 0), 0),
        h = B.reduce((j, L) => j + (L.ipd_admissions || 0), 0),
        A = B.reduce((j, L) => j + (L.er_visits || 0), 0),
        C = B.reduce((j, L) => j + (Math.max(L.opd_hn, L.ipd_hn, L.er_hn) || 0), 0),
        z = j => Number(j || 0).toLocaleString(),
        k = [...B].sort((j, L) => L.total_visits - j.total_visits),
        T = k[0] || null,
        ...
        b = () => V0(null),
        N = () => V0([]),
        D = X.length > 0 ? X.reduce((j, L) => {
          const R = p.reduce((H, q) => H + (j[q] || 0), 0);
          return p.reduce((H, q) => H + (L[q] || 0), 0) > R ? L : j
        }, X[0]) : null,
        S = D ? D.ym : "\u2014",
        V = D ? p.reduce((j, L) => j + (D[L] || 0), 0) : 0,
        _ = [];
      if (_.push(`\u{1F4CA} \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E0A\u0E48\u0E27\u0E07 ${u0.from} \u2192 ${u0.to}: ${z(i)} \u0E04\u0E23\u0E31\u0E49\u0E07 (OPD ${z(y)} \xB7 IPD ${z(h)} \xB7 ER ${z(A)}) \u0E08\u0E32\u0E01\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E27\u0E21 ${z(C)} \u0E23\u0E32\u0E22 \u0E01\u0E23\u0E30\u0E08\u0E32\u0E22 ${B.length} \u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C (\u0E08\u0E32\u0E01\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14 ${e.length} \u0E2B\u0E21\u0E27\u0E14\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19)`), T && P >= 40 && _.push(`\u{1F3E5} \u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E40\u0E14\u0E48\u0E19\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${T.group_name} \u0E04\u0E34\u0E14\u0E40\u0E1B\u0E47\u0E19 ${P}% \u0E02\u0E2D\u0E07\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14 (${z(T.total_visits)} \u0E04\u0E23\u0E31\u0E49\u0E07) \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E41\u0E25\u0E30\u0E01\u0E32\u0E23 reimbursement \u0E01\u0E25\u0E38\u0E48\u0E21\u0E19\u0E35\u0E49\u0E40\u0E1B\u0E47\u0E19\u0E1E\u0E34\u0E40\u0E28\u0E29`), h > 0 && y > 0) {
      ...
      D && V > 0 && _.push(`\u{1F4C8} \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E1E\u0E35\u0E04: ${S} \u0E21\u0E35\u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E23\u0E27\u0E21 ${z(V)} \u0E04\u0E23\u0E31\u0E49\u0E07 (\u0E01\u0E25\u0E38\u0E48\u0E21 Top 5) \u2014 \u0E43\u0E0A\u0E49\u0E27\u0E32\u0E07\u0E41\u0E1C\u0E19\u0E01\u0E33\u0E25\u0E31\u0E07\u0E04\u0E19 + \u0E22\u0E32/\u0E2D\u0E38\u0E1B\u0E01\u0E23\u0E13\u0E4C\u0E25\u0E48\u0E27\u0E07\u0E2B\u0E19\u0E49\u0E32`), _.push("\u{1F4A1} \u0E41\u0E1C\u0E19\u0E1E\u0E31\u0E12\u0E19\u0E32: 1) \u0E08\u0E31\u0E14\u0E17\u0E33 Dashboard \u0E23\u0E32\u0E22\u0E01\u0E25\u0E38\u0E48\u0E21\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E2A\u0E48\u0E07\u0E17\u0E35\u0E21 UM \u0E17\u0E38\u0E01\u0E40\u0E14\u0E37\u0E2D\u0E19 2) \u0E27\u0E34\u0E40\u0E04\u0E23\u0E32\u0E30\u0E2B\u0E4C recall rate per pttype 3) Audit \u0E40\u0E2D\u0E01\u0E2A\u0E32\u0E23\u0E40\u0E23\u0E35\u0E22\u0E01\u0E40\u0E01\u0E47\u0E1A\u0E04\u0E48\u0E32\u0E23\u0E31\u0E01\u0E29\u0E32\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E1E\u0E34\u0E48\u0E21 collection rate");
      const W = {
              ...
              children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                  ...
                  return [u.jsxs("div", {
                    ...
                    const W0 = X[au][m] || 0,
                      M0 = t0 > 0 ? W0 / t0 : 0,
                      ou = W0 > 0 ? `${O}${J0(M0*.85)}` : "transparent";
                    return u.jsxs("div", {
                      style: {
                        padding: "10px 4px",
                        textAlign: "center",
              ...
              children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                  ...
                  const O = w(f.group_name),
                    ...
                    S0 = x.reduce((I, au) => I + (a0[f.group_name]?.[au] || 0), 0);
                  return [u.jsxs("div", {
                    style: {
                      padding: "10px 12px",
                      fontSize: 12,
                    ...
                    const W0 = a0[f.group_name]?.[I] || 0,
                      M0 = t0 > 0 ? W0 / t0 : 0,
                      ou = R[I] || "#94a3b8",
                      Pu = W0 > 0 ? `${ou}${K0(M0*.85)}` : "transparent";
                    return u.jsxs("div", {
                      style: {
                        padding: "10px 4px",
                        textAlign: "center",
                        background: Pu,
                        borderRadius: 4,
                        border: W0 > 0 ? `1px solid ${ou}30` : "1px solid transparent",
                        minHeight: 50,
                        display: "flex",
                        flexDirection: "column",
                        alignItems: "center",
    ...
    })(), l !== "pt" && l !== "staff-services" && l !== "fluoride" && l !== "elderly-cxr" && l !== "ncd-disease" && l !== "imaging-services" && l !== "pttype-services" && l !== "ipd-compare" && l !== "selfharm" && u.jsx(ju, {
      data: y0,
      theme: "default",
      ...
      const e = su.records || [],
        ...
        s = B => B === "1" ? "\u0E27\u0E34\u0E19\u0E34\u0E08\u0E09\u0E31\u0E22\u0E2B\u0E25\u0E31\u0E01" : B === "2" ? "\u0E27\u0E34\u0E19\u0E34\u0E08\u0E09\u0E31\u0E22\u0E23\u0E2D\u0E07" : B === "5" ? "\u0E2A\u0E32\u0E40\u0E2B\u0E15\u0E38\u0E20\u0E32\u0E22\u0E19\u0E2D\u0E01" : B || "-";
      return u.jsxs("div", {
        style: {
          display: "flex",
          flexDirection: "column",
        ...
        children: [u.jsxs("div", {
          ...
          children: [u.jsxs("div", {
            ...
            children: [e.length > 0 && u.jsx("button", {
              onClick: () => {
                nu(() => import("./xlsx.min-CZi5yKex.js").then(B => B.x), fu([0])).then(B => {
                  const r = B.x || B,
                    c = ["\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23", "Source", "HN", "VN/AN", "\u0E0A\u0E37\u0E48\u0E2D-\u0E19\u0E32\u0E21\u0E2A\u0E01\u0E38\u0E25", "ICD-10", "\u0E0A\u0E37\u0E48\u0E2D\u0E42\u0E23\u0E04/\u0E2A\u0E32\u0E40\u0E2B\u0E15\u0E38", "\u0E1B\u0E23\u0E30\u0E40\u0E20\u0E17 Diag", "\u0E41\u0E1C\u0E19\u0E01/\u0E27\u0E2D\u0E23\u0E4C\u0E14"],
                    i = e.map(A => [String(A.service_date || "").slice(0, 10), A.source, A.hn, A.encounter, A.pt_name, A.icd10, A.dx_name, s(A.diagtype), A.dept_name]),
              ...
              children: "\u{1F4CA} \u0E14\u0E32\u0E27\u0E19\u0E4C\u0E42\u0E2B\u0E25\u0E14 Excel"
            })]
          })]
          ...
          children: [u.jsx("div", {
            ...
            children: t.by_icd.map(B => u.jsxs("span", {
              style: {
                padding: "4px 10px",
                background: "#ef444415",
                color: "#dc2626",
              ...
              children: [B.code, " \xB7 ", B.count.toLocaleString()]
            }, B.code))
          })]
        }), u.jsxs("div", {
          style: {
          ...
          children: [u.jsxs("div", {
            ...
            children: e.length === 0 ? u.jsx("div", {
              ...
              children: [u.jsx("thead", {
                ...
                children: e.map((B, r) => u.jsxs("tr", {
                  style: {
                    borderBottom: "1px solid var(--md-border)"
                  },
                  children: [u.jsx("td", {
                    style: N0.td,
                    children: String(B.service_date || "").slice(0, 10)
                  }), u.jsx("td", {
                    style: {
                      ...N0.td,
                      fontWeight: 800,
                      color: B.source === "OPD" ? "#0ea5e9" : "#a855f7"
                    },
                    children: B.source
                  }), u.jsx("td", {
                    style: {
