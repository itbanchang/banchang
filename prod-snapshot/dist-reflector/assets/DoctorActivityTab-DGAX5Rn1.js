...
function r0(E, t, o) {
  const c = [...t].sort((s, _) => (_.total_visits || 0) - (s.total_visits || 0)).findIndex(s => s.code === E.code) + 1,
    ...
    $ = I > 0 ? (E.ipd_admissions || 0) / I : 0,
    d = (E.ipd_admissions || 0) === 0 ? "OPD-only (\u0E44\u0E21\u0E48\u0E23\u0E31\u0E1A\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19)" : $ > .15 ? `IPD-heavy (${Math.round($*100)}% \u0E40\u0E1B\u0E47\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 \u2014 \u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E40\u0E09\u0E1E\u0E32\u0E30\u0E17\u0E32\u0E07)` : `Balanced (OPD ${Math.round((1-$)*100)}% \xB7 IPD ${Math.round($*100)}%)`,
    ...
    b = Number(E.orders_per_visit) || 0,
    w = Number(E.revenue_per_visit) || 0,
    L = p > 0 && b > p * 1.5 ? "\u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19\u0E21\u0E32\u0E01" : p > 0 && b > p * 1.2 ? "\u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19" : p > 0 && b < p * .5 ? "\u0E15\u0E48\u0E33\u0E01\u0E27\u0E48\u0E32\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19" : "\u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E1B\u0E01\u0E15\u0E34",
    ...
    R = [],
    O = [];
  m >= 90 ? j.push(`Top ${Math.max(1,100-m)}% \u0E14\u0E49\u0E32\u0E19\u0E1C\u0E25\u0E1C\u0E25\u0E34\u0E15 (\u0E2D\u0E31\u0E19\u0E14\u0E31\u0E1A ${c}/${t.length})`) : m >= 75 && j.push(`Top 25% \u0E14\u0E49\u0E32\u0E19\u0E1C\u0E25\u0E1C\u0E25\u0E34\u0E15 (\u0E2D\u0E31\u0E19\u0E14\u0E31\u0E1A ${c}/${t.length})`), w > h * 1.2 && j.push(`\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49/\u0E23\u0E32\u0E22\u0E2A\u0E39\u0E07 \u0E3F${r(w)} (\u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07 ${Math.round((w/Math.max(1,h)-1)*100)}%) \u2014 case-mix \u0E21\u0E35\u0E04\u0E38\u0E13\u0E04\u0E48\u0E32\u0E17\u0E32\u0E07\u0E40\u0E28\u0E23\u0E29\u0E10\u0E01\u0E34\u0E08`), $ > .15 && j.push(`\u0E23\u0E31\u0E1A IPD \u0E2A\u0E21\u0E48\u0E33\u0E40\u0E2A\u0E21\u0E2D (${E.ipd_admissions} \u0E23\u0E32\u0E22 \xB7 ${Math.round($*100)}% \u0E02\u0E2D\u0E07 workload) \u2014 \u0E40\u0E2A\u0E23\u0E34\u0E21\u0E04\u0E27\u0E32\u0E21\u0E15\u0E48\u0E2D\u0E40\u0E19\u0E37\u0E48\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E14\u0E39\u0E41\u0E25`), b > 0 && b < p * 1.2 && b > p * .7 && j.push(`Orders/Visit \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 (${b}) \u2014 Clinical Pathway \u0E40\u0E2B\u0E21\u0E32\u0E30\u0E2A\u0E21`), B > 50 ? R.push(`\u26A0 \u0E20\u0E32\u0E23\u0E30\u0E07\u0E32\u0E19\u0E40\u0E01\u0E34\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C (${Math.round(B)} \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19 \xB7 \u0E40\u0E01\u0E13\u0E11\u0E4C 30\u201350) \u2014 \u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07 Burnout`) : B > 30 && (E.ipd_admissions || 0) > 30 && R.push(`\u26A0 OPD ${Math.round(B)}/\u0E27\u0E31\u0E19 + IPD ${E.ipd_admissions} \u0E23\u0E32\u0E22 \u2014 \u0E20\u0E32\u0E23\u0E30\u0E0B\u0E49\u0E2D\u0E19 \u0E04\u0E27\u0E23\u0E40\u0E1D\u0E49\u0E32\u0E23\u0E30\u0E27\u0E31\u0E07`), p > 0 && b > p * 1.5 && R.push(`\u26A0 Orders/Visit = ${b} \u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07 (${p.toFixed(2)}) \u0E21\u0E32\u0E01 \u2014 \u0E17\u0E1A\u0E17\u0E27\u0E19 Clinical Appropriateness`), (E.opd_visits || 0) > 100 && b > 0 && b < .2 && R.push(`\u26A0 Orders/Visit \u0E15\u0E48\u0E33\u0E21\u0E32\u0E01 (${b}) \u0E41\u0E21\u0E49\u0E21\u0E35 OPD ${r(E.opd_visits)} \u0E23\u0E32\u0E22 \u2014 \u0E2D\u0E32\u0E08 Under-investigation`), (E.ipd_admissions || 0) === 0 && m >= 75 && R.push("\u0E41\u0E1E\u0E17\u0E22\u0E4C OPD-only \u0E41\u0E15\u0E48\u0E20\u0E32\u0E23\u0E30\u0E2A\u0E39\u0E07 \u2014 \u0E1E\u0E34\u0E08\u0E32\u0E23\u0E13\u0E32\u0E43\u0E2B\u0E49\u0E23\u0E48\u0E27\u0E21 IPD rotation"), h > 0 && w < h * .4 && (E.opd_visits || 0) > 100 && R.push(`\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49/\u0E23\u0E32\u0E22\u0E15\u0E48\u0E33\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07\u0E21\u0E32\u0E01 (\u0E3F${r(w)} vs \u0E3F${r(h)}) \u2014 \u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A Payer Mix \u0E41\u0E25\u0E30 Coding`), (E.lab_orders || 0) === 0 && (E.xray_orders || 0) === 0 && (E.opd_visits || 0) > 50 && R.push(`\u0E44\u0E21\u0E48\u0E21\u0E35 Lab/X-Ray Orders \u0E40\u0E25\u0E22\u0E41\u0E21\u0E49\u0E21\u0E35 OPD ${r(E.opd_visits)} \u0E23\u0E32\u0E22 \u2014 \u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E01\u0E32\u0E23\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01`), B > 50 && O.push("\u0E25\u0E14\u0E20\u0E32\u0E23\u0E30 OPD \u2014 \u0E1E\u0E34\u0E08\u0E32\u0E23\u0E13\u0E32\u0E08\u0E33\u0E01\u0E31\u0E14 Quota \u0E2B\u0E23\u0E37\u0E2D\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E0A\u0E48\u0E27\u0E22"), p > 0 && b > p * 1.5 && O.push("\u0E23\u0E48\u0E27\u0E21\u0E1B\u0E23\u0E30\u0E0A\u0E38\u0E21 Clinical Guideline \u2014 \u0E25\u0E14 Over-investigation"), w < h * .5 && (E.opd_visits || 0) > 200 && O.push("\u0E17\u0E1A\u0E17\u0E27\u0E19 Coding/Billing \u2014 \u0E2D\u0E32\u0E08\u0E21\u0E35 Revenue Leak"), (E.ipd_admissions || 0) === 0 && m >= 75 && O.push("\u0E2B\u0E21\u0E38\u0E19\u0E40\u0E27\u0E35\u0E22\u0E19\u0E40\u0E02\u0E49\u0E32 IPD \u2014 \u0E40\u0E2A\u0E23\u0E34\u0E21 Team Flexibility"), R.length === 0 && j.length >= 2 && O.push("\u0E1C\u0E25\u0E07\u0E32\u0E19\u0E14\u0E35 \u2014 \u0E1E\u0E34\u0E08\u0E32\u0E23\u0E13\u0E32\u0E40\u0E1B\u0E47\u0E19 Mentor / \u0E1C\u0E39\u0E49\u0E0A\u0E48\u0E27\u0E22\u0E08\u0E31\u0E14\u0E17\u0E33 Clinical Pathway");
  const K = x0(E, t, {
    visitPercentile: m,
...
function x0(E, t, o) {
  ...
  if (m > 50) {
    ...
    $.push({
      ...
      color: "#f43f5e",
      situation: `${d} \u0E23\u0E31\u0E1A\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${Math.round(m)} \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19 (\u0E40\u0E01\u0E34\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C OPD \u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 30\u201350 \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19 \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13 ${F} \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19) \u0E15\u0E25\u0E2D\u0E14\u0E0A\u0E48\u0E27\u0E07 ${I} \u0E27\u0E31\u0E19 \u2014 \u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07 Burnout \u0E2A\u0E39\u0E07 \u0E2A\u0E48\u0E07\u0E1C\u0E25\u0E15\u0E48\u0E2D\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E01\u0E32\u0E23\u0E27\u0E34\u0E19\u0E34\u0E08\u0E09\u0E31\u0E22 \u0E04\u0E27\u0E32\u0E21\u0E1B\u0E25\u0E2D\u0E14\u0E20\u0E31\u0E22\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 \u0E41\u0E25\u0E30\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E01\u0E32\u0E23\u0E04\u0E07\u0E2D\u0E22\u0E39\u0E48\u0E02\u0E2D\u0E07\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23\u0E43\u0E19\u0E23\u0E30\u0E22\u0E30\u0E22\u0E32\u0E27`,
  ...
  if (A > 0 && p < A * .6 && (E.opd_visits || 0) > 200) {
    ...
    $.push({
      ...
      color: "#dc2626",
      situation: `${d} \u0E2A\u0E23\u0E49\u0E32\u0E07\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 \u0E3F${r(p)}/\u0E23\u0E32\u0E22 \u0E15\u0E48\u0E33\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07 \u0E3F${r(A)}/\u0E23\u0E32\u0E22 \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13 ${Math.round((1-p/A)*100)}% \xB7 \u0E08\u0E32\u0E01\u0E08\u0E33\u0E19\u0E27\u0E19 OPD ${r(E.opd_visits)} \u0E23\u0E32\u0E22 \u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 ${I} \u0E27\u0E31\u0E19 \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13\u0E01\u0E32\u0E23 Revenue Gap \u0E2A\u0E39\u0E07\u0E16\u0E36\u0E07 \u0E3F${r(B)} \xB7 \u0E2D\u0E32\u0E08\u0E21\u0E35\u0E2A\u0E32\u0E40\u0E2B\u0E15\u0E38\u0E44\u0E14\u0E49\u0E2B\u0E25\u0E32\u0E22\u0E14\u0E49\u0E32\u0E19\u0E17\u0E35\u0E48\u0E04\u0E27\u0E23\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A\u0E40\u0E23\u0E48\u0E07\u0E14\u0E48\u0E27\u0E19`,
      ...
      target: `\u0E40\u0E1E\u0E34\u0E48\u0E21 Revenue/Visit \u0E02\u0E2D\u0E07 ${d} \u0E08\u0E32\u0E01 \u0E3F${r(p)} \u0E40\u0E1B\u0E47\u0E19 \u0E3F${r(Math.round(A*.85))} \u0E20\u0E32\u0E22\u0E43\u0E19 3 \u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 Revenue Recovery \u2265 \u0E3F${r(Math.round(B*.3))}`,
  ...
  if (g > 0 && h > g * 1.5) {
    ...
    $.push({
      ...
      color: "#f59e0b",
      situation: `${d} \u0E21\u0E35 Orders/Visit = ${h} \u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07 (${g.toFixed(2)}) \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13 ${Math.round((h/g-1)*100)}% \xB7 \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13\u0E01\u0E32\u0E23\u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E2A\u0E48\u0E27\u0E19\u0E40\u0E01\u0E34\u0E19 ${r(F)} \u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 ${I} \u0E27\u0E31\u0E19 \xB7 \u0E2D\u0E32\u0E08\u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19 Over-investigation \u0E2B\u0E23\u0E37\u0E2D\u0E01\u0E32\u0E23\u0E2A\u0E31\u0E48\u0E07\u0E15\u0E23\u0E27\u0E08\u0E0B\u0E49\u0E33\u0E42\u0E14\u0E22\u0E44\u0E21\u0E48\u0E08\u0E33\u0E40\u0E1B\u0E47\u0E19 \u0E0B\u0E36\u0E48\u0E07\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E42\u0E14\u0E22\u0E44\u0E21\u0E48\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E01\u0E32\u0E23\u0E14\u0E39\u0E41\u0E25`,
      ...
      target: `\u0E25\u0E14 Orders/Visit \u0E02\u0E2D\u0E07 ${d} \u0E08\u0E32\u0E01 ${h} \u2192 \u2264 ${(g*1.2).toFixed(2)} \u0E20\u0E32\u0E22\u0E43\u0E19 3 \u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 \u0E1B\u0E23\u0E30\u0E2B\u0E22\u0E31\u0E14\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19 Lab/X-Ray \u0E1B\u0E23\u0E30\u0E21\u0E32\u0E13 \u0E3F${r(Math.round(F*150))} (\u0E2A\u0E21\u0E21\u0E15\u0E34 \u0E3F150/order)`,
  ...
  return (E.opd_visits || 0) > 100 && h > 0 && h < .2 && $.push({
    ...
    color: "#f59e0b",
    situation: `${d} \u0E21\u0E35 Orders/Visit \u0E40\u0E1E\u0E35\u0E22\u0E07 ${h} (\u0E15\u0E48\u0E33\u0E01\u0E27\u0E48\u0E32\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07 ${g.toFixed(2)} \u0E21\u0E32\u0E01) \u0E41\u0E21\u0E49\u0E21\u0E35 OPD ${r(E.opd_visits)} \u0E23\u0E32\u0E22 \xB7 \u0E2D\u0E32\u0E08\u0E1A\u0E48\u0E07\u0E0A\u0E35\u0E49 (1) \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E2A\u0E48\u0E27\u0E19\u0E43\u0E2B\u0E0D\u0E48\u0E40\u0E1B\u0E47\u0E19 Follow-up \u0E17\u0E35\u0E48 stable \u0E2B\u0E23\u0E37\u0E2D (2) \u0E2A\u0E31\u0E48\u0E07\u0E15\u0E23\u0E27\u0E08\u0E19\u0E49\u0E2D\u0E22\u0E40\u0E01\u0E34\u0E19\u0E44\u0E1B\u0E08\u0E19 Miss Diagnosis`,
    ...
    color: "#3b82f6",
    situation: `${d} \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19 Top ${Math.max(1,100-c)}% \u0E14\u0E49\u0E32\u0E19\u0E1C\u0E25\u0E1C\u0E25\u0E34\u0E15 OPD \u0E41\u0E15\u0E48\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E23\u0E31\u0E1A\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 IPD \u0E40\u0E25\u0E22\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 ${I} \u0E27\u0E31\u0E19 \xB7 \u0E02\u0E32\u0E14\u0E42\u0E2D\u0E01\u0E32\u0E2A\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E17\u0E31\u0E01\u0E29\u0E30\u0E01\u0E32\u0E23\u0E14\u0E39\u0E41\u0E25\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 Complex \u0E41\u0E25\u0E30\u0E17\u0E33\u0E43\u0E2B\u0E49\u0E17\u0E35\u0E21 IPD \u0E02\u0E32\u0E14\u0E01\u0E32\u0E23\u0E2A\u0E19\u0E31\u0E1A\u0E2A\u0E19\u0E38\u0E19\u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 peak`,
    ...
    color: "#10b981",
    situation: `${d} \u0E21\u0E35\u0E1C\u0E25\u0E07\u0E32\u0E19\u0E23\u0E2D\u0E1A\u0E14\u0E49\u0E32\u0E19 \u2014 \u0E20\u0E32\u0E23\u0E30\u0E07\u0E32\u0E19\u0E40\u0E2B\u0E21\u0E32\u0E30\u0E2A\u0E21 (${Math.round(m)} \u0E23\u0E32\u0E22/\u0E27\u0E31\u0E19) \xB7 Orders/Visit \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C (${h}) \xB7 Revenue/Visit \u0E43\u0E01\u0E25\u0E49\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07 (\u0E3F${r(p)}) \xB7 \u0E40\u0E2B\u0E21\u0E32\u0E30\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A\u0E40\u0E1B\u0E47\u0E19 Role Model \u0E41\u0E25\u0E30\u0E0A\u0E48\u0E27\u0E22\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E17\u0E35\u0E21\u0E41\u0E1E\u0E17\u0E22\u0E4C`,
...
function p0(E) {
  ...
  const p = o.map(i => i.total_visits || 0),
    ...
    Q = N[0],
    e = N[N.length - 1],
    n = Math.round(U(d.filter(i => i > 0))),
    v = Number(U($.filter(i => i > 0)).toFixed(2)),
...
function c0(E) {
  ...
  const h = o > 0 ? Math.round(m / o) : 0,
    ...
    I = [...t].sort((s, _) => (_.opd_visits || 0) - (s.opd_visits || 0))[0],
    ...
    b = Math.round(q(t.map(s => s.opd_visits || 0)) * 100),
  ...
  let R, O;
  p > 30 ? (R = `\u26A0 \u0E20\u0E32\u0E23\u0E30\u0E17\u0E31\u0E19\u0E15\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E2A\u0E39\u0E07 \u2014 ${o} \u0E17\u0E48\u0E32\u0E19 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${p} \u0E40\u0E04\u0E2A/\u0E27\u0E31\u0E19/\u0E17\u0E48\u0E32\u0E19 (\u0E40\u0E01\u0E34\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 20-30 \u0E40\u0E04\u0E2A) \xB7 \u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07 Burnout`, O = "#f43f5e") : W > 35 ? (R = `\u26A0 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E1E\u0E36\u0E48\u0E07\u0E1E\u0E32 Top 1 \u0E2A\u0E39\u0E07 \u2014 ${B.name} = ${W}% \u0E02\u0E2D\u0E07\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E17\u0E31\u0E19\u0E15\u0E01\u0E23\u0E23\u0E21 \xB7 \u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E2B\u0E32\u0E01\u0E25\u0E32\u0E2D\u0E2D\u0E01/\u0E25\u0E32\u0E1B\u0E48\u0E27\u0E22`, O = "#f59e0b") : j < 60 && c >= 3 ? (R = `\u26A0 Utilization \u0E17\u0E31\u0E19\u0E15\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E15\u0E48\u0E33 \u2014 ${o}/${c} \u0E17\u0E48\u0E32\u0E19 (${j}%) \u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E07\u0E32\u0E19 \xB7 \u0E1E\u0E34\u0E08\u0E32\u0E23\u0E13\u0E32 rebalance \u0E15\u0E32\u0E23\u0E32\u0E07\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01`, O = "#f59e0b") : (R = `\u2713 \u0E17\u0E31\u0E19\u0E15\u0E41\u0E1E\u0E17\u0E22\u0E4C ${o}/${c} \u0E17\u0E48\u0E32\u0E19 \xB7 ${r(m)} \u0E40\u0E04\u0E2A \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${h} \u0E40\u0E04\u0E2A/\u0E17\u0E48\u0E32\u0E19 \xB7 Gini ${b}/100 \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E23\u0E27\u0E21 \u0E3F${r(Math.round(A))}`, O = "#10b981");
  const K = [{
    icon: "\u{1F9B7}",
    title: "1. \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E20\u0E32\u0E23\u0E30\u0E07\u0E32\u0E19\u0E17\u0E31\u0E19\u0E15\u0E01\u0E23\u0E23\u0E21",
    list: [`**\u0E17\u0E31\u0E19\u0E15\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E07\u0E32\u0E19** ${o}/${c} \u0E17\u0E48\u0E32\u0E19 (${j}% \u0E02\u0E2D\u0E07 roster) \u0E43\u0E19\u0E0A\u0E48\u0E27\u0E07 ${g} \u0E27\u0E31\u0E19`, `**\u0E04\u0E48\u0E32\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22** ${h} \u0E40\u0E04\u0E2A/\u0E17\u0E48\u0E32\u0E19 \xB7 **\u0E04\u0E48\u0E32\u0E01\u0E25\u0E32\u0E07** ${$} \u0E40\u0E04\u0E2A/\u0E17\u0E48\u0E32\u0E19 \xB7 **\u0E2A\u0E39\u0E07\u0E2A\u0E38\u0E14** ${r(d)} (${I?.name||"\u2014"}) \xB7 **\u0E15\u0E48\u0E33\u0E2A\u0E38\u0E14** ${r(F)}`, `**\u0E20\u0E32\u0E23\u0E30\u0E23\u0E32\u0E22\u0E27\u0E31\u0E19** \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${p} \u0E40\u0E04\u0E2A/\u0E27\u0E31\u0E19/\u0E17\u0E48\u0E32\u0E19 ${p>30?"\u26A0 \u0E2A\u0E39\u0E07\u0E01\u0E27\u0E48\u0E32\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 20-30 \u0E40\u0E04\u0E2A/\u0E27\u0E31\u0E19 \u2014 \u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07 Burnout":p>20?"\xB7 \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19":"\xB7 \u0E22\u0E31\u0E07\u0E23\u0E31\u0E1A\u0E44\u0E14\u0E49 \u0E21\u0E35\u0E1E\u0E37\u0E49\u0E19\u0E17\u0E35\u0E48\u0E02\u0E22\u0E32\u0E22\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23"}`, `**\u0E0A\u0E48\u0E2D\u0E07\u0E27\u0E48\u0E32\u0E07\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E17\u0E48\u0E32\u0E19** = ${F>0?Math.round(d/Math.max(1,F)):d>0?"\u2014":"1"} \u0E40\u0E17\u0E48\u0E32 ${d>0&&F>0&&d/F>5?"\xB7 \u26A0 \u0E0A\u0E48\u0E2D\u0E07\u0E27\u0E48\u0E32\u0E07\u0E01\u0E27\u0E49\u0E32\u0E07 \u0E04\u0E27\u0E23\u0E17\u0E1A\u0E17\u0E27\u0E19 Scheduling":"\xB7 \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E1B\u0E01\u0E15\u0E34"}`],
    color: p > 30 ? "#f43f5e" : p > 20 ? "#f59e0b" : "#10b981"
  }, {
    icon: "\u{1F4CA}",
    title: "2. \u0E01\u0E32\u0E23\u0E01\u0E23\u0E30\u0E08\u0E32\u0E22\u0E20\u0E32\u0E23\u0E30\u0E41\u0E25\u0E30\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 (Gini Analysis)",
    list: [`**Gini \u0E40\u0E04\u0E2A** = ${b}/100 \xB7 ${b>50?"\u26A0 \u0E40\u0E2B\u0E25\u0E37\u0E48\u0E2D\u0E21\u0E25\u0E49\u0E33\u0E2A\u0E39\u0E07 \u2014 Case \u0E42\u0E2B\u0E25\u0E14\u0E1E\u0E36\u0E48\u0E07\u0E1E\u0E32\u0E1A\u0E32\u0E07\u0E17\u0E48\u0E32\u0E19":b>35?"\u0E40\u0E2B\u0E25\u0E37\u0E48\u0E2D\u0E21\u0E25\u0E49\u0E33\u0E1B\u0E32\u0E19\u0E01\u0E25\u0E32\u0E07":"\u2713 \u0E01\u0E23\u0E30\u0E08\u0E32\u0E22\u0E2A\u0E21\u0E14\u0E38\u0E25"}`, `**Gini \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49** = ${w}/100 \xB7 ${w>50?"\u26A0 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E1E\u0E36\u0E48\u0E07\u0E1E\u0E32 Top \u0E19\u0E49\u0E2D\u0E22\u0E04\u0E19":w>35?"\u0E40\u0E2B\u0E25\u0E37\u0E48\u0E2D\u0E21\u0E25\u0E49\u0E33\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E1B\u0E32\u0E19\u0E01\u0E25\u0E32\u0E07":"\u2713 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E01\u0E23\u0E30\u0E08\u0E32\u0E22\u0E2A\u0E21\u0E14\u0E38\u0E25"}`, `**Top 1 (${B?.name||"\u2014"})** \u0E23\u0E31\u0E1A ${Math.round((I?.opd_visits||0)/Math.max(1,m)*100)}% \u0E02\u0E2D\u0E07\u0E40\u0E04\u0E2A \xB7 ${W}% \u0E02\u0E2D\u0E07\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49`, `**\u0E02\u0E49\u0E2D\u0E2A\u0E23\u0E38\u0E1B**: ${b>50||W>35?"\u0E01\u0E32\u0E23\u0E1E\u0E36\u0E48\u0E07\u0E1E\u0E32\u0E17\u0E31\u0E19\u0E15\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E01\u0E25\u0E38\u0E48\u0E21\u0E19\u0E49\u0E2D\u0E22\u0E2A\u0E39\u0E07 \u2014 \u0E04\u0E27\u0E23\u0E25\u0E07\u0E17\u0E38\u0E19 scheduling \u0E43\u0E2B\u0E21\u0E48\u0E41\u0E25\u0E30\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E17\u0E38\u0E01\u0E17\u0E48\u0E32\u0E19":"\u0E01\u0E32\u0E23\u0E01\u0E23\u0E30\u0E08\u0E32\u0E22\u0E20\u0E32\u0E23\u0E30\u0E41\u0E25\u0E30\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E40\u0E2B\u0E21\u0E32\u0E30\u0E2A\u0E21"}`],
    color: b > 50 || W > 35 ? "#f43f5e" : b > 35 ? "#f59e0b" : "#10b981"
  }, {
    icon: "\u{1F4B0}",
...
function h0() {
  const [E, t] = z.useState(null), [o, c] = z.useState(!0), [m, A] = z.useState(null), [g, h] = z.useState("today"), [p, I] = z.useState(1), [$, d] = z.useState(Y()), [F, B] = z.useState(Y()), [W, H] = z.useState("total_visits"), [b, w] = z.useState(() => new Set), [L, V] = z.useState(!1), [j, R] = z.useState(null), [O, K] = z.useState(() => new Set), [s, _] = z.useState(!1), J = z.useCallback(e => {
    w(n => {
      const v = new Set(n);
    ...
    try {
      const e = Y(),
        n = u0(new Date(Date.now() - 864e5)),
        v = (() => {
          const M = new Date;
          return M.setDate(1), u0(M)
        })();
      let x;
      switch (g) {
        case "today":
  ...
  const G = z.useMemo(() => E?.doctors ? [...E.doctors].sort((e, n) => (n[W] || 0) - (e[W] || 0)) : [], [E, W]),
    X = z.useMemo(() => G.length ? G.slice(0, 3).map(e => ({
    ...
    N = z.useMemo(() => {
      const e = (E?.dentists || []).slice().sort((n, v) => (v.opd_visits || 0) - (n.opd_visits || 0));
  ...
  return u.jsxs("div", {
    ...
    children: [u.jsxs("div", {
      ...
      const n = ["all_doctors", "doctors", "opd", "ipd", "gini", "top20", "revenue", "all_dentists", "dentists", "dentists", "dentists"],
        v = [];
      E.summary && E.summary.total_doctors !== void 0 && v.push({
        label: "\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14",
        value: r(E.summary.total_doctors || 0),
        sub: `active \u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A \xB7 \u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E07\u0E32\u0E19 ${E.summary.opd_doctors||0} \u0E17\u0E48\u0E32\u0E19`,
        color: "#1e40af"
      }), v.push(...e.kpi || []), E.summary && E.summary.dental_doctors !== void 0 && v.push({
      ...
      const x = v.slice(0, 7),
        ...
        T = (C, l, y) => u.jsxs("div", {
          ...
          tabIndex: 0,
          onKeyDown: S => {
            (S.key === "Enter" || S.key === " ") && (S.preventDefault(), R(n[y]))
          },
          style: {
            background: "var(--md-surface)",
            border: j === n[y] ? `2px solid ${C.color||"#7c3aed"}` : "1px solid var(--md-border)",
          ...
          children: [u.jsxs("div", {
            ...
            children: (() => {
              const C = {
                ...
                l = C[j] || C.doctors;
              let y = [...(l.dataKey ? E[l.dataKey] : E.doctors) || []];
              l.filter && (y = y.filter(l.filter)), y.sort((a, i) => l.asc ? (a[l.sortKey] || 0) - (i[l.sortKey] || 0) : (i[l.sortKey] || 0) - (a[l.sortKey] || 0)), l.limit && (y = y.slice(0, l.limit));
              const S = y.reduce((a, i) => a + (i[l.sortKey] || 0), 0),
                D = a => l.showCols.includes(a);
              return [u.jsxs("div", {
                style: {
                  padding: "16px 20px",
                ...
                children: y.length === 0 ? u.jsx("div", {
                  ...
                  children: [u.jsx("thead", {
                    ...
                    children: [...y.map((a, i) => {
                      const k = S > 0 ? Math.round((a[l.sortKey] || 0) / S * 100) : 0;
                      return u.jsxs("tr", {
                        style: {
                        ...
                        children: [u.jsx("td", {
                          ...
                          children: [a.name || a.code, a.position ? u.jsx("div", {
                            style: {
                              fontSize: "10px",
                              color: "var(--md-text-tertiary)",
                              fontWeight: 500
                          ...
                          children: r((a.lab_orders || 0) + (a.xray_orders || 0))
                        }), D("total") && u.jsx("td", {
                          style: {
                            padding: "8px 6px",
                            textAlign: "right",
                          ...
                          children: `\u0E3F${r(Math.round(a.opd_revenue||0))}`
                        }), D("ipdRev") && u.jsx("td", {
                          style: {
                            padding: "8px 6px",
                            textAlign: "right",
                          ...
                          children: `\u0E3F${r(Math.round(a.ipd_revenue||0))}`
                        }), D("rev") && u.jsx("td", {
                          style: {
                            padding: "8px 6px",
                            textAlign: "right",
                          ...
                          children: `\u0E3F${r(Math.round(a.total_revenue||0))}`
                        }), u.jsx("td", {
                          style: {
                            padding: "8px 6px",
                            textAlign: "right",
                      ...
                      children: [u.jsx("td", {
                        ...
                        children: r(y.reduce((a, i) => a + (i.opd_visits || 0), 0))
                      }), D("ipd") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: r(y.reduce((a, i) => a + (i.ipd_admissions || 0), 0))
                      }), D("orders") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: r(y.reduce((a, i) => a + ((i.lab_orders || 0) + (i.xray_orders || 0)), 0))
                      }), D("total") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: r(y.reduce((a, i) => a + (i.total_visits || 0), 0))
                      }), D("opdRev") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: `\u0E3F${r(Math.round(y.reduce((a,i)=>a+(i.opd_revenue||0),0)))}`
                      }), D("ipdRev") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: `\u0E3F${r(Math.round(y.reduce((a,i)=>a+(i.ipd_revenue||0),0)))}`
                      }), D("rev") && u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
                        ...
                        children: `\u0E3F${r(Math.round(y.reduce((a,i)=>a+(i.total_revenue||0),0)))}`
                      }), u.jsx("td", {
                        style: {
                          padding: "10px 6px",
                          textAlign: "right",
      ...
      children: [u.jsxs("div", {
        ...
        var e = Math.max.apply(null, X.map(function(f) {
          ...
          v = Math.max.apply(null, X.map(function(f) {
            return f.Orders || 0
          }).concat([1])),
          x = [{
        ...
        return u.jsx("div", {
          ...
          children: X.map(function(f, T) {
            var M = x[T] || x[2],
              C = (f.OPD || 0) + (f.IPD || 0),
              l = C > 0 ? ((f.Orders || 0) / C).toFixed(2) : "\u2014",
              y = (f.name || "").trim(),
              S = y.split(/\s+/),
              D = S.length >= 2 ? (S[0].charAt(0) || "") + (S[S.length - 1].charAt(0) || "") : y.slice(0, 2);
            D || (D = "\u2014");
            var a = [{
              label: "OPD",
              value: f.OPD || 0,
      ...
      children: [u.jsxs("div", {
        ...
        var e = Math.max.apply(null, N.map(function(x) {
          ...
          n = Math.max.apply(null, N.map(function(x) {
            return x.Orders || 0
          }).concat([1])),
          v = [{
            accent: "linear-gradient(135deg,#fbbf24,#f59e0b)",
        ...
        return u.jsx("div", {
          ...
          children: N.map(function(x, f) {
            var T = v[f] || v[2],
              ...
              l = (x.name || "").trim(),
              y = l.split(/\s+/),
              S = y.length >= 2 ? (y[0].charAt(0) || "") + (y[y.length - 1].charAt(0) || "") : l.slice(0, 2);
            S || (S = "\u2014");
            var D = [{
              label: "OPD",
              value: x.OPD || 0,
              ...
              children: [u.jsxs("div", {
                ...
                children: [u.jsxs("div", {
                  ...
                  children: D.map(function(a) {
                    var i = a.max > 0 ? Math.min(100, a.value / a.max * 100) : 0;
                    return u.jsxs("div", {
                      style: {
                        marginBottom: "12px"
                      },
                      children: [u.jsxs("div", {
                        ...
                        children: [u.jsx("span", {
                          ...
                          style: {
                            fontSize: "16px",
                            fontWeight: 800,
                            color: a.value > 0 ? a.color : "var(--md-text-tertiary)",
                            fontFeatureSettings: '"tnum"'
                          },
                          children: a.value
                        })]
      ...
      children: [u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
          children: [u.jsxs("div", {
            ...
            children: ["\u0E23\u0E32\u0E22\u0E01\u0E32\u0E23\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E41\u0E25\u0E30\u0E01\u0E34\u0E08\u0E01\u0E23\u0E23\u0E21 (", G.length, " \u0E17\u0E48\u0E32\u0E19)"]
          }), u.jsx("div", {
            style: {
              fontSize: "11px",
              fontWeight: 600,
          ...
          type: "button",
          onClick: () => {
            L ? (w(new Set), V(!1)) : (w(new Set(G.map(e => e.code))), V(!0))
          },
          style: {
            padding: "6px 14px",
            borderRadius: "8px",
        ...
        children: u.jsxs("table", {
          ...
          children: [u.jsx("thead", {
            ...
            children: G.map((e, n) => {
              const v = b.has(e.code),
                x = v ? r0(e, G, E.period?.days ? E.period.days : Math.max(1, Math.round((new Date(E.period.end) - new Date(E.period.start)) / 864e5) + 1)) : null;
              return u.jsxs(Z.Fragment, {
                children: [u.jsxs("tr", {
                  onClick: () => J(e.code),
                  style: {
                    borderBottom: "1px solid var(--md-divider)",
                    background: v ? "rgba(2,132,199,.05)" : n % 2 === 0 ? "transparent" : "rgba(0,0,0,.02)",
                    cursor: "pointer"
                  },
                  children: [u.jsx("td", {
                    style: {
      ...
      children: [u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
          ...
          type: "button",
          onClick: () => {
            s ? (K(new Set), _(!1)) : (K(new Set((E.dentists || []).map(e => e.code))), _(!0))
          },
          style: {
            padding: "6px 14px",
            borderRadius: "8px",
            ...
            children: [...E.dentists.map((e, n) => {
              ...
              return u.jsxs(Z.Fragment, {
                children: [u.jsxs("tr", {
                  ...
                  style: {
                    borderBottom: "1px solid var(--md-divider)",
                    background: v ? "rgba(6,182,212,.06)" : n % 2 === 0 ? "transparent" : "rgba(0,0,0,.02)",
                    cursor: "pointer"
                  },
                  children: [u.jsx("td", {
                    style: {
              ...
              children: [u.jsx("td", {
                ...
                children: (() => {
                  const e = E.dentists.reduce((v, x) => v + (x.opd_visits || 0), 0),
                    n = E.dentists.reduce((v, x) => v + (x.lab_orders || 0) + (x.xray_orders || 0), 0);
