...
var Oh = I(Tt => {
  ...
  Tt.ContextConsumer = Xa;
  Tt.ContextProvider = Va;
  Tt.Element = Il;
  Tt.ForwardRef = Ya;
  Tt.Fragment = Ha;
  Tt.Lazy = tu;
  ...
  Tt.isContextConsumer = function(t) {
    return Te(t) === Xa
  };
...
var Rv = I((v7, Nv) => {
  var lI = Ze(),
    ...
    It = {};
  It[TI] = It[EI] = It[jI] = It[MI] = It[CI] = It[II] = It[kI] = It[DI] = It[NI] = !0;
  It[pI] = It[dI] = It[_I] = It[mI] = It[PI] = It[hI] = It[yI] = It[vI] = It[gI] = It[bI] = It[xI] = It[wI] = It[OI] = It[SI] = It[AI] = !1;

  function RI(t) {
    return fI(t) && cI(t.length) && !!It[lI(t)]
  }
  Nv.exports = RI
});
var qc = I((g7, Lv) => {
...
var Zv = I((A7, Yv) => {
  var i2 = Gv(),
    o2 = Xv(),
    a2 = Object.prototype,
    u2 = a2.hasOwnProperty;

  function s2(t) {
    if (!i2(t)) return o2(t);
    var e = [];
    for (var r in Object(t)) u2.call(t, r) && r != "constructor" && e.push(r);
    return e
  }
  Yv.exports = s2
});
var Fn = I((_7, Jv) => {
  ...
  function f2(t) {
    return t != null && c2(t.length) && !l2(t)
  }
  Jv.exports = f2
});
var ao = I((P7, Qv) => {
...
var ig = I((E7, ng) => {
  var rg = eg(),
    x2 = 1,
    w2 = Object.prototype,
    O2 = w2.hasOwnProperty;

  function S2(t, e, r, n, i, o) {
    var a = r & x2,
      u = rg(t),
      s = u.length,
      l = rg(e),
    ...
    for (var c = s; c--;) {
      var p = u[c];
      if (!(a ? p in e : O2.call(e, p))) return !1
    }
    var d = o.get(t),
      y = o.get(e);
...
var Tg = I((D7, Pg) => {
  var Xc = Cc(),
    ...
    gu = "[object Object]",
    K2 = Object.prototype,
    _g = K2.hasOwnProperty;

  function V2(t, e, r, n, i, o) {
    var a = wg(t),
      u = wg(e),
      s = a ? Ag : xg(t),
      l = u ? Ag : xg(e);
    ...
    if (p && !f) return o || (o = new Xc), a || H2(t) ? F2(t, e, r, n, i, o) : $2(t, e, s, r, n, i, o);
    if (!(r & G2)) {
    ...
    return p ? (o || (o = new Xc), U2(t, e, r, n, i, o)) : !1
  }
  Pg.exports = V2
});
var bu = I((N7, Mg) => {
  ...
  function jg(t, e, r, n, i) {
    return t === e ? !0 : t == null || e == null || !Eg(t) && !Eg(e) ? t !== t && e !== e : X2(t, e, r, n, jg, i)
  }
  Mg.exports = jg
});
var Ig = I((R7, Cg) => {
  ...
  function tk(t, e, r, n) {
    ...
    for (; ++i < o;) {
      ...
      if (a && u[2]) {
        ...
        if (!(p === void 0 ? Z2(f, l, J2 | Q2, n, c) : p)) return !1
      }
    }
    return !0
  }
...
var Bg = I((W7, Lg) => {
  ...
  function ck(t) {
    var e = sk(t);
    return e.length == 1 && e[0][2] ? lk(e[0][0], e[0][1]) : function(r) {
      return r === t || uk(r, t, e)
    }
  }
  Lg.exports = ck
...
var Fg = I((F7, zg) => {
  ...
  function gk(t, e, r) {
    ...
    return o || ++n != i ? o : (i = t == null ? 0 : t.length, !!i && yk(i) && hk(a, i) && (mk(t) || dk(t)))
  }
  zg.exports = gk
});
var Ug = I(($7, $g) => {
...
var Gg = I((U7, Hg) => {
  ...
  function Ck(t, e) {
    return _k(t) && Pk(e) ? Tk(Ek(t), e) : function(r) {
      var n = Sk(r, t);
      return n === void 0 && n === e ? Ak(r, t) : Ok(e, n, jk | Mk)
    }
  }
  Hg.exports = Ck
});
...
var mr = I((X7, tb) => {
  ...
  function Gk(t) {
    return typeof t == "function" ? t : t == null ? $k : typeof t == "object" ? Uk(t) ? Fk(t[0], t[1]) : zk(t) : Hk(t)
  }
  tb.exports = Gk
});
var Jc = I((Y7, eb) => {
  ...
  (function(t) {
    ...
    var S = function() {
      ...
      return function(A, j, E, D) {
        var L, G, Z, J, it, gt, K, ct, tt, $, St, Q, bt, Mt, qt, pe, V, ie, oe = A.constructor,
          qe = A.s == j.s ? 1 : -1,
          R = A.d,
          rt = j.d;
        if (!A.s) return new oe(A);
        if (!j.s) throw Error(i + "Division by zero");
        for (G = A.e - j.e, V = rt.length, qt = R.length, K = new oe(qe), ct = K.d = [], Z = 0; rt[Z] == (R[Z] || 0);) ++Z;
        if (rt[Z] > (R[Z] || 0) && --G, E == null ? Q = E = oe.precision : D ? Q = E + (h(A) - h(j)) + 1 : Q = E, Q < 0) return new oe(0);
        if (Q = Q / p + 2 | 0, Z = 0, V == 1)
          for (J = 0, rt = rt[0], Q++;
            (Z < qt || J) && Q--; Z++) bt = J * c + (R[Z] || 0), ct[Z] = bt / rt | 0, J = bt % rt | 0;
        else {
          for (J = c / (rt[0] + 1) | 0, J > 1 && (rt = b(rt, J), R = b(R, J), V = rt.length, qt = R.length), Mt = V, tt = R.slice(0, V), $ = tt.length; $ < V;) tt[$++] = 0;
          ie = rt.slice(), ie.unshift(0), pe = rt[0], rt[1] >= c / 2 && ++pe;
          do J = 0, L = O(rt, tt, V, $), L < 0 ? (St = tt[0], V != $ && (St = St * c + (tt[1] || 0)), J = St / pe | 0, J > 1 ? (J >= c && (J = c - 1), it = b(rt, J), gt = it.length, $ = tt.length, L = O(it, tt, gt, $), L == 1 && (J--, T(it, V < gt ? ie : rt, gt))) : (J == 0 && (L = J = 1), it = rt.slice()), gt = it.length, gt < $ && it.unshift(0), T(tt, it, $), L == -1 && ($ = tt.length, L = O(rt, tt, V, $), L < 1 && (J++, T(tt, V < $ ? ie : rt, $))), $ = tt.length) : L === 0 && (J++, tt = [0]), ct[Z++] = J, L && tt[0] ? tt[$++] = R[Mt] || 0 : (tt = [R[Mt]], $ = 1); while ((Mt++ < qt || tt[0] !== void 0) && Q--)
        }
...
var HO = I((get, UO) => {
  var f$ = Fc(),
    p$ = f$(Object.getPrototypeOf, Object);
  UO.exports = p$
});
var VO = I((bet, KO) => {
  var d$ = Ze(),
  ...
  function w$(t) {
    if (!h$(t) || d$(t) != y$) return !1;
    var e = m$(t);
    if (e === null) return !0;
    var r = b$.call(e, "constructor") && e.constructor;
    return typeof r == "function" && r instanceof r && GO.call(r) == x$
  }
  KO.exports = w$
});
var YO = I((xet, XO) => {
...
var pS = I((Det, fS) => {
  ...
  function r8(t, e, r, n) {
    for (var i = -1, o = e8(t8((e - t) / (r || 1)), 0), a = Array(o); o--;) a[n ? o : ++i] = t, t += r;
    return a
  }
  fS.exports = r8
});
...
var yS = I((Ret, hS) => {
  ...
  function s8(t) {
    return function(e, r, n) {
      return n && typeof n != "number" && u8(e, r, n) && (r = n = void 0), e = Yp(e), r === void 0 ? (r = e, e = 0) : r = Yp(r), n = n === void 0 ? e < r ? 1 : -1 : Yp(n), a8(e, r, n, t)
    }
  }
  hS.exports = s8
});
...
var CS = I((Yet, MS) => {
  ...
  function C8(t, e, r) {
    var n = j8(t) ? P8 : E8;
    return r && M8(t, e, r) && (e = void 0), n(t, T8(e, 3))
  }
  MS.exports = C8
});
var DS = I((Jet, kS) => {
...
var RS = I((Qet, NS) => {
  ...
  function R8(t, e) {
    var r = {};
    return e = N8(e, 3), D8(t, function(n, i, o) {
      k8(r, i, e(n, i, o))
    }), r
  }
  NS.exports = R8
...
var ed = I((rrt, zS) => {
  ...
  function H8(t, e, r) {
    var n = $8(t) ? W8 : z8;
    return r && U8(t, e, r) && (e = void 0), n(t, F8(e, 3))
  }
  zS.exports = H8
});
var aA = I((Trt, oA) => {
...
var Tn = et(Ua()),
  ...
  ze = function(e, r) {
    ...
    if (!Y(e) && !(0, Tn.default)(e)) return n;
    var o;
    if (pr(e)) {
      var a = e.indexOf("%");
...
var Ih = function(e, r) {
  return Y(e) && Y(r) ? e - r : (0, Tn.default)(e) && (0, Tn.default)(r) ? e.localeCompare(r) : e instanceof Date && r instanceof Date ? e.getTime() - r.getTime() : String(e).localeCompare(String(r))
};
    ...
    return _D(e, t), wD(e, [{
      ...
      value: function(n, i) {
        var o = hr(hr({}, this.defaultProps), n.props),
          a = o.layout;
        return a === "vertical" && Y(n.props.height) ? {
...
function KN(t) {
  return Array.isArray(t) && Ct(t[0]) && Ct(t[1]) ? t.join(" ~ ") : t
}
var xx = function(e) {
  var r = e.separator,
    n = r === void 0 ? " : " : r,
        ...
        var N = {
          ...
          H = (p ? (0, gx.default)(f, p) : f).map(function(F, z) {
            ...
            return yr.createElement("li", {
              ...
              style: b
            }, Ct(E) ? yr.createElement("span", {
              className: "recharts-tooltip-item-name"
            }, E) : null, Ct(E) ? yr.createElement("span", {
...
function ZN(t) {
  var e = t.coordinate,
    r = t.translateX,
    n = t.translateY;
  return ut(co, _u(_u(_u(_u({}, "".concat(co, "-right"), Y(r) && e && Y(e.x) && r >= e.x), "".concat(co, "-left"), Y(r) && e && Y(e.x) && r < e.x), "".concat(co, "-bottom"), Y(n) && e && Y(e.y) && n >= e.y), "".concat(co, "-top"), Y(n) && e && Y(e.y) && n < e.y))
}
...
var m0 = /[ \f\n\r\t\v\u2028\u2029]+/,
  ...
  Yr = function(e) {
    ...
    if (c) {
      var F = S[0].width,
        z = w.width;
      H.push("scale(".concat((Y(z) ? z / F : 1) / F, ")"))
    }
...
Co.every = t => (t = Math.floor(t), !isFinite(t) || !(t > 0) ? null : t > 1 ? jt(e => {
...
var ni = jt(t => {
  ...
  bB = ii.range;
var vr = jt(t => t.setHours(0, 0, 0, 0), (t, e) => t.setDate(t.getDate() + e), (t, e) => (e - t - (e.getTimezoneOffset() - t.getTimezoneOffset()) * 6e4) / 864e5, t => t.getDate() - 1),
  xB = vr.range,
  ln = jt(t => {
...
be.every = t => !isFinite(t = Math.floor(t)) || !(t > 0) ? null : jt(e => {
...
xe.every = t => !isFinite(t = Math.floor(t)) || !(t > 0) ? null : jt(e => {
...
function Vf(t) {
  ...
  function g(K, ct) {
    return function(tt) {
      var $ = [],
        ...
        bt = K.length,
        Mt, qt, pe;
      for (tt instanceof Date || (tt = new Date(+tt)); ++St < bt;) K.charCodeAt(St) === 37 && ($.push(K.slice(Q, St)), (qt = bw[Mt = K.charAt(++St)]) != null ? Mt = K.charAt(++St) : qt = Mt === "e" ? " " : "0", (pe = ct[Mt]) && (Mt = pe(tt, qt)), $.push(Mt), Q = St + 1);
  ...
  function C(K, ct, tt, $) {
    for (var St = 0, Q = ct.length, bt = tt.length, Mt, qt; St < Q;) {
      if ($ >= bt) return -1;
      if (Mt = ct.charCodeAt(St++), Mt === 37) {
        if (Mt = ct.charAt(St++), qt = h[Mt in bw ? ct.charAt(St++) : Mt], !qt || ($ = qt(K, tt, $)) < 0) return -1
      } else if (Mt != tt.charCodeAt($++)) return -1
    }
    return $
  }
...
function Xt(t, e, r) {
  return (0, we.default)(t) || (0, we.default)(e) ? r : Ct(e) ? (0, gp.default)(t, e, r) : (0, pi.default)(e) ? e(t) : r
}
...
function di(t, e, r, n) {
  ...
  return a.map(function(u) {
    return Ct(u) || u instanceof Date ? u : ""
  })
}
var x1 = function(e) {
  ...
  S1 = function(e, r, n, i) {
    ...
    if (l) {
      var f = i || {},
        ...
        y = l.verticalAlign,
        m = l.layout;
      if ((m === "vertical" || m === "horizontal" && y === "middle") && d !== "center" && Y(e[d])) return Nt(Nt({}, e), {}, fi({}, d, e[d] + (c || 0)));
      if ((m === "horizontal" || m === "vertical" && d === "center") && y !== "middle" && Y(e[y])) return Nt(Nt({}, e), {}, fi({}, y, e[y] + (p || 0)))
    }
    return e
  },
  rz = function(e, r, n) {
  ...
  j1 = function(e, r) {
    if (!r || r.length !== 2 || !Y(r[0]) || !Y(r[1])) return e;
    var n = Math.min(r[0], r[1]),
      i = Math.max(r[0], r[1]),
      o = [e[0], e[1]];
    return (!Y(e[0]) || e[0] < n) && (o[0] = n), (!Y(e[1]) || e[1] > i) && (o[1] = i), o[0] > i && (o[0] = i), o[1] < n && (o[1] = n), o
  },
  nz = function(e) {
    var r = e.length;
    if (!(r <= 0))
...
var Sp = function(e) {
  ...
  uz = function(e) {
    return e.reduce(function(r, n) {
      return [(0, Ho.default)(n.concat([r[0]]).filter(Y)), (0, Uo.default)(n.concat([r[1]]).filter(Y))]
    }, [1 / 0, -1 / 0])
  },
  Ap = function(e, r, n) {
  ...
  Os = function(e, r, n) {
    ...
    var i = [];
    if (Y(e[0])) i[0] = n ? e[0] : Math.min(e[0], r[0]);
    else if (d1.test(e[0])) {
      var o = +d1.exec(e[0])[1];
      i[0] = r[0] - o
    } else(0, pi.default)(e[0]) ? i[0] = e[0](r[0]) : i[0] = r[0];
    if (Y(e[1])) i[1] = n ? e[1] : Math.max(e[1], r[1]);
    else if (m1.test(e[1])) {
      var a = +m1.exec(e[1])[1];
      i[1] = r[1] + a
...
var Mz = function(e) {
  ...
  Dz = function(e) {
    ...
    return o === "insideLeft" ? Ut({
      ...
      textAnchor: x,
      verticalAnchor: d
    }, _) : (0, jp.default)(o) && (Y(o.x) || pr(o.x)) && (Y(o.y) || pr(o.y)) ? Ut({
      x: u + ze(o.x, l),
      y: s + ze(o.y, f),
      textAnchor: "end",
      verticalAnchor: "end"
...
var L1 = function(e) {
  ...
  Rz = function(e, r) {
    return e ? e === !0 ? ur.createElement(Bt, {
      ...
      content: e,
      viewBox: r
    }) : (0, jp.default)(e) ? ur.createElement(Bt, Yo({
      viewBox: r
    }, e, {
      key: "label-implicit"
    })) : null : null
...
function sr(t) {
  ...
  return !i || !i.length ? null : hi.createElement(xt, {
    ...
    return hi.createElement(Bt, Ps({}, st(f, !0), l, d, {
      parentViewBox: f.parentViewBox,
      value: p,
      textBreakAll: s,
      viewBox: Bt.parseViewBox((0, _s.default)(a) ? f : z1(z1({}, f), {}, {
        clockWise: a
      })),
      key: "label-".concat(c),
      index: c
...
var Z1 = {
  ...
  fF = function(e) {
    ...
    return u === "vertical" && Y(a) ? p = kn().y(ra).x1(ea).x0(a) : Y(a) ? p = kn().x(ea).y1(ra).y0(a) : p = Qi().x(ea).y(ra), p.defined(js).curve(f), p(c)
  },
  ia = function(e) {
    var r = e.className,
      n = e.points,
...
import l$ from "./react-shim-eraudit.js";
...
var c$ = function(e, r, n, i, o, a) {
  ...
  $O = function(e) {
    ...
    return !Y(n) || !Y(o) || !Y(c) || !Y(d) || !Y(u) || !Y(l) ? null : l$.createElement("path", Vp({}, st(v, !0), {
...
var B$ = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
...
function nS(t) {
  ...
  switch (e) {
    ...
    case "sector":
      return hn.createElement(Es, r);
    case "symbols":
      if (G$(e, r)) return hn.createElement(eo, r);
      break;
    default:
      return null
  }
...
function Z$(t, e) {
  var r;
  return ha(t, e) ? r = V$ : ya(t, e) ? r = X$ : xi(t, e) && (r = Y$), r
}
...
var d8 = ["Webkit", "Moz", "O", "ms"],
  wS = function(e, r) {
    if (!e) return null;
    var n = e.replace(/(\w)/, function(o) {
        return o.toUpperCase()
      }),
      i = d8.reduce(function(o, a) {
...
function y8(t, e, r) {
  return e = Fs(e), v8(t, _S() ? Reflect.construct(e, r || [], Fs(t).constructor) : e.apply(t, r))
}
...
var S8 = function(e) {
  ...
  yn = function(t) {
    function e(r) {
      var n;
      return m8(this, e), n = y8(this, e, [r]), Se(n, "handleDrag", function(i) {
    ...
    return b8(e, t), h8(e, [{
      ...
      value: function() {
        ...
        if (!i || !i.length || !Y(u) || !Y(s) || !Y(l) || !Y(f) || l <= 0 || f <= 0) return null;
...
var XS = et(Ro()),
  YS = et(Pe());
import J8 from "./react-shim-eraudit.js";
var G8 = ["x", "y"];
...
function K8(t, e, r) {
  return e = V8(e), e in t ? Object.defineProperty(t, e, {
    value: r,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function $6(t) {
  ...
  }, z6(a, B), Bt.renderCallByParent(t, rA({
    x1: P,
    y1: h,
    x2: _,
    y2: C
...
function Pa(t, e, r) {
  ...
  if (Y(s) || se.isSsr) return XA(i, typeof s == "number" && Y(s) ? s : 0);
  var p = [],
  ...
  return xU(e, t), yU(e, [{
    ...
    value: function(n) {
      var i = this.props,
        ...
        d, y, m, v, x, w, S = c ? -1 : 1,
        P = n.tickSize || f,
        h = Y(n.tickCoord) ? n.tickCoord : n.coordinate;
      switch (l) {
        case "top":
...
function Ta(t) {
  var e, r, n, i, o, a, u = Ai(),
    ...
    f = ee(ee({}, t), {}, {
      ...
      x: Y(t.x) ? t.x : l.left,
      y: Y(t.y) ? t.y : l.top,
      width: Y(t.width) ? t.width : l.width,
      height: Y(t.height) ? t.height : l.height
    }),
    c = f.x,
    p = f.y,
    d = f.width,
    ...
    w = SA(),
    S = AA();
  if (!Y(d) || d <= 0 || !Y(y) || y <= 0 || !Y(c) || c !== +c || !Y(p) || p !== +p) return null;
...
var ll = function(e, r, n, i, o) {
  ...
  if (s.length && (p = s.reduce(function(m, v) {
      if (v.props[f] === n && he(v.props, "extendDomain") && Y(v.props[c])) {
        var x = v.props[c];
    ...
    p = l.reduce(function(m, v) {
      if (v.props[f] === n && he(v.props, "extendDomain") && Y(v.props[d]) && Y(v.props[y])) {
        var x = v.props[d],
          w = v.props[y];
  ...
  return o && o.length && (p = o.reduce(function(m, v) {
    return Y(v) ? [Math.min(m[0], v), Math.max(m[1], v)] : m
  }, p)), p
};
var A_ = et(S_()),
  fl = new A_.default;
...
var X5 = function(e, r) {
  ...
  gl = function(e, r) {
    ...
    return a.length > 0 ? a : e && e.length && Y(i) && Y(o) ? e.slice(i, o + 1) : []
  };
        ...
        return S.forEach(function(A, j) {
          var E = gl(x.data, {
            ...
            gt = s.reduce(function(oe, qe) {
              ...
              var vt = at[mt];
              return U(U({}, oe), {}, ft(ft({}, qe.axisType, vt), "".concat(qe.axisType, "Ticks"), Oe(vt)))
            }, it),
            K = gt[b],
          ...
          if ($) {
            var Mt, qt, pe = (0, qi.default)(G) ? H : G,
              V = (Mt = (qt = mi(K, ct, !0)) !== null && qt !== void 0 ? qt : pe) !== null && Mt !== void 0 ? Mt : 0;
            Q = O1({
              barGap: W,
              barCategoryGap: N,
              bandSize: V !== St ? V : St,
        ...
        function x(w) {
          ...
          return D5(this, x), h = R5(this, x, [w]), ft(h, "eventEmitterSymbol", Symbol("rechartsEventEmitter")), ft(h, "accessibilityManager", new T_), ft(h, "handleLegendBBoxUpdate", function(g) {
            ...
            return Xe(g, {
              ...
              data: k,
              x: Y(g.props.x) ? g.props.x : W.left,
              y: Y(g.props.y) ? g.props.y : W.top + W.height + W.brushBottom - (C.bottom || 0),
              width: Y(g.props.width) ? g.props.width : W.width,
              startIndex: N,
              endIndex: H,
            ...
            if (it)
              if (F >= 0) {
                ...
                var bt, Mt = (bt = h.getItemByXY(h.state.activeCoordinate)) !== null && bt !== void 0 ? bt : {
                    graphicalItem: K
                  },
                  qt = Mt.graphicalItem,
                  pe = qt.item,
...
`),
        ...
        Dt = URL.createObjectURL(vt),
        X = document.createElement("a");
      X.href = Dt, X.download = "BCH360_CustomerInsight_3FY.csv", X.click(), URL.revokeObjectURL(Dt)
    }, [t, Q]),
    pe = Be(async () => {
      if (!t?.payers || Q.length < 3) return;
      ...
      let mt = t.payers.map(ht => {
          let yt = [ht.pttype_code, ht.pttype_name];
          for (let Pt of Q) {
            let Et = ht.fys[Pt.be];
            yt.push(Et.opd_visits + Et.ipd_admissions, Et.total_income, Et.total_paid, Et.total_outstanding, Et.collection_rate)
          }
          return yt.push(ht.income_growth), yt
        }),
        vt = R.utils.aoa_to_sheet([at, ...mt]);
      vt["!cols"] = at.map(ht => ({
        wch: Math.min(Math.max(ht.length + 4, 12), 28)
      })), R.utils.book_append_sheet(rt, vt, "\u0E2A\u0E23\u0E38\u0E1B\u0E2A\u0E34\u0E17\u0E18\u0E34 3 \u0E1B\u0E35\u0E07\u0E1A");
      let Dt = Q[2].be,
        X = ["\u0E23\u0E2B\u0E31\u0E2A\u0E2A\u0E34\u0E17\u0E18\u0E34", "\u0E0A\u0E37\u0E48\u0E2D\u0E2A\u0E34\u0E17\u0E18\u0E34", "\u0E23\u0E27\u0E21\u0E23\u0E32\u0E22\u0E44\u0E14\u0E49", "\u0E04\u0E48\u0E32\u0E22\u0E32", "\u0E04\u0E48\u0E32 Lab", "\u0E04\u0E48\u0E32 Xray", "% \u0E22\u0E32", "% Lab", "% Xray"],
        ot = t.payers.map(ht => {
          let yt = ht.fys[Dt],
            Pt = yt.total_income || 0;
          return [ht.pttype_code, ht.pttype_name, Pt, yt.opd_drug || 0, yt.opd_lab || 0, yt.opd_xray || 0, Pt > 0 ? Math.round(yt.opd_drug / Pt * 1e3) / 10 : 0, Pt > 0 ? Math.round(yt.opd_lab / Pt * 1e3) / 10 : 0, Pt > 0 ? Math.round(yt.opd_xray / Pt * 1e3) / 10 : 0]
        }),
        lt = R.utils.aoa_to_sheet([X, ...ot]);
      if (lt["!cols"] = X.map(ht => ({
          wch: Math.min(Math.max(ht.length + 4, 12), 28)
        })), R.utils.book_append_sheet(rt, lt, `Service Mix ${Dt}`), r?.comparison) {
        let ht = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", ...Q.map(Et => `${Et.be} \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49`), ...Q.map(Et => `${Et.be} \u0E04\u0E23\u0E31\u0E49\u0E07`)],
          yt = r.comparison.map(Et => {
            let zt = [Et.month];
            for (let qr of Q) zt.push(Et[`fy${qr.be}`]?.income || 0);
            for (let qr of Q) zt.push(Et[`fy${qr.be}`]?.visits || 0);
            return zt
          }),
          Pt = R.utils.aoa_to_sheet([ht, ...yt]);
        Pt["!cols"] = ht.map(Et => ({
          wch: 14
        })), R.utils.book_append_sheet(rt, Pt, "\u0E41\u0E19\u0E27\u0E42\u0E19\u0E49\u0E21\u0E23\u0E32\u0E22\u0E40\u0E14\u0E37\u0E2D\u0E19")
      }
      if (s?.payers) {
        let ht = ["\u0E23\u0E2B\u0E31\u0E2A\u0E2A\u0E34\u0E17\u0E18\u0E34", "\u0E0A\u0E37\u0E48\u0E2D\u0E2A\u0E34\u0E17\u0E18\u0E34", ...Ol, "\u0E23\u0E27\u0E21\u0E04\u0E49\u0E32\u0E07\u0E0A\u0E33\u0E23\u0E30"],
          yt = s.payers.map(zt => [zt.pttype_code, zt.pttype_name, ...wl.map(qr => zt[qr] || 0), zt.total_outstanding || 0]),
          Pt = s.grand_total || {};
        yt.push(["", "\u0E23\u0E27\u0E21\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14", ...wl.map(zt => Pt[zt] || 0), Pt.total_outstanding || 0]);
        let Et = R.utils.aoa_to_sheet([ht, ...yt]);
        Et["!cols"] = ht.map(zt => ({
          wch: Math.min(Math.max(zt.length + 4, 14), 24)
        })), R.utils.book_append_sheet(rt, Et, "Aging \u0E04\u0E49\u0E32\u0E07\u0E0A\u0E33\u0E23\u0E30")
      }
      let nt = [
    ...
    ie = ({
      ...
      let X = at[2],
        ot = at[1],
        lt = t?.months_elapsed || 12,
        nt = lt > 0 && lt < 12 ? Math.round(ot * lt / 12) : ot,
        pt = a4(X, nt),
        ht = Dt ? pt <= 0 ? "#059669" : "#dc2626" : pt >= 0 ? "#059669" : "#dc2626",
        yt = pt > 0 ? "\u25B2" : pt < 0 ? "\u25BC" : "\xB7";
      return q("div", {
        ...
        children: [q("div", {
          ...
          children: bt.map((Pt, Et) => q("span", {
            style: {
              color: Et === 2 ? vt : "var(--md-text-tertiary)"
            },
            children: [Pt, ": ", dt(at[Et])]
          }, Pt))
        }), ot > 0 && q("div", {
          style: {
            marginTop: "4px",
          ...
          children: [yt, " ", Math.abs(pt), "% vs \u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19", lt < 12 && q("span", {
            style: {
              marginLeft: "4px",
              fontWeight: 500,
              color: "var(--md-text-tertiary)"
            },
            children: ["(\u0E40\u0E17\u0E35\u0E22\u0E1A ", lt, " \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E41\u0E23\u0E01)"]
          })]
        })]
      })
    },
  ...
  return q("div", {
    ...
    children: [q("div", {
      ...
      let R = t.grand_totals,
        rt = X => Q.map(ot => R[ot.be]?.[X] || 0),
        at = t.months_elapsed || 12,
        mt = (X, ot) => {
          if (ot === 0) return null;
          let lt = X[Q[ot].be]?.total_income || 0,
            nt = X[Q[ot - 1].be]?.total_income || 0;
          if (ot === 2) {
        ...
        vt = (X, ot, lt) => {
          ...
          let nt = X > 0 ? "#059669" : X < 0 ? "#dc2626" : "var(--md-text-tertiary)",
            pt = X > 0 ? "\u25B2" : X < 0 ? "\u25BC" : "\xB7";
          return q("td", {
            style: {
              ...V.td,
            ...
            children: [pt, " ", Math.abs(X), "%"]
          }, `${ot}-d${lt}`)
        },
        Dt = (r?.comparison || []).map(X => {
          let ot = {
            month: X.month
          };
          for (let lt of Q) ot[`fy${lt.be}`] = X[`fy${lt.be}`]?.income || 0;
          return ot
        }).filter(X => Q.some(ot => X[`fy${ot.be}`] > 0));
      return q(La, {
        children: [q("div", {
          style: {
            display: "flex",
          ...
          children: [M(ie, {
            ...
            icon: "\u{1F4CA}",
            label: "\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E08\u0E31\u0E14\u0E40\u0E01\u0E47\u0E1A",
            values: Q.map(X => R[X.be]?.collection_rate || 0),
            unit: "%",
            accent: "#0284c7"
          }), M(ie, {
            icon: "\u{1F6A9}",
            label: "\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E15\u0E49\u0E2D\u0E07\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21",
            values: Q.map(X => t.flagged_count_per_fy?.[X.be] ?? (X.be === Q[2].be ? t.flagged_count : 0)),
            unit: "\u0E2A\u0E34\u0E17\u0E18\u0E34",
            accent: "#dc2626",
            reverse: !0
          })]
          ...
          children: [M("div", {
            ...
            children: q(Id, {
              ...
              children: [M(Ta, {
                ...
                tickFormatter: X => X >= 1e6 ? `${(X/1e6).toFixed(1)}M` : X >= 1e3 ? `${(X/1e3).toFixed(0)}K` : X
              }), M(de, {
                content: M(oe, {})
              }), M(ke, {
                wrapperStyle: {
              ...
              children: [q("thead", {
                children: [q("tr", {
                  ...
                  children: [M("th", {
                    ...
                    children: ["\u0E1B\u0E35\u0E07\u0E1A ", X.be, ot === 2 ? " (\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19)" : ""]
                  }, X.be)), M("th", {
                    rowSpan: 2,
                    style: {
                      ...V.th,
                  ...
                  children: Q.map((X, ot) => q(wn.Fragment, {
                    children: [M("th", {
                      style: {
                        ...V.th,
                        fontSize: "9px"
                ...
                children: A === "groups" ? (t.groups || []).map((X, ot) => {
                  let lt = X.flag_low_collection || X.flag_high_outstanding,
                    nt = Z(X.group_name),
                    pt = E.has(X.group_name),
                    ht = t.payers.filter(yt => yt.group_name === X.group_name);
                  return q(wn.Fragment, {
                    children: [q("tr", {
                      ...
                      children: [M("td", {
                        ...
                        children: q("span", {
                          ...
                          children: [M("span", {
                            ...
                            children: ["(", X.pttype_count, " pttype)"]
                          }), M("span", {
                            style: {
                              marginLeft: "auto",
                              fontSize: "10px",
                        ...
                        return q(wn.Fragment, {
                          children: [M("td", {
                            ...
                            children: dt(Et.opd_visits + Et.ipd_admissions)
                          }), M("td", {
                            style: {
                              ...V.td,
                              fontWeight: 800
                            },
                            children: dt(Et.total_income)
                          }), vt(zt, `gh${ot}`, Pt)]
                        }, yt.be)
                      }), M("td", {
                        style: {
                      ...
                      let Et = yt.flag_low_collection || yt.flag_high_outstanding;
                      return q("tr", {
                        style: {
                          background: Pt % 2 === 0 ? "transparent" : "var(--md-surface-2, rgba(0,0,0,.02))"
                        },
                        children: [q("td", {
                          style: {
                            ...V.tdName,
                  ...
                  return q("tr", {
                    ...
                    children: [M("td", {
                      ...
                      children: q("button", {
                        ...
                        children: [M("span", {
                          ...
                          style: {
                            ...
                            fontSize: "9px",
                            fontWeight: 700,
                            color: Z(X.group_name),
                            padding: "1px 6px",
                            borderRadius: "99px",
                            background: `${Z(X.group_name)}15`
                          },
                          children: X.group_name
                        })]
                      })
                      ...
                      return q(wn.Fragment, {
                        children: [M("td", {
                          style: V.td,
                          children: dt(yt.opd_visits + yt.ipd_admissions)
                        }), M("td", {
                          style: {
                            ...V.td,
                            fontWeight: 700
                          },
                          children: dt(yt.total_income)
                        }), vt(Pt, `p${ot}`, ht)]
                      }, pt.be)
                    }), M("td", {
                      style: {
      ...
      let rt = t.payers.filter(at => at._sort_income > 0).slice(0, 12).map(at => {
        ...
        for (let vt of Q) mt[`fy${vt.be}`] = at.fys[vt.be].total_income;
        return mt
      });
      return q(La, {
        children: [q("div", {
          ...
          children: t.payers.filter(at => at._sort_income > 0).slice(0, 20).map((at, mt) => {
            let vt = at.flag_low_collection || at.flag_high_outstanding,
              Dt = at.fys[Q[2].be];
            return q("div", {
              className: "rounded-2xl p-4",
              style: {
                background: "var(--md-surface)",
                border: vt ? "1.5px solid rgba(220,38,38,.3)" : "1px solid var(--md-border)"
              },
              children: [q("div", {
                style: {
                  display: "flex",
                ...
                return q("div", {
                  ...
                  children: [q("div", {
                    ...
                    children: [ot > 0 && M("div", {
                      ...
                      title: `\u{1F52C} \u0E04\u0E48\u0E32 Lab: ${dt(lt)} \u0E1A\u0E32\u0E17 (${yt.toFixed(1)}%)`
                    }), nt > 0 && M("div", {
                      style: {
                        width: `${Pt}%`,
                        background: Ui.xray
                      },
                      title: `\u2622\uFE0F \u0E04\u0E48\u0E32 X-ray: ${dt(nt)} \u0E1A\u0E32\u0E17 (${Pt.toFixed(1)}%)`
                    })]
                  }), q("div", {
                    style: {
                      display: "flex",
                    ...
                    children: [ot > 0 && q("span", {
                      ...
                      children: ["\u{1F52C} Lab ", yt.toFixed(0), "%"]
                    }), nt > 0 && q("span", {
                      style: {
                        color: Ui.xray
                      },
                      children: ["\u2622\uFE0F Xray ", Pt.toFixed(0), "%"]
                    })]
                  })]
                })
              })(), q("table", {
      ...
      let R = a.loyalty,
        ...
        mt = a.fiscal_year?.be,
        vt = rt.age_bands,
        Dt = vt.lt18 + vt.a18_34 + vt.a35_59 + vt.gte60,
        X = rt.sex.male + rt.sex.female,
        ot = R.total_unique - X,
            ...
            children: [R.map((mt, vt) => {
              ...
              return q("div", {
                ...
                children: [q("div", {
                  ...
                  children: Dt.map((X, ot) => {
                    if (X.v === 0) return null;
                    let lt = mt.total_outstanding > 0 ? X.v / mt.total_outstanding * 100 : 0;
                    return M("div", {
                      style: {
                        width: `${lt}%`,
                        background: X.color,
                      ...
                      title: `${X.label}: ${dt(X.v)} \u0E1A\u0E32\u0E17 (${lt.toFixed(1)}%)`,
