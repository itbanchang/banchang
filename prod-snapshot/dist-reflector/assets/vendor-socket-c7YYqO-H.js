...
const P = {
  ...
  Q = typeof Blob == "function" || typeof Blob < "u" && Object.prototype.toString.call(Blob) === "[object BlobConstructor]",
  j = typeof ArrayBuffer == "function",
  G = n => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(n) : n && n.buffer instanceof ArrayBuffer,
  V = ({
    type: n,
    data: e
  }, t, s) => Q && e instanceof Blob ? t ? s(e) : $(e, s) : j && (e instanceof ArrayBuffer || G(e)) ? t ? s(e) : $(new Blob([e]), s) : s(y[n] + (e || "")),
  $ = (n, e) => {
...
const fe = n => {
    ...
    const m = new ArrayBuffer(e),
      f = new Uint8Array(m);
    for (s = 0; s < t; s += 4) r = E[n.charCodeAt(s)], o = E[n.charCodeAt(s + 1)], a = E[n.charCodeAt(s + 2)], h = E[n.charCodeAt(s + 3)], f[i++] = r << 2 | o >> 4, f[i++] = (o & 15) << 4 | a >> 2, f[i++] = (a & 3) << 6 | h & 63;
    return m
  },
  le = typeof ArrayBuffer == "function",
  M = (n, e) => {
...
const C = typeof Promise == "function" && typeof Promise.resolve == "function" ? e => Promise.resolve().then(e) : (e, t) => t(e, 0),
...
const we = l.setTimeout,
  ve = l.clearTimeout;

function S(n, e) {
  e.useNativeTimers ? (n.setTimeoutFn = we.bind(l), n.clearTimeoutFn = ve.bind(l)) : (n.setTimeoutFn = l.setTimeout.bind(l), n.clearTimeoutFn = l.clearTimeout.bind(l))
}
const Ee = 1.33;

function ke(n) {
  return typeof n == "string" ? Te(n) : Math.ceil((n.byteLength || n.size) * Ee)
}

function Te(n) {
  let e = 0,
    t = 0;
  for (let s = 0, i = n.length; s < i; s++) e = n.charCodeAt(s), e < 128 ? t += 1 : e < 2048 ? t += 2 : e < 55296 || e >= 57344 ? t += 3 : (s++, t += 4);
  return t
}
...
class ie extends H {
  ...
  uri() {
    const e = this.opts.secure ? "https" : "http",
      t = this.query || {};
    return this.opts.timestampRequests !== !1 && (t[this.opts.timestampParam] = ne()), !this.supportsBinary && !t.sid && (t.b64 = 1), this.createUri(e, t)
  }
}
let re = !1;
try {
...
class d extends u {
  ...
  _cleanup(e) {
    if (!(typeof this._xhr > "u" || this._xhr === null)) {
      if (this._xhr.onreadystatechange = Se, e) try {
        this._xhr.abort()
      } catch {}
...
class Le extends H {
  ...
  doOpen() {
    const e = this.uri(),
      ...
      s = ae ? {} : se(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
  ...
  uri() {
    const e = this.opts.secure ? "wss" : "ws",
      t = this.query || {};
    return this.opts.timestampRequests && (t[this.opts.timestampParam] = ne()), this.supportsBinary || (t.b64 = 1), this.createUri(e, t)
  }
}
...
const De = {
  ...
  Ie = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
...
class _ extends u {
  ...
  _getWritablePackets() {
    ...
    for (let s = 0; s < this.writeBuffer.length; s++) {
      ...
      if (i && (t += ke(i)), s > 0 && t > this._maxPayload) return this.writeBuffer.slice(0, s);
      t += 2
    }
  ...
  _sendPacket(e, t, s, i) {
    if (typeof t == "function" && (i = t, t = void 0), typeof s == "function" && (i = s, s = null), this.readyState === "closing" || this.readyState === "closed") return;
  ...
  _onError(e) {
    if (_.priorWebsocketSuccess = !1, this.opts.tryAllTransports && this.transports.length > 1 && this.readyState === "opening") return this.transports.shift(), this._open();
        ...
        if (!s)
          if (g.type === "pong" && g.data === "probe") {
            ...
            _.priorWebsocketSuccess = t.name === "websocket", this.transport.pause(() => {
              s || this.readyState !== "closed" && (f(), this.setTransport(t), t.send([{
                type: "upgrade"
...
let He = class extends Me {
  constructor(e, t = {}) {
    ...
    (!s.transports || s.transports && typeof s.transports[0] == "string") && (s.transports = (s.transports || ["polling", "websocket", "webtransport"]).map(i => De[i]).filter(i => !!i)), super(e, s)
  }
};
class it extends ie {
  doPoll() {
    this._fetch().then(e => {
      if (!e.ok) return this.onError("fetch read error", e.status, e);
  ...
  doWrite(e, t) {
    this._fetch(e).then(s => {
      if (!s.ok) return this.onError("fetch write error", s.status, s);
      t()
    }).catch(s => {
  ...
  _fetch(e) {
    var t;
    const s = e !== void 0,
      i = new Headers(this.opts.extraHeaders);
    return s && i.set("content-type", "text/plain;charset=UTF-8"), (t = this.socket._cookieJar) === null || t === void 0 || t.appendCookies(i), fetch(this.uri(), {
      method: s ? "POST" : "GET",
      body: s ? e : null,
      headers: i,
...
const Ke = typeof ArrayBuffer == "function",
  $e = n => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(n) : n.buffer instanceof ArrayBuffer,
  ce = Object.prototype.toString,
  Ye = typeof Blob == "function" || typeof Blob < "u" && ce.call(Blob) === "[object BlobConstructor]",
  ze = typeof File == "function" || typeof File < "u" && ce.call(File) === "[object FileConstructor]";

function W(n) {
  return Ke && (n instanceof ArrayBuffer || $e(n)) || Ye && n instanceof Blob || ze && n instanceof File
}
...
function Je(n) {
  const e = [],
    t = n.data,
    s = n;
  return s.data = I(t, e), s.attachments = e.length, {
    packet: s,
    buffers: e
  }
}
...
const Qe = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"],
  je = 5;
var c;
(function(n) {
...
class K extends u {
  ...
  decodeString(e) {
    ...
    if (s.type === c.BINARY_EVENT || s.type === c.BINARY_ACK) {
      ...
      const a = Number(o);
      if (!et(a) || a < 0) throw new Error("Illegal attachments");
    ...
    if (e.charAt(++t)) {
      ...
      if (K.isPayloadValid(s.type, r)) s.data = r;
...
const et = Number.isInteger || function(n) {
...
class he extends u {
  ...
  subEvents() {
    if (this.subs) return;
    const e = this.io;
    this.subs = [p(e, "open", this.onopen.bind(this)), p(e, "packet", this.onpacket.bind(this)), p(e, "error", this.onerror.bind(this)), p(e, "close", this.onclose.bind(this))]
  }
  get active() {
    return !!this.subs
  }
  ...
  emit(e, ...t) {
    var s, i, r;
    if (st.hasOwnProperty(e)) throw new Error('"' + e.toString() + '" is a reserved event name');
    ...
    const a = (i = (s = this.io.engine) === null || s === void 0 ? void 0 : s.transport) === null || i === void 0 ? void 0 : i.writable,
      h = this.connected && !(!((r = this.io.engine) === null || r === void 0) && r._hasPingExpired());
...
class F extends u {
  constructor(e, t) {
    var s;
    super(), this.nsps = {}, this.subs = [], e && typeof e == "object" && (t = e, e = void 0), t = t || {}, t.path = t.path || "/socket.io", this.opts = t, S(this, t), this.reconnection(t.reconnection !== !1), this.reconnectionAttempts(t.reconnectionAttempts || 1 / 0), this.reconnectionDelay(t.reconnectionDelay || 1e3), this.reconnectionDelayMax(t.reconnectionDelayMax || 5e3), this.randomizationFactor((s = t.randomizationFactor) !== null && s !== void 0 ? s : .5), this.backoff = new b({
...
export {
  it as Fetch, F as Manager, Pe as NodeWebSocket, Ne as NodeXHR, he as Socket, Pe as WebSocket, qe as WebTransport, Ne as XHR, L as connect, L as
  default, L as io, je as protocol
};