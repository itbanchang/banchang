...
function Ue() {
  let [t, l] = P(null), [u, v] = P(!0), [f, x] = P(null), [g, w] = P(null), [b, N] = P(60), [q, H] = P(60), [F, L] = P(null), [Y, K] = P("today"), [O, W] = P(he()), [h, V] = P(B()), [J, Se] = P(!1), [Ye, Te] = P(0), [Ke, ke] = P(0), oe = be(async (a, s) => {
    v(!0), x(null);
    try {
  ...
  return r("div", {
    ...
    children: [r("div", {
      ...
      children: [e(p, {
        ...
        unit: "\u0E40\u0E15\u0E35\u0E22\u0E07",
        sub: `${i(n.ipd.active_beds)} \u0E08\u0E32\u0E01 ${i(ne)} \u0E40\u0E15\u0E35\u0E22\u0E07 \xB7 \u0E23\u0E31\u0E1A\u0E43\u0E2B\u0E21\u0E48 ${n.ipd.admits_today} \xB7 \u0E08\u0E33\u0E2B\u0E19\u0E48\u0E32\u0E22 ${n.ipd.discharges_today} (ไม่รวม Home Ward)`,
        color: d.amber,
        alert: S.ipdActive,
...
\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25 capacity: ${t.ipd_capacity?.total_beds?`\u0E08\u0E32\u0E01 ward table \xB7 ${t.ipd_capacity.ward_count} \u0E2B\u0E2D\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22 active`:"\u0E04\u0E48\u0E32\u0E40\u0E23\u0E34\u0E48\u0E21\u0E15\u0E49\u0E19 (\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25 ward)"}`
      ...
      children: [e(j, {
        ...
        children: [e(p, {
          icon: "\u{1F48A}",
          label: "\u0E40\u0E20\u0E2A\u0E31\u0E0A\u0E01\u0E23\u0E23\u0E21",
          value: i(n.service_lines.pharmacy_visits || n.service_lines.pharmacy || 0) + " visit / " + i(n.service_lines.pharmacy_revenue || n.service_lines.pharmacy || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E44\u0E14\u0E49\u0E22\u0E32",
          color: "#7c3aed",
          status: {
          ...
          value: i(n.service_lines.lab_visits || n.service_lines.lab || 0) + " visit / " + i(n.service_lines.lab_revenue || n.service_lines.lab || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "Lab orders",
          color: "#0284c7",
          status: {
          ...
          icon: "\u2622\uFE0F",
          label: "\u0E23\u0E31\u0E07\u0E2A\u0E35\u0E27\u0E34\u0E17\u0E22\u0E32",
          value: i(n.service_lines.xray_visits || n.service_lines.xray || 0) + " visit / " + i(n.service_lines.xray_revenue || n.service_lines.xray || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "X-ray \xB7 CT",
          color: "#059669",
          status: {
          ...
          icon: "\u{1F9B7}",
          label: "\u0E17\u0E31\u0E19\u0E15\u0E01\u0E23\u0E23\u0E21",
          value: i(n.service_lines.dental_visits || n.service_lines.dental || 0) + " visit / " + i(n.service_lines.dental_revenue || n.service_lines.dental || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01\u0E1F\u0E31\u0E19",
          color: "#f43f5e",
          status: {
          ...
          icon: "\u{1F3CB}\uFE0F",
          label: "\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E\u0E1A\u0E33\u0E1A\u0E31\u0E14",
          value: i(n.service_lines.pt_visits || n.service_lines.pt || 0) + " visit / " + i(n.service_lines.pt_revenue || n.service_lines.pt || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "PT \xB7 Rehab",
          color: "#d97706",
          status: {
          ...
          icon: "\u{1F33F}",
          label: "\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E41\u0E1C\u0E19\u0E44\u0E17\u0E22",
          value: i(n.service_lines.thaimed_visits || n.service_lines.thaimed || 0) + " visit / " + i(n.service_lines.thaimed_revenue || n.service_lines.thaimed || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "TM \xB7 \u0E19\u0E27\u0E14",
          color: "#16a34a",
          status: {
          ...
          value: i(n.service_lines.dept_140_visits || n.service_lines.dept_140 || 0) + " visit / " + i(n.service_lines.dept_140_revenue || n.service_lines.dept_140 || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          ...
          value: i(n.service_lines.dept_143_visits || n.service_lines.dept_143 || 0) + " visit / " + i(n.service_lines.dept_143_revenue || n.service_lines.dept_143 || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E",
          color: "#9333ea",
          status: {
          ...
          icon: "\u{1F3C3}",
          label: "PMC \u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E GC",
          value: i(n.service_lines.dept_145_visits || n.service_lines.dept_145 || 0) + " visit / " + i(n.service_lines.dept_145_revenue || n.service_lines.dept_145 || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E GC",
          color: "#db2777",
          status: {
          ...
          icon: "\u{1FA78}",
          label: "\u0E44\u0E15\u0E40\u0E17\u0E35\u0E22\u0E21",
          value: i(n.service_lines.dept_040_visits || n.service_lines.dept_040 || 0) + " visit / " + i(n.service_lines.dept_040_revenue || n.service_lines.dept_040 || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "HD \xB7 \u0E0A\u0E31\u0E49\u0E19 2",
          color: "#dc2626",
          status: {
          ...
          icon: "\u{1F489}",
          label: "\u0E09\u0E35\u0E14\u0E22\u0E32\u0E17\u0E33\u0E41\u0E1C\u0E25",
          value: i(n.service_lines.dept_053_visits || n.service_lines.dept_053 || 0) + " visit / " + i(n.service_lines.dept_053_revenue || n.service_lines.dept_053 || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "\u0E2B\u0E49\u0E2D\u0E07\u0E09\u0E35\u0E14\u0E22\u0E32 5",
          color: "#ea580c",
          status: {
          ...
          icon: "\u{1F634}",
          label: "Sleep Test",
          value: i(n.service_lines.dept_130_visits || n.service_lines.dept_130 || 0) + " visit / " + i(n.service_lines.dept_130_revenue || n.service_lines.dept_130 || 0) + " \u0E1A\u0E32\u0E17",
          unit: "",
          sub: "\u0E15\u0E23\u0E27\u0E08\u0E01\u0E32\u0E23\u0E19\u0E2D\u0E19\u0E2B\u0E25\u0E31\u0E1A",
          color: "#6366f1",
          status: {
...
\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E0A\u0E48\u0E27\u0E07\u0E01\u0E48\u0E2D\u0E19: Trauma ${i(M.er_trauma?.prior)} (${M.er_trauma?.delta_pct!=null?(M.er_trauma.delta_pct>=0?"+":"")+M.er_trauma.delta_pct+"%":"\u2014"})`
      ...
      children: [e(p, {
        icon: "\u{1F48A}",
        label: "\u0E40\u0E20\u0E2A\u0E31\u0E0A\u0E01\u0E23\u0E23\u0E21",
        value: i(c.service_lines.pharmacy_visits || c.service_lines.pharmacy || 0) + " visit / " + i(c.service_lines.pharmacy_revenue || c.service_lines.pharmacy || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "\u0E22\u0E32 \xB7 Generic",
        color: "#7c3aed"
      }), e(p, {
        icon: "\u{1F52C}",
        label: "\u0E2B\u0E49\u0E2D\u0E07\u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E01\u0E32\u0E23",
        value: i(c.service_lines.lab_visits || c.service_lines.lab || 0) + " visit / " + i(c.service_lines.lab_revenue || c.service_lines.lab || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "Lab orders",
        color: "#0284c7"
      }), e(p, {
        icon: "\u2622\uFE0F",
        label: "\u0E23\u0E31\u0E07\u0E2A\u0E35\u0E27\u0E34\u0E17\u0E22\u0E32",
        value: i(c.service_lines.xray_visits || c.service_lines.xray || 0) + " visit / " + i(c.service_lines.xray_revenue || c.service_lines.xray || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "X-ray \xB7 CT",
        color: "#059669"
      }), e(p, {
        icon: "\u{1F9B7}",
        label: "\u0E17\u0E31\u0E19\u0E15\u0E01\u0E23\u0E23\u0E21",
        value: i(c.service_lines.dental_visits || c.service_lines.dental || 0) + " visit / " + i(c.service_lines.dental_revenue || c.service_lines.dental || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "DPI",
        color: "#f43f5e"
      }), e(p, {
        icon: "\u{1F3CB}\uFE0F",
        label: "\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E\u0E1A\u0E33\u0E1A\u0E31\u0E14",
        value: i(c.service_lines.pt_visits || c.service_lines.pt || 0) + " visit / " + i(c.service_lines.pt_revenue || c.service_lines.pt || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "PT \xB7 Rehab",
        color: "#d97706"
      }), e(p, {
        icon: "\u{1F33F}",
        label: "\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E41\u0E1C\u0E19\u0E44\u0E17\u0E22",
        value: i(c.service_lines.thaimed_visits || c.service_lines.thaimed || 0) + " visit / " + i(c.service_lines.thaimed_revenue || c.service_lines.thaimed || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "TM \xB7 \u0E19\u0E27\u0E14",
        color: "#16a34a"
      }), e(p, {
        icon: "\u{1F4BC}",
        label: "PMC \u0E2D\u0E2D\u0E1F\u0E1F\u0E34\u0E28\u0E0B\u0E34\u0E19\u0E42\u0E14\u0E23\u0E21",
        value: i(c.service_lines.dept_140_visits || c.service_lines.dept_140 || 0) + " visit / " + i(c.service_lines.dept_140_revenue || c.service_lines.dept_140 || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "\u0E28\u0E39\u0E19\u0E22\u0E4C\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E02\u0E49\u0E32\u0E23\u0E32\u0E0A\u0E01\u0E32\u0E23",
        color: "#0891b2"
      }), e(p, {
        icon: "\u{1F9B4}",
        label: "PMC \u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E\u0E1A\u0E49\u0E32\u0E19\u0E09\u0E32\u0E07",
        value: i(c.service_lines.dept_143_visits || c.service_lines.dept_143 || 0) + " visit / " + i(c.service_lines.dept_143_revenue || c.service_lines.dept_143 || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E",
        color: "#9333ea"
      }), e(p, {
        icon: "\u{1F3C3}",
        label: "PMC \u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E GC",
        value: i(c.service_lines.dept_145_visits || c.service_lines.dept_145 || 0) + " visit / " + i(c.service_lines.dept_145_revenue || c.service_lines.dept_145 || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "\u0E04\u0E25\u0E34\u0E19\u0E34\u0E01\u0E01\u0E32\u0E22\u0E20\u0E32\u0E1E GC",
        color: "#db2777"
      }), e(p, {
        icon: "\u{1FA78}",
        label: "\u0E44\u0E15\u0E40\u0E17\u0E35\u0E22\u0E21",
        value: i(c.service_lines.dept_040_visits || c.service_lines.dept_040 || 0) + " visit / " + i(c.service_lines.dept_040_revenue || c.service_lines.dept_040 || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "HD \xB7 \u0E0A\u0E31\u0E49\u0E19 2",
        color: "#dc2626"
      }), e(p, {
        icon: "\u{1F489}",
        label: "\u0E09\u0E35\u0E14\u0E22\u0E32\u0E17\u0E33\u0E41\u0E1C\u0E25",
        value: i(c.service_lines.dept_053_visits || c.service_lines.dept_053 || 0) + " visit / " + i(c.service_lines.dept_053_revenue || c.service_lines.dept_053 || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "\u0E2B\u0E49\u0E2D\u0E07\u0E09\u0E35\u0E14\u0E22\u0E32 5",
        color: "#ea580c"
      }), e(p, {
        icon: "\u{1F634}",
        label: "Sleep Test",
        value: i(c.service_lines.dept_130_visits || c.service_lines.dept_130 || 0) + " visit / " + i(c.service_lines.dept_130_revenue || c.service_lines.dept_130 || 0) + " \u0E1A\u0E32\u0E17",
        unit: "",
        sub: "\u0E15\u0E23\u0E27\u0E08\u0E01\u0E32\u0E23\u0E19\u0E2D\u0E19\u0E2B\u0E25\u0E31\u0E1A",
        color: "#6366f1"
      })]
