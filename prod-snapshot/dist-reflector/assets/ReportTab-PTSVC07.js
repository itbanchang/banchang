...
function DE(s, m0, M, b0 = "OPD") {
  ...
  for (const J of $0) {
    ...
    H0.push({
      ...
      fy1Px: V0,
      fy2Px: Y0
    }), Eu > n0 && (n0 = Eu, y0 = J.month), Eu < W0 && (W0 = Eu, U0 = J.month)
  }
  let E0 = 0,
    fu = 0;
  if (H0.length >= 2) {
  ...
  const zu = Math.round(M0 / j0),
    h0 = `Run-rate \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ${n(zu)} \u0E1A\u0E32\u0E17/\u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 \u0E2B\u0E32\u0E01\u0E23\u0E31\u0E01\u0E29\u0E32\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E19\u0E35\u0E49\u0E44\u0E14\u0E49\u0E04\u0E23\u0E1A\u0E1B\u0E35 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${B.short} \u0E1B\u0E23\u0E30\u0E40\u0E21\u0E34\u0E19\u0E44\u0E27\u0E49\u0E17\u0E35\u0E48 ${n(cu)} \u0E1A\u0E32\u0E17 (\u0E40\u0E17\u0E35\u0E22\u0E1A FY${m0} annualized: ${n(yu)} \u0E1A\u0E32\u0E17 \xB7 ${Fu>=0?"\u0E1A\u0E27\u0E01":"\u0E25\u0E1A"} ${n(Math.abs(Fu))} \u0E1A\u0E32\u0E17)`,
  ...
  let ku;
  if (y0 && U0) {
    const J = Math.round(n0 - W0);
    ku = `\u0E40\u0E14\u0E37\u0E2D\u0E19 Peak: ${y0} (${n0>=0?"+":""}${Math.round(n0)}%) \xB7 \u0E40\u0E14\u0E37\u0E2D\u0E19 Dip: ${U0} (${W0>=0?"+":""}${Math.round(W0)}%) \xB7 Spread = ${J} percentage points. ` + (J >= 40 ? "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E2A\u0E39\u0E07 \u2014 \u0E0A\u0E48\u0E2D\u0E07\u0E27\u0E48\u0E32\u0E07\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E1E\u0E35\u0E04\u0E41\u0E25\u0E30\u0E14\u0E34\u0E1B\u0E21\u0E32\u0E01 \u0E15\u0E49\u0E2D\u0E07\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23 Staffing, Stock, Capacity \u0E41\u0E1A\u0E1A\u0E22\u0E37\u0E14\u0E2B\u0E22\u0E38\u0E48\u0E19" : J >= 20 ? "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E1B\u0E32\u0E19\u0E01\u0E25\u0E32\u0E07 \u2014 \u0E21\u0E35 Seasonality \u0E41\u0E15\u0E48\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23\u0E44\u0E14\u0E49" : "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E15\u0E48\u0E33 \u2014 Demand \u0E04\u0E48\u0E2D\u0E19\u0E02\u0E49\u0E32\u0E07\u0E2A\u0E21\u0E48\u0E33\u0E40\u0E2A\u0E21\u0E2D")
  ...
  if (E0 >= 30 && N0.push(`\u{1F7E0} Volatility \u0E2A\u0E39\u0E07 (SD=${E0}%) \u2014 \u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E15\u0E48\u0E2D\u0E40\u0E14\u0E37\u0E2D\u0E19\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19 \u0E27\u0E32\u0E07\u0E41\u0E1C\u0E19 Inventory \u0E41\u0E25\u0E30 Staffing \u0E22\u0E32\u0E01 \u0E04\u0E27\u0E23\u0E43\u0E0A\u0E49 Safety Stock \u0E17\u0E35\u0E48\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19`), du.length > 0) {
    const J = du.slice(0, 2).map(G => `${G.month} (${G.growth>=0?"+":""}${G.growth}%)`).join(", ");
    N0.push(`\u{1F7E1} \u0E1E\u0E1A\u0E40\u0E14\u0E37\u0E2D\u0E19 Outlier ${du.length} \u0E40\u0E14\u0E37\u0E2D\u0E19: ${J}${du.length>2?"\u2026":""} \u2014 \u0E2A\u0E2D\u0E1A\u0E2A\u0E27\u0E19\u0E40\u0E2B\u0E15\u0E38\u0E1C\u0E25\u0E40\u0E0A\u0E34\u0E07 Root Cause (\u0E41\u0E1E\u0E17\u0E22\u0E4C\u0E25\u0E32\u0E2D\u0E2D\u0E01, \u0E22\u0E32\u0E02\u0E32\u0E14, \u0E19\u0E42\u0E22\u0E1A\u0E32\u0E22\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19, \u0E40\u0E2B\u0E15\u0E38\u0E01\u0E32\u0E23\u0E13\u0E4C\u0E1E\u0E34\u0E40\u0E28\u0E29)`)
  }
...
function BE() {
  const [s, m0] = Q.useState("opd-compare"), [M, b0] = Q.useState(null), [B, r0] = Q.useState(null), [Z, j0] = Q.useState(null), [Q0, X0] = Q.useState(null), [K0, M0] = Q.useState(null), [d0, g0] = Q.useState(null), [_0, c0] = Q.useState(!0), [Z0, o0] = Q.useState(null), K = Q.useRef(null), [f0, S0] = Q.useState(null), [C0, p0] = Q.useState(null), [Y, uu] = Q.useState(null), [A0, eu] = Q.useState(null), [$0, H0] = Q.useState(null), [y0, U0] = Q.useState(null), [n0, W0] = Q.useState(null), [E0, fu] = Q.useState(null), [hu, G0] = Q.useState(null), du = new Date, wu = du.getMonth() + 1, yu = du.getFullYear(), cu = wu >= 10 ? yu + 544 : yu + 543, Fu = cu - 1, [s0, Wu] = Q.useState(Fu), [u0, Pu] = Q.useState(cu), ru = `${yu}-${String(wu).padStart(2,"0")}-01`, zu = new Date().toISOString().slice(0, 10), [h0, Ru] = Q.useState(ru), [x0, Mu] = Q.useState(zu), [bu, ku] = Q.useState(ru), [N0, Lu] = Q.useState(zu), [F0, Nu] = Q.useState(10), L0 = Q.useCallback(e => e ? F0 === "all" ? e : e.slice(0, F0) : [], [F0]), Tu = Q.useMemo(() => L0(C0?.patients), [C0, L0]), J = Q.useMemo(() => {
    ...
    lE = Q.useCallback(() => {
      ...
      if (s === "pttype-services") {
        ...
        const t = r => Number(r || 0),
          d = new Set(hu === null ? E0.group_order || [] : hu),
      ...
      if (s === "imaging-services") {
        ...
        const t = n0.patients,
          ...
          o = n0.service_counts || {},
          c = n0.total_income || 0,
          a = n0.total_imaging_price || 0,
          m = n0.unique_patients || new Set(t.map(f => f.hn)).size,
      ...
      if (s === "ncd-disease") {
        ...
        if (_ > 0) {
          const A = Math.round(_ / t.length * 100),
            H = t.filter(a0 => (a0.income || 0) > o * 2.5).reduce((a0, z0) => a0 + (z0.income || 0), 0);
          r.push({
            sev: "info",
            cat: "Cost Outlier",
        ...
        if (t0 + v0 + T0 > 0) {
          ...
          r.push({
            ...
            msg: `\u0E04\u0E32\u0E14\u0E01\u0E32\u0E23\u0E13\u0E4C: CKD3\u21924 ~${A} \u0E23\u0E32\u0E22 \xB7 CKD4\u2192ESRD ~${H} \u0E23\u0E32\u0E22 \xB7 ESRD \u0E23\u0E27\u0E21 ${T0+H} \u0E23\u0E32\u0E22 \u2192 HD cost ~${a0.toLocaleString()} \u0E1A\u0E32\u0E17/\u0E1B\u0E35`,
        ...
        const pu = (() => {
          const A = t.length > 0 ? t.filter(a0 => a0.creatinine != null).length / t.length : 0,
            H = D > 0 ? 1 - W / D : 1;
          return Math.round(A * 50 + H * 50)
        })();
        r.push({
          sev: pu >= 80 ? "good" : pu >= 60 ? "med" : "high",
          cat: "NCD Quality Score",
          msg: `NCD Quality Composite: ${pu}/100 (Lab monitoring + Severity mix)`,
          action: pu < 60 ? "\u0E40\u0E1E\u0E34\u0E48\u0E21 annual lab screening \xB7 \u0E15\u0E31\u0E49\u0E07 quality improvement project \xB7 M&M conference \u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A stage progression cases" : pu < 80 ? "\u0E02\u0E22\u0E32\u0E22 screening coverage \xB7 \u0E17\u0E1A\u0E17\u0E27\u0E19 case \u0E21\u0E35 CKD progression \xB7 maintain monitoring frequency" : "maintain current standard \xB7 \u0E40\u0E1C\u0E22\u0E41\u0E1E\u0E23\u0E48 best practice \u0E20\u0E32\u0E22\u0E43\u0E19\u0E41\u0E25\u0E30\u0E20\u0E32\u0E22\u0E19\u0E2D\u0E01"
        }), r.length === 0 && r.push({
          sev: "good",
          cat: "Overall",
...
`),
    ...
    }, [s, M, B, Q0, K0, d0, C0, Y, A0, $0, y0, s0, u0, h0, x0, bu, N0]),
    Uu = Q.useMemo(() => {
      const e = [];
      for (let t = cu; t >= cu - 2; t--) e.push(t);
      return e
    }, [cu]),
    E = AE;
  return u.jsxs("div", {
    ...
    children: [u.jsxs("div", {
      ...
      children: [u.jsx("span", {
        ...
        onClick: sE,
        disabled: s === "ipd-compare" ? !M : s === "opd-compare" ? !B : s === "resource-opd" ? !Q0 : s === "resource-ipd" ? !K0 : s === "frax" ? !C0 : s === "pt" || s === "staff-services" ? !Y : s === "fluoride" ? !A0 : s === "elderly-cxr" ? !$0 : s === "ncd-disease" ? !y0?.patients : s === "imaging-services" ? !n0?.patients : s === "pttype-services" ? !E0?.groups : !d0,
        style: {
          padding: "6px 14px",
          borderRadius: "8px",
          fontSize: "12px",
...
Bed`,
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsx("div", {
              ...
              const H = e.length > 0 ? Math.round(R.count / e.length * 100) : 0,
                a0 = ["#10b981", "#3b82f6", "#8b5cf6", "#f59e0b", "#ef4444"],
                z0 = a0[A % a0.length];
              return u.jsxs("div", {
                style: {
                  marginBottom: "8px"
              ...
              children: [u.jsx("thead", {
                ...
                children: L0(e).map((g, R) => {
                  ...
                  return u.jsxs("tr", {
                    ...
                    onMouseEnter: a0 => a0.currentTarget.style.background = "rgba(59,130,246,.05)",
                    onMouseLeave: a0 => a0.currentTarget.style.background = A,
                    children: [u.jsx("td", {
                      style: {
                        ...E.td,
                        color: "var(--md-text-tertiary)",
    ...
    })(), !_0 && s === "imaging-services" && n0?.patients && (() => {
      const e = n0.patients,
              ...
              children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                  ...
                  return [u.jsxs("div", {
                    ...
                    const R0 = O[xu][A] || 0,
                      tu = a0 > 0 ? R0 / a0 : 0,
                      Iu = R0 > 0 ? `${H}${pu(tu*.85)}` : "transparent";
                    return u.jsxs("div", {
                      style: {
                        padding: "10px 4px",
                        textAlign: "center",
