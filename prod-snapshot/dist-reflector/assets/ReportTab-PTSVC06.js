const Du = (n, g0 = Du, k = g0.f || (g0.f = ["assets/xlsx.min-CZi5yKex.js", "assets/vendor-react-ByYOq5k4.js"])) => n.map(b0 => k[b0]);
import {
  _ as pu,
  E as yE,
  h as Bu
...
function vE(n, g0, k) {
  ...
  const Z = (k0, y0 = 0) => Number.isFinite(Number(k0)) ? Number(k0) : y0,
  ...
  f0.push({
    ...
    text: `\u0E1B\u0E35\u0E07\u0E1A ${k}: IPD \u0E40\u0E2A\u0E35\u0E22\u0E0A\u0E35\u0E27\u0E34\u0E15 ${j0(M0)} \u0E23\u0E32\u0E22 (rate ${m0.toFixed(2)}%) \xB7 OPD \u0E40\u0E2A\u0E35\u0E22\u0E0A\u0E35\u0E27\u0E34\u0E15 ${j0(x0)} \u0E23\u0E32\u0E22 \xB7 \u0E23\u0E27\u0E21 ${j0(d0)}. \u0E40\u0E17\u0E35\u0E22\u0E1A\u0E1B\u0E35\u0E07\u0E1A ${g0}: IPD ${j0(K0)} (rate ${K.toFixed(2)}%) \xB7 OPD ${j0(l0)} \xB7 \u0E23\u0E27\u0E21 ${j0(_0)}. \u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E41\u0E1B\u0E25\u0E07 ${S0>=0?"+":""}${S0}%. ` + (m0 > K + .3 ? "\u26A0 Rate \u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E36\u0E49\u0E19\u0E21\u0E35\u0E19\u0E31\u0E22\u0E2A\u0E33\u0E04\u0E31\u0E0D" : m0 < K - .3 ? "\u2705 Rate \u0E25\u0E14\u0E25\u0E07\u0E21\u0E35\u0E19\u0E31\u0E22\u0E2A\u0E33\u0E04\u0E31\u0E0D" : "Rate \u0E43\u0E01\u0E25\u0E49\u0E40\u0E04\u0E35\u0E22\u0E07\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19"),
    color: eu
  }), f0.push({
    icon: "\u23F1\uFE0F",
    title: "Early Death Pattern (LOS < 2 \u0E27\u0E31\u0E19)",
    text: `\u0E1B\u0E35\u0E07\u0E1A ${k}: Early Death ${j0(r0)} \u0E23\u0E32\u0E22 (${c0.toFixed(1)}% \u0E02\u0E2D\u0E07 IPD Deaths) \xB7 \u0E40\u0E17\u0E35\u0E22\u0E1A\u0E1B\u0E35\u0E07\u0E1A ${g0}: ${j0(Z0)} \u0E23\u0E32\u0E22 (${C0.toFixed(1)}%). ` + (c0 >= 30 ? "\u{1F534} >30% \u0E40\u0E1B\u0E47\u0E19 early death \u2014 \u0E1A\u0E48\u0E07\u0E0A\u0E35\u0E49\u0E04\u0E27\u0E32\u0E21\u0E23\u0E38\u0E19\u0E41\u0E23\u0E07\u0E02\u0E2D\u0E07\u0E42\u0E23\u0E04\u0E15\u0E2D\u0E19\u0E23\u0E31\u0E1A\u0E40\u0E02\u0E49\u0E32 \u0E2B\u0E23\u0E37\u0E2D admission criteria \u0E17\u0E35\u0E48\u0E2D\u0E32\u0E08\u0E0A\u0E49\u0E32" : c0 >= 15 ? "\u26A0 Early death \u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E2A\u0E39\u0E07 \u2014 \u0E04\u0E27\u0E23\u0E17\u0E1A\u0E17\u0E27\u0E19 triage / ER-to-admission flow" : "\u2705 Early death \u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E01\u0E13\u0E11\u0E4C\u0E1B\u0E01\u0E15\u0E34"),
  ...
  return m0 >= 3 && (a0.push("\u{1F534} P0 \xB7 \u0E15\u0E31\u0E49\u0E07 Mortality Review Board (MRB) \u0E23\u0E32\u0E22\u0E2A\u0E31\u0E1B\u0E14\u0E32\u0E2B\u0E4C \u2014 review 100% IPD deaths \xB7 \u0E41\u0E22\u0E01 Preventable vs Non-preventable"), a0.push("\u{1F534} P0 \xB7 Re-train CPR/ACLS + Code Blue response \u0E17\u0E38\u0E01 ward \u0E20\u0E32\u0E22\u0E43\u0E19 30 \u0E27\u0E31\u0E19")), S0 >= 10 && M0 > 0 && a0.push("\u{1F7E0} P1 \xB7 M&M Conference \u0E23\u0E32\u0E22\u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 focus DRG/DX \u0E17\u0E35\u0E48\u0E21\u0E35 mortality \u0E2A\u0E39\u0E07\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14"), c0 >= 20 && a0.push("\u{1F7E0} P1 \xB7 ER Triage Audit \xB7 Early Warning Score (NEWS2) compliance check \xB7 ICU availability in 24/7"), Y && uu >= 3 && a0.push(`\u{1F7E1} P2 \xB7 Retrospective Case Review \u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A ${Y} \xB7 deep-dive case mix + intervention timing`), M0 >= 20 && a0.push("\u{1F535} P1 \xB7 \u0E2A\u0E23\u0E49\u0E32\u0E07 Mortality Dashboard \u0E23\u0E32\u0E22 Ward / DRG \xB7 \u0E17\u0E1A\u0E17\u0E27\u0E19\u0E17\u0E38\u0E01 3 \u0E40\u0E14\u0E37\u0E2D\u0E19"), a0.push("\u{1F535} P1 \xB7 Preventable Death Reporting \u2014 \u0E41\u0E22\u0E01\u0E40\u0E04\u0E2A\u0E17\u0E35\u0E48 intervention \u0E17\u0E35\u0E48\u0E14\u0E35\u0E01\u0E27\u0E48\u0E32\u0E2D\u0E32\u0E08\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C"), x0 > 0 && a0.push("\u{1F7E1} P2 \xB7 ER Mortality Review \u2014 focus DNR/DAMA patterns \xB7 dispatch time \xB7 resuscitation quality"), f0.push({
    ...
    kpi: H0,
    sections: f0,
    footerLeft: `IPD Discharged ${j0(X0)} \xB7 ${t0.length} \u0E40\u0E14\u0E37\u0E2D\u0E19\u0E17\u0E35\u0E48\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E44\u0E14\u0E49 \xB7 FY${g0} vs FY${k} \xB7 \u0E2D\u0E31\u0E1B\u0E40\u0E14\u0E15 ${new Date().toLocaleString("th-TH")}`
  }
}
...
function DE(n, g0, k, b0 = "OPD") {
  ...
  for (const J of $0) {
    const G = J.fy1.lab_orders + J.fy1.drug_orders + J.fy1.xray_orders,
      W0 = J.fy2.lab_orders + J.fy2.drug_orders + J.fy2.xray_orders,
    ...
    H0.push({
      ...
      fy1Px: V0,
      fy2Px: Y0
    }), Eu > a0 && (a0 = Eu, f0 = J.month), Eu < k0 && (k0 = Eu, U0 = J.month)
  }
  let y0 = 0,
    mu = 0;
  if (H0.length >= 2) {
    mu = H0.reduce((G, W0) => G + W0.g, 0) / H0.length;
    const J = H0.reduce((G, W0) => G + (W0.g - mu) ** 2, 0) / H0.length;
  ...
  if (H0.length >= 4) {
    const J = Math.floor(H0.length / 2),
      G = H0.slice(0, J),
      W0 = H0.slice(H0.length - J),
      V0 = G.reduce((ou, iu) => ou + iu.fy1Px, 0),
      Y0 = G.reduce((ou, iu) => ou + iu.fy2Px, 0),
      Eu = W0.reduce((ou, iu) => ou + iu.fy1Px, 0),
      bu = W0.reduce((ou, iu) => ou + iu.fy2Px, 0),
  ...
  for (const [J, G] of Object.entries(n0)) {
    ...
    let Y0;
    G.pxG >= 5 && G.ordG >= 5 ? Y0 = "\u0E02\u0E22\u0E32\u0E22\u0E15\u0E31\u0E27\u0E17\u0E31\u0E49\u0E07\u0E1B\u0E23\u0E34\u0E21\u0E32\u0E13\u0E41\u0E25\u0E30\u0E21\u0E39\u0E25\u0E04\u0E48\u0E32" : G.pxG >= 5 && G.ordG < 2 ? Y0 = "Value-driven \u2014 \u0E23\u0E32\u0E04\u0E32\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E2A\u0E39\u0E07\u0E02\u0E36\u0E49\u0E19" : G.pxG < 0 && G.ordG > 0 ? Y0 = "Margin Compression \u2014 \u0E23\u0E32\u0E04\u0E32\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07\u0E16\u0E39\u0E01\u0E01\u0E14" : G.pxG < -3 && G.ordG < 0 ? Y0 = "\u0E2B\u0E14\u0E15\u0E31\u0E27\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E2D\u0E07\u0E21\u0E34\u0E15\u0E34" : Y0 = "\u0E40\u0E15\u0E34\u0E1A\u0E42\u0E15\u0E43\u0E19\u0E23\u0E30\u0E14\u0E31\u0E1A\u0E1B\u0E01\u0E15\u0E34", ku[J] = {
      label: G.label,
      icon: G.icon,
      color: G.color,
  ...
  const zu = Math.round(M0 / j0),
    ...
    yu = `\u0E04\u0E48\u0E32\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22\u0E15\u0E48\u0E2D\u0E04\u0E23\u0E31\u0E49\u0E07 \u0E1B\u0E35\u0E07\u0E1A ${k}: Lab \u0E3F${a(Math.round(m0.Lab.f2))}/\u0E04\u0E23\u0E31\u0E49\u0E07 (${S0(m0.Lab)>=0?"\u2191":"\u2193"}${Math.abs(S0(m0.Lab))}% \xB7 FY${g0}: \u0E3F${a(Math.round(m0.Lab.f1))}) \xB7 Drug \u0E3F${a(Math.round(m0.Drug.f2))}/\u0E04\u0E23\u0E31\u0E49\u0E07 (${S0(m0.Drug)>=0?"\u2191":"\u2193"}${Math.abs(S0(m0.Drug))}% \xB7 FY${g0}: \u0E3F${a(Math.round(m0.Drug.f1))}) \xB7 CT/X-ray \u0E3F${a(Math.round(m0.Xray.f2))}/\u0E04\u0E23\u0E31\u0E49\u0E07 (${S0(m0.Xray)>=0?"\u2191":"\u2193"}${Math.abs(S0(m0.Xray))}% \xB7 FY${g0}: \u0E3F${a(Math.round(m0.Xray.f1))}) \u2014 \u0E15\u0E31\u0E27\u0E40\u0E25\u0E02\u0E19\u0E35\u0E49\u0E2A\u0E30\u0E17\u0E49\u0E2D\u0E19 Case Complexity \u0E41\u0E25\u0E30\u0E15\u0E49\u0E19\u0E17\u0E38\u0E19\u0E08\u0E23\u0E34\u0E07\u0E15\u0E48\u0E2D\u0E01\u0E32\u0E23\u0E43\u0E2B\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 ${Mu}. ` + (m0.Drug.f2 > m0.Drug.f1 * 1.1 ? "Drug Unit Price \u0E1E\u0E38\u0E48\u0E07\u0E40\u0E01\u0E34\u0E19 10% \u2014 \u0E04\u0E27\u0E23\u0E15\u0E23\u0E27\u0E08\u0E2A\u0E2D\u0E1A High-cost Drug List. " : "") + (m0.Xray.f2 > m0.Xray.f1 * 1.1 ? "Imaging Unit Price \u0E1E\u0E38\u0E48\u0E07\u0E40\u0E01\u0E34\u0E19 10% \u2014 \u0E2D\u0E32\u0E08\u0E21\u0E35\u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49 CT/MRI \u0E2A\u0E31\u0E14\u0E2A\u0E48\u0E27\u0E19\u0E21\u0E32\u0E01\u0E02\u0E36\u0E49\u0E19. " : "");
  let Wu;
  if (f0 && U0) {
    const J = Math.round(a0 - k0);
    Wu = `\u0E40\u0E14\u0E37\u0E2D\u0E19 Peak: ${f0} (${a0>=0?"+":""}${Math.round(a0)}%) \xB7 \u0E40\u0E14\u0E37\u0E2D\u0E19 Dip: ${U0} (${k0>=0?"+":""}${Math.round(k0)}%) \xB7 Spread = ${J} percentage points. ` + (J >= 40 ? "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E2A\u0E39\u0E07 \u2014 \u0E0A\u0E48\u0E2D\u0E07\u0E27\u0E48\u0E32\u0E07\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07\u0E1E\u0E35\u0E04\u0E41\u0E25\u0E30\u0E14\u0E34\u0E1B\u0E21\u0E32\u0E01 \u0E15\u0E49\u0E2D\u0E07\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23 Staffing, Stock, Capacity \u0E41\u0E1A\u0E1A\u0E22\u0E37\u0E14\u0E2B\u0E22\u0E38\u0E48\u0E19" : J >= 20 ? "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E1B\u0E32\u0E19\u0E01\u0E25\u0E32\u0E07 \u2014 \u0E21\u0E35 Seasonality \u0E41\u0E15\u0E48\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23\u0E44\u0E14\u0E49" : "\u0E04\u0E27\u0E32\u0E21\u0E1C\u0E31\u0E19\u0E1C\u0E27\u0E19\u0E15\u0E48\u0E33 \u2014 Demand \u0E04\u0E48\u0E2D\u0E19\u0E02\u0E49\u0E32\u0E07\u0E2A\u0E21\u0E48\u0E33\u0E40\u0E2A\u0E21\u0E2D")
...
function nE({
  ...
  const D = Q.useMemo(() => DE(n, g0, k, b0), [n, g0, k, b0]);
  if (!D) return null;
...
function BE() {
  const [n, g0] = Q.useState("opd-compare"), [k, b0] = Q.useState(null), [D, t0] = Q.useState(null), [Z, j0] = Q.useState(null), [Q0, X0] = Q.useState(null), [K0, M0] = Q.useState(null), [l0, x0] = Q.useState(null), [_0, d0] = Q.useState(!0), [Z0, r0] = Q.useState(null), K = Q.useRef(null), [m0, S0] = Q.useState(null), [C0, c0] = Q.useState(null), [Y, uu] = Q.useState(null), [A0, eu] = Q.useState(null), [$0, H0] = Q.useState(null), [f0, U0] = Q.useState(null), [a0, k0] = Q.useState(null), [y0, mu] = Q.useState(null), [ju, G0] = Q.useState(null), lu = new Date, wu = lu.getMonth() + 1, fu = lu.getFullYear(), du = wu >= 10 ? fu + 544 : fu + 543, Fu = du - 1, [n0, ku] = Q.useState(Fu), [u0, Pu] = Q.useState(du), ru = `${fu}-${String(wu).padStart(2,"0")}-01`, zu = new Date().toISOString().slice(0, 10), [p0, Ru] = Q.useState(ru), [h0, Mu] = Q.useState(zu), [yu, Wu] = Q.useState(ru), [N0, Lu] = Q.useState(zu), [F0, Nu] = Q.useState(10), L0 = Q.useCallback(e => e ? F0 === "all" ? e : e.slice(0, F0) : [], [F0]), Tu = Q.useMemo(() => L0(C0?.patients), [C0, L0]), J = Q.useMemo(() => {
  ...
  Q.useEffect(() => {
    n === "ipd-compare" ? G() : n === "opd-compare" ? W0() : n === "resource-opd" ? V0() : n === "resource-ipd" ? Y0() : n === "mortality" ? Eu() : n === "frax" ? bu() : n === "pt" ? _u() : n === "fluoride" ? Au() : n === "elderly-cxr" ? ou() : n === "ncd-disease" ? iu() : n === "imaging-services" ? Ou() : n === "pttype-services" ? Hu() : n === "staff-services" && Cu()
  }, [n, G, W0, V0, Y0, Eu, bu, _u, Cu, Au, ou, iu, Ou, Hu]), Q.useEffect(() => {
    const e = setTimeout(() => {
  ...
  const Yu = Q.useMemo(() => {
      ...
      const e = k.comparison.filter(d => d.fy2.has_data).map(d => d.month);
      if (e.length === 0) return "";
      const t = k.fiscal_years?.fy2?.be || u0;
    ...
    sE = Q.useCallback(() => {
      ...
      t.document.write(`
      <html><head><title>\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 ${k?.title||`${n0}-${u0}`}</title>
      <style>
    ...
    lE = Q.useCallback(() => {
      const e = (t, d) => {
        ...
        C["!ref"] = t.utils.encode_range({
          ...
          xSplit: 0,
          ySplit: 3
        }, t.utils.book_append_sheet(W, C, "Overview");
        const U = {};
        ...
        d.patientData.forEach((F, j) => {
          ...
          xSplit: 0,
          ySplit: 1
        }, t.utils.book_append_sheet(W, U, d.patientSheetName || "Data"), t.writeFile(W, d.filename)
      };
      if (n === "ipd-compare") {
        if (!k?.comparison) return;
        const t = (h, A) => h > 0 ? Math.round((A - h) / h * 100) + "%" : A > 0 ? "100%" : "0%",
          d = k.fiscal_years?.fy1?.label || `\u0E1B\u0E35\u0E07\u0E1A ${n0}`,
          W = k.fiscal_years?.fy2?.label || `\u0E1B\u0E35\u0E07\u0E1A ${u0}`,
          r = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", `Admit (${d})`, `D/C (${d})`, "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19", "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22", "\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07", "\u0E40\u0E15\u0E35\u0E22\u0E07\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E08\u0E23\u0E34\u0E07", "Sum AdjRW", "CMI", `Admit (${W})`, `D/C (${W})`, "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19", "\u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19\u0E40\u0E09\u0E25\u0E35\u0E48\u0E22", "\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07", "\u0E40\u0E15\u0E35\u0E22\u0E07\u0E17\u0E35\u0E48\u0E43\u0E0A\u0E49\u0E08\u0E23\u0E34\u0E07", "Sum AdjRW", "CMI", "YoY Admit %", "YoY D/C %", "YoY \u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19 %", "YoY ALOS %", "YoY \u0E04\u0E23\u0E2D\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07 %", "YoY Active Bed %", "YoY AdjRW %", "YoY CMI %", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 Admit", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 D/C", "\u0E2A\u0E48\u0E27\u0E19\u0E15\u0E48\u0E32\u0E07 \u0E27\u0E31\u0E19\u0E19\u0E2D\u0E19"],
          c = k.comparison.map(h => [h.month, h.fy1.admits, h.fy1.discharges, h.fy1.total_los, h.fy1.alos, h.fy1.occupancy_rate, h.fy1.active_beds, h.fy1.sum_adjrw, h.fy1.cmi, h.fy2.admits, h.fy2.discharges, h.fy2.total_los, h.fy2.alos, h.fy2.occupancy_rate, h.fy2.active_beds, h.fy2.sum_adjrw, h.fy2.cmi, t(h.fy1.admits, h.fy2.admits), t(h.fy1.discharges, h.fy2.discharges), t(h.fy1.total_los, h.fy2.total_los), t(h.fy1.alos, h.fy2.alos), t(h.fy1.occupancy_rate, h.fy2.occupancy_rate), t(h.fy1.active_beds, h.fy2.active_beds), t(h.fy1.sum_adjrw, h.fy2.sum_adjrw), t(h.fy1.cmi, h.fy2.cmi), h.admit_diff, (h.fy2.discharges || 0) - (h.fy1.discharges || 0), h.fy2.total_los - h.fy1.total_los]),
          o = k.fy1_totals,
          m = k.fy2_totals;
        c.push(["\u0E23\u0E27\u0E21", o.admits, o.discharges, o.total_los, o.alos, o.occupancy_rate, o.active_beds, o.sum_adjrw, o.cmi, m.admits, m.discharges, m.total_los, m.alos, m.occupancy_rate, m.active_beds, m.sum_adjrw, m.cmi, t(o.admits, m.admits), t(o.discharges, m.discharges), t(o.total_los, m.total_los), t(o.alos, m.alos), t(o.occupancy_rate, m.occupancy_rate), t(o.active_beds, m.active_beds), t(o.sum_adjrw, m.sum_adjrw), t(o.cmi, m.cmi), k.overall_admit_diff, (m.discharges || 0) - (o.discharges || 0), m.total_los - o.total_los]), pu(() => import("./xlsx-BuHXVOW6.js"), []).then(h => {
          const A = [r, ...c],
      ...
      if (n === "frax") {
        ...
        const d = new Set(t.map(b => b.hn)).size,
          W = t.length > 0 ? t.reduce((b, _) => b + (Number(_.major_osteoporotic) || 0), 0) / t.length : 0,
        ...
        pu(() => import("./xlsx.min-CZi5yKex.js").then(x => x.x), Du([0, 1])).then(x => {
          e(x, {
            ...
            kpis: [...n === "staff-services" && Y?.staff_registry_count ? [{
              ...
              color: "7C3AED",
              fmt: "#,##0",
              note: `\u0E21\u0E32\u0E43\u0E0A\u0E49\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 ${W} \u0E23\u0E32\u0E22 (${Y.staff_registry_count>0?Math.round(W/Y.staff_registry_count*1e3)/10:0}%)`
            }] : [], {
      ...
      if (n === "fluoride") {
        ...
        const t = A0.patients,
          ...
          W = t.reduce((p, l) => p + (Number(l.income) || 0), 0),
      ...
      if (n === "elderly-cxr") {
        ...
        const t = $0.patients,
          ...
          W = $0.total_cxr_price || t.reduce((i, x) => i + (Number(x.cxr_price) || 0), 0),
        ...
        M > 0 && H.push({
          ...
          sev: "info",
          cat: "Cost Analysis",
          msg: `\u0E04\u0E48\u0E32 CXR \u0E23\u0E27\u0E21 ${W.toLocaleString()} \u0E1A\u0E32\u0E17 \xB7 \u0E23\u0E32\u0E22\u0E44\u0E14\u0E49 Visit \u0E23\u0E27\u0E21 ${d.toLocaleString()} \u0E1A\u0E32\u0E17`,
      ...
      if (n === "opd-compare") {
        ...
        const t = (C, S) => C > 0 ? Math.round((S - C) / C * 100) + "%" : S > 0 ? "100%" : "0%",
          ...
          W = D.fiscal_years?.fy2?.label || "\u0E1B\u0E35\u0E1B\u0E31\u0E08\u0E08\u0E38\u0E1A\u0E31\u0E19",
          ...
          o = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", ...c.map(C => `${C} (${d})`), ...c.map(C => `${C} (${W})`), ...c.map(C => `YoY ${C} %`)],
      ...
      if (n === "resource-opd" || n === "resource-ipd") {
        ...
        o.push(["\u0E23\u0E27\u0E21", m.lab_orders, m.lab_price, m.drug_orders, m.drug_price, m.xray_orders, m.xray_price, A, C, h.lab_orders, h.lab_price, h.drug_orders, h.drug_price, h.xray_orders, h.xray_price, S, w, `${t.overall_orders_growth_pct}%`, `${t.overall_price_growth_pct}%`]), pu(() => import("./xlsx-BuHXVOW6.js"), []).then(R => {
          ...
          R.utils.book_append_sheet(_, b, `\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 ${W}`), R.writeFile(_, `BCH360_Resource_${d}_Monthly_${n0}_${u0}.xlsx`)
        });
        return
      }
      if (n === "ncd-disease") {
        ...
        pu(() => import("./xlsx.min-CZi5yKex.js").then(y => y.x), Du([0, 1])).then(y => {
          ...
          X(s, 0, "\u{1FAC0}  \u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E2A\u0E23\u0E38\u0E1B\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 NCD \u0E41\u0E22\u0E01\u0E42\u0E23\u0E04", dE), o0(s, 0, s, z0 - 1), w0[s] = {
            hpx: 56
          }, s++, X(s, 0, `\u{1F4C5}  \u0E0A\u0E48\u0E27\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25:  ${f0.date_range.start}  \u2192  ${f0.date_range.end}    \xB7    \u{1F465}  ${t.length.toLocaleString()} visit  /  ${W.toLocaleString()} \u0E23\u0E32\u0E22`, cE), o0(s, 0, s, z0 - 1), w0[s] = {
            hpx: 28
          ...
          const hE = [
            ...
            ["\u0E08\u0E33\u0E19\u0E27\u0E19\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23 (HN \u0E44\u0E21\u0E48\u0E0B\u0E49\u0E33)", W, "\u0E23\u0E32\u0E22", T.purple, "#,##0", "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E32\u0E22\u0E1A\u0E38\u0E04\u0E04\u0E25 \u0E19\u0E31\u0E1A 1 HN \u0E15\u0E48\u0E2D 1 \u0E04\u0E23\u0E31\u0E49\u0E07"],
      ...
      if (n === "mortality") {
        ...
        const t = ["\u0E40\u0E14\u0E37\u0E2D\u0E19", `IPD \u0E08\u0E33\u0E2B\u0E19\u0E48\u0E32\u0E22 (${n0})`, `IPD \u0E15\u0E32\u0E22 (${n0})`, `IPD \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E15\u0E32\u0E22% (${n0})`, `OPD \u0E15\u0E32\u0E22 (${n0})`, `\u0E23\u0E27\u0E21\u0E15\u0E32\u0E22 (${n0})`, `IPD \u0E08\u0E33\u0E2B\u0E19\u0E48\u0E32\u0E22 (${u0})`, `IPD \u0E15\u0E32\u0E22 (${u0})`, `IPD \u0E2D\u0E31\u0E15\u0E23\u0E32\u0E15\u0E32\u0E22% (${u0})`, `OPD \u0E15\u0E32\u0E22 (${u0})`, `\u0E23\u0E27\u0E21\u0E15\u0E32\u0E22 (${u0})`],
          ...
          W = "\uFEFF" + [t.join(","), ...d.map(m => m.join(","))].join(`\r
`),
          r = new Blob([W], {
    ...
    }, [n, k, D, Q0, K0, l0, C0, Y, A0, $0, f0, n0, u0, p0, h0, yu, N0]),
    Uu = Q.useMemo(() => {
      const e = [];
  ...
  return u.jsxs("div", {
    ...
    children: [u.jsxs("div", {
      ...
      children: [u.jsx("span", {
        ...
        onClick: () => n === "ipd-compare" ? G() : n === "opd-compare" ? W0() : n === "resource-opd" ? V0() : n === "resource-ipd" ? Y0() : n === "frax" ? bu() : n === "pt" ? _u() : n === "staff-services" ? Cu() : n === "fluoride" ? Au() : n === "elderly-cxr" ? ou() : n === "ncd-disease" ? iu() : n === "imaging-services" ? Ou() : n === "pttype-services" ? Hu() : Eu(),
        disabled: _0,
        style: {
          padding: "6px 16px",
          borderRadius: "8px",
        ...
        onClick: sE,
        disabled: n === "ipd-compare" ? !k : n === "opd-compare" ? !D : n === "resource-opd" ? !Q0 : n === "resource-ipd" ? !K0 : n === "frax" ? !C0 : n === "pt" || n === "staff-services" ? !Y : n === "fluoride" ? !A0 : n === "elderly-cxr" ? !$0 : n === "ncd-disease" ? !f0?.patients : n === "imaging-services" ? !a0?.patients : n === "pttype-services" ? !y0?.groups : !l0,
        style: {
          padding: "6px 14px",
          borderRadius: "8px",
          fontSize: "12px",
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
          ...
          const S = o(r.sum_adjrw, c.sum_adjrw),
            w = o(r.cmi, c.cmi),
            R = k.comparable_months || 0,
            M = k.custom_range ? `${k.custom_range.start} \u2014 ${k.custom_range.end}` : k.fiscal_years?.fy2?.label || "",
            b = [],
            _ = c.admits - c.discharges,
            H = r.discharges > 0 ? r.sum_adjrw / r.discharges : 0,
            p = c.discharges > 0 ? c.sum_adjrw / c.discharges : 0;
          k.total_beds * 30 * R, m < -5 ? b.push({
            icon: "\u{1F4C9}",
            color: "#dc2626",
          ...
          return c.occupancy_rate > 85 ? b.push({
            ...
            detail: `Active Bed ${a(c.active_beds,1)}/${k.total_beds} \u0E40\u0E15\u0E35\u0E22\u0E07 \u2014 \u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07\u0E40\u0E15\u0E35\u0E22\u0E07\u0E25\u0E49\u0E19 \u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E2D Admit \u0E19\u0E32\u0E19 + Workload \u0E1E\u0E22\u0E32\u0E1A\u0E32\u0E25\u0E2A\u0E39\u0E07 + \u0E40\u0E1E\u0E34\u0E48\u0E21\u0E04\u0E27\u0E32\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07 HAI`,
            actions: [{
              who: "Bed Manager",
            ...
            detail: `Active Bed ${a(c.active_beds,1)}/${k.total_beds} \u0E40\u0E15\u0E35\u0E22\u0E07 \u2014 \u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23 (\u0E1A\u0E38\u0E04\u0E25\u0E32\u0E01\u0E23/\u0E2A\u0E32\u0E18\u0E32\u0E23\u0E13\u0E39\u0E1B\u0E42\u0E20\u0E04) \u0E16\u0E39\u0E01\u0E43\u0E0A\u0E49\u0E44\u0E21\u0E48\u0E04\u0E38\u0E49\u0E21\u0E04\u0E48\u0E32`,
            actions: [{
              who: "\u0E1C\u0E39\u0E49\u0E1A\u0E23\u0E34\u0E2B\u0E32\u0E23",
            ...
            detail: `Active Bed ${a(c.active_beds,1)}/${k.total_beds} \u0E40\u0E15\u0E35\u0E22\u0E07 \u2014 \u0E43\u0E0A\u0E49\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E32\u0E01\u0E23\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E2A\u0E21\u0E14\u0E38\u0E25 \u0E22\u0E31\u0E07\u0E21\u0E35\u0E40\u0E15\u0E35\u0E22\u0E07\u0E2A\u0E33\u0E23\u0E2D\u0E07\u0E23\u0E2D\u0E07\u0E23\u0E31\u0E1A Surge`,
            actions: []
          }), w < -10 ? b.push({
            icon: "\u{1F4CB}",
            color: "#dc2626",
            ...
            children: [u.jsxs("div", {
              ...
              children: [u.jsx("span", {
                ...
                children: [M, " \xB7 ", R, " \u0E40\u0E14\u0E37\u0E2D\u0E19 \xB7 \u0E40\u0E15\u0E35\u0E22\u0E07 ", k.total_beds]
              })]
            }), u.jsx("div", {
              style: {
                display: "flex",
      ...
      children: [u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
          ...
          children: [u.jsx("div", {
            ...
            children: [k.custom_range ? `${k.custom_range.start} \u0E16\u0E36\u0E07 ${k.custom_range.end} vs \u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19` : Yu && `${k.fiscal_years.fy2.label} ${Yu}`, " \xB7 \u0E40\u0E15\u0E35\u0E22\u0E07\u0E08\u0E23\u0E34\u0E07: ", k.total_beds, " \u0E40\u0E15\u0E35\u0E22\u0E07"]
          })]
        }), u.jsxs("table", {
          style: {
            width: "100%",
...
Bed`,
            ...
            children: [k.comparison.filter(e => e.fy1.has_data && e.fy2.has_data).map((e, t) => u.jsxs("tr", {
              ...
              children: [u.jsx("td", {
                ...
                const o = d > 0 ? Math.round((W - d) / d * 100) : W > 0 ? 100 : 0;
                return u.jsxs("td", {
                  style: {
                    ...E.tdNum,
                    fontWeight: 800,
              ...
              children: [u.jsx("td", {
                ...
                return u.jsxs(u.Fragment, {
                  children: [u.jsx("td", {
                    ...
                    children: a(W.discharges)
                  }), u.jsx("td", {
                    style: d,
                    children: a(W.total_los)
                  }), u.jsx("td", {
                    style: {
                      ...d,
                      borderRight: t
                    ...
                    style: d,
                    children: a(W.occupancy_rate, 2)
                  }), u.jsx("td", {
                    style: {
                      ...d,
                      borderRight: t
                    },
                    children: a(W.active_beds, 2)
                  }), u.jsx("td", {
                    style: d,
                    children: a(W.sum_adjrw, 2)
                  }), u.jsx("td", {
                    style: {
                      ...d,
                      borderRight: e
      ...
      const e = Q0,
        t = e.fy1_totals,
        d = e.fy2_totals,
        W = (o, m) => m > 0 ? Math.round((o - m) / m * 100) : o > 0 ? 100 : 0;
          ...
          children: [u.jsxs("div", {
            ...
            children: [u.jsxs("thead", {
              ...
              children: [e.comparison.filter(o => o.fy1?.has_data && o.fy2?.has_data).map((o, m) => {
                const h = o.fy1,
                  A = o.fy2,
                  C = W(A.total_deaths, h.total_deaths),
              ...
              children: [u.jsx("thead", {
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", $0.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E0A\u0E32\u0E22 ", r, " \xB7 \u0E2B\u0E0D\u0E34\u0E07 ", c, " \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", W.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
              ...
              children: [u.jsx("thead", {
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", A0.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", W.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
      ...
      const W = Y.opd_count || e.filter(g => g.visit_type === "OPD").length,
      ...
      return u.jsxs("div", {
        ...
        children: [u.jsx("div", {
          ...
          children: [...n === "staff-services" && Y.staff_registry_count ? [{
            ...
            unit: "\u0E23\u0E32\u0E22",
            color: "#0ea5e9",
            yoy: f(i(W, L?.opd_count), L?.opd_count, "\u0E23\u0E32\u0E22")
          }, {
            label: "\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E43\u0E19 (IPD)",
            icon: "\u{1F6CF}\uFE0F",
            value: r.toLocaleString(),
              ...
              children: [u.jsx("thead", {
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", Y.total.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 OPD ", W, " (", c.toLocaleString(), " \u0E3F) \xB7 IPD ", r, " (", o.toLocaleString(), " \u0E3F) \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", d.toLocaleString(), " \u0E1A\u0E32\u0E17/\u0E23\u0E32\u0E22"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
              ...
              children: [u.jsx("thead", {
                ...
                children: u.jsxs("tr", {
                  ...
                  children: [u.jsxs("td", {
                    ...
                    }), "\u0E23\u0E27\u0E21 ", e.length.toLocaleString(), " visit \xB7 ", d.toLocaleString(), " \u0E23\u0E32\u0E22 \xB7 \u0E40\u0E09\u0E25\u0E35\u0E48\u0E22 ", W.toLocaleString(), " \u0E1A\u0E32\u0E17/visit"]
                  }), u.jsx("td", {
                    style: {
                      ...E.tdNum,
                      fontWeight: 900,
      ...
      const l = Object.entries(p).sort((B, F) => F[1].count - B[1].count),
        L = t.reduce((B, F) => B + (W[F] || 0), 0),
        i = t.reduce((B, F) => (W[F] || 0) > (W[B] || 0) ? F : B, t[0]),
      ...
      const e = y0.group_order || ["UC", "\u0E02\u0E49\u0E32\u0E23\u0E32\u0E0A\u0E01\u0E32\u0E23 / \u0E2D\u0E1B\u0E17", "\u0E0A\u0E33\u0E23\u0E30\u0E40\u0E07\u0E34\u0E19\u0E40\u0E2D\u0E07", "\u0E15\u0E48\u0E32\u0E07\u0E0A\u0E32\u0E15\u0E34 (1.5 \u0E40\u0E17\u0E48\u0E32)", "\u0E15\u0E48\u0E32\u0E07\u0E14\u0E49\u0E32\u0E27", "\u0E1B\u0E23\u0E30\u0E01\u0E31\u0E19\u0E2A\u0E31\u0E07\u0E04\u0E21", "\u0E1E\u0E23\u0E1A", "\u0E23\u0E31\u0E10\u0E27\u0E34\u0E2A\u0E32\u0E2B\u0E01\u0E34\u0E08", "\u0E2D\u0E37\u0E48\u0E19\u0E46"],
        ...
        W = t.filter(j => d.has(j.group_name)),
        r = (y0.group_trend || []).filter(j => d.has(j.group_name)),
        c = (y0.summary || []).filter(j => d.has(j.group_name)),
        o = W.reduce((j, I) => j + (I.total_visits || 0), 0),
        m = W.reduce((j, I) => j + (I.opd_visits || 0), 0),
        h = W.reduce((j, I) => j + (I.ipd_admissions || 0), 0),
        A = W.reduce((j, I) => j + (I.er_visits || 0), 0),
        C = W.reduce((j, I) => j + (Math.max(I.opd_hn, I.ipd_hn, I.er_hn) || 0), 0),
        S = j => Number(j || 0).toLocaleString(),
        w = [...W].sort((j, I) => I.total_visits - j.total_visits),
        R = w[0] || null,
        ...
        B = [];
      if (B.push(`\u{1F4CA} \u0E20\u0E32\u0E1E\u0E23\u0E27\u0E21\u0E0A\u0E48\u0E27\u0E07 ${y0.from} \u2192 ${y0.to}: ${S(o)} \u0E04\u0E23\u0E31\u0E49\u0E07 (OPD ${S(m)} \xB7 IPD ${S(h)} \xB7 ER ${S(A)}) \u0E08\u0E32\u0E01\u0E1C\u0E39\u0E49\u0E1B\u0E48\u0E27\u0E22\u0E23\u0E27\u0E21 ${S(C)} \u0E23\u0E32\u0E22 \u0E01\u0E23\u0E30\u0E08\u0E32\u0E22 ${W.length} \u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C (\u0E08\u0E32\u0E01\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14 ${e.length} \u0E2B\u0E21\u0E27\u0E14\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19)`), R && M >= 40 && B.push(`\u{1F3E5} \u0E2B\u0E21\u0E27\u0E14\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E40\u0E14\u0E48\u0E19\u0E17\u0E35\u0E48\u0E2A\u0E38\u0E14: ${R.group_name} \u0E04\u0E34\u0E14\u0E40\u0E1B\u0E47\u0E19 ${M}% \u0E02\u0E2D\u0E07\u0E1A\u0E23\u0E34\u0E01\u0E32\u0E23\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14 (${S(R.total_visits)} \u0E04\u0E23\u0E31\u0E49\u0E07) \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E04\u0E38\u0E13\u0E20\u0E32\u0E1E\u0E41\u0E25\u0E30\u0E01\u0E32\u0E23 reimbursement \u0E01\u0E25\u0E38\u0E48\u0E21\u0E19\u0E35\u0E49\u0E40\u0E1B\u0E47\u0E19\u0E1E\u0E34\u0E40\u0E28\u0E29`), h > 0 && m > 0) {
          ...
          children: [u.jsx("div", {
            ...
            children: [u.jsx("thead", {
              children: u.jsxs("tr", {
                ...
                children: ["\u0E2B\u0E21\u0E27\u0E14 / \u0E01\u0E25\u0E38\u0E48\u0E21\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C", "OPD (\u0E04\u0E23\u0E31\u0E49\u0E07)", "OPD (\u0E04\u0E19)", "IPD (\u0E04\u0E23\u0E31\u0E49\u0E07)", "IPD (\u0E04\u0E19)", "ER (\u0E04\u0E23\u0E31\u0E49\u0E07)", "ER (\u0E04\u0E19)", "\u0E23\u0E27\u0E21 (\u0E04\u0E23\u0E31\u0E49\u0E07)", "% \u0E02\u0E2D\u0E07\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14"].map((j, I) => u.jsx("th", {
                  style: {
                    padding: "8px 10px",
